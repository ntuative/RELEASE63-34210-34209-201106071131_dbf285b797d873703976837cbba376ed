package
{
   ...
   public class HabboMain extends Sprite
   {
      ...
      private static const const_1016:Number = 0.71;
      ...
      private var var_1406:HabboTracking;
      ...
      private function initializeCore() : void
      {
         ...
         catch(error:Error)
         {
            ...
            Core.crash("Failed to initialize the core: " + error.message,Core.const_1212,error);
         }
      }
      ...
      protected function onAddedToStage(param1:Event = null) : void
      {
         ...
         {
            Habbo.trackLoginStep(Habbo.const_21);
            Habbo.reportCrash("Failed to prepare the core: " + error.message,Core.const_1212,error);
            Core.dispose();
         }
      }
      ...
      private function prepareCore() : void
      {
         ...
         this.var_1406 = HabboTracking.getInstance();
      ...
      private function onProgressEvent(param1:ProgressEvent) : void
      {
         ...
         if(this.var_1)
         {
            ...
            if(param1 is LibraryProgressEvent)
            {
               ...
               {
                  if(this.var_1406 && !this.var_1406.disposed)
                  {
                     this.var_1406.trackGoogle("libraryLoaded",_loc4_.fileName,_loc4_.elapsedTime);
                  }
               }
            }
         }
      ...
      private function updateLoadingBar(param1:DisplayObjectContainer, param2:Number) : void
      {
         ...
         var _loc12_:Number = 1 - const_1016 + this.var_24.getNumberOfFilesLoaded() / _loc11_ * const_1016;
         _loc8_.x = 1 + 1;
         _loc8_.y = 1 + 1;

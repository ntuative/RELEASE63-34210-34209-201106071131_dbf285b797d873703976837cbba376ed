package com.sulake.habbo.localization
{
   public class BadgeBaseAndLevel
   {
      ...
      public function BadgeBaseAndLevel(param1:String)
      {
         ...
         {
            this.var_1334 = int(_loc3_);
         }
         Logger.log("Split badgeId " + param1 + " into " + this._base + " and " + this.var_1334);
      }
      ...
      {
         this.var_1334 = Math.max(1,param1);
      }
      
      public function get badgeId() : String
      {
         return this._base + this.var_1334;
      }
   }
}

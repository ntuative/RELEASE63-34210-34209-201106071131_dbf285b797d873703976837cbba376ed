package com.sulake.habbo.localization
{
   ...
   public class HabboLocalizationManager extends CoreLocalizationManager implements IHabboLocalizationManager
   {
      ...
      public function HabboLocalizationManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_2844 = ["I","II","III","IV","V","VI","VII","VIII","IX","X","XI","XII","XIII","XIV","XV","XVI","XVII","XVIII","XIX","XX"];
         ...
         if(param2 != null)
         {
            ...
            if(!this.var_2068)
            {
               if("false" == this._configuration.getKey("use.default.localizations","false"))
               {
                  ...
                  events.addEventListener(LocalizationEvent.const_179,this.onLocalizationLoaded);
      ...
      {
         var _loc2_:* = null;
         events.removeEventListener(LocalizationEvent.const_179,this.onLocalizationLoaded);
         if(this._configuration.keyExists("external.override.texts.txt"))
         {
            ...
            events.addEventListener(LocalizationEvent.const_179,this.onLocalizationOverrideLoaded);
      ...
      {
         events.removeEventListener(LocalizationEvent.const_179,this.onLocalizationOverrideLoaded);
         unlock();
      }
      ...
      {
         this.var_2067[param1] = param2;
      }
      
      private function getBadgePointLimit(param1:String) : int
      {
         return this.var_2067[param1];
      }
      ...
      {
         return this.var_2844[Math.max(0,param1 - 1)];
      }

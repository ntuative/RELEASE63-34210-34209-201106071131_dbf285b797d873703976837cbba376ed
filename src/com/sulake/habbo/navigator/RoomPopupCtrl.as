package com.sulake.habbo.navigator
{
   ...
   public class RoomPopupCtrl extends PopupCtrl
   {
      ...
      public function RoomPopupCtrl(param1:HabboNavigator, param2:int, param3:int)
      {
         ...
         this.var_2514 = new RoomThumbnailRenderer(param1);
      ...
      override public function refreshContent(param1:IWindowContainer) : void
      {
         ...
         this.refreshRoomName(this.var_197,this.var_136);
         if(this.var_136.ownerName != "" && this.var_136.ownerName != "-")
         {
         }
         this.refreshOwnerName();
         this.refreshTextWithCaption("roomctg",this.var_197,!!this.var_136.event ? this.getEventCtg(this.var_136.categoryId) : this.getRoomCtg(this.var_136.categoryId));
         this.refreshRoomDesc(this.var_197,this.var_136);
         this.refreshExtraCont();
         this.refreshInfo(this.var_197,"trading_allowed",this.var_136.allowTrading);
         this.refreshInfo(this.var_197,"doormode_doorbell",this.var_136.doorMode == 1);
         this.refreshInfo(this.var_197,"doormode_password",this.var_136.doorMode == 2);
      ...
      {
         this.refreshTextWithCaption("roomowner",this.var_197,this.var_136.ownerName);
      ...
      private function refreshExtraCont() : void
      {
         ...
         this.var_1075.refreshTags(_loc1_,this.var_136.tags);
         ...
         this.var_2514.refreshThumbnail(_loc1_,this.var_136.thumbnail,false);
      ...
      private function onOwnerName(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(_loc3_ != null)
         {
            navigator.mainViewCtrl.startSearch(Tabs.const_209,Tabs.const_256,_loc3_.text);
            this.hideInstantly();
         }
      }
   }

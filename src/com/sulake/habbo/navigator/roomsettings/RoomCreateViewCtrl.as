package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomCreateViewCtrl
   {
      ...
      private var var_1205:RoomLayout;
      ...
      public function RoomCreateViewCtrl(param1:HabboNavigator)
      {
         ...
         this.var_630 = new Timer(100);
         this.var_630.addEventListener(TimerEvent.TIMER,this.updateArrowPos);
         this.var_47 = new Array();
         this.var_47.push(new RoomLayout(HabboClubLevelEnum.const_59,104,"a"));
         this.var_47.push(new RoomLayout(HabboClubLevelEnum.const_59,94,"b"));
         this.var_47.push(new RoomLayout(HabboClubLevelEnum.const_59,36,"c"));
         this.var_47.push(new RoomLayout(HabboClubLevelEnum.const_59,84,"d"));
         this.var_47.push(new RoomLayout(HabboClubLevelEnum.const_59,80,"e"));
         this.var_47.push(new RoomLayout(HabboClubLevelEnum.const_59,80,"f"));
         this.var_47.push(new RoomLayout(HabboClubLevelEnum.const_59,416,"i"));
         this.var_47.push(new RoomLayout(HabboClubLevelEnum.const_59,320,"j"));
         this.var_47.push(new RoomLayout(HabboClubLevelEnum.const_59,448,"k"));
         this.var_47.push(new RoomLayout(HabboClubLevelEnum.const_59,352,"l"));
         this.var_47.push(new RoomLayout(HabboClubLevelEnum.const_59,384,"m"));
         this.var_47.push(new RoomLayout(HabboClubLevelEnum.const_59,372,"n"));
         this.var_47.push(new RoomLayout(HabboClubLevelEnum.const_39,80,"g"));
         this.var_47.push(new RoomLayout(HabboClubLevelEnum.const_39,74,"h"));
         this.var_47.push(new RoomLayout(HabboClubLevelEnum.const_39,416,"o"));
         this.var_47.push(new RoomLayout(HabboClubLevelEnum.const_39,352,"p"));
         this.var_47.push(new RoomLayout(HabboClubLevelEnum.const_39,304,"q"));
         this.var_47.push(new RoomLayout(HabboClubLevelEnum.const_39,336,"r"));
         this.var_47.push(new RoomLayout(HabboClubLevelEnum.const_39,748,"u"));
         this.var_47.push(new RoomLayout(HabboClubLevelEnum.const_39,438,"v"));
         this.var_47.push(new RoomLayout(HabboClubLevelEnum.const_44,540,"t"));
         this.var_47.push(new RoomLayout(HabboClubLevelEnum.const_44,512,"w"));
         this.var_47.push(new RoomLayout(HabboClubLevelEnum.const_44,396,"x"));
         this.var_47.push(new RoomLayout(HabboClubLevelEnum.const_44,440,"y"));
         this.var_47.push(new RoomLayout(HabboClubLevelEnum.const_44,456,"z"));
         this.var_47.push(new RoomLayout(HabboClubLevelEnum.const_44,208,"0"));
      }
      ...
      public function dispose() : void
      {
         if(this.var_630)
         {
            this.var_630.removeEventListener(TimerEvent.TIMER,this.updateArrowPos);
            this.var_630.reset();
            this.var_630 = null;
         }
      }
      ...
      {
         var _loc3_:IBitmapWrapperWindow = IBitmapWrapperWindow(this.var_1205.view.findChildByName("select_arrow"));
         var _loc6_:int = Math.abs(_loc3_.y - 0) < 2 || Math.abs(_loc3_.y - 15) < 2 ? 1 : 2;
         _loc3_.y += !!this.var_1828 ? _loc6_ : -_loc6_;
         if(_loc3_.y < 0)
         {
            this.var_1828 = true;
            _loc3_.y = 1;
      ...
      private function prepare() : void
      {
         ...
         this.var_188 = IWindowContainer(this._navigator.getXmlWindow("roc_create_room"));
         this.var_66 = IItemListWindow(this.var_188.findChildByName("item_list"));
         ...
         this.var_1206 = new TextFieldManager(this._navigator,ITextFieldWindow(this.var_188.findChildByName("room_name_input")),25,null,this._navigator.getText("navigator.createroom.roomnameinfo"));
         var _loc4_:Rectangle = Util.getLocationRelativeTo(this.var_188.desktop,this.var_188.width,this.var_188.height);
         this.var_188.x = _loc4_.x;
         this.var_188.y = _loc4_.y;
      }
      
      public function refresh() : void
      {
         this.var_1206.goBackToInitialState();
         this.var_1206.input.textBackgroundColor = 4294967295;
         this.var_1205 = this.var_47[0];
         this.refreshRoomThumbnails();
      ...
      {
         return IWindowContainer(this._navigator.windowManager.createWindow("","",HabboWindowType.const_87,HabboWindowStyle.const_32,HabboWindowParam.const_69,new Rectangle(0,0,100,300)));
      }
      
      private function isMandatoryFieldsFilled() : Boolean
      {
         return Boolean(this.var_1206.checkMandatory(this._navigator.getText("navigator.createroom.nameerr")));
      }
      
      private function getCreateButton() : IButtonWindow
      {
         return IButtonWindow(this.var_188.findChildByName("create_button"));
      }
      
      private function getCancelButton() : IButtonWindow
      {
         return IButtonWindow(this.var_188.findChildByName("back_button"));
      }
      ...
      {
         var _loc2_:String = this.var_1206.getText();
         var _loc3_:String = "model_" + this.var_1205.name;

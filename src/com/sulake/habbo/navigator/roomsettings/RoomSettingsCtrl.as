package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomSettingsCtrl
   {
      ...
      private var var_1313:ICheckBoxWindow;
      
      private var var_1314:ICheckBoxWindow;
      
      private var var_1307:ICheckBoxWindow;
      
      private var var_851:ICheckBoxWindow;
      
      private var var_2023:ITextWindow;
      
      private var var_1033:IDropMenuWindow;
      
      private var var_1037:IDropMenuWindow;
      
      private var var_2775:IWindowContainer;
      
      private var var_1310:IWindowContainer;
      
      private var var_1311:IWindowContainer;
      ...
      {
         if(param1 != this.var_391 || this.var_1306 < 1)
         {
            return;
         }
         this.close();
      ...
      public function onRoomSettingsSaveError(param1:int, param2:int, param3:String) : void
      {
         ...
         {
            this.var_849.displayError("${navigator.roomsettings.roomnameismandatory}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1952)
         {
            this.var_849.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1918)
         {
            this.var_1312.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1728)
         {
            this.setTagError(this.var_1034,param3,"${navigator.roomsettings.unacceptablewords}");
            this.setTagError(this.var_1036,param3,"${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1953)
         {
            this.setTagError(this.var_1034,param3,"${navigator.roomsettings.nonuserchoosabletag}");
            this.setTagError(this.var_1036,param3,"${navigator.roomsettings.nonuserchoosabletag}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1834)
         {
            this.var_1035.displayError("${navigator.roomsettings.passwordismandatory}");
         }
         else
         {
            this.var_849.displayError("Update failed: error " + param2);
         }
      }
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         _loc2_.addEventListener(WindowEvent.const_497,this.onDoorModePasswordUnselect);
         ...
         this.var_849 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("room_name")),60);
         this.var_1312 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("description")),255);
         this.var_1034 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("tag1")),30);
         this.var_1036 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("tag2")),30);
         this.var_1035 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("password")),30);
         this.var_1308 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("password_confirm")),30);
         this.var_1313 = ICheckBoxWindow(this._window.findChildByName("allow_pets_checkbox"));
         this.var_1314 = ICheckBoxWindow(this._window.findChildByName("allow_foodconsume_checkbox"));
         this.var_1307 = ICheckBoxWindow(this._window.findChildByName("allow_walk_through_checkbox"));
         this.var_851 = ICheckBoxWindow(this._window.findChildByName("hide_walls_checkbox"));
         this.var_2023 = this._window.findChildByName("hide_walls_text") as ITextWindow;
         this.var_1033 = IDropMenuWindow(this._window.findChildByName("wall_thickness"));
         this.var_1037 = IDropMenuWindow(this._window.findChildByName("floor_thickness"));
         this.var_2775 = IWindowContainer(this._window.findChildByName("thumbnail_container"));
         this.var_1310 = IWindowContainer(this._window.findChildByName("basic_settings_container"));
         this.var_1311 = IWindowContainer(this._window.findChildByName("advanced_settings_container"));
         this.var_2022 = IWindowContainer(this._window.findChildByName("switch_view_container"));
         ...
         this.var_1309 = IWindowContainer(this._window.findChildByName("password_container"));
         this.var_1578 = ITextWindow(this._window.findChildByName("switch_view_text"));
         this.var_1578.mouseThreshold = 0;
         this.var_1578.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onSwitchView);
         this.var_1309.visible = false;
         if(!this.var_1577)
         {
      ...
      public function refresh(param1:IWindowContainer) : void
      {
         ...
         this.var_2022.visible = this.var_1577;
         this.populateForm();
         if(this.var_850)
         {
            this.var_1311.visible = true;
            this.var_1579.visible = true;
            this.refreshFlatControllers();
            this.var_1311.height = Util.getLowestPoint(this.var_1311) + 4;
         }
         else
         {
            this.var_1310.visible = true;
            this.var_1579.visible = true;
            this.var_2775.visible = this.var_1577;
            this.var_1310.height = Util.getLowestPoint(this.var_1310) + 4;
         }
         this.var_1578.text = !!this.var_850 ? "${navigator.roomsettings.tobasicsettings}" : "${navigator.roomsettings.toadvancedsettings}";
         Util.moveChildrenToColumn(this._window,[this.var_1310.name,this.var_1311.name,this.var_1579.name,this.var_2022.name],0,0);
      ...
      private function populateForm() : void
      {
         ...
         this.var_849.setText(_loc1_.name);
         this.var_1312.setText(_loc1_.description);
         this.var_1035.setText("");
         this.var_1308.setText("");
         ...
         this.setTag(this.var_1034,_loc1_.tags[0]);
         this.setTag(this.var_1036,_loc1_.tags[1]);
         if(this.var_1313)
         {
            if(_loc1_.allowPets)
            {
               this.var_1313.select();
            }
            else
            {
               this.var_1313.unselect();
            }
         }
         if(this.var_1314)
         {
            ...
            {
               this.var_1314.select();
            }
            else
            {
               this.var_1314.unselect();
            }
         }
         if(this.var_1307)
         {
            ...
            {
               this.var_1307.select();
            }
            else
            {
               this.var_1307.unselect();
            }
         }
         if(!this.VIPFeaturesAllowed())
         {
            this.disableWindow(this.var_851);
            this.disableWindow(this.var_1033);
            this.disableWindow(this.var_1037);
            this.disableWindow(this.var_2023);
         }
         else
         {
            this.enableWindow(this.var_851);
            this.enableWindow(this.var_1033);
            this.enableWindow(this.var_1037);
            this.enableWindow(this.var_2023);
         }
         if(this.var_851)
         {
            if(_loc1_.hideWalls)
            ...
            {
               this.var_851.unselect();
            }
         }
         if(this.var_1033)
         {
            this.var_1033.selection = this.getThicknessSelectionIndex(_loc1_.wallThickness);
         }
         if(this.var_1037)
         {
            this.var_1037.selection = this.getThicknessSelectionIndex(_loc1_.floorThickness);
         }
         this.clearErrors();
      }
      ...
      private function onSaveButtonClick(param1:WindowMouseEvent) : void
      {
         ...
         _loc2_.name = this.var_849.getText();
         _loc2_.description = this.var_1312.getText();
         ...
         switch(_loc4_.name)
         {
            ...
            case "doormode_password":
               ...
               break;
            default:
               _loc2_.doorMode = RoomSettingsFlatInfo.const_509;
         }
         if(_loc2_.doorMode == RoomSettingsFlatInfo.const_130)
         {
            _loc8_ = this.var_1035.getText();
            _loc9_ = this.var_1308.getText();
            if(_loc8_ != _loc9_)
            {
               this.var_1035.clearErrors();
               this.var_1308.displayError("${navigator.roomsettings.invalidconfirm}");
               return;
            }
            if(_loc8_ != "")
            {
         ...
         _loc2_.allowPets = this.var_1313.isSelected;
         _loc2_.allowFoodConsume = this.var_1314.isSelected;
         _loc2_.allowWalkThrough = this.var_1307.isSelected;
         _loc2_.hideWalls = this.var_851.isSelected;
         _loc2_.wallThickness = this.var_1033.selection - 2;
         _loc2_.floorThickness = this.var_1037.selection - 2;
         _loc2_.tags = new Array();
         this.addTag(this.var_1034,_loc2_.tags);
         this.addTag(this.var_1036,_loc2_.tags);
         this.clearErrors();
         this.var_1306 = _loc2_.roomId;
      ...
      private function refreshFlatControllers() : void
      {
         ...
         var _loc1_:IWindow = this.var_247.findChildByName("ruler");
         if(_loc1_ != null)
         {
            _loc1_.visible = true;
         }
         var _loc2_:IWindow = this.var_247.findChildByName("flat_ctrls_caption_txt");
         if(_loc2_ != null)
         {
            this._navigator.registerParameter("navigator.roomsettings.flatctrls.caption","cnt","" + this.var_57.controllerCount);
            _loc2_.visible = true;
         }
         var _loc3_:IWindowContainer = IWindowContainer(this.var_247.findChildByName("flat_controller_list"));
         if(_loc3_ != null)
         {
            ...
            _loc5_ = this.var_247.findChildByName("flat_ctrls_info_txt");
            _loc6_ = this.var_247.findChildByName("flat_ctrls_limit_txt");
            _loc7_ = IWindowContainer(this.var_247.findChildByName("flat_controllers_footer"));
            if(this.var_57 != null && this.var_57.controllers.length > 0)
            {
               ...
               Util.moveChildrenToColumn(this.var_247,["flat_ctrls_caption_txt","flat_ctrls_limit_txt","flat_controller_list","flat_ctrls_info_txt","flat_controllers_footer"],_loc2_.y,5);
            }
            else
            {
         ...
         var _loc4_:IButtonWindow = IButtonWindow(this.var_247.findChildByName("remove_flat_ctrl"));
         if(_loc4_ != null)
         {
            if(_loc8_)
            {
      ...
      {
         return IWindowContainer(this._navigator.windowManager.createWindow(param1,"",HabboWindowType.const_87,HabboWindowStyle.const_32,HabboWindowParam.const_69,new Rectangle(0,0,100,20)));
      }

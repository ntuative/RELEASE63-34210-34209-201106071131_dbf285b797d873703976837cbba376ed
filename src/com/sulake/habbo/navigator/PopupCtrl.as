package com.sulake.habbo.navigator
{
   ...
   public class PopupCtrl
   {
      ...
      public function PopupCtrl(param1:HabboNavigator, param2:int, param3:int, param4:String)
      {
         ...
         this.var_420.addEventListener(TimerEvent.TIMER,this.onDisplayTimer);
      ...
      public function dispose() : void
      {
         ...
         if(this.var_420)
         {
            this.var_420.removeEventListener(TimerEvent.TIMER,this.onDisplayTimer);
            this.var_420.reset();
            this.var_420 = null;
         }
         if(this.var_350)
      ...
      public function showPopup(param1:IWindow) : void
      {
         if(this.var_58 == null)
         {
            this.var_58 = IWindowContainer(this._navigator.getXmlWindow(this.var_1118));
            this.var_58.visible = false;
            this.var_58.setParamFlag(HabboWindowParam.const_47,true);
         ...
         this.var_58.x = _loc2_.x + this.var_2223 + param1.width;

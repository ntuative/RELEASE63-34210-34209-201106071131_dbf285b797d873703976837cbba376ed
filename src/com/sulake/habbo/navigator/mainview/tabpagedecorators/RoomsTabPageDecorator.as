package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class RoomsTabPageDecorator implements ITabPageDecorator
   {
      ...
      public function refreshCustomContent(param1:IWindowContainer) : void
      {
         ...
         {
            this.var_145 = IDropMenuWindow(_loc3_.findChildByName("roomCtgFilter"));
      ...
      private function startSearch() : void
      {
         ...
         if(_loc1_ == 0)
         {
            this._navigator.mainViewCtrl.startSearch(Tabs.const_208,Tabs.const_396);
         }
         else if(_loc1_ == 1)
         {
            this._navigator.mainViewCtrl.startSearch(Tabs.const_208,Tabs.const_1007);
         }
         else
         {
            ...
            this._navigator.mainViewCtrl.startSearch(Tabs.const_208,Tabs.const_396,"" + _loc3_);
         }
         if(this.var_145)
         {
            this._navigator.trackNavigationDataPoint(this.var_145.enumerateSelection()[this.var_145.selection],"category.view");
         }
      }

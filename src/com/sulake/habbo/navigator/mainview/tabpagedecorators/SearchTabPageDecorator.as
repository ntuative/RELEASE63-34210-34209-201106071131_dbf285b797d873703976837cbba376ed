package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class SearchTabPageDecorator implements ITabPageDecorator
   {
      ...
      private var var_2145:TextSearchInputs;
      ...
      public function refreshCustomContent(param1:IWindowContainer) : void
      {
         ...
         if(this.var_2145 == null)
         {
            ...
            this.var_2145 = new TextSearchInputs(this._navigator,false,_loc4_);
         ...
         {
            this.var_2145.searchStr.setText(this._navigator.data.guestRoomSearchResults.searchParam);
         }
      ...
      private function refreshSearchInfo(param1:IWindowContainer) : void
      {
         ...
         {
            _loc5_.visible = true;
            if(this._navigator.data.guestRoomSearchResults.searchType == Tabs.const_422)
            {
      ...
      {
         this._navigator.mainViewCtrl.startSearch(Tabs.const_209,Tabs.const_256,"-1",MainViewCtrl.const_873);
      }

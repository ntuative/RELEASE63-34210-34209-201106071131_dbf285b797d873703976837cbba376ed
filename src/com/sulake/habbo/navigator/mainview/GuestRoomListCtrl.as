package com.sulake.habbo.navigator.mainview
{
   ...
   public class GuestRoomListCtrl implements IViewCtrl
   {
      ...
      private var var_518:RoomPopupCtrl;
      
      private var var_587:IScrollbarWindow;
      ...
      public function GuestRoomListCtrl(param1:HabboNavigator)
      {
         ...
         this.var_518 = new RoomPopupCtrl(this._navigator,5,-5);
      ...
      public function set content(param1:IWindowContainer) : void
      {
         ...
         this.var_587 = IScrollbarWindow(this.var_188.findChildByName("scroller"));
      }
      ...
      public function refresh() : void
      {
         ...
         this.var_188.findChildByName("no_rooms_found").visible = _loc1_.length < 1;
      }
      ...
      private function getListEntry(param1:int) : IWindowContainer
      {
         ...
         _loc2_.addEventListener(WindowMouseEvent.const_178,this.onMouseMove);
         ...
         _loc2_.setParamFlag(HabboWindowParam.const_1870,true);
      ...
      private function onMouseOver(param1:WindowEvent) : void
      {
         ...
         if(this.var_518.visible && this.var_2450)
         {
            return;
         }
         ...
         this.var_518.room = _loc4_;
         this.var_518.showPopup(_loc2_);
      }
      ...
      private function hilite(param1:IWindowContainer) : void
      {
         ...
         {
            _loc2_ = this.var_1469.tags[0];
            this.var_1469.color = this.getBgColor(_loc2_);
         }
      ...
      private function checkFastHorizontalMove(param1:WindowEvent) : void
      {
         ...
         var _loc3_:int = Math.abs(this.var_2451 - _loc2_.stageX);
         this.var_2451 = _loc2_.stageX;
         this.var_2450 = _loc3_ > 2;
      }
   }
}

package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_313:MainViewCtrl;
      ...
      private var var_2514:RoomThumbnailRenderer;
      
      private var var_1035:GuestRoomPasswordInput;
      ...
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_313 = new MainViewCtrl(this);
         this.var_635 = new RoomInfoViewCtrl(this);
         this.var_1210 = new RoomCreateViewCtrl(this);
         this.var_2514 = new RoomThumbnailRenderer(this);
         this.var_1035 = new GuestRoomPasswordInput(this);
         this.var_321 = new GuestRoomDoorbell(this);
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = IBitmapWrapperWindow(this._windowManager.createWindow(param1,"",HabboWindowType.const_327,HabboWindowStyle.const_48,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6));
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         if(param1.type == HabboToolbarEvent.const_50)
         {
            ...
            {
               this.var_313.onNavigatorToolBarIconClick();
            }
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         this.var_313.startSearch(Tabs.const_209,Tabs.const_422,param1);
         this.trackNavigationDataPoint("Search","search.tag",param1);
         this.var_313.mainWindow.activate();
      }
      ...
      public function showOwnRooms() : void
      {
         ...
         this.var_313.startSearch(Tabs.const_252,Tabs.const_270);
         this.var_437.getTab(Tabs.const_252).tabPageDecorator.tabSelected();
      }

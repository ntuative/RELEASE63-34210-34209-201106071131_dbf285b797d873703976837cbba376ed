package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailCtrl
   {
      ...
      private var var_1714:IButtonWindow;
      
      private var var_1713:IButtonWindow;
      
      private var var_1712:IButtonWindow;
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         this.var_1714 = IButtonWindow(this.find("bg_tab"));
         this.var_1713 = IButtonWindow(this.find("top_tab"));
         this.var_1712 = IButtonWindow(this.find("obj_tab"));
         this.var_2288 = IWindowContainer(this.find("tile_grid"));
         this.var_2287 = IWindowContainer(this.find("now_editing_container"));
         Util.setProcDirectly(this.find("save"),this.onSaveButton);
         Util.setProcDirectly(this.find("cancel"),this.onCancelButton);
         Util.setProcDirectly(this.var_1714,this.onBgTabButton);
         Util.setProcDirectly(this.var_1713,this.onTopTabButton);
         Util.setProcDirectly(this.var_1712,this.onObjTabButton);
      }
      ...
      private function onTopTabButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_76.mode = ThumbnailEditorModel.const_65;
         this.reload();
      }
      ...
      private function onObjTabButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_76.mode = ThumbnailEditorModel.const_35;
         this.reload();
      }
      ...
      {
         this.setEnabled(this.var_1714,this.var_76.mode != ThumbnailEditorModel.const_37);
         this.setEnabled(this.var_1713,this.var_76.mode != ThumbnailEditorModel.const_65);
         this.setEnabled(this.var_1712,this.var_76.mode != ThumbnailEditorModel.const_35);
      }
      
      private function refreshEditArea() : void
      {
         var _loc1_:IWindowContainer = this.var_2287;
         Util.hideChildren(_loc1_);
         this.refreshEditImg(_loc1_,"edit_bg",this.var_76.mode == ThumbnailEditorModel.const_37);
         this.refreshEditImg(_loc1_,"edit_top",this.var_76.mode == ThumbnailEditorModel.const_65);
         this.refreshEditImg(_loc1_,"edit_obj",this.var_76.mode == ThumbnailEditorModel.const_35,false);
         if(this.var_76.mode == ThumbnailEditorModel.const_35)
         {
      ...
      private function refreshPositionGrid() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc1_:IWindowContainer = this.var_2288;
         _loc1_.visible = true;
         if(_loc1_.numChildren == 0)
         {
            while(_loc3_ <= RoomThumbnailRenderer.const_618)
            {
      ...
      private function populateImgList(param1:IItemListWindow, param2:int) : void
      {
         ...
         while(_loc8_ < _loc6_.length)
         {
            ...
            if(_loc9_ == 0)
            {
               _loc7_ = IWindowContainer(this._navigator.windowManager.createWindow("row_" + _loc8_,"",HabboWindowType.const_87,HabboWindowStyle.const_32,HabboWindowParam.const_69,new Rectangle(0,0,param1.width,66)));
               param1.addListItem(_loc7_);
            }
            _loc10_ = _loc6_[_loc8_];
            _loc11_ = IRegionWindow(this._navigator.windowManager.createWindow("img_" + _loc8_,"",WindowType.const_420,HabboWindowStyle.const_48,0 | 0,new Rectangle(_loc9_ * 66,0,66,66),this.onImgSel,_loc10_.id));
            _loc11_.mouseThreshold = 0;
            _loc12_ = IBitmapWrapperWindow(this._navigator.windowManager.createWindow("img_" + _loc8_,"",HabboWindowType.const_327,HabboWindowStyle.const_48,HabboWindowParam.const_69,new Rectangle(0,0,66,66),this.onImgSel,_loc10_.id));

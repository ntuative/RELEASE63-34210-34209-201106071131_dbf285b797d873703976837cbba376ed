package com.sulake.habbo.communication.protocol
{
   ...
   public class WedgieProtocol implements IProtocol
   {
      ...
      public static const const_1773:uint = 1;
      
      public static const const_1954:uint = 2;
       
      
      private var var_1448:IProtocolEncoder;
      ...
      {
         super();
         this.var_1448 = new WedgieEncoder();
         this.var_1155 = new WedgieDecoder();
      }
      
      public function dispose() : void
      {
         this.var_1448.dispose();

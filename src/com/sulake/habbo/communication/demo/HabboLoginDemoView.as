package com.sulake.habbo.communication.demo
{
   ...
   public class HabboLoginDemoView extends EventDispatcher
   {
      ...
      public static const const_601:String = "InitConnection";
      ...
      private function createWindow() : void
      {
         ...
         this._window = this.var_170.windowManager.createWindow("habbo_login_window","Login",HabboWindowType.const_141,HabboWindowStyle.const_48,0 | 0,new Rectangle(10,10,320,240),null) as IFrameWindow;
         ...
         var _loc7_:SharedObject = SharedObject.getLocal(this.const_2018,"/");
         if(_loc5_ != null)
         {
      ...
      private function windowEventProcessor(param1:WindowEvent = null, param2:IWindow = null) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            _loc6_ = SharedObject.getLocal(this.const_2018,"/");
         ...
         {
            dispatchEvent(new Event(const_601));
         }
      }
      ...
      private function initSSOTicket(param1:Boolean) : void
      {
         ...
         {
            this.var_147.removeEventListener(SSOTicket.const_445,this.onParsedTicketSuccess);
            this.var_147.removeEventListener(SSOTicket.const_352,this.onParsedTicketFailure);
            this.var_147 = null;
         }
         var _loc2_:String = "";
         ...
         this.var_147 = new SSOTicket(this.var_170.assets,_loc3_,_loc2_,param1);
         this.var_147.addEventListener(SSOTicket.const_445,this.onParsedTicketSuccess);
         this.var_147.addEventListener(SSOTicket.const_352,this.onParsedTicketFailure);
      }
      
      private function onParsedTicketSuccess(param1:Event) : void
      {
         Logger.log("Got ticket: " + this.var_147.ticket);
         Logger.log("Has Facebook: " + this.var_147.isFacebookUser);
         if(this.var_147.isFacebookUser)
         {
            this.var_170.habboConfiguration.setKey("facebook.user","1");
         }
         this.var_170.flashClientUrl = this.var_147.flashClientUrl;
         this.var_170.ssoTicket = this.var_147.ticket;
         this.var_147.removeEventListener(SSOTicket.const_445,this.onParsedTicketSuccess);
         this.var_147.removeEventListener(SSOTicket.const_352,this.onParsedTicketFailure);
         this.var_147 = null;
         dispatchEvent(new Event(const_601));

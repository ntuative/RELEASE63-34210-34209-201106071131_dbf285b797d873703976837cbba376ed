package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_2944:PseudoRandom;
      ...
      private var var_252:HabboHotelView;
      
      private var var_1659:String = "";
      
      private const const_2018:String = "fuselogin";
      ...
      public function setSSOTicket(param1:String) : void
      {
         ...
         {
            this.var_713 = param1;
            this.var_61.initConnection(HabboConnectionType.const_260);
         }
      }
      ...
      {
         if(this.var_61 && this.var_157 && this.var_16 && this._windowManager)
         {
      ...
      private function componentsAreRunning() : void
      {
         ...
         this.var_252 = new HabboHotelView(this._windowManager,assets,Component(context).events,_loc1_);
         ...
         {
            this.var_252.loadHotelViewImage(_loc3_ + _loc2_);
         }
         var _loc4_:* = this.var_157.getKey("use.sso.ticket") == "1";
         this.var_713 = this.var_157.getKey("sso.ticket",null);
         this.var_2143 = this.var_157.getKey("flash.client.url","");
         this.var_2943 = this.var_157.getKey("external.variables.txt","");
         if(this.var_252 == null)
         {
            this.var_252 = new HabboHotelView(this._windowManager,assets,Component(context).events,_loc1_);
         }
         if(_loc4_)
         {
            this.var_61.mode = HabboConnectionType.const_100;
            if(this.var_713)
            {
               this.var_61.initConnection(HabboConnectionType.const_260);
            }
         ...
         else if(this._windowManager != null)
         {
            ...
            if(_loc5_)
            {
               ...
               this._view.addEventListener(HabboLoginDemoView.const_601,this.onInitConnection);
            }
            else
            {
               Core.crash("Login without an SSO ticket is not supported",Core.const_1914);
            }
         }
      }
      ...
      private function onInitConnection(param1:Event = null) : void
      {
         ...
         else
         {
            ...
            {
               this.var_61.mode = HabboConnectionType.const_1196;
            }
         }
         this.var_61.initConnection(HabboConnectionType.const_260);
      }
      ...
      private function onConnectionEstablished(param1:Event = null) : void
      {
         ...
         if(_loc2_ != null)
         {
            this.dispatchLoginStepEvent(HabboCommunicationEvent.const_830);
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         this.var_2944 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(this.var_61.mode)
         {
            case HabboConnectionType.const_100:
               ...
               this.var_1659 = _loc4_;
               this.var_252.loadBannerImage(_loc7_ + "?token=" + this.var_1659,this.onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_1196:
               this.sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1921:
               this.var_1104 = this.generateRandomHexString(30);
               this.var_579 = new DiffieHellman(new BigInteger(this.var_157.getKey("connection.development.prime"),16),new BigInteger(this.var_157.getKey("connection.development.generator"),16));
               this.var_579.init(this.var_1104);
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         var _loc7_:IEncryption = new RC4_R27(_loc6_,this.var_2944);
      ...
      private function sendConnectionParameters(param1:IConnection) : void
      {
         ...
         this.var_1660 = true;
         this.dispatchLoginStepEvent(HabboCommunicationEvent.const_298);
         connection.send(new VersionCheckMessageComposer(401,this.var_2143,this.var_2943));
         var machineId:String = "";
         try
         {
            so = SharedObject.getLocal(this.const_2018,"/");
      ...
      private function onSessionParamsEvent(param1:IMessageEvent) : void
      {
         ...
         if(this.var_713 != null)
         {
            _loc4_ = new SSOTicketMessageComposer(this.var_713);
            _loc2_.send(_loc4_);
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(param1.type == Event.CLOSE && !this.var_2942)
         {
      ...
      private function onHotelViewBannerLoaded(param1:BitmapData) : void
      {
         ...
         var _loc4_:String = xor(_loc3_,this.var_1659);

package com.sulake.habbo.communication.messages.parser.room.engine
{
   ...
   public class SlideObjectBundleMessageParser implements IMessageParser
   {
      ...
      private var var_3043:Number;
      
      private var var_3042:String;
      
      private var var_1581:Array;
      
      private var var_1580:SlideObjectMessageData = null;
      ...
      public function parse(param1:IMessageDataWrapper) : Boolean
      {
         ...
         switch(_loc14_)
         {
            ...
            case 1:
               ...
               _loc9_ = new Vector3d(_loc2_,_loc3_,_loc11_);
               _loc10_ = new Vector3d(_loc4_,_loc5_,_loc12_);
               this.var_1580 = new SlideObjectMessageData(_loc7_,_loc9_,_loc10_,SlideObjectMessageData.const_1369);
               break;
            case 2:
               _loc7_ = param1.readInteger();
               _loc11_ = Number(param1.readString());
               ...
               _loc9_ = new Vector3d(_loc2_,_loc3_,_loc11_);
               _loc10_ = new Vector3d(_loc4_,_loc5_,_loc12_);
               this.var_1580 = new SlideObjectMessageData(_loc7_,_loc9_,_loc10_,SlideObjectMessageData.const_1282);
               break;
            default:

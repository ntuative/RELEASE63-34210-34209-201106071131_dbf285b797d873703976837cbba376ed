package com.sulake.habbo.communication.messages.parser.room.engine
{
   ...
   public class HeightMapMessageParser implements IMessageParser
   {
      ...
      public function isRoomTile(param1:int, param2:int) : Boolean
      {
         ...
         var _loc3_:Array = this.var_1135[param2] as Array;
         return Boolean(_loc3_[param1]);
      }
      ...
      public function parse(param1:IMessageDataWrapper) : Boolean
      {
         ...
         while(_loc7_ < _loc5_.length)
         {
            ...
            if(_loc16_.length > 0)
            {
               if(_loc16_.length > this.var_265)
               {
                  this.var_265 = _loc16_.length;
               }
               _loc9_ = [];
         ...
         while(_loc7_ < _loc8_.length)
         {
            ...
            while(_loc9_.length < this.var_265)
            {
               _loc9_.push(-1);
            }
            _loc7_++;
         ...
         while(_loc7_ < _loc10_.length)
         {
            ...
            while(_loc11_.length < this.var_265)
            {
               _loc11_.push(true);
            }
            _loc7_++;
         ...
         while(_loc7_ < _loc12_.length)
         {
            ...
            while(_loc13_.length < this.var_265)
            {
               _loc13_.push(false);
            }
            _loc7_++;

package com.sulake.habbo.communication.messages.parser.moderation
{
   ...
   public class IssueInfoMessageParser implements IMessageParser
   {
      ...
      private var var_1895:IssueMessageData;
      ...
      public function parse(param1:IMessageDataWrapper) : Boolean
      {
         ...
         this.var_1895 = new IssueMessageData(_loc2_,_loc3_,_loc4_,_loc5_,_loc6_,_loc7_,_loc8_,_loc9_,_loc10_,_loc11_,_loc12_,_loc13_,_loc14_,_loc15_,_loc16_,_loc17_,_loc21_,_loc22_,_loc23_,_loc18_,_loc19_,_loc20_);
         return true;
      }
   }
}

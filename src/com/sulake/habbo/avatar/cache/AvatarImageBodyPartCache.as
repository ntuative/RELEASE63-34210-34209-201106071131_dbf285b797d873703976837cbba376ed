package com.sulake.habbo.avatar.cache
{
   ...
   public class AvatarImageBodyPartCache
   {
      ...
      public function setAction(param1:IActiveActionData, param2:int) : void
      {
         ...
         var _loc3_:AvatarImageActionCache = this.getActionCache(this.var_876);
         if(_loc3_ != null)
         {
      ...
      public function disposeActions(param1:int, param2:int) : void
      {
         ...
         var _loc4_:* = null;
         var _loc6_:* = null;
         if(this.var_283 == null || this._disposed)
         {
            return;
         }
         ...
         {
            _loc4_ = this.var_283.getValue(_loc6_) as AvatarImageActionCache;
            if(_loc4_ != null)
            {
      ...
      public function getActionCache(param1:IActiveActionData = null) : AvatarImageActionCache
      {
         ...
         return this.var_283.getValue(param1.id) as AvatarImageActionCache;
      }
      
      public function updateActionCache(param1:IActiveActionData, param2:AvatarImageActionCache) : void
      {
         this.var_283.add(param1.id,param2);
      }

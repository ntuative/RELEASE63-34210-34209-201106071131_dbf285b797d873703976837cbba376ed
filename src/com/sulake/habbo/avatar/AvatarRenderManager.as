package com.sulake.habbo.avatar
{
   ...
   public class AvatarRenderManager extends Component implements IAvatarRenderManager
   {
      ...
      private const const_2278:String = "hd-99999-99999";
      ...
      private var var_308:PetDataManager;
      
      private var var_753:PaletteManager;
      
      private var var_345:String;
      
      private var var_307:Map;
      
      private var var_233:AvatarAssetDownloadManager;
      ...
      public function AvatarRenderManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_345 = RenderMode.const_1827;
         ...
         this.var_116.add(AvatarType.const_139,_loc4_);
         ...
         this.var_116.add(AvatarType.const_58,_loc4_);
         this._aliasCollection = new AssetAliasCollection(this,param1.assets as AssetLibraryCollection);
         this.var_308 = new PetDataManager(this,param1.assets as AssetLibraryCollection);
         this.var_753 = new PaletteManager(param1.assets as AssetLibraryCollection);
         var _loc5_:XML = param3.getAssetByName("HabboAvatarPetFigure").content as XML;
         this.var_308.populateFigureData(_loc5_);
      ...
      override public function dispose() : void
      {
         ...
         {
            for each(_loc1_ in this.var_116.getValues())
            {
               _loc1_.dispose();
            }
         ...
         if(this.var_233)
         {
            this.var_233.removeEventListener(Event.COMPLETE,this.onAvatarAssetsDownloadManagerReady);
      ...
      private function onAllModulesReadyAndRunning(param1:Event) : void
      {
         ...
         this.var_308.init();
         this.var_753.init();
         _loc2_ = this.var_116.getValue(AvatarType.const_139) as AvatarStructure;
         if(_loc2_)
         {
         ...
         _loc2_ = this.var_116.getValue(AvatarType.const_58) as AvatarStructure;
         if(_loc2_)
         {
            _loc2_.resetPartOffsets(context.assets);
         }
      ...
      private function onHabboConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(param2 != null)
         {
            ...
            _loc3_ = this.var_116.getValue(AvatarType.const_139) as AvatarStructure;
            if(_loc3_ != null)
            {
               ...
               if(this.var_233 == null)
               {
                  ...
                  this.var_233 = new AvatarAssetDownloadManager(context.assets,_loc6_,_loc7_,_loc3_);
                  this.var_233.addEventListener(Event.COMPLETE,this.onAvatarAssetsDownloadManagerReady);
               }
            }
         }
      }
      ...
      private function checkIfReady() : void
      {
         if(!this.var_1086)
         {
            if(this.var_2382 && this.var_2381 && this.var_2383)
            {
               this.var_1086 = true;
      ...
      public function isFigureReady(param1:IAvatarFigureContainer) : Boolean
      {
         ...
         return this.var_233.isReady(param1);
      }
      ...
      public function downloadFigure(param1:IAvatarFigureContainer, param2:IAvatarImageListener) : void
      {
         ...
         this.var_233.loadFigureSetData(param1,param2);
      }
      ...
      {
         var _loc5_:AvatarStructure = this.var_116.getValue(AvatarType.const_139) as AvatarStructure;
         if(_loc5_ == null)
         {
            return null;
         }
         ...
         if(this.var_233.isReady(_loc6_))
         {
            return new AvatarImage(_loc5_,this._aliasCollection,_loc6_,param2);
         }
         if(!this.var_1766)
         {
            this.var_1766 = new AvatarFigureContainer(this.const_2278);
         }
         this.var_233.loadFigureSetData(_loc6_,param4);
      ...
      public function removePetImageListener(param1:IPetImageListener) : void
      {
         ...
         for each(_loc2_ in this.var_307.getKeys())
         {
      ...
      public function getPetFigureString(param1:String) : String
      {
         ...
         return this.var_308.createPetFigureString(_loc3_,_loc4_,_loc5_);
      }
      ...
      public function createPetImage(param1:int, param2:int, param3:uint, param4:String, param5:IPetImageListener = null) : IAvatarImage
      {
         var _loc9_:* = null;
         var _loc6_:* = false;
         if(this.mode != RenderMode.const_1823)
         {
            _loc6_ = !this.var_308.assetsReady(param1,param4);
         }
         var _loc7_:String = this.var_308.createPetFigureString(param1,param2,param3);
         var _loc8_:AvatarStructure = this.var_116.getValue(AvatarType.const_58) as AvatarStructure;
         if(_loc8_ == null)
         {
            return null;
         }
         ...
         if(param5 != null)
         {
            ...
            this.var_307.add(_loc7_,_loc9_);
         }
      ...
      public function resetPetData() : void
      {
         ...
         this.var_308.populateFigureData(_loc1_);
         var _loc2_:AvatarStructure = this.var_116.getValue(AvatarType.const_58);
         _loc2_.initFigureData(_loc1_);
         _loc2_.resetPartOffsets(context.assets);
         var _loc5_:Array = this.var_307.getKeys();
         for each(_loc6_ in _loc5_)
         {
            _loc4_ = this.var_307.getValue(_loc6_);
            if(_loc4_)
            {
      ...
      {
         var _loc2_:AvatarStructure = this.var_116.getValue(param1) as AvatarStructure;
         if(_loc2_ != null)
         {
      ...
      {
         var _loc3_:AvatarStructure = this.var_116.getValue(AvatarType.const_139) as AvatarStructure;
      ...
      {
         return this.var_308 as IPetDataManager;
      }
      ...
      public function injectFigureData(param1:String, param2:XML) : void
      {
         ...
         switch(param1)
         {
            ...
            case AvatarType.const_58:
               _loc3_ = this.var_116.getValue(AvatarType.const_58) as AvatarStructure;
               break;
            default:

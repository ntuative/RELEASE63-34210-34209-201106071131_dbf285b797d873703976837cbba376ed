package com.sulake.habbo.avatar
{
   ...
   public class HabboAvatarEditor
   {
      ...
      private static const const_1549:String = "hr-515-33.hd-600-1.ch-635-70.lg-716-66-62.sh-735-68";
      ...
      private var var_1006:IFigureData;
      ...
      private var var_1257:IHabboAvatarEditorDataSaver = null;
      ...
      public function HabboAvatarEditor(param1:uint, param2:HabboAvatarEditorManager)
      {
         ...
         this.var_541 = param2;
         this.var_1006 = this.var_541.avatarRenderManager.getFigureData(AvatarType.const_139);
      }
      ...
      private function init(param1:Array = null) : void
      {
         ...
         this.var_661["null"] = new FigureData(this);
         this.var_661["null"] = new FigureData(this);
         var _loc2_:FigureData = this.var_661["null"];
         var _loc3_:FigureData = this.var_661["null"];
         _loc2_.loadAvatarData(const_1550,FigureData.const_89);
         _loc3_.loadAvatarData(const_1549,FigureData.FEMALE);
         this.var_114 = new Map();
         this.var_540 = new Map();
         this.var_114.add(AvatarEditorFigureCategory.const_983,new BodyModel(this));
         this.var_114.add(AvatarEditorFigureCategory.const_53,new HeadModel(this));
         this.var_114.add(AvatarEditorFigureCategory.const_283,new TorsoModel(this));
         this.var_114.add(AvatarEditorFigureCategory.const_737,new LegsModel(this));
         ...
         this.var_540.add(AvatarEditorSideCategory.const_114,new WardrobeModel(this));
         this.var_540.add(AvatarEditorSideCategory.const_622,new ClubPromoModel(this));
      ...
      public function loadAvatarInEditor(param1:String, param2:String, param3:int = 0) : void
      {
         ...
         if(this.var_818 != param3)
         {
            this.var_818 = param3;
            _loc4_ = true;
         }
         var _loc5_:FigureData = this.var_661[param2];
         if(_loc5_ == null)
         {
            return;
         }
      ...
      public function getFigureSetType(param1:String) : ISetType
      {
         ...
         return this.var_1006.getSetType(param1);
      }
      ...
      public function getPalette(param1:int) : IPalette
      {
         ...
         return this.var_1006.getPalette(param1);
      }
      ...
      private function selectDefaultCategory(param1:Array) : void
      {
         ...
         {
            this.toggleAvatarEditorPage(AvatarEditorFigureCategory.const_983);
         }
      }
      ...
      {
         return this.var_661[this.var_991];
      }
      ...
      public function saveCurrentSelection() : void
      {
         ...
         {
            this.var_1257.saveFigure(_loc1_,_loc2_);
         }
         else
         {
      ...
      public function generateDataContent(param1:IAvatarEditorCategoryModel, param2:String) : CategoryData
      {
         ...
         if(_loc8_ != null)
         {
            ...
            _loc12_ = this.isClubTryoutAllowed() && this.var_1920;
            for each(_loc13_ in _loc9_.colors)
            {
               if(_loc13_.isSelectable && (_loc12_ || this.var_818 >= _loc13_.clubLevel))
               {
                  _loc17_ = 0;
                  while(_loc17_ < const_679)
                  {
                     _loc18_ = new AvatarEditorGridColorItem(AvatarEditorView.var_1663.clone() as IWindowContainer,param1,_loc13_);
            ...
            {
               _loc23_ = false;
               if(_loc6_.gender == FigureData.const_1676)
               {
                  _loc23_ = true;
               }
               ...
               if(_loc6_.isSelectable && _loc23_ && (_loc12_ || this.var_818 >= _loc6_.clubLevel))
               {
                  _loc7_ = new AvatarEditorGridPartItem(AvatarEditorView.var_1377.clone() as IWindowContainer,param1,_loc6_,_loc11_,_loc16_);
                  _loc3_.push(_loc7_);
               }
            }
         }
      ...
      public function getDefaultColour(param1:String) : int
      {
         ...
         if(_loc2_ != null)
         {
            ...
            {
               if(_loc4_.isSelectable && this.var_818 >= _loc4_.clubLevel)
               {
                  return _loc4_.id;
               }
            }
      ...
      public function get wardrobe() : WardrobeModel
      {
         ...
         return this.var_540.getValue(AvatarEditorSideCategory.const_114);
      }

package com.sulake.habbo.avatar
{
   ...
   public class AvatarStructure extends EventDispatcher
   {
      ...
      private var var_1094:AvatarActionManager;
      
      private var var_408:FigureData;
      
      private var var_485:PartSetsData;
      
      private var _animationData:AnimationData;
      
      private var var_879:AnimationManager;
      
      private var var_1091:ActionDefinition;
      
      private var var_574:String;
      
      private var var_1647:PartOffsetData;
      ...
      {
         this.var_1647.loadOffsets(param1);
      }
      ...
      public function initGeometry(param1:XML) : void
      {
         if(!param1)
         {
            Logger.log("[AvatarStructure] Could not init Geometry for structure: " + this.var_574);
            return;
         }
      ...
      public function initActions(param1:IAssetLibrary, param2:XML) : void
      {
         if(!param2)
         {
            Logger.log("[AvatarStructure] Could not init Actions for structure: " + this.var_574);
            return;
         }
         this.var_1094 = new AvatarActionManager(param1,this.var_574,param2);
         this.var_1091 = this.var_1094.getDefaultAction();
      }
      ...
      public function initPartSets(param1:XML) : Boolean
      {
         if(!param1)
         {
            Logger.log("[AvatarStructure] Could not init Part Sets for structure: " + this.var_574);
            return false;
         }
         if(this.var_485.parse(param1))
         {
            if(this.var_574 == AvatarType.const_139)
            {
      ...
      public function initAnimation(param1:XML) : Boolean
      {
         if(!param1)
         {
            Logger.log("[AvatarStructure] Could not init Animations for structure: " + this.var_574);
            return false;
         }
      ...
      public function initFigureData(param1:XML) : Boolean
      {
         if(!param1)
         {
            Logger.log("[AvatarStructure] Could not init Figure Data for structure: " + this.var_574);
            return false;
         }
         return this.var_408.parse(param1);
      }
      
      public function injectFigureData(param1:XML) : void
      {
         this.var_408.injectXML(param1);
      }
      ...
      public function registerAnimations(param1:AssetLibraryCollection, param2:String = "fx", param3:int = 200) : void
      {
         ...
         while(_loc5_ < param3)
         {
            if(param1.hasAsset(param2 + _loc5_))
            {
               ...
               this.var_879.registerAnimation(this,_loc4_);
            }
            _loc5_++;
         }
      }
      ...
      public function getPartColor(param1:IAvatarFigureContainer, param2:String, param3:int = 0) : IPartColor
      {
         ...
         var _loc5_:ISetType = this.var_408.getSetType(param2);
         if(_loc5_ == null)
         {
            return null;
         }
         var _loc6_:IPalette = this.var_408.getPalette(_loc5_.paletteID);
         if(!_loc6_)
         {
            return null;
         }
      ...
      {
         return this.var_879.getLayerData(param1,param2,param3) as AnimationLayerData;
      }
      
      public function getAnimation(param1:String) : Animation
      {
         return this.var_879.getAnimation(param1) as Animation;
      }
      
      public function getActionDefinition(param1:String) : ActionDefinition
      {
         return this.var_1094.getActionDefinition(param1);
      }
      
      public function getActionDefinitionWithState(param1:String) : ActionDefinition
      {
         return this.var_1094.getActionDefinitionWithState(param1);
      }
      ...
      {
         return this.var_1094.sortActions(param1);
      }
      
      public function getMandatorySetTypeIds(param1:String, param2:int) : Array
      {
         if(!this.var_707[param1])
         {
            this.var_707[param1] = new Dictionary();
         }
         if(this.var_707[param1][param2])
         {
            return this.var_707[param1][param2];
         }
         this.var_707[param1][param2] = this.var_408.getMandatorySetTypeIds(param1,param2);
         return this.var_707[param1][param2];
      }
      
      public function getDefaultPartSet(param1:String, param2:String) : IFigurePartSet
      {
         return this.var_408.getDefaultPartSet(param1,param2);
      }
      
      public function getCanvasOffsets(param1:Array, param2:String, param3:int) : Array
      {
         return this.var_1094.getCanvasOffsets(param1,param2,param3);
      }
      ...
      public function getActiveBodyPartIds(param1:IActiveActionData) : Array
      {
         ...
         if(param1.definition.isAnimation)
         {
            ...
            _loc7_ = this.var_879.getAnimation(_loc6_) as Animation;
            if(_loc7_ != null)
            {
      ...
      {
         var _loc4_:Number = AvatarDirectionAngle.const_1940[param3];
      ...
      public function getParts(param1:String, param2:IAvatarFigureContainer, param3:IActiveActionData, param4:String, param5:int, param6:Array, param7:Dictionary = null) : Array
      {
         ...
         if(param3.definition.isAnimation)
         {
            ...
            _loc9_ = this.var_879.getAnimation(_loc23_) as Animation;
            if(_loc9_ != null)
            {
         ...
         for each(_loc16_ in _loc20_)
         {
            ...
            _loc29_ = this.var_408.getSetType(_loc16_);
            if(_loc29_)
            {
               _loc30_ = this.var_408.getPalette(_loc29_.paletteID);
               if(_loc30_)
               {
      ...
      {
         return this.var_1647.getOffset(param1,param2,param3,param4,param5,param6);
      }

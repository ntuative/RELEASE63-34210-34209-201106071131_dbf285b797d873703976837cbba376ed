package com.sulake.habbo.avatar
{
   ...
   public class HabboAvatarEditorManager extends Component implements IHabboAvatarEditor
   {
      ...
      private var var_1180:AvatarEditorMessageHandler;
      ...
      {
         var _loc6_:HabboAvatarEditor = this.var_235.getValue(param1);
         if(!_loc6_)
         {
            _loc6_ = new HabboAvatarEditor(param1,this);
            this.var_235.add(param1,_loc6_);
         }
      ...
      {
         var _loc5_:HabboAvatarEditor = this.var_235.getValue(param1) as HabboAvatarEditor;
         if(_loc5_)
         {
      ...
      {
         var _loc2_:HabboAvatarEditor = this.var_235.getValue(param1) as HabboAvatarEditor;
         if(_loc2_)
         {
      ...
      public function close(param1:uint) : void
      {
         ...
         switch(param1)
         {
            case AvatarEditorInstanceId.const_214:
               _loc2_.hide();
               break;
            case AvatarEditorInstanceId.const_442:
               _loc2_.hide();
               _loc2_.dispose();
               this.var_235.remove(param1);
               break;
            default:
               _loc2_.dispose();
               this.var_235.remove(param1);
      ...
      {
         return this.var_235.getValue(param1) as HabboAvatarEditor;
      }
      ...
      private function onAvatarRenderManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         (this.var_946 as Component).events.addEventListener(AvatarRenderEvent.AVATAR_RENDER_READY,this.onAvatarRendererReady);
      }
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1180 = new AvatarEditorMessageHandler(this,this._communication);
      }

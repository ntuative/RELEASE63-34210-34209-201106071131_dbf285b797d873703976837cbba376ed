package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridView
   {
      ...
      private var var_2805:Boolean = true;
      ...
      public function initFromList() : void
      {
         ...
         var _loc5_:* = null;
         var _loc6_:* = null;
         var _loc1_:CategoryData = this.var_76.getCategoryData(this.var_1592);
         if(!_loc1_)
         {
            return;
         }
      ...
      private function partEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.const_45)
         {
            ...
            this.var_76.selectPart(this.var_1592,_loc3_);
         }
      }
         ...
         if(param1.type == WindowMouseEvent.const_45)
         {
            ...
            while(_loc7_ < this.const_679)
            {
               if(this.var_561.length > _loc7_)
               {
                  ...
                  if(_loc5_ > -1)
                  {
                     this.var_76.selectColor(this.var_1592,_loc5_,_loc7_);
                     return;
                  }
               }
               _loc7_++;

package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridPartItem implements IAvatarImageListener
   {
      ...
      private var var_784:IFigurePartSet;
      ...
      private const const_2283:int = 13421772;
      ...
      public function AvatarEditorGridPartItem(param1:IWindowContainer, param2:IAvatarEditorCategoryModel, param3:IFigurePartSet, param4:Array, param5:Boolean = true)
      {
         ...
         if(param3 == null)
         {
            this.var_717 = new BitmapData(1,1,true,16777215);
         }
         if(param3 != null)
         {
            _loc7_ = param3.parts;
            ...
            {
               this.var_1835 = Math.max(this.var_1835,_loc6_.colorLayerIndex);
            }
         }
         this.var_438 = this.var_76.controller.manager.avatarRenderManager;
      ...
      private function updateThumbVisualization() : void
      {
         ...
         if(_loc1_)
         {
            if(this.var_717 != null && !this.var_1834)
            {
               _loc3_ = this.var_717;
            }
            else
         ...
         if(_loc2_)
         {
            if(this.var_784)
            {
               switch(this.var_784.clubLevel)
               {
                  case HabboClubLevelEnum.const_59:
                     _loc2_.visible = false;
                     break;
                  case HabboClubLevelEnum.const_39:
                     _loc2_.style = HabboIconType.const_916;
                     break;
                  case HabboClubLevelEnum.const_44:
                     _loc2_.style = HabboIconType.const_723;
               }
            }
            else
            {
         ...
         if(this.isSelected)
         {
            this.var_1483.color = this.const_2283;
         }
         else
         {
            this.var_1483.color = this.const_2282;
         }
      ...
      private function analyzePartLayers() : Boolean
      {
         ...
         for each(_loc2_ in this.partSet.parts)
         {
            if(_loc7_)
            {
               _loc3_ = "undefined_undefined_" + _loc2_.type + "_" + _loc2_.id + "_" + this.const_376[_loc6_] + "_" + FigureData.const_141;
      ...
      private function renderThumb() : BitmapData
      {
         ...
         if(this.var_634 == null)
         {
            if(!this.analyzePartLayers())
            {
               if(!this.var_1833)
               {
                  ...
                  this.var_1833 = _loc9_.content as BitmapData;
               }
         ...
         for each(_loc2_ in _loc8_)
         {
            ...
            if(_loc4_)
            {
               ...
               if(this.var_1834 && _loc2_.colorLayerIndex > 0)
               {

package com.sulake.habbo.avatar.common
{
   ...
   public class CategoryData
   {
      ...
      private const const_2305:int = 2;
      ...
      public function selectColorIds(param1:Array) : void
      {
         ...
         this.var_232 = new Array(param1.length);
         var _loc3_:int = 0;
      ...
      public function selectPartIndex(param1:int) : AvatarEditorGridPartItem
      {
         ...
         if(this.var_938 >= 0 && this._parts.length > this.var_938)
         {
            _loc2_ = this._parts[this.var_938];
            if(_loc2_)
            {
               _loc2_.isSelected = false;
            }
      ...
      public function selectColorIndex(param1:int, param2:int) : AvatarEditorGridColorItem
      {
         ...
         this.deselectColorIndex(this.var_232[param2],param2);
         this.var_232[param2] = param1;
      ...
      public function getSelectedColorIds() : Array
      {
         ...
         while(_loc5_ < this.var_232.length)
         {
            ...
            {
               if(_loc7_.length > this.var_232[_loc5_])
               {
                  _loc8_ = _loc7_[this.var_232[_loc5_]] as AvatarEditorGridColorItem;
      ...
      public function getSelectedColor(param1:int) : AvatarEditorGridColorItem
      {
         ...
         if(!_loc2_ || _loc2_.length <= this.var_232[param1])
         {
            return null;
         }
         return _loc2_[this.var_232[param1]] as AvatarEditorGridColorItem;
      }
      ...
      {
         return this._parts[this.var_938] as AvatarEditorGridPartItem;
      }

package com.sulake.habbo.avatar
{
   ...
   public class AvatarAssetDownloadLibrary extends EventDispatcher
   {
      ...
      private static var var_1778:int = 1;
      ...
      public function AvatarAssetDownloadLibrary(param1:String, param2:String, param3:String, param4:IAssetLibrary)
      {
         ...
         this._state = name_3;
         this._assets = param4;
         this.var_755 = String(param1);
         this._revision = String(param2);
         this.var_1171 = param3 + this.var_755 + ".swf";
         ...
         var _loc6_:IAssetLibrary = _loc5_.getAssetLibraryByUrl(this.var_755 + ".swf");
         if(_loc6_ != null)
         {
            Logger.log("[AvatarAssetDownloadLibrary] Already Downloaded by Core: " + this.var_755);
            this._state = name_4;
         }
      }
      ...
      {
         Core.error("Could not load avatar asset library " + this.var_755 + " from URL " + this.var_1171,false,Core.const_1228);
      }
      ...
      {
         var _loc1_:String = this.var_755;

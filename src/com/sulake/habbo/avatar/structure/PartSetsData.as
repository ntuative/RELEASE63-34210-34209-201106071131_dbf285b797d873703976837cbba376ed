package com.sulake.habbo.avatar.structure
{
   ...
   public class PartSetsData implements IStructureData
   {
      ...
      public function parse(param1:XML) : Boolean
      {
         ...
         {
            this.var_937[String(_loc3_.@id)] = new ActivePartSet(_loc3_);
         }
         return true;
      }
      ...
      {
         var _loc2_:ActivePartSet = this.var_937[param1.activePartSet];
         if(_loc2_ != null)
         {
            return _loc2_.parts;
         }
      ...
      {
         return this.var_937[param1.activePartSet] as ActivePartSet;
      }
   }
}

   ...
   public class AvatarModelGeometry
   {
      ...
      public function AvatarModelGeometry(param1:XML)
      {
         ...
         if(_loc2_ != null)
         {
            ...
            this.var_912.x = _loc11_;
            this.var_912.y = _loc12_;
            this.var_912.z = _loc13_;
         }
         ...
         for each(_loc6_ in param1.type)
         {
            ...
            this.var_733[String(_loc6_.@id)] = _loc7_;
            this.var_1682[String(_loc6_.@id)] = _loc8_;
         }
      }
      ...
      {
         var _loc2_:* = [];
         var _loc3_:AvatarSet = this.var_1683.findAvatarSet(param1);
         if(_loc3_ != null)
         {
      ...
      {
         var _loc2_:AvatarSet = this.var_1683.findAvatarSet(param1);
         if(_loc2_ != null)
         {
      ...
      {
         return this.var_733[param1] != null;
      }
      ...
      private function hasBodyPart(param1:String, param2:String) : Boolean
      {
         ...
         {
            _loc3_ = this.var_733[param1] as Dictionary;
      ...
      private function getBodyPartsOfType(param1:String) : Dictionary
      {
         if(this.typeExists(param1))
         {
            return this.var_733[param1] as Dictionary;
         }
      ...
      public function getBodyPartOfItem(param1:String, param2:String) : GeometryBodyPart
      {
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc3_:Dictionary = this.var_1682[param1];
         if(_loc3_ != null)
         {
      ...
      public function getBodyPartsAtAngle(param1:String, param2:uint, param3:String) : Array
      {
         ...
         for each(_loc7_ in _loc5_)
         {
            ...
            _loc9_ = _loc7_.getDistance(this.var_912);
      ...
      public function getParts(param1:String, param2:String, param3:uint, param4:Array) : Array
      {
         ...
         if(this.hasBodyPart(param1,param2))
         {
            ...
            return _loc5_.getParts(this.var_1134,this.var_912,param4);
         }
         return [];
      }

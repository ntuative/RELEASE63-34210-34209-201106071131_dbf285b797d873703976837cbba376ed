package com.sulake.habbo.avatar.geometry
{
   public class Vector3D
   {
      ...
      {
         return this._x * param1.x + this.var_182 * param1.y + this.var_181 * param1.z;
      }
      
      public function cross(param1:Vector3D) : Vector3D
      {
         var _loc2_:Vector3D = new Vector3D();
         _loc2_.x = this.var_182 * param1.z - this.var_181 * param1.y;
         _loc2_.y = this.var_181 * param1.x - this._x * param1.z;
         _loc2_.z = this._x * param1.y - this.var_182 * param1.x;
         return _loc2_;
      }
      ...
      {
         return Math.sqrt(this._x * this._x + this.var_182 * this.var_182 + this.var_181 * this.var_181);
      }
      
      public function toString() : String
      {
         return "Vector3D: (" + this._x + "," + this.var_182 + "," + this.var_181 + ")";
      }

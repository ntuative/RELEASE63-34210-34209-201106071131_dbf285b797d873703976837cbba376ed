package com.sulake.habbo.avatar.wardrobe
{
   ...
   public class WardrobeModel implements ISideContentModel
   {
      ...
      private function isSlotEnabled(param1:int) : Boolean
      {
         if(param1 <= 5)
         {
            return this.var_27.manager.sessionData.hasUserRight("fuse_use_wardrobe",HabboClubLevelEnum.const_39);
         }
         return this.var_27.manager.sessionData.hasUserRight("fuse_larger_wardrobe",HabboClubLevelEnum.const_44);
      }

package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      public function AvatarDataContainer(param1:XML)
      {
         ...
         this.var_735 = new ColorTransform(this.var_1932,this.var_1933,this.var_1934,this._alphaMultiplier);
         this.var_1331 = this.generatePaletteMapForGrayscale(this.var_2822,this.var_2820);
      }

package com.sulake.habbo.avatar.actions
{
   ...
   public class ActionDefinition implements IActionDefinition
   {
      ...
      public function ActionDefinition(param1:XML)
      {
         ...
         this.var_2667 = String(param1.@activepartset);
         this.var_2664 = String(param1.@assetpartdefinition);
         this.var_2666 = String(param1.@lay);
         this.var_859 = String(param1.@geometrytype);
         this.var_2433 = Boolean(parseInt(param1.@main));
         this.var_2665 = Boolean(parseInt(param1.@method_8));
         ...
         for each(_loc3_ in param1.param)
         {
            ...
            if(_loc5_ == "default")
            {
               this.var_2663 = _loc6_;
            }
            else
            {
               this.var_1931[_loc5_] = _loc6_;
            }
         }
         for each(_loc4_ in param1.type)
         {
            _loc7_ = String(_loc4_.@id);
            this.var_149[_loc7_] = new ActionType(_loc4_);
         }
      }
      ...
      public function setOffsets(param1:String, param2:int, param3:Array) : void
      {
         ...
         {
            this.var_823.add(param1,new Map());
         }
         var _loc4_:Map = this.var_823.getValue(param1);
      ...
      public function getOffsets(param1:String, param2:int) : Array
      {
         ...
         var _loc3_:Map = this.var_823.getValue(param1) as Map;
         if(_loc3_ == null)
         {
            return null;
         }
      ...
      public function getParameterValue(param1:String) : String
      {
         ...
         var _loc2_:String = this.var_1931[param1];
         if(_loc2_ == null)
         {
            _loc2_ = this.var_2663;
         }
         return _loc2_;
      }
      ...
      private function getTypePrevents(param1:String) : Array
      {
         ...
         var _loc2_:ActionType = this.var_149[param1];
         if(_loc2_ != null)
         {

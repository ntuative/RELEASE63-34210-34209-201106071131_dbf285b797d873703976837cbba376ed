package com.sulake.habbo.avatar.palette
{
   ...
   public class PaletteMap
   {
      ...
      {
         var _loc2_:int = this.var_621.indexOf(param1);
         return _loc2_ < 0 ? 0 : int(_loc2_);
      }
      
      public function colorizeBitmap(param1:BitmapData) : void
      {
         param1.paletteMap(param1,param1.rect,new Point(0,0),this._blank,this.var_621,this._blank,this._blank);
      }
      ...
      public function colorize(param1:ByteArray) : ByteArray
      {
         ...
         while(param1.bytesAvailable >= 4)
         {
            ...
            _loc7_ = uint(this.var_621[_loc5_] as uint);
      ...
      public function invert() : void
      {
         ...
         while(this.var_621.length > 0)
         {
            _loc1_.push(this.var_621.pop());
         }
         this.var_621 = _loc1_;
      }
   }

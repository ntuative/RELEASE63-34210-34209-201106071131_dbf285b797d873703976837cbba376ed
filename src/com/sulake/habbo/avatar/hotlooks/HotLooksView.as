package com.sulake.habbo.avatar.hotlooks
{
   ...
   public class HotLooksView implements IAvatarEditorCategoryView
   {
      ...
      public function init() : void
      {
         ...
         this.var_684 = this._window.findChildByName("hotlooks") as IItemGridWindow;
      ...
      {
         while(this.var_684.numGridItems > 0)
         {
            this.var_684.removeGridItemAt(0);
         }
         this._window.dispose();
         this._window = null;
         this.var_76 = null;
      ...
      public function update() : void
      {
         ...
         for each(_loc2_ in this.var_76.hotLooks)
         {
            ...
            this.var_684.addGridItem(_loc1_);
      ...
      private function hotLooksEventProc(param1:WindowEvent, param2:IWindow = null) : void
      {
         ...
         {
            _loc3_ = this.var_684.getGridItemIndex(param2.parent);

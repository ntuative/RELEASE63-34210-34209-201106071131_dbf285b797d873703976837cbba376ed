   ...
   public class LegsView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      override public function init() : void
      {
         ...
         if(!var_41)
         {
            ...
            var_41["null"] = new AvatarEditorGridView(var_76,FigureData.const_232,_windowManager,_assetLibrary);
            var_41["null"] = new AvatarEditorGridView(var_76,FigureData.const_243,_windowManager,_assetLibrary);
            var_41["null"] = new AvatarEditorGridView(var_76,FigureData.const_290,_windowManager,_assetLibrary);
         }
         else
         {
         ...
         if(var_76 && var_158 == "")
         {
            var_76.switchCategory(FigureData.const_232);
         }
      }

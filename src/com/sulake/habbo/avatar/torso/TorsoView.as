   ...
   public class TorsoView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      override public function init() : void
      {
         ...
         if(!var_41)
         {
            ...
            var_41["null"] = new AvatarEditorGridView(var_76,FigureData.const_278,_windowManager,_assetLibrary);
            var_41["null"] = new AvatarEditorGridView(var_76,FigureData.const_226,_windowManager,_assetLibrary);
            var_41["null"] = new AvatarEditorGridView(var_76,FigureData.const_251,_windowManager,_assetLibrary);

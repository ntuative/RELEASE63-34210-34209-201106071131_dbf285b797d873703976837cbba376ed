package com.sulake.habbo.avatar
{
   ...
   public class AvatarImage implements IAvatarImage, IDisposable
   {
      ...
      protected var var_1808:int;
      
      protected var var_298:IActiveActionData;
      
      protected var var_1115:Boolean;
      
      protected var var_823:Array;
      
      protected var _assets:AssetAliasCollection;
      
      protected var var_283:AvatarImageCache;
      
      protected var var_655:AvatarFigureContainer;
      
      protected var var_585:IAvatarDataContainer;
      ...
      public function setDirection(param1:String, param2:int) : void
      {
         ...
         if(param1 == AvatarSetType.const_53 || param1 == AvatarSetType.const_40)
         {
      ...
      private function getFullImageCacheKey() : String
      {
         ...
         if(this.var_270.length == 1 && this.var_99 == this.var_1808)
         {
            return this.var_99 + this.var_531 + this.var_640 % 4;
         }
         if(this.var_270.length == 2)
         {
            for each(_loc1_ in this.var_270)
            {
               ...
               {
                  return this.var_99 + this.var_531 + 0;
               }
               if(_loc1_.actionType == "fx" && (_loc1_.actionParameter == "38" || _loc1_.actionParameter == "39"))
               {
                  _loc2_ = this.var_640 % 11;
                  return this.var_99 + "_" + this.var_1808 + this.var_531 + _loc2_;
               }
            }
         }
         return null;
      ...
      {
         if(param3 != this.var_2581 || param2 != this.var_2580 || param1 != this.var_2579)
         {
            this.var_2581 = param3;
            this.var_2580 = param2;
            this.var_2579 = param1;
            this.var_1867 = this._structure.getBodyParts(param1,param2,param3);
         }
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         var _loc5_:AvatarCanvas = this._structure.getCanvas(this._scale,this.var_298.definition.geometryType);
         if(_loc5_ == null)
         {
            return null;
         }
         if(this.var_1395 || this.var_48 == null || (this.var_48.width != _loc5_.width || this.var_48.height != _loc5_.height))
         {
            if(this.var_48 != null && !this.var_1395)
            {
               this.var_48.dispose();
            }
         ...
         var _loc6_:Array = this.getBodyParts(param1,this.var_298.definition.geometryType,this.var_99);
         this.var_48.lock();
         ...
         while(_loc12_ >= 0)
         {
            ...
            _loc9_ = _loc4_.getImageContainer(_loc8_,this.var_640);
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         while(_loc12_ >= 0)
         {
            ...
            _loc8_ = _loc2_.getImageContainer(_loc7_,this.var_640);
            if(_loc8_ != null)
            {
               _loc9_ = _loc8_.image;
               if(_loc9_ == null)
      ...
      protected function addActionData(param1:String, param2:String = "") : void
      {
         ...
         this.var_344.push(new ActiveActionData(param1,param2,this.var_640));
      }
      ...
      private function resetActions() : Boolean
      {
         ...
         this.resetBodyPartCache(this.var_1091);
         return true;
      }
      ...
      private function sortActions() : Boolean
      {
         ...
         var _loc1_:Boolean = false;
         this.var_531 = "";
         this.var_270 = this._structure.sortActions(this.var_344);
         if(this.var_270 == null)
         {
         ...
         {
            this.var_823 = this._structure.getCanvasOffsets(this.var_270,this._scale,this.var_99);
            for each(_loc4_ in this.var_270)
            {
               this.var_531 += _loc4_.actionType + _loc4_.actionParameter;
               if(_loc4_.actionType == AvatarAction.const_357)
               {
                  _loc5_ = parseInt(_loc4_.actionParameter);
                  if(this.var_1500 != _loc5_)
                  {
                     _loc2_ = true;
                  }
                  this.var_1500 = _loc5_;
                  _loc3_ = true;
               }
            }
            if(!_loc3_)
      ...
      private function setActionsToParts() : void
      {
         ...
         for each(_loc1_ in this.var_270)
         {
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               {
                  this.var_918 = _loc1_.definition.isAnimated(_loc1_.actionParameter);
                  _loc2_ = this._structure.getAnimation(_loc1_.definition.state + "." + _loc1_.actionParameter);
                  if(_loc2_ != null)
                  {
               ...
               if(_loc1_.actionType == AvatarAction.const_347 || _loc1_.actionType == AvatarAction.const_266 || _loc1_.actionType == AvatarAction.const_399)
               {
                  this.var_918 = true;
               }
            }

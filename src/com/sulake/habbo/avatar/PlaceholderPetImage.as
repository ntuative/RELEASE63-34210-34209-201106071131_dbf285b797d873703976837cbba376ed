package com.sulake.habbo.avatar
{
   ...
   public class PlaceholderPetImage extends PetImage
   {
      ...
      public function PlaceholderPetImage(param1:AvatarStructure, param2:AssetAliasCollection, param3:String, param4:String, param5:IAssetLibrary)
      {
         ...
         var _loc6_:AvatarCanvas = _structure.getCanvas(_scale,var_298.definition.geometryType);
         if(_loc6_)
         {
      ...
      override public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         var _loc2_:BitmapData = this.getPlaceHolderImage(var_99,_scale);
         if(!_loc2_)
         {
            return null;
         }
      ...
      override public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         var _loc3_:BitmapData = this.getPlaceHolderImage(var_99,_scale);
      ...
      private function getPlaceHolderImage(param1:int, param2:String) : BitmapData
      {
         ...
         _loc3_ += "_png";
         _loc6_;
         var _loc4_:BitmapData = this.var_627.getValue(_loc3_);
         if(!_loc4_)
         {
            ...
            _loc6_;
            this.var_627.add(_loc3_,_loc4_.clone());
            _loc4_ = this.var_627.getValue(_loc3_);
         }
         return _loc4_;
      }

package com.sulake.habbo.friendbar.view.utils
{
   ...
   public class FriendListIcon extends Icon
   {
      ...
      override public function notify(param1:Boolean) : void
      {
         super.notify(param1);
         this.enable(param1);
         toggleTimer(param1 || _hover,!!_hover ? int(const_1096) : int(const_1095));
         if(!var_898 && !_hover)
         {
      ...
      {
         super.hover(param1);
         toggleTimer(param1 || var_898,!!_hover ? int(const_1096) : int(const_1095));
         if(!var_898 && !_hover)
         {
            image = this._assets.getAssetByName("icon_friendlist_png") as BitmapDataAsset;
         }

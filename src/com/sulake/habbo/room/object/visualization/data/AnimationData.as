   ...
   public class AnimationData
   {
      ...
      public function dispose() : void
      {
         ...
         if(this.var_130 != null)
         {
            ...
            {
               _loc2_ = this.var_130.getWithIndex(_loc1_) as AnimationLayerData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      private function addLayer(param1:int, param2:int, param3:int, param4:Boolean, param5:XML) : Boolean
      {
         ...
         this.var_130.add(param1,_loc6_);
      ...
      {
         var _loc4_:AnimationLayerData = this.var_130.getValue(param2) as AnimationLayerData;
         if(_loc4_ != null)
         {
      ...
      {
         var _loc6_:AnimationLayerData = this.var_130.getValue(param2) as AnimationLayerData;
         if(_loc6_ != null)
         {

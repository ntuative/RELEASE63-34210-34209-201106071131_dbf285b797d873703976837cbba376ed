package com.sulake.habbo.room.object.visualization.data
{
   ...
   public class SizeData
   {
      ...
      public static const const_406:int = 1000;
      ...
      private var var_1485:int = 360;
      
      private var var_788:DirectionData = null;
      
      private var var_267:Map;
      
      private var _colors:Map;
      
      private var var_1216:DirectionData = null;
      ...
      public function SizeData(param1:int, param2:int)
      {
         ...
         this.var_788 = new DirectionData(param1);
      ...
      public function defineLayers(param1:XML) : Boolean
      {
         ...
         return this.defineDirection(this.var_788,_loc2_);
      }
      ...
      public function defineDirections(param1:XML) : Boolean
      {
         ...
         while(_loc5_ < _loc4_.length())
         {
            ...
            _loc3_.copyValues(this.var_788);
      ...
      private function defineDirection(param1:DirectionData, param2:XMLList) : Boolean
      {
         ...
         while(_loc4_ < param2.length())
         {
            ...
            {
               case "ADD":
                  param1.setInk(_loc6_,LayerData.const_1154);
                  break;
               case "SUBTRACT":
                  param1.setInk(_loc6_,LayerData.const_1171);
                  break;
               case "DARKEN":
      ...
      public function getDirectionValue(param1:int) : int
      {
         var _loc6_:int = 0;
         var _loc7_:int = 0;
         var _loc2_:int = (param1 % 360 + 360 + this.var_1485 / 2) % 360 / this.var_1485;
         ...
         {
            _loc6_ = int(this.var_267.getKey(_loc5_)) * this.var_1485;

package com.sulake.habbo.room.object.visualization.data
{
   public class AnimationLayerData
   {
      ...
      public function dispose() : void
      {
         ...
         {
            _loc2_ = this.var_251[_loc1_] as AnimationFrameSequenceData;
            if(_loc2_ != null)
            {
               _loc2_.dispose();
            }
      ...
      public function getFrame(param1:int, param2:int) : AnimationFrame
      {
         ...
         if(!this.var_1724)
         {
            ...
            {
               _loc3_ = this.var_251[_loc5_] as AnimationFrameSequenceData;
               if(_loc3_ != null)
               {
         ...
         _loc5_ = this.var_251.length * Math.random();
         _loc3_ = this.var_251[_loc5_] as AnimationFrameSequenceData;
      ...
      {
         if(param2 < 0 || param2 >= this.var_251.length)
         {
            return null;
         }
         var _loc5_:AnimationFrameSequenceData = this.var_251[param2] as AnimationFrameSequenceData;
         if(_loc5_ != null)
         {
      ...
      private function getFrameFromSpecificSequence(param1:int, param2:AnimationFrameSequenceData, param3:int, param4:int, param5:Boolean) : AnimationFrame
      {
         ...
         if(param2 != null)
         {
            ...
            _loc13_ = this.var_2069 * _loc12_;
            if(param5)
            {
               _loc13_ = 0;
            }
            _loc14_ = false;
            if(!this.var_1724 && !param2.isRandom)
            {
               if(param3 == this.var_251.length - 1 && param4 == param2.frameCount - 1)
               {
                  _loc14_ = true;
               }
            }

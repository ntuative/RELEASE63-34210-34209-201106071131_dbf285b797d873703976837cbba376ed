package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureWaterAreaVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_1555:String = "shore";
      ...
      {
         if(this.var_2710 == param1 && this.var_2711 == direction)
         {
         ...
         while(_loc2_ >= 0)
         {
            if(getSpriteTag(param1,direction,_loc2_) == const_1555)
            {
               this.var_1966 = _loc2_;
               this.var_2710 = param1;
               this.var_2711 = direction;
               return this.var_1966;
            }
            _loc2_--;
         }
      ...
      private function getInstanceMask(param1:int) : IGraphicAsset
      {
         ...
         if(_loc3_ != null)
         {
            if(this.var_1270.indexOf(_loc2_) < 0)
            {
      ...
      private function updateBorderData() : void
      {
         ...
         var _loc3_:int = this.var_547 + 2;
         var _loc4_:int = this.var_666 + 2;
         var _loc5_:int = 0;
         ...
         this.var_1965 = false;
         _loc5_ = 0;
         while(_loc5_ < this.var_458.length)
         {
            if(this.var_458[_loc5_] == true)
            {
               this.var_1965 = true;
            }
            _loc5_++;
      ...
      private function updateTopBorder(param1:Array, param2:int) : int
      {
         ...
         while(_loc8_ < _loc3_ - 1)
         {
            if(_loc4_[_loc8_] == false)
            {
               ...
               this.var_665[param2] = ShoreMaskCreatorUtility.getBorderType(_loc6_,_loc7_);
            }
            param2++;
            _loc8_++;
         }
      ...
      private function updateRightBorder(param1:Array, param2:int) : int
      {
         ...
         while(_loc10_ < _loc4_ - 1)
         {
            ...
            if(_loc7_[_loc3_ - 1] == false)
            {
               ...
               this.var_665[param2] = ShoreMaskCreatorUtility.getBorderType(_loc5_,_loc6_);
            }
            param2++;
            _loc10_++;
         }
      ...
      {
         var _loc2_:* = null;
         if(this.var_547 == 0 || this.var_666 == 0)
         {
            ...
            this.var_547 = _loc2_.getNumber(RoomObjectVariableEnum.const_319);
            this.var_666 = _loc2_.getNumber(RoomObjectVariableEnum.const_384);
         }
         this.var_458 = [];
         this.var_665 = [];
         var _loc1_:int = 0;
         while(_loc1_ < this.var_547 * 2 + this.var_666 * 2)
         {
            this.var_458.push(false);
            this.var_665.push(ShoreMaskCreatorUtility.const_84);
            _loc1_++;
         }
      }
      ...
      {
         var _loc1_:int = this.var_547 + 2;
         var _loc2_:int = this.var_666 + 2;
         var _loc3_:* = [];
         var _loc4_:* = null;
         var _loc5_:int = 0;
         var _loc6_:int = 0;
      ...
      private function createShoreMask(param1:int, param2:int, param3:Number) : BitmapData
      {
         ...
         return ShoreMaskCreatorUtility.createShoreMask2x2(this.var_79,getSize(param3),this.var_458,this.var_665,assetCollection);
      }

package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class ShoreMaskCreatorUtility
   {
      ...
      {
         return param1 + param2 * const_1463;
      }
            ...
            if(param2.getAsset(_loc4_) == null)
            {
               if(param3 != null)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     ...
                     _loc7_ = [const_157,const_84,const_78,const_157,const_84,const_78];
                     _loc8_ = [const_84,const_84,const_84,const_78,const_78,const_78];
                     _loc9_ = null;
                     _loc10_ = 0;
                     if(_loc6_ != null)
                     {

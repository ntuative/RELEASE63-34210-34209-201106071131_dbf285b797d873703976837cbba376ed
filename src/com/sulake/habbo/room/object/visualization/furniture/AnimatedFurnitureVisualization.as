package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class AnimatedFurnitureVisualization extends FurnitureVisualization
   {
      ...
      protected function getAnimationId(param1:AnimationStateData) : int
      {
         ...
         if(_loc2_ != const_1204 && this._animationData.hasAnimation(this.var_432,_loc2_))
         {
            return _loc2_;
         }
         return const_1204;
      ...
      override protected function updateObject(param1:Number, param2:Number) : Boolean
      {
         ...
         if(super.updateObject(param1,param2))
         {
            ...
            if(_loc4_ != this._state)
            {
               ...
               if(_loc5_ != null)
               {
                  _loc6_ = _loc5_.getNumber(RoomObjectVariableEnum.const_982);
         ...
         if(super.updateModel(param1))
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  ...
                  {
                     _loc5_ = _loc3_.getNumber(RoomObjectVariableEnum.const_982);
                  ...
                  _loc4_ = _loc3_.getNumber(RoomObjectVariableEnum.const_1011);
                  if(!isNaN(_loc4_))
                  {
                     _loc6_ = this._animationData.getAnimationId(this.var_432,_loc4_);
      ...
      protected function setSubAnimation(param1:AnimationStateData, param2:int, param3:Boolean = true) : Boolean
      {
         ...
         if(param3)
         {
            ...
            if(param2 != _loc5_)
            {
               if(!this._animationData.isImmediateChange(this.var_432,param2,_loc5_))
               {
                  _loc6_ = AnimationData.getTransitionFromAnimationId(_loc5_);
                  if(this._animationData.hasAnimation(this.var_432,_loc6_))
                  {
      ...
      protected function resetAllAnimationFrames() : void
      {
         if(this.var_124 != null)
         {
            this.var_124.setLayerCount(this.var_607);
         }
      }
      ...
      override protected function updateAnimation(param1:Number) : int
      {
         ...
         {
            this.var_432 = param1;
            this.var_607 = this._animationData.getLayerCount(param1);
      ...
      {
         var _loc2_:int = 0;
         if(!this.var_124.animationOver || this.var_939)
         {
      ...
      protected function updateFramesForAnimation(param1:AnimationStateData, param2:Number) : int
      {
         ...
         var _loc7_:* = 1 << this.var_607 - 1;
         var _loc8_:int = this.var_607 - 1;
         while(_loc8_ >= 0)
         {
            ...
            if(!_loc9_ || this.var_939)
            {
               ...
               if(this.var_939 || _loc11_ == null || _loc11_.remainingFrameRepeats >= 0 && _loc13_ <= 0)
               {
                  ...
                  if(_loc12_ == AnimationFrame.const_1288)
                  {
               ...
               if(_loc11_ == null || _loc11_.remainingFrameRepeats == AnimationFrame.const_531)
               {
                  _loc10_ = true;
                  _loc9_ = true;
               }

   ...
   public class FurnitureCuboidVisualization extends RoomObjectSpriteVisualization
   {
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_150 != null)
         {
            ...
            {
               _loc2_ = this.var_150[_loc1_] as FurniturePlane;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      protected function initializePlanes() : void
      {
         ...
         var _loc5_:Number = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_476);
      ...
      protected function updatePlanes(param1:IRoomGeometry, param2:int) : void
      {
         ...
         var _loc5_:int = 0;
         while(_loc5_ < this.var_150.length)
         {
            _loc6_ = false;
            ...
            _loc9_ = this.var_150[_loc5_] as FurniturePlane;
            if(_loc9_ != null)
            {

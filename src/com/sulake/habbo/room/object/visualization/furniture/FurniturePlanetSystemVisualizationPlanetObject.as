package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePlanetSystemVisualizationPlanetObject
   {
      ...
      private static const const_1493:Number = 30;
      ...
      {
         this.var_797 = new Vector3d(0,0,0);
         this._children = new Array();
         super();
         this._name = param1;
         this._index = param2;
         this.var_1620 = param3;
         this.var_2552 = param4 * 0 * 2 / 360;
         this.var_1855 = param5 * 0 * 2 / 360;
         this._height = param6;
         this.var_1226 = 0;
      }
      ...
      {
         var _loc3_:Number = this.var_1620 * Math.cos(this.var_1226 + this.var_1855);
         var _loc4_:Number = this.var_1620 * Math.sin(this.var_1226 + this.var_1855);
         var _loc5_:Number = this._height;
         this.var_797.x = (_loc3_ - _loc4_) * (param2 / 2);
         this.var_797.y = (_loc4_ + _loc3_) * (param2 / 2) * 0.5 - this._height * (param2 / 2);
         this.var_797.z = -int(4 * (_loc3_ + _loc4_) - 0.7);
         if(param1 != null)
         {
            this.var_797.add(param1);
         }
         return this.var_797;
      }

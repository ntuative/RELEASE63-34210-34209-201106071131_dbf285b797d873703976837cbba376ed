package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureVisualizationData implements IRoomObjectVisualizationData
   {
      ...
      public static const const_639:Array = new Array("a","b","c","d","e","f","g","h","i","j","k","l","m","n","o","p","q","r","s","t","u","v","w","x","y","z");
      ...
      private var var_925:SizeData = null;
      ...
      public function dispose() : void
      {
         ...
         if(this.var_303 != null)
         {
            ...
            {
               _loc1_ = this.var_303.getWithIndex(_loc2_) as SizeData;
               if(_loc1_ != null)
               {
                  _loc1_.dispose();
               }
      ...
      protected function defineVisualizations(param1:XML) : Boolean
      {
         ...
         while(_loc4_ < _loc2_.length())
         {
            ...
            if(this.var_303.getValue(String(_loc6_)) != null)
            {
               return false;
            }
            ...
            this.var_303.add(String(_loc6_),_loc9_);
      ...
      protected function getSizeData(param1:int) : SizeData
      {
         ...
         if(_loc2_ < this._sizes.length)
         {
            this.var_925 = this.var_303.getValue(String(this._sizes[_loc2_])) as SizeData;
         }
         else
         {
            this.var_925 = null;

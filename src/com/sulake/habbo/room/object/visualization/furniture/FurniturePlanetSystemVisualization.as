package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePlanetSystemVisualization extends AnimatedFurnitureVisualization
   {
      ...
      override protected function updateAnimation(param1:Number) : int
      {
         ...
         if(this.var_277 != null)
         {
            ...
            while(_loc3_ < this.var_277.length)
            {
               ...
               _loc2_.update(this._offsetArray,this.var_2726,param1);
               _loc3_++;
            }
      ...
      private function readDefinition() : Boolean
      {
         ...
         var _loc3_:String = _loc2_.getString(RoomObjectVariableEnum.const_1305);

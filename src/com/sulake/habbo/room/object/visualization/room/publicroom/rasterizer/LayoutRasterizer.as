package com.sulake.habbo.room.object.visualization.room.publicroom.rasterizer
{
   ...
   public class LayoutRasterizer
   {
      ...
      private var var_913:Boolean = true;
      ...
      public function set layout(param1:String) : void
      {
         if(param1 != this.var_914)
         {
            ...
            this._adBgIndex = -1;
            this._adImgIndex = -1;
            this.var_1423 = this.var_47.getValue(this.var_914);
         }
      }
      ...
      public function initialize(param1:XML) : void
      {
         ...
         this.var_2280 = new Vector3d(-0.5,0.5,0);
         this.var_913 = false;
      }
      ...
      public function initializeGeometry(param1:IRoomGeometry) : void
      {
         ...
         var _loc3_:Point = param1.getScreenPoint(this.var_2280);
         _loc3_.x -= _loc2_.x;
         _loc3_.y -= _loc2_.y;
         _loc3_.x = Math.round(_loc3_.x);
         _loc3_.y = Math.round(_loc3_.y);
         this.var_1145.x = _loc3_.x;
         this.var_1145.y = _loc3_.y;
      }
      ...
      public function initializeAds(param1:int, param2:IRoomObjectSpriteVisualization) : void
      {
         ...
         var _loc3_:LayoutRasterizerData = this.var_47.getValue(this.var_914);
         if(_loc3_ == null)
         {
            return;
         }
                  ...
                  if(_loc9_ != null)
                  {
                     if(_loc7_.@id.toString().length > 0)
                     {
                        ...
                        if(_loc10_ == "billboard_bg")
                        {
                           ...
                           {
                              this.var_1698 = RoomObjectVariableEnum.const_1151;
                           }
                           if(_loc11_.indexOf("right") > -1)
                           {
                              this.var_1698 = RoomObjectVariableEnum.const_1354;
                           }
                           if(param2 != null)
                           {
                              _loc5_ = param2.getSprite(this.var_1144 + this._adBgIndex);
                              if(_loc5_ != null)
                              {
                        ...
                        if(_loc10_ == "billboard_img")
                        {
                           ...
                           if(param2 != null)
                           {
                              _loc5_ = param2.getSprite(this.var_1144 + this._adImgIndex);
                              if(_loc5_ != null)
                              {
                                 _loc5_.visible = false;
                                 _loc5_.alpha = 0;
      ...
      {
         var _loc1_:LayoutRasterizerData = this.var_47.getValue(this.var_914);
         if(_loc1_ == null)
         {
            return 0;
         }
      ...
      {
         if(param2 == this.var_2278 && param3 == this.var_2279)
         {
            return;
         }
         ...
         if(param1 != null)
         {
            _loc4_ = param1.getSprite(this.var_1144 + this._adBgIndex);
            _loc5_ = param1.getSprite(this.var_1144 + this._adImgIndex);
         }
         ...
         if(param3)
         {
            ...
            _loc5_.tag = RoomObjectVariableEnum.const_596;
         }
         if(param2 != "")
         {
            _loc4_.visible = true;
      ...
      public function setElementToSprite(param1:int, param2:IRoomObjectSprite, param3:String = "", param4:Boolean = false) : void
      {
         ...
         param2.offsetX = int(_loc8_.@x) + _loc9_.offsetX + this.var_1145.x;
         param2.offsetY = int(_loc8_.@y) + _loc9_.offsetY + this.var_1145.y;
         ...
         if(_loc6_.@id.toString().length > 0)
         {
            ...
            if(this.var_424.indexOf(_loc10_) >= 0 && this.var_913)
            {
               param1 = this.var_424.indexOf(_loc10_);
               if(this.var_602[param1] != "")
               {
                  _loc9_ = this.var_763.getAsset(this.var_602[param1]);
                  if(_loc9_ != null && _loc9_.asset != null)
                  {
                     param2.asset = _loc9_.asset.content as BitmapData;
                  }

package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualization extends RoomObjectSpriteVisualization
   {
      ...
      public static const const_1790:int = 16777215;
      
      public static const const_1927:int = 13421772;
      
      private static const const_1076:int = 16777215;
      
      private static const const_1077:int = 13421772;
      
      private static const const_1074:int = 10066329;
      
      private static const const_1075:int = 10066329;
      
      public static const const_1861:int = 16777215;
      
      public static const const_1683:int = 13421772;
      
      public static const const_1935:int = 10066329;
      ...
      private var var_555:RoomPlaneBitmapMaskParser = null;
      
      private var var_1519:String = null;
      
      private var _floorType:String = null;
      
      private var var_1520:String = null;
      ...
      private var var_2757:int = 255;
      
      private var var_2756:int = 255;
      
      private var var_2000:Boolean = true;
      
      private var var_1297:int = 0;
      
      private var var_1911:int = -1000;
      
      private const const_2300:int = 250;
      ...
      public function RoomVisualization()
      {
         ...
         this.var_555 = new RoomPlaneBitmapMaskParser();
      ...
      private function resetRoomPlanes() : void
      {
         ...
         if(this.var_150 != null)
         {
            ...
            {
               _loc2_ = this.var_150[_loc1_] as RoomPlane;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      protected function defineSprites() : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc1_:int = this.var_150.length;
         createSprites(_loc1_);
         var _loc2_:int = 0;
         while(_loc2_ < _loc1_)
         {
            _loc3_ = this.var_150[_loc2_] as RoomPlane;
      ...
      protected function initializeRoomPlanes() : void
      {
         ...
         {
            this._planeParser.wallThicknessMultiplier = this.var_1549;
         }
         var _loc2_:String = _loc1_.getModel().getString(RoomObjectVariableEnum.const_1278);
         ...
         var _loc5_:* = 0;
         var _loc6_:int = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_1268);
         var _loc7_:int = 0;
         while(_loc7_ < this._planeParser.planeCount)
         {
            ...
            if(_loc12_ == RoomPlaneData.const_246)
            {
               ...
               if(_loc14_.z != 0)
               {
                  _loc13_.color = const_1790;
               }
               else
               {
                  _loc13_.color = const_1927;
               }
            ...
            else if(_loc12_ == RoomPlaneData.const_395)
            {
               ...
               if(_loc14_.y > 0)
               {
                  _loc13_.color = const_1861;
               }
               else if(_loc14_.y == 0)
               {
                  _loc13_.color = const_1683;
               }
               else
               {
                  _loc13_.color = const_1935;
               }
               if(this._data != null)
               {
            ...
            else if(_loc12_ == RoomPlaneData.const_1933)
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_77,true,_loc11_,_loc6_);
               if(_loc9_.length < 1 || _loc10_.length < 1)
               {
      ...
      private function getLandscapeWidth() : Number
      {
         ...
         while(_loc2_ < this._planeParser.planeCount)
         {
            ...
            if(_loc3_ == RoomPlaneData.const_395)
            {
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean, param4:Boolean) : void
      {
         ...
         if(_loc9_ < this.var_1911 + this.const_2300 && !_loc6_ && !_loc8_)
         {
            return;
         }
            ...
            while(_loc10_ < this.var_387.length)
            {
               ...
               if(_loc12_ != null && _loc13_ != null && _loc13_.type != RoomPlane.TYPE_LANDSCAPE)
               {
                  if(this.var_2000)
                  {
                     ...
                     _loc15_ = uint((_loc14_ & 255) * this.var_2756 / 255);
                     _loc16_ = uint((_loc14_ >> 8 & 255) * this.var_2757 / 255);
                     _loc17_ = uint((_loc14_ >> 16 & 255) * this.var_2755 / 255);
         ...
         var_159 = _loc7_.getUpdateID();
         this.var_1911 = _loc9_;
      }
      ...
      private function updateGeometry(param1:IRoomGeometry) : Boolean
      {
         ...
         if(param1.updateId != this.var_1849)
         {
            this.var_1849 = param1.updateId;
            this.var_839 = null;
            _loc3_ = param1.direction;
            if(_loc3_ != null && (_loc3_.x != this.var_1493 || _loc3_.y != this.var_2528 || _loc3_.z != this.var_2527 || param1.scale != this.var_2002))
            {
               this.var_1493 = _loc3_.x;
               this.var_2528 = _loc3_.y;
               this.var_2527 = _loc3_.z;
               this.var_2002 = param1.scale;
               _loc2_ = true;
            }
         }
         return _loc2_;
      ...
      private function updateMasksAndColors(param1:IRoomObjectModel) : Boolean
      {
         ...
         var _loc2_:Boolean = false;
         if(var_159 != param1.getUpdateID())
         {
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_1207);
            if(_loc3_ != this.var_2001)
            {
               this.updatePlaneMasks(_loc3_);
               this.var_2001 = _loc3_;
               _loc2_ = true;
            }
            _loc4_ = uint(param1.getNumber(RoomObjectVariableEnum.const_826));
            if(_loc4_ != this.var_1298)
            {
               this.var_1298 = _loc4_;
               this.var_2756 = this.var_1298 & 255;
               this.var_2757 = this.var_1298 >> 8 & 255;
               this.var_2755 = this.var_1298 >> 16 & 255;
               _loc2_ = true;
            }
      ...
      private function updatePlaneTexturesAndVisibilities(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_159 != param1.getUpdateID())
         {
            _loc2_ = param1.getString(RoomObjectVariableEnum.const_207);
            ...
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_861));
            _loc6_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_910));
            _loc7_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_943));
      ...
      private function updatePlaneThicknesses(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_159 != param1.getUpdateID())
         {
            _loc2_ = param1.getNumber(RoomObjectVariableEnum.const_1315);
            _loc3_ = param1.getNumber(RoomObjectVariableEnum.const_1359);
            if(!isNaN(_loc2_) && !isNaN(_loc3_) && (_loc2_ != this._floorThicknessMultiplier || _loc3_ != this.var_1549))
            {
      ...
      protected function updatePlaneTextureTypes(param1:String, param2:String, param3:String) : Boolean
      {
         ...
         var _loc4_:int = 0;
         while(_loc4_ < this.var_150.length)
         {
            _loc5_ = this.var_150[_loc4_] as RoomPlane;
            if(_loc5_ != null)
            {
      ...
      protected function updatePlaneMasks(param1:String) : void
      {
         ...
         this.var_555.initialize(_loc2_);
         var _loc3_:* = null;
         var _loc4_:* = [];
         var _loc5_:* = [];
         var _loc6_:Boolean = false;
         var _loc7_:int = 0;
         while(_loc7_ < this.var_150.length)
         {
            _loc3_ = this.var_150[_loc7_] as RoomPlane;
            if(_loc3_ != null)
            {
         ...
         var _loc8_:int = 0;
         while(_loc8_ < this.var_555.maskCount)
         {
            _loc10_ = this.var_555.getMaskType(_loc8_);
            _loc11_ = this.var_555.getMaskLocation(_loc8_);
            _loc12_ = this.var_555.getMaskCategory(_loc8_);
            if(_loc11_ != null)
            {
               _loc13_ = 0;
               while(_loc13_ < this.var_150.length)
               {
                  _loc3_ = this.var_150[_loc13_] as RoomPlane;
                     ...
                     if(_loc3_ != null && _loc3_.location != null && _loc3_.normal != null)
                     {
                        ...
                        if(_loc15_ < 0.01)
                        {
                           if(_loc3_.leftSide != null && _loc3_.rightSide != null)
                           {
                              ...
                              if(_loc3_.type == RoomPlane.const_77 || _loc3_.type == RoomPlane.TYPE_LANDSCAPE && _loc12_ == RoomPlaneBitmapMaskData.const_296)
                              {
         ...
         while(_loc9_ < _loc4_.length)
         {
            ...
            {
               _loc3_ = this.var_150[_loc18_] as RoomPlane;

   ...
   public class Plane
   {
      ...
      public function dispose() : void
      {
         ...
         if(this.var_353 != null)
         {
            ...
            {
               _loc1_ = this.var_353.getWithIndex(_loc2_) as PlaneVisualization;
               if(_loc1_ != null)
               {
                  _loc1_.dispose();
               }
      ...
      public function clearCache() : void
      {
         ...
         {
            _loc2_ = this.var_353.getWithIndex(_loc1_) as PlaneVisualization;
            if(_loc2_ != null)
            {
               _loc2_.clearCache();
            }
      ...
      {
         if(this.var_353.getValue(String(param1)) != null)
         {
            return null;
         }
         var _loc4_:PlaneVisualization = new PlaneVisualization(param1,param2,param3);
         this.var_353.add(String(param1),_loc4_);
      ...
      protected function getPlaneVisualization(param1:int) : PlaneVisualization
      {
         ...
         {
            this.var_1150 = this.var_353.getValue(String(this._sizes[_loc2_])) as PlaneVisualization;
         }
         else
         {
            this.var_1150 = null;

   ...
   public class PlaneMask
   {
      ...
      public function dispose() : void
      {
         ...
         if(this.var_572 != null)
         {
            _loc1_ = null;
            _loc2_ = 0;
            while(_loc2_ < this.var_572.length)
            {
               _loc1_ = this.var_572.getWithIndex(_loc2_) as PlaneMaskVisualization;
               if(_loc1_ != null)
               {
                  _loc1_.dispose();
               }
      ...
      {
         if(this.var_572.getValue(String(param1)) != null)
         {
            return null;
         }
         var _loc2_:PlaneMaskVisualization = new PlaneMaskVisualization();
         this.var_572.add(String(param1),_loc2_);
      ...
      protected function getMaskVisualization(param1:int) : PlaneMaskVisualization
      {
         ...
         {
            this.var_1364 = this.var_572.getValue(String(this._sizes[_loc2_])) as PlaneMaskVisualization;
         }
         else
         {
            this.var_1364 = null;

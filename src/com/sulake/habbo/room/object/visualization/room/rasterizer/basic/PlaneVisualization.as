   ...
   public class PlaneVisualization
   {
      ...
      public function dispose() : void
      {
         ...
         if(this.var_130 != null)
         {
            ...
            {
               _loc2_ = this.var_130[_loc1_] as IDisposable;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      public function clearCache() : void
      {
         ...
         if(this.var_130 != null)
         {
            ...
            while(_loc1_ < this.var_130.length)
            {
               _loc2_ = this.var_130[_loc1_] as PlaneVisualizationLayer;
               _loc3_ = this.var_130[_loc1_] as PlaneVisualizationAnimationLayer;
               if(_loc2_ != null)
               {
                  _loc2_.clearCache();
               }
      ...
      public function setLayer(param1:int, param2:PlaneMaterial, param3:uint, param4:int, param5:int = 0) : Boolean
      {
         ...
         var _loc6_:* = this.var_130[param1] as IDisposable;
         if(_loc6_ != null)
         {
            _loc6_.dispose();
            _loc6_ = null;
      ...
      public function setAnimationLayer(param1:int, param2:XML, param3:IGraphicAssetCollection) : Boolean
      {
         ...
         var _loc4_:* = this.var_130[param1] as IDisposable;
         if(_loc4_ != null)
         {
            _loc4_.dispose();
            _loc4_ = null;
      ...
      public function render(param1:BitmapData, param2:int, param3:int, param4:IVector3d, param5:Boolean, param6:int = 0, param7:int = 0, param8:int = 0, param9:int = 0, param10:Number = 0.0, param11:Number = 0.0, param12:int = 0) : BitmapData
      {
         ...
         {
            _loc14_ = this.var_130[_loc13_] as PlaneVisualizationLayer;
            _loc15_ = this.var_130[_loc13_] as PlaneVisualizationAnimationLayer;
            if(_loc14_ != null)
            {

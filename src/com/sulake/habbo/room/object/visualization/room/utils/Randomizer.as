package com.sulake.habbo.room.object.visualization.room.utils
{
   public class Randomizer
   {
      ...
      public static const const_2080:int = 1;
      
      public static const const_2083:int = 16777216;
      ...
      private var var_2009:int = 16777216;
      
      private var var_3015:int = 69069;
      
      private var var_3014:int = 5;
      ...
      {
         var _loc1_:int = this.var_3015 * this.var_2010 + this.var_3014;
         if(_loc1_ < 0)
         {
            _loc1_ = -_loc1_;
         }
         _loc1_ %= this.var_2009;
      ...
      private function iterateScaled(param1:int, param2:int) : int
      {
         ...
         return int(param1 + _loc3_ / this.var_2009 * param2);
      }
   }
}

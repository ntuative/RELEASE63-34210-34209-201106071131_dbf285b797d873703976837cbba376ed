package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class PlaneMaterialCell
   {
      ...
      private var var_669:PlaneTexture;
      ...
      public function getHeight(param1:IVector3d) : int
      {
         ...
         if(this.var_669 != null)
         {
            _loc2_ = this.var_669.getBitmap(param1);
            if(_loc2_ != null)
            {
         ...
         if(this.var_669 != null)
         {
            ...
            if(_loc2_ != null)
            {
               if(!this.isStatic)
               {
                  ...
                  _loc3_ = Math.min(this.var_1273,this._extraItemOffsets.length);
                  _loc4_ = Math.max(this.var_1273,this._extraItemOffsets.length);
                  _loc5_ = Randomizer.getArray(this.var_1273,_loc4_);
                  _loc6_ = 0;
                  while(_loc6_ < _loc3_)
                  {

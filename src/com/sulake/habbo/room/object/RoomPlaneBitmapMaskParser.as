   ...
   public class RoomPlaneBitmapMaskParser
   {
      ...
      public function initialize(param1:XML) : Boolean
      {
         ...
         while(_loc6_ < _loc5_.length())
         {
            ...
            this.var_187.add(_loc8_,_loc14_);
            _loc6_++;
         }
         return true;
      }
      ...
      public function reset() : void
      {
         ...
         {
            _loc2_ = this.var_187.getWithIndex(_loc1_) as RoomPlaneBitmapMaskData;
            if(_loc2_ != null)
            {
               _loc2_.dispose();
            }
      ...
      public function addMask(param1:String, param2:String, param3:IVector3d, param4:String) : void
      {
         ...
         this.var_187.remove(param1);
         this.var_187.add(param1,_loc5_);
      }
      
      public function removeMask(param1:String) : Boolean
      {
         var _loc2_:RoomPlaneBitmapMaskData = this.var_187.remove(param1) as RoomPlaneBitmapMaskData;
         if(_loc2_ != null)
         {
            _loc2_.dispose();
            return true;
      ...
      public function getMaskLocation(param1:int) : IVector3d
      {
         ...
         var _loc2_:RoomPlaneBitmapMaskData = this.var_187.getWithIndex(param1) as RoomPlaneBitmapMaskData;
         if(_loc2_ != null)
         {
            return _loc2_.loc;
         }

package com.sulake.habbo.room.object
{
   ...
   public class RoomPlaneParser
   {
      ...
      private static const const_681:Number = 0.25;
      
      private static const const_1164:Number = 0.25;
      ...
      public function initializeTileMap(param1:int, param2:int) : Boolean
      {
         ...
         while(_loc3_ < param2)
         {
            ...
            this.var_132.push(_loc4_);
            this.var_668.push(_loc5_);
            _loc3_++;
         }
         this.var_265 = param1;
         this._height = param2;
         this.var_462 = this.var_265;
         this.var_461 = -1;
      ...
      public function setTileHeight(param1:int, param2:int, param3:Number) : Boolean
      {
         ...
         var _loc8_:int = 0;
         if(param1 >= 0 && param1 < this.var_265 && param2 >= 0 && param2 < this._height)
         {
            _loc4_ = this.var_132[param2] as Array;
            ...
            {
               if(param1 == this.var_462 || param1 == this.var_461)
               {
                  _loc5_ = false;
                  _loc6_ = this.var_459;
                  while(_loc6_ < this.var_460)
                  {
               ...
               if(param2 == this.var_459 || param2 == this.var_460)
               {
                  _loc7_ = false;
                  _loc8_ = this.var_462;
      ...
      public function getTileHeight(param1:int, param2:int) : Number
      {
         ...
         var _loc3_:Array = this.var_132[param2] as Array;
      ...
      public function initializeFromTileData(param1:Boolean = false) : Boolean
      {
         ...
         {
            _loc8_ = 0;
            while(_loc8_ < this.var_265)
            {
               this.var_668[_loc2_][_loc8_] = this.var_132[_loc2_][_loc8_];
               _loc8_++;
            }
            _loc2_++;
         }
         var _loc3_:Point = findEntranceTile(this.var_132);
         var _loc4_:int = 0;
         if(_loc3_ != null)
         {
         ...
         this.var_1105 = getFloorHeight(this.var_132);
         if(!param1)
         {
      ...
      private function addWall(param1:IVector3d, param2:IVector3d, param3:IVector3d, param4:IVector3d, param5:Boolean, param6:Boolean, param7:Boolean) : void
      {
         ...
         this.addPlane(RoomPlaneData.const_395,param1,param2,param3,[param4]);
         var _loc8_:Number = const_1164 * this.var_1549;
         var _loc9_:Number = const_681 * this._floorThicknessMultiplier;
      ...
      {
         if(param1 == null || this.var_132 == null || param1 == this.var_132)
         {
            return false;
         }
         var _loc3_:int = 0;
         ...
         var _loc5_:* = null;
         var _loc6_:* = null;
         if(param1.length > this.var_132.length)
         {
            return false;
         }
         ...
         while(_loc3_ < _loc7_)
         {
            ...
            _loc6_ = this.var_132[_loc3_] as Array;
      ...
      private function addFloor(param1:IVector3d, param2:IVector3d, param3:IVector3d, param4:Boolean, param5:Boolean, param6:Boolean, param7:Boolean, param8:Number, param9:Number, param10:Number, param11:Number, param12:Boolean, param13:Boolean) : void
      {
         ...
         if(_loc14_)
         {
            _loc18_ = const_681 * this._floorThicknessMultiplier;
            _loc19_ = _loc18_;
      ...
      public function getXML() : XML
      {
         ...
         var _loc7_:int = 0;
         var _loc8_:* = null;
         var _loc1_:XML = <tileMap width="{this.var_265}" height="{this._height}" wallHeight="{this.var_1548}"/>;
         var _loc2_:int = 0;
         while(_loc2_ < this._height)
         {
            _loc5_ = <tileRow/>;
            _loc6_ = this.var_668[_loc2_];
            _loc7_ = 0;
            while(_loc7_ < this.var_265)
            {
      ...
      public function getPlaneLocation(param1:int) : IVector3d
      {
         ...
         var _loc2_:RoomPlaneData = this.var_150[param1] as RoomPlaneData;
         if(_loc2_ != null)
         {
            return _loc2_.loc;
         }
      ...
      public function getPlaneType(param1:int) : int
      {
         if(param1 < 0 || param1 >= this.planeCount)
         {
            return RoomPlaneData.const_1334;
         }
         var _loc2_:RoomPlaneData = this.var_150[param1] as RoomPlaneData;
         if(_loc2_ != null)
         {
      ...
      public function getPlaneMaskLeftSideLoc(param1:int, param2:int) : Number
      {
         ...
         var _loc3_:RoomPlaneData = this.var_150[param1] as RoomPlaneData;
         if(_loc3_ != null)
         {

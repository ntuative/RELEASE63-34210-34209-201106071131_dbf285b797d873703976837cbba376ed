package com.sulake.habbo.room.object.logic
{
   ...
   public class PetLogic extends MovingObjectLogic
   {
      ...
      {
         var _loc1_:Array = [RoomObjectMouseEvent.const_151,RoomObjectMoveEvent.const_402];
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(!this.var_2396)
         {
            ...
            if(param1 is RoomObjectAvatarChatUpdateMessage)
            {
               ...
               this.var_1454 = getTimer() + _loc5_.numberOfWords * 1000;
               return;
            }
            if(param1 is RoomObjectAvatarPetGestureUpdateMessage)
            {
               _loc6_ = param1 as RoomObjectAvatarPetGestureUpdateMessage;
               _loc2_.setString(RoomObjectVariableEnum.const_173,_loc6_.gesture);
            ...
            if(param1 is RoomObjectAvatarSleepUpdateMessage)
            {
               ...
               _loc2_.setNumber(RoomObjectVariableEnum.const_295,Number(_loc7_.isSleeping));
               return;
            }
         }
         ...
         if(param1 is RoomObjectAvatarFigureUpdateMessage)
         {
            ...
            _loc2_.setString(RoomObjectVariableEnum.const_1924,_loc10_.race);
            _loc2_.setNumber(RoomObjectVariableEnum.const_825,this.getPaletteIndex(_loc10_.figure));
            return;
         }
      }
      ...
      private function debugMouseEvent(param1:RoomSpriteMouseEvent) : void
      {
         ...
         if(!param1.altKey && !param1.ctrlKey)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_212,_loc3_ + this.var_940);
         }
         else if(param1.altKey && !param1.ctrlKey)
         {
            ++this.var_1779;
            _loc2_.setNumber(RoomObjectVariableEnum.const_244,this.var_1779);
            _loc2_.setNumber(RoomObjectVariableEnum.const_173,NaN);
         }
         else if(param1.ctrlKey && !param1.altKey)
         {
            ++this.var_1780;
            _loc2_.setNumber(RoomObjectVariableEnum.const_173,this.var_1780);
         }
         else
         {
            this.var_940 += 45;
      ...
      private function updateActions(param1:int, param2:IRoomObjectModelController) : void
      {
         ...
         {
            param2.setString(RoomObjectVariableEnum.const_173,null);
            this.var_1453 = 0;
         }
         if(this.var_1454 > 0)
         {

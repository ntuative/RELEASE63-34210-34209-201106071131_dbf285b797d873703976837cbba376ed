package com.sulake.habbo.room.object.logic.room.publicroom
{
   ...
   public class PublicRoomLogic extends RoomLogic
   {
      ...
      {
         var _loc1_:Array = [RoomObjectRoomAdEvent.const_222,RoomObjectRoomAdEvent.const_324,RoomObjectRoomAdEvent.const_362];
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         _loc2_.setString(RoomObjectVariableEnum.const_753,"");
         _loc2_.setNumber(RoomObjectVariableEnum.const_575,Number(false));
         this.var_801 = true;
      }
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(_loc3_ != null)
         {
            switch(_loc3_.type)
            {
               case RoomObjectRoomAdUpdateMessage.const_1318:
                  _loc2_.setString(RoomObjectVariableEnum.const_381,_loc3_.asset);
                  _loc2_.setString(RoomObjectVariableEnum.const_753,_loc3_.clickUrl);
                  _loc2_.setNumber(RoomObjectVariableEnum.const_575,Number(true));
                  this.var_1562 = getTimer() + _loc2_.getNumber(RoomVariableEnum.const_1177);
            }
         }
      }
      ...
      public function adDelayTimeout() : void
      {
         ...
         _loc1_.setNumber(RoomObjectVariableEnum.const_575,Number(false));
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         switch(_loc3_.type)
         {
            case MouseEvent.CLICK:
               if(_loc3_.spriteTag == RoomObjectVariableEnum.const_596)
               {
                  _loc7_ = _loc4_.getString(RoomObjectVariableEnum.const_753);

package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_1422:uint = 16777215;
      
      private var var_1697:int = 255;
      
      private var var_1143:uint = 16777215;
      
      private var var_1695:int = 255;
      
      private var var_1142:int = 0;
      
      private var var_1696:int = 1500;
      ...
      {
         var _loc1_:Array = [RoomObjectMouseEvent.const_520,RoomObjectMouseEvent.const_151];
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.setString(RoomObjectVariableEnum.const_1278,param1.toString(),true);
            _loc2_.setNumber(RoomObjectVariableEnum.const_826,16777215);
            _loc2_.setNumber(RoomObjectVariableEnum.const_861,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_910,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_943,1);
         }
      }
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(this.var_1142)
         {
            ...
            if(_loc2_ - this.var_1142 >= this.var_1696)
            {
               _loc3_ = this.var_1143;
               _loc4_ = this.var_1695;
               this.var_1142 = 0;
            }
            else
            {
               _loc7_ = this.var_1422 >> 16 & 255;
               _loc8_ = this.var_1422 >> 8 & 255;
               _loc9_ = this.var_1422 & 255;
               _loc10_ = this.var_1143 >> 16 & 255;
               _loc11_ = this.var_1143 >> 8 & 255;
               _loc12_ = this.var_1143 & 255;
               _loc13_ = (_loc2_ - this.var_1142) / this.var_1696;
               _loc7_ += (_loc10_ - _loc7_) * _loc13_;
               _loc8_ += (_loc11_ - _loc8_) * _loc13_;
               _loc9_ += (_loc12_ - _loc9_) * _loc13_;
               _loc3_ = (_loc7_ << 16) + (_loc8_ << 8) + _loc9_;
               _loc4_ = this.var_1697 + (this.var_1695 - this.var_1697) * _loc13_;
               this._color = _loc3_;
            ...
            _loc6_.setNumber(RoomObjectVariableEnum.const_826,_loc3_);
         }
      }
      ...
      private function updatePlaneTypes(param1:RoomObjectRoomUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            ...
            case RoomObjectRoomUpdateMessage.const_738:
               ...
               break;
            case RoomObjectRoomUpdateMessage.const_799:
      ...
      private function updatePlaneMasks(param1:RoomObjectRoomMaskUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomMaskUpdateMessage.const_612:
               _loc5_ = "null";
               if(param1.maskCategory == RoomObjectRoomMaskUpdateMessage.const_296)
               {
                  _loc5_ = "null";
               }
               this.var_555.addMask(param1.maskId,param1.maskType,param1.maskLocation,_loc5_);
               _loc4_ = true;
               break;
            case RoomObjectRoomMaskUpdateMessage.const_843:
               _loc4_ = this.var_555.removeMask(param1.maskId);
         }
         if(_loc4_)
         {
            _loc6_ = this.var_555.getXML();
            _loc7_ = _loc6_.toXMLString();
            param2.setString(RoomObjectVariableEnum.const_1207,_loc7_);
         }
      }
      ...
      private function updatePlaneVisibilities(param1:RoomObjectRoomPlaneVisibilityUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1251:
               param2.setNumber(RoomObjectVariableEnum.const_861,_loc3_);
               break;
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1202:
               param2.setNumber(RoomObjectVariableEnum.const_910,_loc3_);
               param2.setNumber(RoomObjectVariableEnum.const_943,_loc3_);
         }
      }
      ...
      private function updatePlaneProperties(param1:RoomObjectRoomPlanePropertyUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomPlanePropertyUpdateMessage.const_681:
               param2.setNumber(RoomObjectVariableEnum.const_1315,param1.value);
               break;
            case RoomObjectRoomPlanePropertyUpdateMessage.const_1164:
      ...
      private function updateColors(param1:RoomObjectRoomColorUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         this.var_1422 = this._color;
         this.var_1697 = this.var_1681;
         this.var_1143 = _loc3_;
         this.var_1695 = _loc4_;
         this.var_1142 = getTimer();
         this.var_1696 = 1500;
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         if(_loc5_ < 1 || _loc5_ > this._planeParser.planeCount)
         {
            ...
            {
               _loc4_.setNumber(RoomObjectVariableEnum.const_638,0);
            }
            return;
         }
         _loc5_--;
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1686,_loc19_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1761,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1923,_loc21_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_638,_loc5_ + 1);
            var _loc22_:String = "";
            var _loc23_:int = 0;
            var _loc24_:* = null;
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  if(eventDispatcher != null)
                  {
                     ...
                     else if(_loc12_ == RoomPlaneData.const_262 || _loc12_ == RoomPlaneData.const_395)
                     {
                        _loc26_ = 90;
                        if(_loc11_ != null)
                        {

package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurnitureIceStormLogic extends FurnitureMultiStateLogic
   {
      ...
      private function handleDataUpdateMessage(param1:RoomObjectDataUpdateMessage) : void
      {
         ...
         {
            this.var_1988 = _loc2_;
            this.var_2738 = param1.extra;
            this.var_1279 = lastUpdateTime + _loc3_;
         }
      }
      ...
      {
         var _loc2_:* = null;
         if(this.var_1279 > 0 && param1 >= this.var_1279)
         {
            this.var_1279 = 0;
            _loc2_ = new RoomObjectDataUpdateMessage(this.var_1988,String(this.var_1988),this.var_2738);

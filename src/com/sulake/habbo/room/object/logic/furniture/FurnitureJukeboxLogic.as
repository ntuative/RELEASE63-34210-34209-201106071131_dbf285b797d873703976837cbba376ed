package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurnitureJukeboxLogic extends FurnitureMultiStateLogic
   {
      ...
      {
         var _loc1_:Array = [RoomObjectFurnitureActionEvent.const_590,RoomObjectFurnitureActionEvent.const_578,RoomObjectFurnitureActionEvent.const_523,RoomObjectFurnitureActionEvent.const_598,RoomObjectWidgetRequestEvent.const_150];
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         {
            object.getModelController().setString(RoomWidgetInfostandExtraParamEnum.const_455,RoomWidgetInfostandExtraParamEnum.const_556);
            ...
            if(_loc4_ != this.var_2509)
            {
               this.var_2509 = _loc4_;
               if(_loc4_ == 1)
               {

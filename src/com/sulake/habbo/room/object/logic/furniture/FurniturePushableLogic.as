package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurniturePushableLogic extends FurnitureMultiStateLogic
   {
      ...
      private static const const_1067:int = 0;
      
      private static const const_2019:int = 1;
      ...
      override public function update(param1:int) : void
      {
         if(object != null)
         {
            this.var_1993.assign(object.getLocation());
            super.update(param1);
            if(Vector3d.dif(object.getLocation(),this.var_1993).length == 0)
            {
               if(object.getState(0) != const_1067)
               {
                  object.setState(const_1067,0);
               }
            }
         }
      }

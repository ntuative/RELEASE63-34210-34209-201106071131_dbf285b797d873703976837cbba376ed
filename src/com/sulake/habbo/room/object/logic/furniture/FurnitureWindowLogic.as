   ...
   public class FurnitureWindowLogic extends FurnitureMultiStateLogic
   {
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_.length() > 0)
         {
            ...
            {
               _loc4_ = _loc3_.@type;
               object.getModelController().setNumber(RoomObjectVariableEnum.const_1199,1,true);
               object.getModelController().setString(RoomObjectVariableEnum.const_1341,_loc4_,true);
            }
         }
      }
   }

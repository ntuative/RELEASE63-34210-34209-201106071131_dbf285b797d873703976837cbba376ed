package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurnitureLogic extends MovingObjectLogic
   {
      ...
      private static const const_1129:Number = 0.0625;
      ...
      private var var_666:Number = 0.0;
      
      private var var_1654:Number = 0.0;
      ...
      private var var_1370:RoomObjectUpdateMessage;
      ...
      {
         var _loc1_:Array = [RoomObjectRoomAdEvent.const_324,RoomObjectRoomAdEvent.const_362,RoomObjectRoomAdEvent.const_500,RoomObjectStateChangeEvent.const_67,RoomObjectMouseEvent.const_151,RoomObjectRoomAdEvent.const_222,RoomObjectMouseEvent.const_514];
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc3_.length() == 1)
         {
            this.var_666 = Number(_loc3_);
         }
         _loc3_ = _loc2_.@z;
         if(_loc3_.length() == 1)
         {
            this.var_1654 = Number(_loc3_);
         }
         this.var_2752 = this.var_547 / 2;
         this.var_2753 = this.var_666 / 2;
         _loc3_ = _loc2_.@centerZ;
         if(_loc3_.length() == 1)
         {
            this.var_2139 = Number(_loc3_);
         }
         else
         {
            this.var_2139 = this.var_1654 / 2;
         }
         ...
         object.getModelController().setNumber(RoomObjectVariableEnum.const_319,this.var_547,true);
         object.getModelController().setNumber(RoomObjectVariableEnum.const_384,this.var_666,true);
         object.getModelController().setNumber(RoomObjectVariableEnum.const_476,this.var_1654,true);
         object.getModelController().setNumber(RoomObjectVariableEnum.const_1777,this.var_2752,true);
         object.getModelController().setNumber(RoomObjectVariableEnum.const_1938,this.var_2753,true);
         object.getModelController().setNumber(RoomObjectVariableEnum.const_987,this.var_2139,true);
         object.getModelController().setNumberArray(RoomObjectVariableEnum.const_746,this.var_267,true);
         object.getModelController().setNumber(RoomObjectVariableEnum.const_342,1);
      }
         ...
         switch(param1.type)
         {
            ...
            case MouseEvent.MOUSE_DOWN:
               if(eventDispatcher != null)
               {
                  _loc4_ = object.getId();
                  _loc5_ = object.getType();
                  _loc6_ = new RoomObjectMouseEvent(RoomObjectMouseEvent.const_514,param1.eventId,_loc4_,_loc5_,param1.altKey,param1.ctrlKey,param1.shiftKey,param1.buttonDown);
                  eventDispatcher.dispatchEvent(_loc6_);
               }
         }
      }
      ...
      override public function useObject() : void
      {
         ...
         if(object != null)
         {
            ...
            if(_loc3_ != null)
            {
               ...
               {
                  eventDispatcher.dispatchEvent(new RoomObjectRoomAdEvent(RoomObjectRoomAdEvent.const_500,_loc1_,_loc2_));
               }
            }
            if(eventDispatcher != null)
            {
      ...
      private function handleDataUpdateMessage(param1:RoomObjectDataUpdateMessage) : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_982,lastUpdateTime);
         }
      }
      ...
      private function handleItemDataUpdateMessage(param1:RoomObjectItemDataUpdateMessage) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.setString(RoomObjectVariableEnum.const_1311,param1.itemData);
         }
      }
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(param1.dir != null && param1.loc != null)
         {
            if(!(param1 is RoomObjectMoveUpdateMessage))
            {
               ...
               if(_loc4_ != null && _loc4_.x != param1.dir.x && this.var_2140 && _loc5_ != null && _loc5_.x == param1.loc.x && _loc5_.y == param1.loc.y && _loc5_.z == param1.loc.z)
               {
                  this.var_410 = 1;
                  this.var_1370 = new RoomObjectUpdateMessage(param1.loc,param1.dir);
                  param1 = null;
               }
            }
            this.var_2140 = true;
      ...
      override protected function getLocationOffset() : IVector3d
      {
         if(this.var_410 > 0)
         {
            this.var_1100.x = 0;
            this.var_1100.y = 0;
            if(this.var_410 <= const_474 / 2)
            {
               this.var_1100.z = const_1129 * this.var_410;
            }
            else if(this.var_410 <= const_474)
            {
               if(this.var_1370)
               {
                  super.processUpdateMessage(this.var_1370);
                  this.var_1370 = null;
               }
               this.var_1100.z = const_1129 * (const_474 - this.var_410);
            }

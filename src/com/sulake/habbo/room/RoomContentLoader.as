package com.sulake.habbo.room
{
   ...
   public class RoomContentLoader implements IRoomContentLoader, IFurniDataListener, IDisposable
   {
      ...
      public static const const_996:String = "RCL_LOADER_READY";
      
      private static const const_380:String = "RCL_PUBLICROOM_";
      
      private static const const_2037:int = 0;
      ...
      private static const const_703:String = "room";
      
      private static const TILE_CURSOR:String = "tile_cursor";
      
      private static const const_1117:String = "selection_arrow";
      ...
      private var var_1648:IEventDispatcher = null;
      ...
      public function RoomContentLoader(param1:String)
      {
         ...
         this.var_2923 = ["hh_people_pool","hh_people_pool_calippo","hh_paalu","hh_people_paalu"];
         this.var_2920 = ["room_public","room_public_park","room_public_pool"];
         super();
      ...
      public function initialize(param1:IEventDispatcher, param2:IHabboConfigurationManager) : void
      {
         ...
         this.var_2919 = param2.getKey("flash.dynamic.download.url","furniture/");
         this.var_2922 = param2.getKey("flash.dynamic.download.name.template","%typeid%.swf");
      ...
      private function initPetData() : void
      {
         ...
         for each(_loc3_ in _loc1_)
         {
            ...
            this.var_1096.add(_loc2_,_loc3_);
            _loc2_++;
         }
      ...
      private function populateFurniData(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            ...
            {
               this.var_881.add(_loc4_,_loc6_);
            }
            _loc7_ = _loc2_.name;
            if(_loc2_.type == "s")
            {
               this.var_487.add(_loc3_,_loc4_);
               if(this.var_409[_loc7_] == null)
               {
                  this.var_409[_loc7_] = 1;
               }
            }
            else if(_loc2_.type == "i")
            {
               ...
               this.var_709.add(_loc3_,_loc4_);
      ...
      private function continueInitilization() : void
      {
         if(this.var_2921)
         {
            ...
            {
               this.var_1648.dispatchEvent(new Event(const_996));
            }
         }
      }
      ...
      public function setRoomObjectAlias(param1:String, param2:String) : void
      {
         if(this.var_575 != null)
         {
            this.var_575.remove(param1);
            this.var_575.add(param1,param2);
         }
         if(this.var_577 != null)
         {
            this.var_577.remove(param2);
            this.var_577.add(param2,param1);
         }
      }
      ...
      private function getRoomObjectOriginalName(param1:String) : String
      {
         ...
         if(this.var_577 != null)
         {
            _loc2_ = this.var_577.getValue(param1) as String;
         }
         if(_loc2_ == null)
         {
            _loc2_ = param1;
      ...
      public function getObjectCategory(param1:String) : int
      {
         ...
         {
            return RoomObjectCategoryEnum.const_345;
         }
         return RoomObjectCategoryEnum.const_149;
      }
      ...
      {
         return [const_473,const_702,const_701,const_703,TILE_CURSOR,const_1117];
      }
      
      public function getActiveObjectType(param1:int) : String
      {
         var _loc2_:String = this.var_487.getValue(param1) as String;
         return this.getObjectType(_loc2_);
      }
      
      public function getWallItemType(param1:int, param2:String = null) : String
      {
         var _loc3_:String = this.var_709.getValue(param1) as String;
      ...
      {
         return this.var_1096.getValue(param1) as String;
      }
      
      public function getPetColor(param1:int, param2:int) : PetColorResult
      {
         var _loc3_:Map = this.var_1095[param1];
         if(_loc3_ != null)
         {
      ...
      {
         var _loc2_:String = this.var_709.getValue(param1) as String;
         return this.getObjectColorIndex(_loc2_);
      }
      
      public function getRoomObjectAdURL(param1:String) : String
      {
         if(this.var_881.getValue(param1) != null)
         {
            return this.var_881.getValue(param1);
         }
         return "";
      }
      ...
      {
         if(this.var_224 != null && this.var_224.hasWorldType(const_380 + param1))
         {
      ...
      {
         if(param1 == RoomObjectVisualizationEnum.const_292 || param1 == RoomObjectVisualizationEnum.const_58 || param1 == RoomObjectVisualizationEnum.BOT)
         {
            return true;
         }
         return false;
      ...
      public function insertObjectContent(param1:int, param2:int, param3:IAssetLibrary) : Boolean
      {
         ...
         if(_loc5_)
         {
            ...
            if(this.initializeGraphicAssetCollection(_loc4_,param3))
            {
               ...
               {
                  case RoomObjectCategoryEnum.const_27:
                     if(this.var_409[_loc4_] == null)
                     {
                        this.var_409[_loc4_] = 1;
                     }
                     break;
                  case RoomObjectCategoryEnum.const_26:
      ...
      public function loadObjectContent(param1:String, param2:IEventDispatcher) : Boolean
      {
         ...
         if(this.var_1649.getValue(param1) != null)
         {
            this.var_224 = this.var_1649.getValue(param1) as PublicRoomData;
         }
         ...
         {
            _loc4_.addEventListener(AssetLibrary.const_923,this.onContentLoaded);
            _loc6_ = 0;
      ...
      public function loadLegacyContent(param1:String, param2:IEventDispatcher) : Array
      {
         ...
         {
            if(_loc3_[_loc5_].toString().length > 0 && this.var_2923.indexOf(_loc3_[_loc5_]) == -1)
            {
      ...
      private function onContentLoadError(param1:Event) : void
      {
         ...
         for each(_loc4_ in _loc3_)
         {
            ...
            {
               Core.crash("Failed to load asset: " + _loc2_.url,Core.const_1718);
               return;
            }
         }
      }
      ...
      private function onContentLoaded(param1:Event) : void
      {
         ...
         if(_loc4_)
         {
            if(this.var_2920.indexOf(this.getVisualizationType(_loc5_)) >= 0)
            {
      ...
      private function extractPetDataFromLoadedContent(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            this.var_1095.add(_loc6_,_loc3_);
         }
      }
      ...
      private function extractPublicRoomDataFromLoadedContent(param1:String, param2:IAssetLibrary) : void
      {
         ...
         this.var_1649.add(param1,_loc4_);
         this.var_224 = _loc4_;
      ...
      public function extractObjectContent(param1:String, param2:String) : Boolean
      {
         ...
         this.var_880.add(param2,param1);
         if(this.initializeGraphicAssetCollection(param2,_loc3_))
         {
            return true;
         }
         this.var_880.remove(param2);
         return false;
      }
      ...
      private function getAssetLibrary(param1:String) : IAssetLibrary
      {
         ...
         if(_loc3_ == null)
         {
            _loc4_ = this.var_880.getValue(_loc2_);
            if(_loc4_ != null)
            {
      ...
      private function extractPublicRoomFromXML(param1:String, param2:XML) : PublicRoomData
      {
         ...
         {
            _loc6_ = _loc3_[_loc5_];
            _loc7_ = const_380 + String(_loc6_.@name);
            _loc8_ = 32;
            _loc9_ = 1;
      ...
      {
         if(this.getObjectCategory(const_380 + param1) == RoomObjectCategoryEnum.const_86)
         {
            return true;
         }
         return false;
      ...
      public function getPublicRoomWorldHeightScale(param1:String) : Number
      {
         ...
         {
            return this.var_224.getWorldHeightScale(const_380 + param1);
         }
         return 1;
      }
      ...
      public function getPublicRoomWorldSize(param1:String) : int
      {
         if(this.var_224 != null)
         {
            return this.var_224.getWorldScale(const_380 + param1);
         }
         return 32;
      }

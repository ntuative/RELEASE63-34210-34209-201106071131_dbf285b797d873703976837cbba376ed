package com.sulake.habbo.room.utils
{
   ...
   public class LegacyWallGeometry implements IDisposable
   {
      ...
      private static const const_1130:String = "l";
      ...
      public function initialize(param1:int, param2:int, param3:int) : void
      {
         var _loc5_:* = null;
         var _loc6_:int = 0;
         if(param1 <= this.var_265 && param2 <= this._height)
         {
            this.var_265 = param1;
            this._height = param2;
      ...
      public function getLocation(param1:int, param2:int, param3:int, param4:int, param5:String) : IVector3d
      {
         ...
         if(param1 == 0 && param2 == 0)
         {
            ...
            {
               _loc7_ = this.var_265 - 1;
               while(_loc7_ >= 0)
               {
                  _loc6_ = 1;
                  while(_loc6_ < this._height)
                  {
                     if(this.getTileHeight(_loc7_,_loc6_) <= this.var_1105)
                     {
                        if(_loc6_ - 1 < param2)
                        {
                           param1 = _loc7_;
      ...
      public function getLocationOldFormat(param1:Number, param2:Number, param3:String) : IVector3d
      {
         ...
         while(_loc4_ < this.var_265)
         {
            ...
            {
               if(this.getTileHeight(_loc4_,_loc5_) <= this.var_1105)
               {
                  _loc8_ = _loc4_ - 1;
                  _loc9_ = _loc5_;
               ...
               if(this.getTileHeight(_loc4_,_loc5_ + 1) <= this.var_1105)
               {
                  _loc8_ = _loc4_;
                  _loc9_ = _loc5_;

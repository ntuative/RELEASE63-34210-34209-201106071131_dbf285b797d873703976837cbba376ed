package com.sulake.habbo.room
{
   ...
   public class RoomMessageHandler
   {
      ...
      private var var_2032:Boolean = true;
      
      private var var_1587:int = -1.0E9;
      
      private var var_1041:int = 0;
      
      private var var_1042:int = 0;
      
      private var var_853:Object;
      
      public function RoomMessageHandler(param1:IRoomCreator)
      {
         this.var_853 = new Object();
         super();
         this.var_12 = param1;
      ...
      {
         if(this.var_1041 != 0 || this.var_1042 != 0)
         {
            if(this.var_12 != null)
            {
               this.var_12.disposeRoom(this.var_1041,this.var_1042);
            }
         }
      ...
      private function onRoomReady(param1:IMessageEvent) : void
      {
         ...
         if(this.var_1041 != _loc3_.roomId || this.var_1042 != _loc3_.roomCategory)
         {
      ...
      private function onFloorHeightMap(param1:IMessageEvent) : void
      {
         ...
         if(this.var_853.objectData)
         {
            this.addActiveObject(_loc4_,_loc5_,this.var_853.objectData);
            this.var_853.objectData = null;
         }
         else
         {
            this.var_853.floorReady = true;
         }
      }
      ...
      private function onObjectInject(param1:IMessageEvent) : void
      {
         ...
         var _loc5_:int = this.getRoomCategory(_loc3_.roomCategory);
         var _loc6_:ObjectMessageData = _loc3_.data;
         if(this.var_853.floorReady)
         {
            this.addActiveObject(_loc4_,_loc5_,_loc6_);
         }
         else
         {
            this.var_853.objectData = _loc6_;
         }
      }
      ...
      private function onUserUpdate(param1:IMessageEvent) : void
      {
         ...
         var _loc7_:Number = _loc6_.getNumber(RoomVariableEnum.const_917);
         var _loc8_:int = 0;
      ...
      private function onDance(param1:IMessageEvent) : void
      {
         ...
         var _loc4_:int = this.getRoomId(_loc3_.roomId);
         var _loc5_:int = this.getRoomCategory(_loc3_.roomCategory);
         this.var_12.updateObjectUserAction(_loc4_,_loc5_,_loc3_.userId,RoomObjectVariableEnum.const_582,_loc3_.danceStyle);
      }
      ...
      private function onAvatarSleep(param1:IMessageEvent) : void
      {
         ...
         this.var_12.updateObjectUserAction(_loc4_,_loc5_,_loc3_.userId,RoomObjectVariableEnum.const_295,_loc6_);
      }
      ...
      private function onCarryObject(param1:IMessageEvent) : void
      {
         ...
         if(param1 is CarryObjectMessageEvent)
         {
            ...
            this.var_12.updateObjectUserAction(_loc3_,_loc4_,_loc2_.userId,RoomObjectVariableEnum.const_322,_loc2_.itemType,_loc2_.itemName);
         }
      }
      ...
      private function onUseObject(param1:IMessageEvent) : void
      {
         ...
         if(param1 is UseObjectMessageEvent)
         {
            ...
            _loc3_ = this.getRoomId(_loc2_.roomId);
            _loc4_ = this.getRoomCategory(_loc2_.roomCategory);
            this.var_12.updateObjectUserAction(_loc3_,_loc4_,_loc2_.userId,RoomObjectVariableEnum.const_267,_loc2_.itemType);
         }
      }
      ...
      private function onTypingStatus(param1:IMessageEvent) : void
      {
         ...
         this.var_12.updateObjectUserAction(_loc4_,_loc5_,_loc3_.userId,RoomObjectVariableEnum.const_546,_loc6_);
      }
      ...
      private function onPetExperience(param1:PetExperienceEvent) : void
      {
         ...
         var _loc3_:int = this.getRoomId(_loc2_.roomId);
         var _loc4_:int = this.getRoomCategory(_loc2_.roomCategory);
         this.var_12.updateObjectUserAction(_loc3_,_loc4_,_loc2_.petRoomIndex,RoomObjectVariableEnum.const_450,_loc2_.gainedExperience);
      }
      ...
      private function onGamePlayerNumberValue(param1:IMessageEvent) : void
      {
         ...
         if(param1 is GamePlayerValueMessageEvent)
         {
            ...
            _loc3_ = this.getRoomId(_loc2_.roomId);
            _loc4_ = this.getRoomCategory(_loc2_.roomCategory);
            this.var_12.updateObjectUserAction(_loc3_,_loc4_,_loc2_.userId,RoomObjectVariableEnum.const_431,_loc2_.value);
         }
      }
   }
}

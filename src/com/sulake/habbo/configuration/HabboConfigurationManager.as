package com.sulake.habbo.configuration
{
   ...
   public class HabboConfigurationManager extends Component implements IHabboConfigurationManager
   {
      ...
      public function HabboConfigurationManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_648 = this.getKey("url_prefix");
         if(this.var_648 != null && this.var_648.length > 0)
         {
            this.setKey("client.fatal.error.url",this.var_648 + "/flash_client_error");
         }
         this.init();
      }
      ...
      private function onConfigurationError(param1:Event = null) : void
      {
         ...
         Core.error("Could not load external variables. Failed to load URL " + this.getKey("external.variables.txt") + "HTTP status " + _loc3_ + ". Client startup failed!",true,Core.const_1245);
      }
      ...
      private function onInitConfiguration(param1:Event = null) : void
      {
         ...
         if(_loc3_ == null || _loc3_.length == 0)
         {
            ...
            Core.error("Could not load external variables, got empty data from URL " + this.getKey("external.variables.txt") + " data length = " + _loc5_ + ". Client startup failed!",false,Core.const_1245);
         }
         ...
         if(_loc4_ && _loc4_ != "")
         {
            ...
            _loc7_.addEventListener(AssetLoaderEvent.const_30,this.onInitConfigurationOverride);
            _loc7_.addEventListener(AssetLoaderEvent.const_42,this.onConfigurationOverrideError);
         }
         else if(!this.var_801)
         {
            this.var_801 = true;
            if(locked)
            {
      ...
      private function parseConfiguration(param1:String) : void
      {
         ...
         this.var_648 = this.getKey("url.prefix");
         if(this.var_648.length > 0)
         {
            externalAccessDomain = this.var_648.replace("http://","");
      ...
      {
         var _loc2_:String = this.var_982[param1] as String;
         return _loc2_ != null;
      }
      
      public function getKey(param1:String, param2:String = "", param3:Dictionary = null) : String
      {
         var _loc4_:String = this.var_982[param1] as String;
         if(_loc4_ == null)
         {
            _loc4_ = param2;
         }
         if(_loc4_ != null)
         {
            ...
            {
               _loc4_ = _loc4_.replace("%predefined%",this.var_648);
      ...
      public function setKey(param1:String, param2:String, param3:Boolean = false, param4:Boolean = false) : void
      {
         ...
         if(this.var_1882.indexOf(param1) < 0 || param3)
         {
            this.var_982[param1] = param2;
         }
         if(param3)
         {
            this.var_1882.push(param1);
         }
      }
      ...
      {
         var _loc3_:String = this.var_982[param1] as String;
         if(_loc3_ == null)
         {
            return param2;
         }

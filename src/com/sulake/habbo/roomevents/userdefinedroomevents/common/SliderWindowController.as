package com.sulake.habbo.roomevents.userdefinedroomevents.common
{
   ...
   public class SliderWindowController extends EventDispatcher
   {
      ...
      public function setValue(param1:Number, param2:Boolean = true) : void
      {
         ...
         param1 = Math.min(this.var_1242,param1);
         this.var_980 = param1;
         if(param2)
         {
      ...
      private function updateSliderPosition() : void
      {
         ...
         if(_loc1_ != null)
         {
            _loc1_.x = this.getSliderPosition(this.var_980);
         }
      ...
      {
         return int(this.var_1716 * (Number(param1 - this._minValue) / (this.var_1242 - this._minValue)));
      }
      
      private function getValueAtPosition(param1:Number) : Number
      {
         return param1 / this.var_1716 * (this.var_1242 - this._minValue) + this._minValue;
      }
      ...
      private function sliderProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_981)
         {
            if(param1.type == WindowMouseEvent.const_57 || param1.type == WindowMouseEvent.const_274)
            {
               this.var_981 = false;
            }
         }
         if(!this.var_981 || param1.type != WindowEvent.const_436)
         {
            return;
         }
         if(this.var_646 != 0)
      ...
      private function sliderButtonRightProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            if(this.var_646 != 0)
            {
               _loc3_ = this.var_980 + this.var_646;
      ...
      private function displaySlider() : void
      {
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc2_ != null && this.var_743 != null)
            {
               _loc2_.bitmap = new BitmapData(this.var_743.width,this.var_743.height,true,16777215);
               _loc2_.bitmap.copyPixels(this.var_743,this.var_743.rect,new Point(0,0),null,null,true);
               _loc2_.procedure = this.sliderProcedure;
               this.var_1716 = _loc1_.width - _loc2_.width;
            }
         }
      ...
      private function storeAssets(param1:IAssetLibrary) : void
      {
         ...
         this.var_743 = BitmapData(_loc2_.content);
      }
   }
}

package com.sulake.habbo.roomevents.userdefinedroomevents.conditions
{
   ...
   public class UserCountIn implements ConditionType
   {
      ...
      private var var_1229:SliderWindowController;
      ...
      public function readIntParamsFromForm(param1:IWindowContainer) : Array
      {
         ...
         _loc2_.push(this.var_1229.getValue());
         return _loc2_;
      }
      ...
      {
         this.var_87 = param2;
         this.var_1230 = new SliderWindowController(param2,this.getMinInput(param1),param2.assets,1,50,1);
         this.var_1230.addEventListener(Event.CHANGE,this.onMinSliderChange);
         this.var_1230.setValue(1);
         this.var_1229 = new SliderWindowController(param2,this.getMaxInput(param1),param2.assets,1,50,1);
         this.var_1229.addEventListener(Event.CHANGE,this.onMaxSliderChange);
         this.var_1229.setValue(50);
      }
      ...
      public function onEditStart(param1:IWindowContainer, param2:Triggerable) : void
      {
         ...
         this.var_1230.setValue(_loc3_);
         this.var_1229.setValue(_loc4_);
      }

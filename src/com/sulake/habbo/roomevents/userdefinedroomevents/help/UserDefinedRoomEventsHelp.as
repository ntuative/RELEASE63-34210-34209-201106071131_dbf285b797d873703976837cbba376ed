package com.sulake.habbo.roomevents.userdefinedroomevents.help
{
   ...
   public class UserDefinedRoomEventsHelp
   {
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_1954 = IWindowContainer(this.find(this._window,"help_container"));
         this.var_1264 = this.var_1954.findChildByName("button_previous") as IContainerButtonWindow;
         if(this.var_1264)
         {
            this.var_1264.procedure = this.onButtonClick;
         }
         this.var_1265 = this.var_1954.findChildByName("button_next") as IContainerButtonWindow;
         if(this.var_1265)
         {
      ...
      {
         if(this.var_276 >= this.var_69.length - 1)
         {
      ...
      {
         ++this.var_276;
         this.var_276 = Math.min(this.var_276,this.var_69.length - 1);
         this.openPage();
      }
      ...
      {
         --this.var_276;
         this.var_276 = Math.max(this.var_276,0);
         this.openPage();
      }
      ...
      private function localize() : void
      {
         ...
         if(_loc1_)
         {
            _loc1_.text = ILocalization(this.var_69[this.var_276][0]).value;
         }
         if(_loc2_)
         {
            _loc2_.text = ILocalization(this.var_69[this.var_276][2]).value;
         }
         if(_loc3_)
         {
            _loc4_ = ILocalization(this.var_69[this.var_276][1]).value;

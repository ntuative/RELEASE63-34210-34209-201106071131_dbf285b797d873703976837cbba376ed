package com.sulake.habbo.sound
{
   ...
   public class HabboSoundManagerFlash10 extends Component implements IHabboSoundManager, IUpdateReceiver
   {
      ...
      private static const const_1631:int = 60;
      
      private static const const_1630:int = 25165823;
      
      private static const const_1632:int = 16777215;
      ...
      private var var_2860:Boolean = false;
      ...
      public function HabboSoundManagerFlash10(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null, param4:Boolean = true)
      {
         ...
         events.addEventListener(TraxSongLoadEvent.const_834,this.onTraxLoadComplete);
      ...
      public function playSound(param1:String) : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc2_:HabboSound = this.var_1073.getValue(param1);
         if(_loc2_ == null)
         {
            _loc3_ = "";
            switch(param1)
            {
               case HabboSoundTypesEnum.const_1236:
                  ...
                  break;
               case HabboSoundTypesEnum.const_1711:
            ...
            this.var_1073.add(param1,_loc2_);
         }
      ...
      private function loadSample(param1:int) : void
      {
         ...
         _loc4_.load(_loc3_);
         this.var_699.add(_loc4_,param1);
      }
      ...
      private function addTraxSongForDownload(param1:int, param2:String) : IHabboSound
      {
         ...
         if(!_loc3_.ready)
         {
            this.var_1345.add(param1,_loc3_);
         }
         return _loc3_;
      }
      ...
      public function notifyPlayedSong(param1:String, param2:String) : void
      {
         ...
         this.var_1074.addSongPlayingNotification(param1,param2);
      }
      ...
      private function onNotificationsReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1074 = IHabboNotifications(param2);
      }
      ...
      {
         if(this._configuration == null || this._connection == null || this._roomEngine == null || this.var_231 != null)
         {
            return;
         }
      ...
      {
         events.dispatchEvent(new TraxSongLoadEvent(TraxSongLoadEvent.const_1736,this.var_867));
         this.var_867 = -1;
         this.var_866 = null;
      }
      ...
      private function updateVolumeSetting(param1:Number) : void
      {
         ...
         this.var_231.updateVolume(this.var_1002);
      }
      ...
      private function processLoadedSample(param1:Sound) : void
      {
         ...
         var _loc4_:* = null;
         if(this.var_699.getValue(param1) != null)
         {
            _loc2_ = this.var_699.remove(param1);
            if(this.var_291.getValue(_loc2_) == null)
            {
               this.var_1607.clear();
               _loc3_ = param1.length;
               param1.extract(this.var_1607,int(_loc3_ * 44.1));
               _loc4_ = new TraxSample(this.var_1607,_loc2_,TraxSample.const_1947,TraxSample.const_1762);
      ...
      private function processLoadedSamples() : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:int = 0;
         if(this.var_1344.length > 0)
         {
            _loc1_ = getTimer();
            _loc2_ = _loc1_;
            while(_loc2_ - _loc1_ < const_1631 && this.var_1344.length > 0)
            {
               _loc3_ = this.var_1344.splice(0,1)[0];
               this.processLoadedSample(_loc3_);
               _loc2_ = getTimer();
            }
            if(this.var_699.length == 0 && this.var_867 != -1)
            {
               this.var_866.ready = true;
               _loc4_ = this.var_867;
               this.var_867 = -1;
               this.var_866 = null;
               events.dispatchEvent(new TraxSongLoadEvent(TraxSongLoadEvent.const_834,_loc4_));
               if(this.var_2860)
               {
      ...
      private function loadNextSong() : void
      {
         var _loc1_:int = 0;
         var _loc2_:* = null;
         if(this.var_866 == null && this.var_1345.length > 0)
         {
            _loc1_ = this.var_1345.getKey(0);
            _loc2_ = this.var_1345.remove(_loc1_);
            if(_loc2_ != null && !_loc2_.disposed)
            {
               this.validateSampleAvailability(_loc2_,true);
               if(_loc2_.ready)
               {
                  events.dispatchEvent(new TraxSongLoadEvent(TraxSongLoadEvent.const_834,_loc1_));
               }
               else
               {
                  this.var_866 = _loc2_;
      ...
      private function processSampleMemoryUsage() : void
      {
         ...
         var _loc1_:* = 0;
         var _loc2_:* = [];
         var _loc3_:Array = this.var_231.samplesIdsInUse;
         var _loc4_:int = 0;
         ...
         if(_loc1_ > const_1630)
         {
            ...
            _loc8_ = 0;
            _loc9_ = 0;
            while(_loc8_ < _loc1_ - const_1632 && _loc9_ < _loc2_.length)
            {
            ...
            if(_loc7_.length > 0)
            {
               ...
               this.var_231.samplesUnloaded(_loc7_);
            }
         }
      }

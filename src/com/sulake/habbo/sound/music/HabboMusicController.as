package com.sulake.habbo.sound.music
{
   ...
   public class HabboMusicController implements IHabboMusicController, IDisposable
   {
      ...
      private static const const_1488:int = HabboMusicPrioritiesEnum.const_136;
      ...
      private var var_526:IPlayListController = null;
      ...
      public function HabboMusicController(param1:HabboSoundManagerFlash10, param2:IEventDispatcher, param3:IEventDispatcher, param4:IConnection)
      {
         ...
         this.var_752.push(new TraxSongInfoMessageEvent(this.onSongInfoMessage));
         this.var_752.push(new UserSongDisksInventoryMessageEvent(this.onSongDiskInventoryMessage));
         for each(_loc5_ in this.var_752)
         {
            this._connection.addMessageEvent(_loc5_);
         }
         this.var_87.addEventListener(RoomEngineSoundMachineEvent.const_790,this.onJukeboxInit);
         this.var_87.addEventListener(RoomEngineSoundMachineEvent.const_279,this.onJukeboxDispose);
         this.var_87.addEventListener(RoomEngineSoundMachineEvent.const_979,this.onSoundMachineInit);
         this.var_87.addEventListener(RoomEngineSoundMachineEvent.const_846,this.onSoundMachineDispose);
         ...
         _loc6_ = 0;
         while(_loc6_ < HabboMusicPrioritiesEnum.const_301)
         {
            this.var_316[_loc6_] = null;
      ...
      protected function onSongFinishedPlayingEvent(param1:SoundCompleteEvent) : void
      {
         ...
         {
            if(this.getTopRequestPriority() == this._priorityPlaying && this.getSongRequestCountAtPriority(this._priorityPlaying) == this.var_1851)
            {
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            if(this.var_268)
            {
               ...
               {
                  _loc3_ = this.var_268.getWithIndex(_loc2_) as SongDataEntry;
            ...
            if(this.var_87)
            {
               this.var_87.removeEventListener(RoomEngineSoundMachineEvent.const_790,this.onJukeboxInit);
               this.var_87.removeEventListener(RoomEngineSoundMachineEvent.const_279,this.onJukeboxDispose);
               this.var_87.removeEventListener(RoomEngineSoundMachineEvent.const_979,this.onSoundMachineInit);
               this.var_87.removeEventListener(RoomEngineSoundMachineEvent.const_846,this.onSoundMachineDispose);
            }
      ...
      private function getSongIdRequestedAtPriority(param1:int) : int
      {
         ...
         if(this.var_316[param1] == null)
         {
            return -1;
         }
         var _loc2_:SongStartRequestData = this.var_316[param1];
      ...
      {
         var _loc1_:int = this.var_316.length - 1;
         while(_loc1_ >= 0)
         {
            if(this.var_316[_loc1_] != null)
            {
               return _loc1_;
            }
            _loc1_--;
      ...
      private function getSongDataEntry(param1:int) : SongDataEntry
      {
         ...
         {
            _loc2_ = this.var_268.getValue(param1) as SongDataEntry;
         }
         return _loc2_;
      }
      ...
      public function updateVolume(param1:Number) : void
      {
         ...
         var _loc4_:* = null;
         var _loc2_:int = 0;
         while(_loc2_ < HabboMusicPrioritiesEnum.const_301)
         {
      ...
      {
         if(this.var_638.getValue(param1) == null)
         {
            this.var_638.add(param1,param2);
            this.var_793.push(param1);
         }
      }
      ...
      public function getSongDiskInventoryDiskId(param1:int) : int
      {
         ...
         {
            return this.var_368.getKey(param1);
         }
         return -1;
      }
      ...
      public function getSongDiskInventorySongId(param1:int) : int
      {
         if(param1 >= 0 && param1 < this.var_368.length)
         {
            return this.var_368.getWithIndex(param1);
         }
         return -1;
      }
      ...
      public function samplesUnloaded(param1:Array) : void
      {
         ...
         while(_loc2_ < this.var_268.length)
         {
            ...
            if(_loc3_.id != this.var_1494 && _loc4_ != null && _loc4_.ready)
            {
      ...
      public function get samplesIdsInUse() : Array
      {
         ...
         {
            if(this.var_316[_loc2_] != null)
            {
               _loc3_ = this.var_316[_loc2_];
               _loc4_ = this.var_268.getValue(_loc3_.songId);
               if(_loc4_ != null)
               {
      ...
      private function sendNextSongRequestMessage(param1:TimerEvent) : void
      {
         ...
         this._connection.send(new GetSongInfoMessageComposer(this.var_793));
         Logger.log("Requested song info\'s : " + this.var_793);
         this.var_793 = new Array();
      }
      ...
      private function onSongInfoMessage(param1:IMessageEvent) : void
      {
         ...
         while(_loc5_ < _loc4_.length)
         {
            ...
            if(_loc7_)
            {
               ...
               this.var_268.add(_loc6_.id,_loc10_);
      ...
      {
         if(param2 == -1 || param1 < 0 || param1 >= HabboMusicPrioritiesEnum.const_301)
         {
            return false;
         }
         ...
         this.var_1851 = this.getSongRequestCountAtPriority(param1);
         this.var_1494 = param2;
         if(this._priorityPlaying <= const_1488)
         {
      ...
      private function notifySongPlaying(param1:SongDataEntry) : void
      {
         ...
         if(param1.length >= 8000 && (this.var_2535 != param1.id || _loc3_ > this.var_2534 + 8000))
         {
            this._soundManager.notifyPlayedSong(param1.name,param1.creator);
            this.var_2535 = param1.id;
      ...
      private function onSoundMachineInit(param1:Event) : void
      {
         ...
         this.var_526 = new SoundMachinePlayListController(this._soundManager,this,this._events,this.var_87,this._connection) as IPlayListController;
      }
      ...
      {
         this.disposeRoomPlaylist();
         this.var_526 = new JukeboxPlayListController(this._soundManager,this,this._events,this._connection) as IPlayListController;

package com.sulake.habbo.sound.music
{
   ...
   public class SoundMachinePlayListController implements IPlayListController
   {
      ...
      private var var_231:HabboMusicController;
      ...
      public function SoundMachinePlayListController(param1:HabboSoundManagerFlash10, param2:HabboMusicController, param3:IEventDispatcher, param4:IEventDispatcher, param5:IConnection)
      {
         ...
         this.var_231 = param2;
         this.var_752 = [];
         this.var_752.push(new PlayListMessageEvent(this.onPlayListMessage));
         this.var_752.push(new PlayListSongAddedMessageEvent(this.onPlayListSongAddedMessage));
         for each(_loc6_ in this.var_752)
         {
         ...
         this.var_87.addEventListener(RoomEngineSoundMachineEvent.const_802,this.onSoundMachinePlayEvent);
         this.var_87.addEventListener(RoomEngineSoundMachineEvent.const_798,this.onSoundMachineStopEvent);
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            if(this.var_87)
            {
               this.var_87.removeEventListener(RoomEngineSoundMachineEvent.const_802,this.onSoundMachinePlayEvent);
               this.var_87.removeEventListener(RoomEngineSoundMachineEvent.const_798,this.onSoundMachineStopEvent);
               this.var_87 = null;
            }
            this._disposed = true;
         }
      ...
      {
         var _loc2_:* = null;
         if(this.var_455 == param1)
         {
            this.playCurrentSongAndNotify(this.var_455);
            _loc2_ = this.getNextEntry();
            if(_loc2_ != null)
            {
               this.var_231.addSongInfoRequest(_loc2_.id);
            }
         }
      }
      ...
      public function stopPlaying() : void
      {
         this.var_455 = -1;
         this.var_662 = false;
         this.var_231.stop(HabboMusicPrioritiesEnum.const_136);
      }
      ...
      private function onSongInfoReceivedEvent(param1:SongInfoReceivedEvent) : void
      {
         ...
         while(_loc3_ < this._playListEntries.length)
         {
            ...
            {
               _loc4_ = this.var_231.getSongInfo(param1.id) as SongDataEntry;
               if(_loc4_ != null)
               {
      ...
      private function playCurrentSongAndNotify(param1:int) : void
      {
         ...
         if(this.var_231.playSong(param1,HabboMusicPrioritiesEnum.const_136,_loc3_,0,0,0))
         {

package com.sulake.habbo.sound.trax
{
   ...
   public class TraxSample implements IDisposable
   {
      ...
      public static const const_1947:String = "sample_44khz";
      
      public static const const_1802:String = "sample_22khz";
      
      public static const const_1854:String = "sample_11khz";
      
      public static const const_1762:String = "sample_16bit";
      
      public static const const_1798:String = "sample_8bit";
      
      public static const SAMPLE_VALUE_MULTIPLIER:Number = 0.000030517578125;
      
      private static const const_1034:int = 32;
      ...
      public function TraxSample(param1:ByteArray, param2:int, param3:String = "sample_44khz", param4:String = "sample_16bit")
      {
         ...
         var _loc6_:int = this.var_168 * this.var_81;
         ...
         while(_loc11_ < _loc10_)
         {
            ...
            if(_loc11_ >= _loc10_ - 1 - const_1034)
            {
               _loc12_ *= (_loc10_ - _loc11_ - 1) / Number(const_1034);
            }
            ...
            _loc9_ *= _loc5_;
            _loc9_ += _loc14_;
            if(_loc11_ % this.var_168 == this.var_168 - 1)
            {
               this.var_125[int(_loc11_ / this.var_168)] = _loc9_;
               _loc9_ = 0;
            }
            _loc11_++;
         }
      ...
      {
         return this.var_125.length * this.var_168 * this.var_81;
      }
      
      public function get usageCount() : int
      {
         return this.var_619.length;
      }
      ...
      public function setSample(param1:Vector.<int>, param2:int, param3:int, param4:int) : int
      {
         ...
         var _loc5_:int = this.var_168 * this.var_81;
         param4 /= _loc5_;
         if(param2 < 0)
         {
            param3 += param2;
      ...
      public function setUsageFromSong(param1:int, param2:uint) : void
      {
         ...
         if(this.var_619.indexOf(param1) == -1)
         {
      ...
      public function isUsedFromSong(param1:int) : Boolean
      {
         ...
         return this.var_619.indexOf(param1) != -1;
      }
   }
}

package com.sulake.habbo.session
{
   ...
   public class BadgeImageManager
   {
      ...
      public static const const_1874:String = "normal_badge";
       
      
      private const const_2016:String = "badge_";
      ...
      private function getBadgeImageInternal(param1:String, param2:String = "normal_badge") : BitmapData
      {
         ...
         var _loc6_:* = null;
         var _loc7_:* = null;
         var _loc3_:String = this.const_2016 + param1;
         ...
         if(_loc4_ != null)
         {
            ...
            _loc7_.addEventListener(AssetLoaderEvent.const_30,this.onBadgeImageReady);
         }
         return null;
      }
      ...
      private function onBadgeImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc2_ != null)
         {
            if(_loc2_.assetLoader != null && _loc2_.assetLoader.content != null)
            {
               ...
               _loc4_ = _loc2_.assetName.replace(this.const_2016,"");

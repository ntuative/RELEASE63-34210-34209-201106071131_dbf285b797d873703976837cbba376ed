package com.sulake.habbo.session
{
   ...
   public class UserDataManager implements IUserDataManager
   {
      ...
      {
         var _loc3_:* = null;
         var _loc4_:Map = this.var_772.getValue(param2);
         if(_loc4_ != null)
         {
      ...
      public function getUserBadges(param1:int) : Array
      {
         ...
         var _loc2_:* = this.var_955.getValue(param1) as Array;
         if(_loc2_ == null)
         {
            _loc2_ = [];
         }
      ...
      public function setUserData(param1:IUserData) : void
      {
         ...
         var _loc2_:Map = this.var_772.getValue(param1.type);
         if(_loc2_ == null)
         {
            _loc2_ = new Map();
            this.var_772.add(param1.type,_loc2_);
         }
      ...
      public function removeUserDataByIndex(param1:int) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc3_ = this.var_772.getValue(_loc2_.type);
            if(_loc3_ != null)
            {
      ...
      {
         this.var_955.remove(param1);
         this.var_955.add(param1,param2);
      }
      ...
      {
         return this.getUserDataByType(param1,const_1466);
      }

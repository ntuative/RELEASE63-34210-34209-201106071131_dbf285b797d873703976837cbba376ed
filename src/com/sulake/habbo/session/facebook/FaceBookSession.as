package com.sulake.habbo.session.facebook
{
   ...
   public class FaceBookSession implements IDisposable
   {
      ...
      private static const const_1104:String = "FlashExternalInterface.authenticateFacebook";
      
      private static const const_1645:String = "sendAccessTokenToServer";
      
      private static const const_1644:String = "fbKLogOut";
      ...
      private function onAuthenticate(param1:FaceBookAuthenticateEvent) : void
      {
         ...
         if(false)
         {
            ExternalInterface.addCallback(const_1645,this.jsFaceBookLogInCallback);
            ExternalInterface.addCallback(const_1644,this.jsFaceBookLogOutCallback);
            Logger.log("-- -- ADDED JAVASCRIPT CALLBACK HOOKS!");
            ExternalInterface.call(const_1104);
            Logger.log("-- -- CALLED JAVASCRIPT METHOD " + const_1104);
         }
      }

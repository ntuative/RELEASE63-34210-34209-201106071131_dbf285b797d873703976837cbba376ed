package com.sulake.habbo.session
{
   ...
   public class RoomSession implements IRoomSession
   {
      ...
      private const const_2298:int = 2500;
      ...
      private var var_1278:UserDataManager;
      ...
      public function RoomSession(param1:int, param2:int, param3:IHabboTracking, param4:String = "", param5:String = "")
      {
         ...
         this.var_1278 = new UserDataManager();
      }
      ...
      public function set connection(param1:IConnection) : void
      {
         ...
         {
            this.var_1278.connection = param1;
         }
      }
      ...
      {
         this._connection.send(new ChatMessageComposer(param1,this.var_1558));
         this.var_1557.add(this.var_1558,getTimer());
         ++this.var_1558;
      }
      ...
      {
         var _loc3_:int = 0;
         var _loc2_:Object = this.var_1557.remove(param1);
         if(_loc2_ != null)
         {
            _loc3_ = getTimer();
            if(_loc3_ - int(_loc2_) > this.const_2298)
            {
      ...
      {
         return this.var_1278 as IUserDataManager;
      }

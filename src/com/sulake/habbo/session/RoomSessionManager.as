package com.sulake.habbo.session
{
   ...
   public class RoomSessionManager extends Component implements IRoomSessionManager, IRoomHandlerListener
   {
      ...
      private function initializeManager() : void
      {
         ...
         if(this.initialized && this.var_2057)
         {
            this.gotoRoom(this.var_2831,this.var_2830,this.var_2058);
            this.var_2057 = false;
            this.var_2058 = "";
         }
      }
         ...
         if(param1 != null && this.var_84 != null)
         {
            ...
            while(_loc2_ < this.var_84.length)
            {
               ...
               if(_loc3_ != null)
               {
                  ...
                  _loc3_.var_28 = param1.roomCategory;
               }
               _loc2_++;
            }
         }

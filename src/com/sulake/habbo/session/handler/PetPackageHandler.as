package com.sulake.habbo.session.handler
{
   ...
   public class PetPackageHandler extends BaseHandler
   {
      ...
      private function onOpenPetPackageRequested(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:IRoomSession = listener.getSession(_xxxRoomId,var_28);
         if(_loc3_ == null)
         {
            return;
         }
         if(listener && false)
         {
            listener.events.dispatchEvent(new RoomSessionPetPackageEvent(RoomSessionPetPackageEvent.const_495,_loc3_,_loc2_.objectId,_loc2_.petType,_loc2_.breed,_loc2_.color,0,null));
         }
      }
      ...
      private function onOpenPetPackageResult(param1:IMessageEvent) : void
      {
         ...
         if(listener && false)
         {
            listener.events.dispatchEvent(new RoomSessionPetPackageEvent(RoomSessionPetPackageEvent.const_580,_loc3_,_loc2_.objectId,-1,-1,"",_loc2_.nameValidationStatus,_loc2_.nameValidationInfo));
         }
      }
   }
}

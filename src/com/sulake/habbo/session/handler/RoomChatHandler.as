   ...
   public class RoomChatHandler extends BaseHandler
   {
      ...
      private function onRoomChat(param1:IMessageEvent) : void
      {
         ...
         if(listener && false)
         {
            ...
            {
               _loc3_ = listener.getSession(_xxxRoomId,var_28);
               if(_loc3_ == null)
               {
                  return;
               }
      ...
      private function onFloodControl(param1:IMessageEvent) : void
      {
         ...
         if(listener && false)
         {
            ...
            listener.events.dispatchEvent(new RoomSessionChatEvent(RoomSessionChatEvent.const_492,_loc3_,-1,"" + _loc4_,0,null));
         }
      }
   }
}

package com.sulake.habbo.session.handler
{
   ...
   public class TeleportErrorHandler extends BaseHandler
   {
      ...
      private function onDoorOtherEndDeletedMessage(param1:IMessageEvent) : void
      {
         ...
         if(listener && false)
         {
            listener.events.dispatchEvent(new RoomSessionErrorMessageEvent(RoomSessionErrorMessageEvent.const_1153,_loc3_));
         }
      }
      ...
      private function onDoorNotInstalledMessage(param1:IMessageEvent) : void
      {
         ...
         if(listener && false)
         {
            listener.events.dispatchEvent(new RoomSessionErrorMessageEvent(RoomSessionErrorMessageEvent.const_1229,_loc3_));
         }
      }
   }
}

package com.sulake.habbo.session.handler
{
   ...
   public class ViralFurniHandler extends BaseHandler
   {
      ...
      private function onViralFurniStatus(param1:IMessageEvent) : void
      {
         ...
         var _loc6_:IRoomSession = listener.getSession(_xxxRoomId,var_28);
         if(_loc6_ == null)
         {
            return;
         }
      ...
      private function onViralGiftReceived(param1:IMessageEvent) : void
      {
         ...
         var _loc4_:IRoomSession = listener.getSession(_xxxRoomId,var_28);
         if(_loc4_ == null)
         {
            return;
         }
         var _loc5_:RoomSessionViralFurniStatusEvent = new RoomSessionViralFurniStatusEvent(RoomSessionViralFurniStatusEvent.const_597,_loc4_);

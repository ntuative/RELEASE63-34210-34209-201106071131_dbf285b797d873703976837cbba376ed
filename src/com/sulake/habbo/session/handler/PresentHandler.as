package com.sulake.habbo.session.handler
{
   ...
   public class PresentHandler extends BaseHandler
   {
      ...
      private function onPresentOpened(param1:IMessageEvent) : void
      {
         ...
         var _loc5_:IRoomSession = listener.getSession(_xxxRoomId,var_28);
         if(_loc5_ == null)
         {
            return;
         }
         if(listener && false)
         {
            listener.events.dispatchEvent(new RoomSessionPresentEvent(RoomSessionPresentEvent.const_326,_loc5_,_loc2_.classId,_loc2_.itemType,_loc2_.productCode));
         }
      }
   }
}

package com.sulake.habbo.advertisement
{
   ...
   public class AdManager extends Component implements IAdManager
   {
      ...
      private var var_1168:BitmapData = null;
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_2385 = this._config.getKey("interstitial.enabled","false") == "true";
         this.var_2387 = int(this._config.getKey("interstitial.interval","30000"));
         this.var_2384 = int(this._config.getKey("interstitial.show.time","5000"));
         this.var_1772 = int(this._config.getKey("interstitial.max.displays.flash","-1"));
      ...
      public function showInterstitial() : Boolean
      {
         ...
         if(this.var_234 != null && this.var_234.running)
         {
            this.var_234.reset();
            return false;
         }
         ...
         if(this.var_1772 > 0 && this.var_1770 >= this.var_1772)
         {
            return false;
         }
         var _loc1_:int = getTimer() - this.var_1170;
      ...
      private function onInterstitial(param1:InterstitialMessageEvent) : void
      {
         ...
         this.var_1450 = _loc2_.imageUrl;
         this.var_2386 = _loc2_.clickUrl;
         this.var_1170 = getTimer();
         if(this.var_1450 != "")
         {
            _loc3_ = this.var_1450;
            ...
            {
               this.var_234 = new Timer(this.var_2384,1);
               this.var_234.addEventListener(TimerEvent.TIMER_COMPLETE,this.interstitialTimerComplete);
            }
            if(this.var_234.running)
            {
               this.var_234.reset();
            }
            this.var_234.start();
            _loc4_ = new URLRequest(this.var_1450);
      ...
      private function startInterstitial(param1:Bitmap) : void
      {
         ...
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_534,0,0,param1.bitmapData,this.var_2386));
            this.var_1170 = getTimer();
         }
         else
         {
      ...
      private function stopInterstitial() : void
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_504));
         }
      }
      ...
      private function onRoomAd(param1:RoomAdMessageEvent) : void
      {
         ...
         this.var_1771 = _loc2_.clickUrl;
         if(this.var_1449 != "" && this.var_1771 != "")
         {
      ...
      private function roomAdImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(this.isValidAdImage(_loc3_))
         {
            ...
            events.dispatchEvent(new AdEvent(AdEvent.const_501,0,0,_loc4_,_loc2_.assetName,this.var_1771,this.var_1169,this.var_1168));
         }
      }
      ...
      private function adWarningRightReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            this.var_1168 = this.emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
      ...
      private function loadImageAsset(param1:AdImageEvent) : void
      {
         ...
         var _loc3_:Array = this.var_617.getValue(_loc2_);
         if(_loc3_ == null)
         {
            _loc3_ = new Array();
            this.var_617.add(_loc2_,_loc3_);
         }
         if(_loc3_.length > 0)
         {
      ...
      private function onBillboardImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         var _loc2_:AssetLoaderStruct = param1.target as AssetLoaderStruct;
         var _loc3_:Bitmap = _loc2_.assetLoader.content as Bitmap;
         var _loc4_:Array = this.var_617.remove(_loc2_.assetName);
      ...
      private function dispatchImageAsset(param1:BitmapData, param2:AdImageEvent) : void
      {
         if(events != null)
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_897,param2.roomId,0,param1.clone(),param2.imageUrl,param2.clickUrl,null,null,param2.objectId));
         }
      }
      ...
      private function onBillboardImageLoadError(param1:AssetLoaderEvent) : void
      {
         var _loc4_:* = null;
         var _loc2_:AssetLoaderStruct = param1.target as AssetLoaderStruct;
         var _loc3_:Array = this.var_617.remove(_loc2_.assetName);
         ...
         for each(_loc4_ in _loc3_)
         {
            ...
            events.dispatchEvent(new AdEvent(AdEvent.const_920,_loc4_.roomId,0,null,_loc4_.imageUrl,_loc4_.clickUrl,null,null,_loc4_.objectId));
         }
      }
   }
}

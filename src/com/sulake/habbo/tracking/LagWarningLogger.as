package com.sulake.habbo.tracking
{
   ...
   public class LagWarningLogger
   {
      ...
      public function configure(param1:IHabboConfigurationManager) : void
      {
         ...
         this.var_1794 = int(param1.getKey("lagWarningLog.interval.seconds","10")) * 1000;
      }
      
      public function chatLagDetected(param1:int) : void
      {
         if(!this.var_1921 || this.var_1794 <= 0)
         {
            return;
         }
         ++this.var_1182;
      ...
      private function reportWarningsAsNeeded(param1:int) : void
      {
         ...
         if(this._lastWarning == 0 || param1 - this._lastWarning > this.var_1794)
         {

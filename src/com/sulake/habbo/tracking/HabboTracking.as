package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, IUpdateReceiver
   {
      ...
      private var var_457:FramerateTracker = null;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1806,new Date().getTime().toString());
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1808,!true ? ExternalInterface.call("window.navigator.userAgent.toString") : "unknown");
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1776,Capabilities.serverString);
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_948,String(false));
         ...
         if(!disposed)
         {
            ...
            if(this.var_219)
            {
               if(!this.var_219.disposed)
               {
                  ...
                  Component(this.var_219).events.removeEventListener(HabboFriendListTrackingEvent.const_547,this.onFriendlistTrackingEvent);
               }
            ...
            {
               this.var_324.stop();
               this.var_324.removeEventListener(TimerEvent.TIMER,this.onRoomActionTimerEvent);
               this.var_324 = null;
            }
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(this._configuration)
         {
            if(this.var_275 != null)
            {
               this.var_275.configuration = this._configuration;
            }
            if(this.var_274 != null)
            {
            ...
            if(this._configuration)
            {
               ...
               {
                  this.var_664.configure(this._configuration);
               }
               if(this.var_457 != null)
               {
                  this.var_457.configure(this._configuration);
               }
               if(this.var_456 != null)
               {
                  this.var_456.configure(this._configuration);
               }
            }
         }
      }
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_830,this.onConnectionEvent);
         Component(context).events.addEventListener(HabboCommunicationEvent.const_298,this.onConnectionEvent);
         ...
         Component(context).events.addEventListener(HabboHotelViewEvent.const_892,this.onHotelViewEvent);
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case HabboCommunicationEvent.INIT:
               this.trackLoginStep(HabboLoginTrackingStep.const_1960);
               break;
            case HabboCommunicationEvent.const_830:
               this.trackLoginStep(HabboLoginTrackingStep.const_1851,String(this._communication.port));
               break;
            case HabboCommunicationEvent.const_298:
               this.trackLoginStep(HabboLoginTrackingStep.const_298);
               break;
      ...
      {
         this.trackLoginStep(HabboLoginTrackingStep.const_1250);
         if(context && false)
         {
            context.root.events.removeEventListener(HabboLoginTrackingStep.const_1250,this.onCoreRunning);
         }
      }
      ...
      private function onFriendlistReady(param1:IID, param2:IUnknown) : void
      {
         ...
         Component(this.var_219).events.addEventListener(HabboFriendListTrackingEvent.const_547,this.onFriendlistTrackingEvent);
      }
      ...
      private function onFriendlistTrackingEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            ...
            case HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST:
               ...
               break;
            case HabboFriendListTrackingEvent.const_547:
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         if(!this.var_2685)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1970);
            this.var_2685 = true;
         }
         ...
         if(_loc2_.privateRoom)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_948,String(true));
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_326.events.addEventListener(AdEvent.const_501,this.onRoomAdLoad);
      }
      ...
      private function onRoomAction(param1:RoomEngineEvent) : void
      {
         if(param1.type == RoomEngineEvent.const_177)
         {
            if(this.var_1944 < 1)
            {
               if(!this.var_324)
               {
                  this.var_324 = new Timer(60000,1);
                  this.var_324.addEventListener(TimerEvent.TIMER,this.onRoomActionTimerEvent);
                  this.var_324.start();
               }
            }
         }
         ...
         if(!disposed)
         {
            if(this._connection)
            {
               if(this.var_457)
               {
                  ...
                  this.trackEventLog("Performance","fps",String(this.var_457.frameRate),_loc2_);
                  ++this.var_1944;
               }
            }
         }
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            ++this.var_1946;
            ErrorReportStorage.addDebugData("Invalid time counter","Invalid times: " + this.var_1946);
         }
         ...
         if(this.var_274 != null)
         {
            this.var_274.update(param1,this.var_545);
         }
         if(this.var_275 != null)
         {
            this.var_275.update(param1,this.var_545);
         }
         if(this.var_457 != null)
         {
            this.var_457.trackUpdate(param1,this,this.var_545);
         }
         if(this.var_664 != null)
         {
            this.var_664.update(this.var_545);
         }
      }
   }
}

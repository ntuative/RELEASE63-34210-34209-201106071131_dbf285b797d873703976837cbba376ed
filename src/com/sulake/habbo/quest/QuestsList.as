package com.sulake.habbo.quest
{
   ...
   public class QuestsList implements IDisposable
   {
      ...
      private static const const_1459:int = 30;
      ...
      public function onToolbarClick() : void
      {
         ...
         {
            this.var_771 = new WindowToggle(this._window,this._window.desktop,this.requestQuests,this.close);
         }
         this.var_771.toggle();
         this.var_1801 = false;
      }
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_587 = IScrollbarWindow(this._window.findChildByName("scroller"));
         this._window.center();
         this.var_66.spacing = const_1460;
      }
      ...
      public function createListEntry() : IWindowContainer
      {
         ...
         _loc6_.x = _loc3_.width - _loc6_.width - const_1461;
         ...
         _loc3_.x = _loc2_.x + _loc2_.width + const_1462;
      ...
      public function setEntryHeight(param1:IWindowContainer) : void
      {
         ...
         _loc2_.findChildByName("completion_txt").y = _loc2_.height - const_1459;
      ...
      private function onWindowClose(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            if(_loc3_ && this.var_1801 && !this.var_1800)
            {
               this.var_1801 = false;

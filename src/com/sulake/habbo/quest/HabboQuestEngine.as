package com.sulake.habbo.quest
{
   ...
   public class HabboQuestEngine extends Component implements IHabboQuestEngine, IUpdateReceiver
   {
      ...
      private static const const_1432:int = 800;
      
      private static const const_1431:int = 15;
      
      private static const const_1429:int = 300;
      ...
      private var var_1178:QuestController;
      
      private var var_945:AchievementController;
      ...
      public function HabboQuestEngine(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_1178 = new QuestController(this);
         this.var_945 = new AchievementController(this);
         ...
         registerUpdateReceiver(this,const_1430);
      }
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_366.events.removeEventListener(BadgeImageReadyEvent.const_119,this.var_945.onBadgeImageReady);
      ...
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_366.events.addEventListener(BadgeImageReadyEvent.const_119,this.var_945.onBadgeImageReady);
      }
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         if(param1.type == HabboToolbarEvent.const_50)
         {
            ...
            {
               this.var_1178.onToolbarClick();
            }
            if(param1.iconId == HabboToolbarIconEnum.ACHIEVEMENTS)
            {
               this.var_945.onToolbarClick();
            }
         }
      }
      ...
      {
         return this.var_1178.questTracker.isVisible();
      }

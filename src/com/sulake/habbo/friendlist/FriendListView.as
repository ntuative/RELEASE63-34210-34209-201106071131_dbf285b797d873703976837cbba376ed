package com.sulake.habbo.friendlist
{
   ...
   public class FriendListView
   {
      ...
      private static const const_1515:Point = new Point(110,50);
       
      
      private var _friendList:HabboFriendList;
      
      private var var_2122:FriendListTabsView;
      ...
      public function FriendListView(param1:HabboFriendList)
      {
         ...
         this.var_2122 = new FriendListTabsView(this._friendList);
      }
      ...
      public function openFriendList() : void
      {
         ...
         {
            this.prepare();
            this.var_17.position = const_1515;
         }
         else
         {
      ...
      private function prepare() : void
      {
         ...
         this.var_1090 = IWindowContainer(this.var_17.content.findChildByName("main_content"));
         this.var_271 = IWindowContainer(this.var_17.content.findChildByName("footer"));
         this.var_2122.prepare(this.var_1090);
         this.var_17.procedure = this.onWindow;
         this.var_17.content.setParamFlag(HabboWindowParam.const_1183,false);
         this.var_17.content.setParamFlag(HabboWindowParam.const_1289,true);
         this.var_17.header.setParamFlag(HabboWindowParam.const_972,false);
         this.var_17.header.setParamFlag(HabboWindowParam.const_724,true);
         this.var_17.content.setParamFlag(HabboWindowParam.const_972,false);
         this.var_17.content.setParamFlag(HabboWindowParam.const_724,true);
         this.var_17.findChildByName("open_edit_ctgs_but").procedure = this.onEditCategoriesButtonClick;
         this.var_1642 = ITextWindow(this.var_17.findChildByName("info_text"));
         this.var_1642.text = "";
      ...
      private function onWindow(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:int = this.var_2120 == -1 ? 0 : int(this.var_17.height - this.var_2120);
         var _loc4_:int = this.var_2123 == -1 ? 0 : int(this.var_17.width - this.var_2123);
      ...
      private function refreshWindowSize() : void
      {
         ...
         this.var_271.y = Util.getLowestPoint(this.var_17.content);
         ...
         this.var_17.scaler.setParamFlag(HabboWindowParam.const_1314,this._friendList.tabs.findSelectedTab() != null);
         this.var_17.scaler.setParamFlag(HabboWindowParam.const_972,false);
         ...
         this.var_2120 = this.var_17.height;
         this.var_2123 = this.var_17.width;

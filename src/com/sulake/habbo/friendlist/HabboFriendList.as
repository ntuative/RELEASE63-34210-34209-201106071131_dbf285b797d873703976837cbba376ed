package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList, IAvatarImageListener
   {
      ...
      private var var_748:ISessionDataManager;
      ...
      private var var_1733:OpenedToWebPopup;
      
      private var var_2294:int;
      
      var var_114:FriendCategories;
      
      private var var_426:FriendRequests;
      
      private var var_1732:AvatarSearchResults;
      
      private var _toolbar:IHabboToolbar;
      
      private var var_1074:IHabboNotifications;
      ...
      public function HabboFriendList(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_1732 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_1074)
         {
            this.var_1074.release(new IIDHabboNotifications());
            this.var_1074 = null;
         }
         if(this._toolbar)
         {
         ...
         if(this.var_748)
         {
            this.var_748.release(new IIDSessionDataManager());
            this.var_748 = null;
         }
         super.dispose();
      }
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         {
            this.var_1733 = new OpenedToWebPopup(this);
         }
         this.var_1733.show(x,y);
      }
      ...
      {
         this.openFriendListWithTab(FriendListTab.const_429);
      }
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = this._windowManager.createWindow(param1,"",HabboWindowType.const_327,HabboWindowStyle.const_48,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6) as IBitmapWrapperWindow;
      ...
      {
         var _loc2_:IAvatarImage = this.var_798.createAvatarImage(param1,AvatarScaleType.const_113,null,this);
         if(!_loc2_)
         {
            return null;
         }
      ...
      {
         this.var_1074 = param2 as IHabboNotifications;
      ...
      {
         this.var_748 = param2 as ISessionDataManager;
      }
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         this.var_426 = new FriendRequests(new FriendRequestsDeps(this),_loc2_.userFriendLimit,_loc2_.extendedFriendLimit,_loc2_.evenMoreExtendedFriendLimit);
         for each(_loc3_ in _loc2_.categories)
         {
            this.var_114.addCategory(new FriendCategory(_loc3_.id,_loc3_.name));
         }
         this.var_114.addCategory(new FriendCategory(FriendCategory.const_1356,this.getText("friendlist.friends")));
         this.var_114.addCategory(new FriendCategory(FriendCategory.const_417,this.getText("friendlist.friends.offlinecaption")));
         ...
         {
            _loc5_ = this.var_114.findCategory(FriendCategory.const_417);
            if(_loc5_)
            {
               _loc5_.setOpen(true);
            }
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         this.var_426.clearAndUpdateView(false);
         for each(_loc3_ in _loc2_.reqs)
         {
            this.var_426.addRequest(new FriendRequest(_loc3_));
         }
         if(_loc2_.reqs.length > 0)
         {
            this.var_437.findTab(FriendListTab.const_102).setNewMessageArrived(true);
         }
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         this.var_426.addRequestAndUpdateView(_loc3_);
         var _loc4_:FriendListTab = this.var_437.findTab(FriendListTab.const_102);
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         this.var_1732.searchReceived(_loc2_.friends,_loc2_.others);
      ...
      {
         var _loc2_:FriendListTab = this.var_437.findTab(FriendListTab.const_102);
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         if(!this.var_748 || !this.var_426)
         {
            return;
         }
         var _loc2_:int = 0;
         if(this.var_748.hasUserRight("fuse_super_extended_buddylist",HabboClubLevelEnum.const_44))
         {
            _loc2_ = this.var_426.vipLimit;
         }
         else if(this.var_748.hasUserRight("fuse_extended_buddylist",HabboClubLevelEnum.const_39))
         {
            _loc2_ = this.var_426.clubLimit;
         }
         if(_loc2_ > this.var_426.limit)
         {
            this.var_426.limit = _loc2_;
         }
      }

package com.sulake.habbo.friendlist
{
   ...
   public class FriendsView implements ITabView, IFriendsView
   {
      ...
      public static const const_2253:String = "bg";
       
      
      private var _friendList:HabboFriendList;
      
      private var var_2695:IContainerButtonWindow;
      
      private var var_2697:IContainerButtonWindow;
      
      private var var_2696:IContainerButtonWindow;
      
      private var var_2670:IContainerButtonWindow;
      
      private var var_66:IItemListWindow;
      
      private var var_641:AvatarPopupCtrl;
      ...
      public function init(param1:HabboFriendList) : void
      {
         ...
         this.var_641 = new AvatarPopupCtrl(this._friendList);
      }
      ...
      {
         this.var_2695 = this.initButton("open_minimail",this.onMinimailButtonClick,param1);
         this.var_2697 = this.initButton("open_homepage",this.onHomeButtonClick,param1);
         this.var_2696 = this.initButton("room_invite",this.onInviteButtonClick,param1);
         this.var_2670 = this.initButton("remove_friend",this.onRemoveButtonClick,param1);
         this.refreshButtons();
      }
      ...
      private function refreshButtons() : void
      {
         ...
         this.setEnabled(this.var_2695,this.isEnableMinimailButton(_loc1_));
         this.setEnabled(this.var_2697,this.isEnableHomeButton(_loc1_));
         this.setEnabled(this.var_2696,this.isEnableInviteButton(_loc1_));
         this.setEnabled(this.var_2670,this.isEnableRemoveButton(_loc1_));
      }
      ...
      private function onFriendClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            this.var_641.setData(_loc3_.online,_loc3_.name,_loc3_.motto,_loc3_.figure,_loc3_.lastAccess);
            this.var_641.showPopup(this._friendList.view.mainWindow,_loc3_.view);
         }
         else if(param1.type == WindowMouseEvent.const_25)
         {
            this.var_641.closePopup();
         }
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK || param1.type == WindowMouseEvent.const_148)
         {
            _loc4_ = this._friendList.categories.findFriend(param2.id);
            _loc4_.selected = !_loc4_.selected;
            this.refreshButtons();
            this.refreshList();
            if(param1.type == WindowMouseEvent.const_148 && _loc4_.online)
            {

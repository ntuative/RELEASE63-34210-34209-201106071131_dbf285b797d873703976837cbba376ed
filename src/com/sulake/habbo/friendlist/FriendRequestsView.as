package com.sulake.habbo.friendlist
{
   ...
   public class FriendRequestsView implements ITabView, IFriendRequestsView
   {
      ...
      private static const const_2017:String = "no_reqs_info";
      ...
      private var var_1896:IContainerButtonWindow;
      
      private var var_1897:IContainerButtonWindow;
      ...
      {
         this.var_1896 = IContainerButtonWindow(param1.findChildByName("accept_all_but"));
         this.var_1897 = IContainerButtonWindow(param1.findChildByName("reject_all_but"));
         this.var_1897.procedure = this.onDismissAllButtonClick;
         this.var_1896.procedure = this.onAcceptAllButtonClick;
         this.refreshButtons();
      }
      ...
      public function refreshRequestEntry(param1:FriendRequest) : void
      {
         ...
         else if(param1.state == FriendRequest.const_400)
         {
      ...
      public function acceptRequest(param1:int) : void
      {
         ...
         _loc2_.state = FriendRequest.const_400;
         ...
         {
            this._friendList.events.dispatchEvent(new FriendRequestEvent(FriendRequestEvent.const_64,param1));
         }
      }
      ...
      public function declineRequest(param1:int) : void
      {
         ...
         if(this._friendList && this._friendList.events)
         {
            this._friendList.events.dispatchEvent(new FriendRequestEvent(FriendRequestEvent.const_330,param1));
         }
      }
      ...
      private function onDismissAllButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(_loc4_.state != FriendRequest.const_400 && _loc4_.state != FriendRequest.const_387)
            {
               _loc4_.state = FriendRequest.const_387;
               this.refreshRequestEntry(_loc4_);
               if(this._friendList && this._friendList.events)
               {
                  this._friendList.events.dispatchEvent(new FriendRequestEvent(FriendRequestEvent.const_330,_loc4_.requestId));
               }
            }
         }
         this.refresh();
      ...
      private function onAcceptAllButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         for each(_loc4_ in this._friendList.friendRequests.requests)
         {
            if(_loc4_.state != FriendRequest.const_400 && _loc4_.state != FriendRequest.const_387)
            {
               ...
               _loc4_.state = FriendRequest.const_400;
               this.refreshRequestEntry(_loc4_);
               if(this._friendList && this._friendList.events)
               {
                  this._friendList.events.dispatchEvent(new FriendRequestEvent(FriendRequestEvent.const_64,_loc4_.requestId));
               }
            }
         }
         this._friendList.send(_loc3_);
      ...
      private function refreshButtons() : void
      {
         ...
         this.setEnabled(this.var_1896,_loc1_);
         this.setEnabled(this.var_1897,_loc1_);
      }

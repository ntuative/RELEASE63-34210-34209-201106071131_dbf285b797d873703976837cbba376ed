package com.sulake.habbo.friendlist
{
   ...
   public class FriendListTabsView
   {
      ...
      public function refresh(param1:String) : void
      {
         ...
         this.var_188.width = this._friendList.tabs.tabContentWidth;
         this.var_188.findChildByName("bg").width = this._friendList.tabs.tabContentWidth;
         var _loc2_:int = 1;
         for each(_loc3_ in this._friendList.tabs.getTabs())
         {
            _loc4_ = this.var_188.getChildByName("flt_" + _loc3_.id) as IWindowContainer;
         ...
         this.var_188.height = _loc2_ + 1;
         this.var_188.findChildByName("bg").height = this.var_188.height;
      ...
      private function onTabClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            this._friendList.trackFriendListEvent(HabboFriendListTrackingEvent.const_547);
         }
      }

package com.sulake.habbo.friendlist
{
   ...
   public class AlertView implements IDisposable
   {
      ...
      {
         var _loc1_:IFrameWindow = IFrameWindow(var_645[this.var_1118]);
         if(_loc1_ != null)
         {
            _loc1_.dispose();
         }
         ...
         var_645[this.var_1118] = this._alert;
      }
      ...
      {
         var _loc1_:IFrameWindow = IFrameWindow(this._friendList.getXmlWindow(this.var_1118));

package com.sulake.habbo.friendlist
{
   ...
   public class SearchView implements ITabView, ISearchView
   {
      ...
      private var var_736:ITextFieldWindow;
      ...
      {
         this.var_736 = ITextFieldWindow(param1.findChildByName("search_str"));
         this.var_736.procedure = this.onSearchInput;
         this.var_736.addEventListener(WindowKeyboardEvent.const_224,this.onSearchStrInput);
      ...
      private function refreshShading() : void
      {
         ...
         {
            this.var_66.getListItemAt(_loc1_).color = this._friendList.laf.getRowShadingColor(FriendListTab.const_429,_loc1_ % 2 == 1);
            _loc1_++;
         }
      }
      ...
      private function onSearchEntry(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            this.var_641.setData(_loc3_.isAvatarOnline,_loc3_.avatarName,_loc3_.avatarMotto,_loc3_.avatarFigure,_loc3_.lastOnlineDate,_loc3_.realName);
            this.var_641.showPopup(this._friendList.view.mainWindow,IWindowContainer(param2));
         }
      ...
      private function onSearchStrInput(param1:WindowKeyboardEvent) : void
      {
         ...
         {
            _loc4_ = 25;
            _loc5_ = this.var_736.text;
            if(_loc5_.length > _loc4_)
            {
               this.var_736.text = _loc5_.substring(0,_loc4_);
            }
         }
      }
      ...
      {
         var _loc1_:String = this.var_736.text;

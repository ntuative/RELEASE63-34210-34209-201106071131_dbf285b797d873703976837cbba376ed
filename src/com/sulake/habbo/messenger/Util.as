package com.sulake.habbo.messenger
{
   ...
   public class Util
   {
      ...
      {
         return param1.createWindow(param2,param2,HabboWindowType.const_87,HabboWindowStyle.const_32,0 | (!!param5 ? HabboWindowParam.const_69 : 0),new Rectangle(param3,param4,600,600),null) as IWindowContainer;
      }
   }
}

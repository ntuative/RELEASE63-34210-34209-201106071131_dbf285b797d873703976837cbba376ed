package com.sulake.habbo.help
{
   ...
   public class HabboHelp extends Component implements IHabboHelp
   {
      ...
      private var var_923:IHabboConfigurationManager;
      
      private var var_366:ISessionDataManager;
      
      private var var_1152:FaqIndex;
      ...
      private var var_1428:CallForHelpData;
      
      private var var_2318:UserRegistry;
      ...
      {
         this.var_1428 = new CallForHelpData();
         this.var_2318 = new UserRegistry();
         super(param1,param2,param3);
         this._assetLibrary = param3;
         this.var_1152 = new FaqIndex();
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_923)
         {
            this.var_923.release(new IIDHabboConfigurationManager());
            this.var_923 = null;
         }
      ...
      public function getConfigurationKey(param1:String, param2:String = null, param3:Dictionary = null) : String
      {
         ...
         return this.var_923.getKey(param1,param2,param3);
      }
      ...
      {
         this.var_1428.reportedUserId = param1;
         this.var_1428.reportedUserName = param2;
         this.var_72.showUI(HabboHelpViewEnum.const_432);
      }
      ...
      public function startNameChange() : void
      {
         if(this.var_115)
         {
            this.var_115.showView(TutorialUI.const_316);
         }
      }
      ...
      {
         this.var_976 = IHabboLocalizationManager(param2);
         queueInterface(new IIDHabboConfigurationManager(),this.onConfigurationManagerReady);
      }
      
      private function onConfigurationManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         this.var_923 = IHabboConfigurationManager(param2);
      ...
      public function showWelcomeScreen(param1:WelcomeNotification) : void
      {
         if(!this.var_924)
         {
            this.var_924 = new WelcomeScreenController(this,this._windowManager);
         }

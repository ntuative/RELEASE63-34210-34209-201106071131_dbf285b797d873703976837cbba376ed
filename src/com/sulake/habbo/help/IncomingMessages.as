   ...
   public class IncomingMessages
   {
      ...
      private function onUsers(param1:IMessageEvent) : void
      {
         ...
         while(_loc4_ < _loc3_.getUserCount())
         {
            ...
            {
               this.var_2409 = _loc5_.id;
            }
            _loc4_++;
         }
         this.var_23.tellUI(HabboHelpViewEnum.const_935);
      }
      ...
      {
         this.var_23.showUI(HabboHelpViewEnum.const_432);
      }
      ...
      private function onFaqClientFaqs(param1:IMessageEvent) : void
      {
         ...
         this.var_23.tellUI(HabboHelpViewEnum.const_221);
      }
      ...
      private function onFaqCategories(param1:IMessageEvent) : void
      {
         ...
         this.var_23.showUI(HabboHelpViewEnum.const_493);
      }
      ...
      private function onFaqCategory(param1:IMessageEvent) : void
      {
         ...
         this.var_23.tellUI(HabboHelpViewEnum.const_359,_loc6_);
      }
      ...
      private function onFaqText(param1:IMessageEvent) : void
      {
         ...
         if(_loc4_ != null)
         {
            this.var_23.tellUI(HabboHelpViewEnum.const_271,_loc4_);
         }
      }
      ...
      private function onFaqSearchResults(param1:IMessageEvent) : void
      {
         ...
         this.var_23.showUI(HabboHelpViewEnum.const_1267);
         this.var_23.tellUI(HabboHelpViewEnum.const_1267,_loc5_);
      }

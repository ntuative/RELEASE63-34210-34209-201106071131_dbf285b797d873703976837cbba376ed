   ...
   public class CallForHelpTopicSelection extends HelpViewController implements IHelpViewController
   {
      ...
      override public function render() : void
      {
         ...
         for each(_loc5_ in _loc4_)
         {
            ...
            if(_loc7_ != 0)
            {
               this.var_811.push(_loc7_);
            }
         }
         _loc6_ = 0;
         while(_loc6_ < this.var_811.length)
         {
            _loc8_ = this.var_811[_loc6_];
      ...
      private function handleListItemClick(param1:IWindow) : void
      {
         ...
         if(this.var_811 == null || _loc3_ < 0 || _loc3_ >= this.var_811.length)
         {
            return;
         }
         if(_loc3_ > -1)
         {
            main.component.callForHelpData.topicIndex = this.var_811[_loc3_];
            main.showUI(HabboHelpViewEnum.const_739);
            main.tellUI(HabboHelpViewEnum.const_739,null);
         }
      }
   }
}

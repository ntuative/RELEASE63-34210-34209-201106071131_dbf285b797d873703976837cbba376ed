   ...
   public class WelcomeScreenController implements IUpdateReceiver
   {
      ...
      public function dispose() : void
      {
         if(this.var_198)
         {
            ...
            this.var_198.toolbar.events.removeEventListener(HabboToolbarEvent.const_50,this.onToolbarClicked);
            this.var_198 = null;
         }
      ...
      public function showWelcomeScreen(param1:WelcomeNotification) : void
      {
         ...
         this.var_70 = param1;
         this.var_198.toolbar.events.addEventListener(HabboToolbarEvent.const_50,this.onToolbarClicked);
         ...
         this.var_223.y = this.var_198.toolbar.getIconVerticalLocation(param1.targetIconId) - this._window.height / 2;
         this._window.y = this.var_223.y;
      ...
      private function initializeWindow() : void
      {
         ...
         _loc4_.content.setParamFlag(WindowParam.const_335,false);
         _loc4_.height -= 20;
      ...
      public function update(param1:uint) : void
      {
         ...
         var _loc2_:Number = Point.distance(this._window.rectangle.topLeft,this.var_223);
         if(_loc2_ > 5)
         {
            _loc3_ = Point.interpolate(this._window.rectangle.topLeft,this.var_223,0.5);
            this._window.x = _loc3_.x;
            this._window.y = _loc3_.y;
         }
         else
         {
            this._window.x = this.var_223.x;
            this._window.y = this.var_223.y;
            this.var_198.removeUpdateReceiver(this);
         }
      }

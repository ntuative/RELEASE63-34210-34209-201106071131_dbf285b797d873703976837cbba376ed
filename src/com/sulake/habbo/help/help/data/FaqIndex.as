package com.sulake.habbo.help.help.data
{
   ...
   public class FaqIndex
   {
      ...
      {
         super();
         this.var_730 = new FaqCategory(-999,"${help.faq.title.urgent}");
         this.var_729 = new FaqCategory(-9999,"${help.faq.title.normal}");
         this.var_731 = new FaqCategory(-99999,"${help.faq.title.searchresults}");
      ...
      public function dispose() : void
      {
         ...
         if(this.var_163 != null)
         {
            ...
            {
               _loc2_ = this.var_163.getWithIndex(_loc1_);
               _loc2_.dispose();
               _loc1_++;
            }
      ...
      {
         var _loc4_:FaqCategory = this.var_163.getValue(param1);
      ...
      public function storeAnswerText(param1:int, param2:String) : void
      {
         ...
         if(this.var_731.hasItem(param1))
         {
            this.var_731.getItem(param1).answerText = param2;
         }
         var _loc3_:int = 0;
         while(_loc3_ < this.var_163.length)
         {
            _loc4_ = this.var_163.getWithIndex(_loc3_);
      ...
      private function findItem(param1:int) : FaqItem
      {
         ...
         if(this.var_731.hasItem(param1))
         {
            return this.var_731.getItem(param1);
         }
         var _loc2_:int = 0;
         while(_loc2_ < this.var_163.length)
         {
            _loc3_ = this.var_163.getWithIndex(_loc2_);

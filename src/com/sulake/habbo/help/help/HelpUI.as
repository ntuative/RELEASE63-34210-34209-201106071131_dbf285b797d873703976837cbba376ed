package com.sulake.habbo.help.help
{
   ...
   public class HelpUI
   {
      ...
      private var var_2144:String = "HHVE_HELP_FRONTPAGE";
      ...
      public function HelpUI(param1:HabboHelp, param2:IAssetLibrary, param3:IHabboWindowManager)
      {
         ...
         this._windowManager.registerLocalizationParameter("info.client.version","version",new String(201106071126));
         this.var_137 = new Map();
         this.var_137.add(HabboHelpViewEnum.const_1678,IHelpViewController(new PlaceholderView(this,this._windowManager,this._assetLibrary)));
         this.var_137.add(HabboHelpViewEnum.const_221,IHelpViewController(new HelpMainView(this,this._windowManager,this._assetLibrary)));
         this.var_137.add(HabboHelpViewEnum.const_493,IHelpViewController(new FaqBrowseTopView(this,this._windowManager,this._assetLibrary)));
         this.var_137.add(HabboHelpViewEnum.const_359,IHelpViewController(new FaqBrowseCategoryView(this,this._windowManager,this._assetLibrary)));
         this.var_137.add(HabboHelpViewEnum.const_271,IHelpViewController(new FaqBrowseEntry(this,this._windowManager,this._assetLibrary)));
         this.var_137.add(HabboHelpViewEnum.const_432,IHelpViewController(new CallForHelpTopicSelection(this,this._windowManager,this._assetLibrary)));
         this.var_137.add(HabboHelpViewEnum.const_739,IHelpViewController(new CallForHelpTextInput(this,this._windowManager,this._assetLibrary)));
         this.var_137.add(HabboHelpViewEnum.const_309,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_thanks")));
         this.var_137.add(HabboHelpViewEnum.const_1262,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_abusive")));
         this.var_137.add(HabboHelpViewEnum.const_1166,IHelpViewController(new CallForHelpPendingItemView(this,this._windowManager,this._assetLibrary)));
         this.var_137.add(HabboHelpViewEnum.const_935,IHelpViewController(new CallForHelpReportUserSelection(this,this._windowManager,this._assetLibrary)));
      }
      ...
      public function dispose() : void
      {
         ...
         var _loc1_:Array = this.var_137.getKeys();
         var _loc2_:int = 0;
         while(_loc2_ < _loc1_.length)
         {
            _loc3_ = _loc1_[_loc2_];
            _loc4_ = this.var_137.getValue(_loc3_) as IHelpViewController;
            if(_loc4_ != null)
            {
               _loc4_.dispose();
            }
      ...
      public function showUI(param1:String = null, param2:Boolean = true) : void
      {
         ...
         {
            if(this.var_580.length == 0 || param1 != this.var_412)
            {
               this.var_580.push(this.var_412);
            }
         }
         this.var_412 = param1;
         ...
         if(_loc3_ == null)
         {
            Logger.log("* No view controller found for " + this.var_412);
            return;
         }
      ...
      public function showCallForHelpResult(param1:String) : void
      {
         switch(param1)
         {
            case CallForHelpResultEnum.const_309:
               this.showUI(HabboHelpViewEnum.const_309);
               break;
            case CallForHelpResultEnum.const_1232:
      ...
      public function updateCallForGuideBotUI(param1:Boolean) : void
      {
         ...
         var _loc2_:IHelpViewController = this.var_137.getValue(HabboHelpViewEnum.const_221) as IHelpViewController;
      ...
      public function handleCallGuideBot() : void
      {
         ...
         this.hideUI();
         this.var_23.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_508));
      }
      ...
      public function setRoomSessionStatus(param1:Boolean) : void
      {
         ...
         {
            _loc3_ = this.var_137.getWithIndex(_loc2_) as IHelpViewController;
            if(_loc3_ != null)
            {
      ...
      {
         return this.var_137.getValue(this.var_412);
      }
      ...
      private function createWindow() : void
      {
         ...
         this.var_2233 = this._window.width - _loc3_.width;
      ...
      public function updateWindowDimensions() : void
      {
         ...
         this._window.width = _loc1_.width + this.var_2233;
      }
      ...
      private function onBack(param1:WindowMouseEvent) : void
      {
         ...
         {
            this.showUI(this.var_580.pop(),false);
         }
      }
      ...
      {
         var _loc3_:* = null;
         if(this.var_412 == HabboHelpViewEnum.const_221)
         {
            return;
         }
         if(this.var_714.length < 2)
         {
            _loc3_ = this._assetLibrary.getAssetByName("back_png") as BitmapDataAsset;
            this.var_714.push(_loc3_.content as BitmapData);
            _loc3_ = this._assetLibrary.getAssetByName("back_hi_png") as BitmapDataAsset;
            this.var_714.push(_loc3_.content as BitmapData);
         }
         var _loc2_:IBitmapWrapperWindow = this.var_411.findChildByName("back_image") as IBitmapWrapperWindow;
         if(_loc2_ == null)
         {
            return;
         }
         ...
         if(param1)
         {
            _loc2_.bitmap.copyPixels(this.var_714[1],this.var_714[1].rect,new Point(0,0));
         }
         else
         {
            _loc2_.bitmap.copyPixels(this.var_714[0],this.var_714[0].rect,new Point(0,0));
         }
      }
      ...
      private function addBackButtonWindow() : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:* = null;
         if(this.var_412 == HabboHelpViewEnum.const_221 || this.var_580.length == 0)
         {
            return;
         }
         if(this.var_411 == null)
         {
            ...
            this.var_411 = this._windowManager.buildFromXML(XML(_loc2_.content)) as IWindowContainer;
            _loc3_ = this.var_411.findChildByName("back_image");
            if(_loc3_ != null)
            {
            ...
            _loc4_ = this.var_411.findChildByName("back_text");
            if(_loc4_ != null)
            {
         ...
         var _loc1_:IItemListWindow = this._window.findChildByName("content_list") as IItemListWindow;
         if(_loc1_ == null || this.var_411 == null)
         {
            return;
         }
         if(_loc1_.getListItemIndex(this.var_411 as IWindow) > -1)
         {
            return;
         }
         _loc1_.addListItem(this.var_411 as IWindow);
         this.setBackButtonActiveState(false);
      }
   }
}

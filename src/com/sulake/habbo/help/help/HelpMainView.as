package com.sulake.habbo.help.help
{
   ...
   public class HelpMainView extends HelpViewController
   {
      ...
      private static const const_1569:int = 60;
      ...
      override public function render() : void
      {
         ...
         if(_loc6_ == null || _loc6_.getFrontPageUrgentCategory().getAgeSeconds() > const_1569)
         {
      ...
      {
         main.showUI(HabboHelpViewEnum.const_493);
      }
      ...
      {
         main.component.callForHelpData.reportedUserId = 0;
         main.showUI(HabboHelpViewEnum.const_935);
      }

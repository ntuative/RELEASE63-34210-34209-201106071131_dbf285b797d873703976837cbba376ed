package com.sulake.habbo.ui
{
   ...
   public class RoomDesktop implements IRoomDesktop, IRoomWidgetMessageListener, IRoomWidgetHandlerContainer
   {
      ...
      private var var_1291:IRoomWidgetFactory = null;
      
      private var var_366:ISessionDataManager = null;
      
      private var var_16:IRoomSessionManager = null;
      
      private var var_946:IAvatarRenderManager = null;
      ...
      private var var_390:DesktopLayoutManager;
      ...
      private var var_2774:uint = 16777215;
      ...
      public function RoomDesktop(param1:IRoomSession, param2:IAssetLibrary, param3:IConnection)
      {
         ...
         this.var_390 = new DesktopLayoutManager();
      }
      ...
      public function set friendList(param1:IHabboFriendList) : void
      {
         ...
         if(this._friendList)
         {
            ...
            this._friendList.events.addEventListener(FriendRequestEvent.const_330,this.processEvent);
         }
      }
      ...
      public function set roomEngine(param1:IRoomEngine) : void
      {
         ...
         if(this._roomEngine != null && this._roomEngine.events != null)
         {
            ...
            this._roomEngine.events.addEventListener(RoomContentLoadedEvent.const_964,this.onRoomContentLoaded);
         }
      }
      ...
      {
         this.var_390.setLayout(param1,this._windowManager,this._config);
      }
      ...
      public function dispose() : void
      {
         ...
         if(this._friendList && this._friendList.events)
         {
            ...
            this._friendList.events.removeEventListener(FriendRequestEvent.const_330,this.processEvent);
         }
         ...
         if(this._roomEngine != null && this._roomEngine.events != null)
         {
            ...
            this._roomEngine.events.removeEventListener(RoomContentLoadedEvent.const_964,this.onRoomContentLoaded);
         }
      ...
      public function init() : void
      {
         ...
         if(this.var_326 != null && this.var_33.state == RoomSessionEvent.const_280)
         {
            this.var_2018 = !this.var_326.showInterstitial();
         }
      ...
      public function createWidget(param1:String) : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc9_ != null)
            {
               ...
               {
                  _loc8_ = this.var_847.getValue(_loc11_);
                  if(_loc8_ == null)
                  {
                     _loc8_ = [];
                     this.var_847.add(_loc11_,_loc8_);
                  }
                  else
                  {
            ...
            if(_loc10_ != null)
            {
               ...
               {
                  _loc8_ = this.var_848.getValue(_loc12_);
                  if(_loc8_ == null)
                  {
                     _loc8_ = [];
                     this.var_848.add(_loc12_,_loc8_);
                  }
                  _loc8_.push(_loc4_);
               }
            }
         }
         _loc2_ = this.var_1291.createWidget(param1,_loc4_);
         if(_loc2_ == null)
         {
            return;
         }
         ...
         this.var_390.addWidgetWindow(param1,_loc2_.mainWindow);
         ...
         {
            param1 = "null";
            _loc13_ = new RoomWidgetRoomViewUpdateEvent(param1,this.var_390.roomViewRect);
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         var _loc2_:Array = this.var_848.getValue(param1.type);
         if(_loc2_ != null)
         {
            for each(_loc3_ in _loc2_)
            {
      ...
      private function isFurnitureSelectionDisabled(param1:RoomEngineObjectEvent) : Boolean
      {
         ...
         if(_loc3_ != null)
         {
            ...
            if(_loc4_ != null)
            {
               if(_loc4_.getNumber(RoomObjectVariableEnum.const_1357) == 1)
               {
                  _loc2_ = true;
                  if(this.var_366.isAnyRoomController)
                  {
                     _loc2_ = false;
                  }
               }
      ...
      public function roomObjectEventHandler(param1:RoomEngineObjectEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineObjectEvent.const_796:
               ...
               {
                  _loc4_ = new RoomWidgetRoomObjectUpdateEvent(RoomWidgetRoomObjectUpdateEvent.const_864,_loc2_,_loc3_,param1.roomId,param1.roomCategory);
               }
               if(this.var_1024 != null && _loc3_ == RoomObjectCategoryEnum.const_29)
               {
                  _loc7_ = this.var_33.userDataManager.getUserDataByIndex(_loc2_);
                  if(_loc7_ != null && _loc7_.type == RoomObjectTypeEnum.const_137)
                  {
                     this.var_1024.userSelected(_loc7_.webID,_loc7_.name);
                  }
               }
               break;
            ...
            case RoomEngineObjectEvent.const_180:
               _loc4_ = new RoomWidgetRoomObjectUpdateEvent(RoomWidgetRoomObjectUpdateEvent.const_817,_loc2_,_loc3_,param1.roomId,param1.roomCategory);
               break;
            case RoomEngineObjectEvent.const_184:
               ...
               break;
            case RoomEngineObjectEvent.const_947:
               if(!this.var_33.isRoomController && !this.var_366.isAnyRoomController)
               {
                  return;
               }
      ...
      public function roomEngineEventHandler(param1:RoomEngineEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineEvent.const_491:
      ...
      public function createRoomView(param1:int) : void
      {
         ...
         var _loc21_:* = null;
         var _loc2_:Rectangle = this.var_390.roomViewRect;
         ...
         if(_loc7_ != null)
         {
            _loc13_ = this._roomEngine.getRoomNumberValue(this.var_33.roomId,this.var_33.roomCategory,RoomVariableEnum.const_722);
            _loc14_ = this._roomEngine.getRoomNumberValue(this.var_33.roomId,this.var_33.roomCategory,RoomVariableEnum.const_952);
            _loc15_ = this._roomEngine.getRoomNumberValue(this.var_33.roomId,this.var_33.roomCategory,RoomVariableEnum.const_997);
            _loc16_ = this._roomEngine.getRoomNumberValue(this.var_33.roomId,this.var_33.roomCategory,RoomVariableEnum.const_922);
         ...
         _loc10_.addEventListener(WindowMouseEvent.const_148,this.canvasMouseHandler);
         ...
         _loc10_.addEventListener(WindowMouseEvent.const_274,this.canvasMouseHandler);
         ...
         this.var_390.addRoomView(_loc9_);
      ...
      private function resizeColorizer(param1:WindowEvent) : void
      {
         ...
         _loc3_.graphics.beginFill(this.var_2774);
      ...
      {
         var _loc3_:IWindowContainer = this.var_390.getRoomView() as IWindowContainer;
         if(_loc3_ == null)
         {
            return;
         }
      ...
      public function getRoomViewRect() : Rectangle
      {
         ...
         return this.var_390.roomViewRect;
      }
      ...
      public function canvasMouseHandler(param1:WindowEvent) : void
      {
         ...
         switch(_loc2_.type)
         {
            case WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK:
               _loc3_ = "null";
               break;
            case WindowMouseEvent.const_148:
               _loc3_ = "null";
               break;
      ...
      private function onRoomViewResized(param1:WindowEvent) : void
      {
         ...
         this._roomEngine.modifyRoomCanvas(this.var_33.roomId,this.var_33.roomCategory,this.var_329[0],_loc2_.width,_loc2_.height);
         if(this.var_534 == null)
         {
            this.var_534 = new Timer(const_1576,1);
      ...
      private function trackZoomTime(param1:Boolean) : void
      {
         ...
         {
            _loc2_ = getTimer();
            _loc3_ = Math.round((_loc2_ - this.var_2016) / 1000);
      ...
      {
         if(this.var_16 != null && this.var_33 != null && this.var_2018 && this.var_2015)
         {
      ...
      private function handleRoomAdClick(param1:RoomEngineObjectEvent) : void
      {
         ...
         var _loc4_:String = _loc3_.getString(RoomObjectVariableEnum.const_430);
      ...
      private function handleRoomAdTooltip(param1:RoomEngineObjectEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineObjectEvent.const_484:
               ...
               this.var_246 = this._windowManager.createWindow("room_ad_tooltip",_loc3_,WindowType.const_451,WindowStyle.const_124,WindowParam.const_105) as IToolTipWindow;

package com.sulake.habbo.ui.handler
{
   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function InfoStandWidgetHandler(param1:IHabboMusicController)
      {
         ...
         {
            this.var_231.events.addEventListener(NowPlayingEvent.const_103,this.onNowPlayingChanged);
            this.var_231.events.addEventListener(SongInfoReceivedEvent.const_95,this.onSongInfoReceivedEvent);
         }
      }
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            ...
            {
               this._container.sessionDataManager.events.removeEventListener(UserTagsReceivedEvent.const_185,this.onUserTags);
               this._container.sessionDataManager.events.removeEventListener(BadgeImageReadyEvent.const_119,this.onBadgeImage);
            }
            if(this._container.roomSessionManager != null)
            {
               this._container.roomSessionManager.events.removeEventListener(RoomSessionUserFigureUpdateEvent.const_188,this.method_2);
         ...
         if(this._container.sessionDataManager != null)
         {
            this._container.sessionDataManager.events.addEventListener(UserTagsReceivedEvent.const_185,this.onUserTags);
            this._container.sessionDataManager.events.addEventListener(BadgeImageReadyEvent.const_119,this.onBadgeImage);
         }
         if(this._container.roomSessionManager != null)
         {
            this._container.roomSessionManager.events.addEventListener(RoomSessionUserFigureUpdateEvent.const_188,this.method_2);
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = this.var_637.length - 1;
            while(_loc1_ >= 0)
            {
               _loc2_ = this.var_637.getWithIndex(_loc1_);
               if(_loc2_)
               {
                  _loc2_.dispose();
               }
         ...
         if(this.var_231 != null)
         {
            this.var_231.events.removeEventListener(NowPlayingEvent.const_103,this.onNowPlayingChanged);
            this.var_231.events.removeEventListener(SongInfoReceivedEvent.const_95,this.onSongInfoReceivedEvent);
            this.var_231 = null;
         }
         this.var_1115 = true;
         this.container = null;
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetRoomObjectMessage.const_503);
         _loc1_.push(RoomWidgetRoomObjectMessage.const_755);
         ...
         _loc1_.push(RoomWidgetFurniActionMessage.const_894);
         _loc1_.push(RoomWidgetFurniActionMessage.const_936);
         _loc1_.push(RoomWidgetFurniActionMessage.const_1316);
         _loc1_.push(RoomWidgetRoomTagSearchMessage.const_858);
         _loc1_.push(RoomWidgetGetBadgeDetailsMessage.const_793);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_1735);
         _loc1_.push(RoomWidgetPetCommandMessage.const_628);
         _loc1_.push(RoomWidgetPetCommandMessage.const_853);
         _loc1_.push(RoomWidgetUserActionMessage.const_629);
         _loc1_.push(RoomWidgetUserActionMessage.const_411);
         _loc1_.push(RoomWidgetChangeMottoMessage.const_777);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         if(_loc4_ != null)
         {
            ...
            else if(param1.type == RoomWidgetUserActionMessage.const_411 || param1.type == RoomWidgetUserActionMessage.const_629 || param1.type == RoomWidgetUserActionMessage.const_560)
            {
         ...
         switch(param1.type)
         {
            case RoomWidgetRoomObjectMessage.const_503:
               return this.handleGetObjectInfoMessage(param1 as RoomWidgetRoomObjectMessage);
            case RoomWidgetRoomObjectMessage.const_755:
            ...
            case RoomWidgetUserActionMessage.const_507:
               _loc8_ = new RoomWidgetChatInputContentUpdateEvent(RoomWidgetChatInputContentUpdateEvent.const_1285,_loc3_.name);
            ...
            case RoomWidgetRoomTagSearchMessage.const_858:
               ...
               break;
            case RoomWidgetGetBadgeDetailsMessage.const_793:
            ...
            case RoomWidgetUserActionMessage.const_555:
               ...
               break;
            case RoomWidgetPetCommandMessage.const_853:
            ...
            case RoomWidgetPetCommandMessage.const_628:
               ...
               break;
            case RoomWidgetChangeMottoMessage.const_777:
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_26:
               ...
               if(_loc8_.getString(RoomWidgetInfostandExtraParamEnum.const_455) != null)
               {
                  _loc6_.extraParam = _loc8_.getString(RoomWidgetInfostandExtraParamEnum.const_455);
               }
               else if(_loc8_.getNumber(RoomObjectVariableEnum.const_911) == 1)
               {
                  _loc6_.extraParam = RoomWidgetInfostandExtraParamEnum.const_1290;
               }
               ...
               _loc10_ = _loc8_.getNumber(RoomObjectVariableEnum.const_1361);
               _loc11_ = _loc8_.getNumber(RoomObjectVariableEnum.const_1160);
               ...
               if(_loc6_.extraParam != null && _loc6_.extraParam.length > 0)
               {
                  ...
                  _loc28_ = "";
                  _loc29_ = "";
                  if(_loc6_.extraParam == RoomWidgetInfostandExtraParamEnum.const_556)
                  {
                     _loc30_ = this.var_231.getRoomItemPlaylist();
                     if(_loc30_ != null)
                     {
                  ...
                  else if(_loc6_.extraParam.indexOf(RoomWidgetInfostandExtraParamEnum.const_401) == 0)
                  {
                     _loc31_ = _loc6_.extraParam.substr(RoomWidgetInfostandExtraParamEnum.const_401.length);
                     _loc26_ = parseInt(_loc31_);
                     _loc29_ = "null";
                  }
                  if(_loc26_ != -1)
                  {
                     _loc32_ = this.var_231.getSongInfo(_loc26_);
                     if(_loc32_ != null)
                     {
            ...
            case RoomObjectCategoryEnum.const_29:
               ...
               {
                  if(_loc12_.type != RoomObjectTypeEnum.const_624)
                  {
                     return null;
                  }
                  _loc13_ = "null";
               ...
               if(_loc13_ == RoomWidgetUserInfoUpdateEvent.const_143)
               {
                  ...
                  if(_loc17_ != null)
                  {
                     _loc38_ = _loc17_.getModel().getString(RoomObjectVariableEnum.const_896);
                  ...
                  if(!_loc34_)
                  {
                     _loc14_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_713;
                  }
                  if(!_loc35_)
                  {
                     _loc14_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_944;
                  }
               ...
               if(_loc13_ == RoomWidgetUserInfoUpdateEvent.BOT)
               {
                  ...
                  _loc15_.push(RoomWidgetUserInfoUpdateEvent.const_1906);
               }
               else
               {
      ...
      private function method_2(param1:RoomSessionUserFigureUpdateEvent) : void
      {
         var _loc5_:* = null;
         var _loc6_:* = false;
         if(this._container == null)
      ...
      private function onPetInfo(param1:RoomSessionPetInfoUpdateEvent) : void
      {
         ...
         var _loc7_:BitmapData = this.var_637.getValue(_loc4_) as BitmapData;
         if(_loc7_ == null)
         {
            _loc7_ = this.getPetImage(_loc4_);
            this.var_637.add(_loc4_,_loc7_);
         }
         if(this._container != null && this._container.events != null)
         {
            ...
            if(_loc13_ != null)
            {
               ...
               if(_loc14_ != null)
               {
                  _loc15_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_896);
      ...
      private function onNowPlayingChanged(param1:NowPlayingEvent) : void
      {
         ...
         if(this.var_231 != null)
         {
            ...
            if(_loc2_ != -1)
            {
               _loc5_ = this.var_231.getSongInfo(_loc2_);
               if(_loc5_ != null)
               {
                  _loc3_ = _loc5_.name;
            ...
            this._container.events.dispatchEvent(new RoomWidgetSongUpdateEvent(RoomWidgetSongUpdateEvent.const_448,_loc2_,_loc3_,_loc4_));
         }
      }
      ...
      private function onSongInfoReceivedEvent(param1:SongInfoReceivedEvent) : void
      {
         ...
         if(this.var_231 != null)
         {
            ...
            if(_loc2_ != null)
            {
               this._container.events.dispatchEvent(new RoomWidgetSongUpdateEvent(RoomWidgetSongUpdateEvent.const_410,param1.id,_loc2_.name,_loc2_.creator));
            }
         }
      }
   }

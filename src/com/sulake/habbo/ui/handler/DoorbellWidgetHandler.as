package com.sulake.habbo.ui.handler
{
   ...
   public class DoorbellWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         return [RoomWidgetLetUserInMessage.const_980];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetLetUserInMessage.const_980:
      ...
      {
         return [RoomSessionDoorbellEvent.const_132,RoomSessionDoorbellEvent.const_166,RoomSessionDoorbellEvent.const_64];
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomSessionDoorbellEvent.const_166:
               ...
               break;
            case RoomSessionDoorbellEvent.const_64:
               _loc2_ = param1 as RoomSessionDoorbellEvent;
               if(_loc2_ == null)
               {
                  return;
               }
               this._container.events.dispatchEvent(new RoomWidgetDoorbellEvent(RoomWidgetDoorbellEvent.const_64,_loc2_.userName));
               break;
         }
      }

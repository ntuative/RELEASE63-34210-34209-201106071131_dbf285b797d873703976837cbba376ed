package com.sulake.habbo.ui.handler
{
   ...
   public class RoomQueueWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetRoomQueueMessage.CHANGE_TO_SPECTATOR_QUEUE:
               this._container.roomSession.changeQueue(RoomSessionQueueEvent.const_1252);
               break;
      ...
      {
         return [RoomSessionQueueEvent.const_483];
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionQueueEvent.const_483:
               ...
               switch(_loc2_.queueSetTarget)
               {
                  case RoomSessionQueueEvent.const_1173:
                     _loc3_ = "null";
                     break;
                  case RoomSessionQueueEvent.const_1252:
                     _loc3_ = "null";
               }
               if(_loc3_ == null)
               {
               ...
               if(_loc5_.length > 1)
               {
                  ...
                  {
                     _loc6_ = _loc2_.getQueueSize(RoomSessionQueueEvent.const_1783) + 1;
                  }
               }
               else
               {

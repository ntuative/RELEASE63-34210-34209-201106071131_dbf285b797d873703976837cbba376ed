package com.sulake.habbo.ui.handler
{
   ...
   public class FurnitureEcotronBoxWidgetHandler implements IRoomWidgetHandler, IGetImageListener
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_995,RoomWidgetEcotronBoxOpenMessage.const_791,RoomWidgetEcotronBoxOpenedMessage.const_1907];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_995:
               ...
               break;
            case RoomWidgetEcotronBoxOpenMessage.const_791:

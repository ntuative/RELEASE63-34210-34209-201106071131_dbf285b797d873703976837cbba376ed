package com.sulake.habbo.ui.handler
{
   ...
   public class FurniChooserWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function getWidgetMessages() : Array
      {
         ...
         _loc1_.push(RoomWidgetRoomObjectMessage.const_363);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRequestWidgetMessage.REQUEST_FURNI_CHOOSER:
               ...
               break;
            case RoomWidgetRoomObjectMessage.const_363:
      ...
      private function handleFurniChooserRequest() : void
      {
         ...
         this._container.events.dispatchEvent(new RoomWidgetChooserContentEvent(RoomWidgetChooserContentEvent.const_958,_loc3_,this._container.sessionDataManager.isAnyRoomController));
      }

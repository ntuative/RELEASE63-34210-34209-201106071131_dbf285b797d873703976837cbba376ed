package com.sulake.habbo.ui.handler
{
   ...
   public class FurnitureStickieWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_985,RoomWidgetStickieSendUpdateMessage.const_742,RoomWidgetStickieSendUpdateMessage.const_521];
      }
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_985:
               ...
               if(_loc3_ != null)
               {
                  ...
                  if(_loc6_ != null)
                  {
                     _loc7_ = _loc6_.getString(RoomObjectVariableEnum.const_1311);
                     if(_loc7_.length < 6)
                     {
                        return null;
                     }
                     ...
                     _loc11_ = new RoomWidgetStickieDataUpdateEvent(RoomWidgetStickieDataUpdateEvent.const_945,_loc2_.id,_loc3_.getType(),_loc9_,_loc8_,_loc10_);
            ...
            case RoomWidgetStickieSendUpdateMessage.const_521:
               ...
               break;
            case RoomWidgetStickieSendUpdateMessage.const_742:

package com.sulake.habbo.ui.handler
{
   ...
   public class ChatWidgetHandler implements IRoomWidgetHandler, IPetImageListener, IAvatarImageListener, IGetImageListener
   {
      ...
      private var var_1797:Map = null;
      
      private var var_1187:Array;
      
      private var _connection:IConnection = null;
      
      private var var_1188:Number = 0.0;
      
      private var var_770:Point = null;
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = 0;
            while(_loc1_ < this.var_436.length)
            {
               _loc2_ = this.var_436.getWithIndex(_loc1_) as BitmapData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      {
         return [RoomWidgetChatMessage.const_938,RoomWidgetChatSelectAvatarMessage.const_782];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetChatMessage.const_938:
                     ...
                     if(_loc5_.length > 0)
                     {
                        ...
                        switch(_loc6_.toLowerCase())
                        {
                           ...
                           case ":sign":
                              ...
                              return null;
                           case ":chooser":
                              if(this._container.sessionDataManager.hasUserRight("fuse_habbo_chooser",HabboClubLevelEnum.const_39) || this._container.sessionDataManager.hasSecurity(SecurityLevelEnum.const_1150))
                              {
                              ...
                              return null;
                           case ":furni":
                              if(this._container.sessionDataManager.hasUserRight("fuse_furni_chooser",HabboClubLevelEnum.const_39) || this._container.sessionDataManager.hasSecurity(SecurityLevelEnum.const_1150))
                              {
               ...
               break;
            case RoomWidgetChatSelectAvatarMessage.const_782:
                  ...
                  if(_loc4_ != null)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        if(_loc10_ != null)
                        {
                           ...
                           {
                              _loc13_ = this.var_436.getValue(_loc16_) as BitmapData;
                           }
                           _loc12_ = uint(this.var_624.getValue(_loc16_));
                           if(_loc13_ == null)
                           {
                              if(this._container.avatarRenderManager != null)
                              {
                                    ...
                                    default:
                                       ...
                                       if(_loc17_ != null)
                                       {
                                          ...
                                          if(_loc18_ != null)
                                          {
                                             ...
                                             this.var_624.add(_loc16_,_loc12_);
                                          }
                                       }
                                 }
                                 if(_loc13_ != null)
                                 {
                                    ...
                                    {
                                       this.var_436.add(_loc16_,_loc13_);
                                    }
                                 }
                              }
                           }
      ...
      private function updateWidgetPosition() : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(this.var_1188 > 0)
            {
               _loc5_ = Number(_loc4_.scale / this.var_1188);
            }
            if(this.var_770 == null)
            {
               ...
               this.var_515.y = 0;
               this.var_515.z = 0;
               this.var_770 = _loc4_.getScreenPoint(this.var_515);
               this.var_1188 = _loc4_.scale - 10;
            }
            _loc6_ = "";
            _loc7_ = null;
            this.var_515.x = 0;
            this.var_515.y = 0;
            this.var_515.z = 0;
            _loc8_ = _loc4_.getScreenPoint(this.var_515);
            if(_loc8_ != null)
            {
               ...
               if(_loc8_.x != this.var_770.x || _loc8_.y != this.var_770.y)
               {
                  _loc10_ = PointMath.sub(_loc8_,PointMath.mul(this.var_770,_loc5_));
      ...
      public function avatarImageReady(param1:String) : void
      {
         ...
         if(this.var_436)
         {
            _loc2_ = this.var_436.remove(param1) as BitmapData;
            if(_loc2_ != null)
            {
               this.var_1187.push(_loc2_);
            }
      ...
      private function getPetImage(param1:String) : BitmapData
      {
         ...
         if(_loc3_ < 8)
         {
            ...
            if(_loc5_ != null)
            {
               ...
               if(_loc6_ != null)
               {
                  ...
                  if(_loc7_ != 0)
                  {
                     this.var_624.add(param1,_loc7_);
                  }
               }
            }
         }
         else
         {
            ...
            if(_loc9_ != null)
            {
               ...
               if(_loc9_.id > 0)
               {
                  this.var_1797.add(_loc9_.id,param1);
               }
            }
         }
         return _loc2_;
      ...
      {
         var _loc3_:String = this.var_1797.remove(param1);
         if(_loc3_ != null)
         {

package com.sulake.habbo.ui.handler
{
   ...
   public class SpamWallPostItWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private var var_1743:IMessageEvent;
      ...
      {
         this.var_1743 = new RequestSpamWallPostItMessageEvent(this.onSpamWallPostItRequest);
         this._connection = param1;
         this._connection.addMessageEvent(this.var_1743);
      }
      ...
      public function dispose() : void
      {
         ...
         {
            this._disposed = true;
            this._connection.removeMessageEvent(this.var_1743);
      ...
      private function onSpamWallPostItRequest(param1:RequestSpamWallPostItMessageEvent) : void
      {
         ...
         if(this._container != null)
         {
            ...
            {
               this._container.events.dispatchEvent(new RoomWidgetSpamWallPostItEditEvent(RoomWidgetSpamWallPostItEditEvent.const_579,_loc3_,_loc4_,_loc5_));
            }
         }
      }
      ...
      {
         return [RoomWidgetSpamWallPostItEditEvent.const_579,RoomWidgetSpamWallPostItFinishEditingMessage.const_977];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetSpamWallPostItFinishEditingMessage.const_977:

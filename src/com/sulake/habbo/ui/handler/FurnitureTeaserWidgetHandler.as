package com.sulake.habbo.ui.handler
{
   ...
   public class FurnitureTeaserWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_988,RoomWidgetViralFurniMessage.const_878,RoomWidgetViralFurniMessage.const_195];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_988:
               ...
               break;
            case RoomWidgetViralFurniMessage.const_878:
      ...
      {
         return [RoomSessionViralFurniStatusEvent.const_499,RoomSessionViralFurniStatusEvent.const_597];
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionViralFurniStatusEvent.const_499:
               ...
               _loc3_ = new RoomWidgetTeaserDataUpdateEvent(RoomWidgetTeaserDataUpdateEvent.const_811);
               ...
               break;
            case RoomSessionViralFurniStatusEvent.const_597:
               _loc2_ = param1 as RoomSessionViralFurniStatusEvent;

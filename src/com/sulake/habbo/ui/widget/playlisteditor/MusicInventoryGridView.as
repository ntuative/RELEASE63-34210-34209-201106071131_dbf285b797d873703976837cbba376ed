package com.sulake.habbo.ui.widget.playlisteditor
{
   ...
   public class MusicInventoryGridView
   {
      ...
      private var var_629:IItemGridWindow;
      ...
      public function destroy() : void
      {
         ...
         {
            this.var_629.destroyGridItems();
            this.var_629 = null;
         }
         if(this.var_231 != null)
         {
            if(this.var_231.events != null)
            {
      ...
      public function refresh() : void
      {
         ...
         this.var_629.removeGridItems();
         var _loc1_:Map = this._items;
         var _loc2_:Map = new Map();
         var _loc3_:Array = _loc1_.getKeys();
         this._items = new Map();
         var _loc4_:int = this.var_231.getSongDiskInventorySize();
         var _loc5_:int = 0;
         while(_loc5_ < _loc4_)
         {
            _loc7_ = this.var_231.getSongDiskInventoryDiskId(_loc5_);
            _loc8_ = this.var_231.getSongDiskInventorySongId(_loc5_);
            _loc9_ = this.var_231.getSongInfo(_loc8_);
            _loc10_ = null;
            _loc11_ = null;
            if(_loc9_ != null)
            {
            ...
            this.var_629.addGridItem(_loc12_.window);
      ...
      public function setPreviewIconToPause() : void
      {
         ...
         {
            this.var_110.playButtonState = MusicInventoryGridItem.const_1301;
         }
      }
      ...
      public function setPreviewIconToPlay() : void
      {
         if(this.var_110 != null)
         {
            this.var_110.playButtonState = MusicInventoryGridItem.const_654;
         }
      }
      ...
      private function gridItemEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         var _loc4_:int = 0;
         var _loc5_:* = null;
         var _loc3_:* = param1.type == WindowMouseEvent.const_148;
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK || _loc3_)
         {
            ...
            {
               if(this.var_110.playButtonState == MusicInventoryGridItem.const_654)
               {
                  this.var_110.playButtonState = MusicInventoryGridItem.const_1321;
            ...
            {
               _loc4_ = this.var_629.getGridItemIndex(param1.window);
               if(_loc4_ != -1)
               {

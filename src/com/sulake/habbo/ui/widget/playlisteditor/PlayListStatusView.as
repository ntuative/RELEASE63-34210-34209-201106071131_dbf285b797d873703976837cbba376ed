package com.sulake.habbo.ui.widget.playlisteditor
{
   ...
   public class PlayListStatusView
   {
      ...
      public static const const_770:String = "PLSV_ADD_SONGS";
      
      public static const const_1155:String = "PLSV_START_PLAYBACK";
      
      public static const const_486:String = "PLSV_NOW_PLAYING";
      ...
      {
         if(this.var_46 != const_486)
         {
            return;
         }
         var _loc2_:IWindowContainer = this.var_473[this.var_46];
      ...
      public function set addSongsBackgroundImage(param1:BitmapData) : void
      {
         ...
         var _loc2_:IWindowContainer = this.var_473[const_770];
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function createWindows() : void
      {
         ...
         if(_loc1_ != null)
         {
            this.var_473.add(const_486,_loc1_);

package com.sulake.habbo.ui.widget.playlisteditor
{
   ...
   public class MusicInventoryStatusView
   {
      ...
      public static const const_768:String = "MISV_BUY_MORE";
      
      public static const const_877:String = "MISV_PREVIEW_PLAYING";
      ...
      {
         var _loc1_:* = null;
         for each(_loc1_ in this.var_473.getValues())
         {
            _loc1_.destroy();
         }
         this.var_473 = null;
      ...
      public function selectView(param1:String) : void
      {
         ...
         this._container.addChildAt(this.var_473[param1] as IWindowContainer,0);
         this.var_46 = param1;
      }
      ...
      public function set authorName(param1:String) : void
      {
         ...
         this.var_2007.text = param1;
      }
      
      public function setPreviewPlayingBackgroundImage(param1:BitmapData, param2:Boolean = true) : void
      {
         this.blitBackgroundImage(const_877,"preview_play_background_image",param1);
      ...
      {
         this.blitBackgroundImage(const_768,"get_more_music_background_image",param1);
         if(param2 && param1 != null)
         {
            param1.dispose();
         }
      ...
      private function createWindows() : void
      {
         ...
         if(_loc1_ != null)
         {
            this.var_473.add(const_877,_loc1_);
            this.var_2008 = _loc1_.getChildByName("preview_play_track_name") as ITextWindow;
            this.var_2007 = _loc1_.getChildByName("preview_play_author_name") as ITextWindow;
            ...
            this.setPreviewPlayingBackgroundImage(this._widget.getImageGalleryAssetBitmap(PlayListEditorWidgetAssetsEnum.const_615));
         ...
         if(_loc1_ != null)
         {
            this.var_473.add(const_768,_loc1_);
            ...
            this.setGetMoreMusicBackgroundImage(this._widget.getImageGalleryAssetBitmap(PlayListEditorWidgetAssetsEnum.const_604));
         }
      }
      ...
      {
         var _loc6_:* = null;
         var _loc4_:IWindowContainer = this.var_473[param1] as IWindowContainer;
         if(_loc4_ == null)
         {
            return;
         }

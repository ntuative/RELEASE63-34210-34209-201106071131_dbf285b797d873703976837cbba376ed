   ...
   public class PlayListEditorItemListView
   {
      ...
      public function setItemIndexPlaying(param1:int) : void
      {
         ...
         if(param1 < 0)
         {
            ...
            {
               _loc3_.setIconState(PlayListEditorItem.const_631);
            }
            return;
         }
         ...
         if(this.var_1130 >= 0 && this.var_1130 < this._items.length)
         {
            _loc2_ = this._items[this.var_1130] as PlayListEditorItem;
            _loc2_.setIconState(PlayListEditorItem.const_631);
         }
         _loc2_ = this._items[param1] as PlayListEditorItem;
         _loc2_.setIconState(PlayListEditorItem.const_1339);
      ...
      private function itemEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK || _loc3_)
         {
            if(param2.name == "button_remove_from_playlist" || _loc3_)
            {
               ...
               if(this.var_909 > -1)
               {
                  this._widget.sendRemoveFromPlayListMessage(this.var_909);
               }
               this.var_110 = null;
               this.var_909 = -1;
            }

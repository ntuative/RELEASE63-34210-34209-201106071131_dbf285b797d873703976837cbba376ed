package com.sulake.habbo.ui.widget.poll
{
   ...
   public class PollOfferDialog implements IPollDialog
   {
      ...
      public static const const_1950:String = "POLL_OFFER_STATE_OK";
      
      public static const const_754:String = "POLL_OFFER_STATE_CANCEL";
      ...
      private function onOk(param1:WindowEvent) : void
      {
         ...
         this._state = const_1950;
         this._widget.messageListener.processWidgetMessage(new RoomWidgetPollMessage(RoomWidgetPollMessage.const_937,this._id));
      }
      ...
      private function onCancel(param1:WindowEvent) : void
      {
         ...
         this._widget.messageListener.processWidgetMessage(new RoomWidgetPollMessage(RoomWidgetPollMessage.const_625,this._id));

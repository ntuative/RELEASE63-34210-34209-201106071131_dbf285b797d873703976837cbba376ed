package com.sulake.habbo.ui.widget.poll
{
   ...
   public class PollContentDialog implements IPollDialog
   {
      ...
      private function nextQuestion() : void
      {
         ...
         var _loc7_:int = 0;
         ++this.var_1328;
         if(this.var_1328 < this.var_1055.length)
         {
            _loc1_ = this.var_1055[this.var_1328] as Dictionary;
            if(!_loc1_)
            {
      ...
      private function answerPollQuestion() : void
      {
         ...
         var question:Dictionary = this.var_1055[this.var_1328] as Dictionary;
      ...
      private function showCancelConfirm() : void
      {
         ...
         if(!this.var_332)
         {
            ...
            this.var_332 = this._widget.windowManager.buildFromXML(_loc1_.content as XML,2) as IFrameWindow;
            this.var_332.center();
            _loc2_ = this.var_332.findChildByName("header_button_close");
            if(_loc2_ != null)
            {
               _loc2_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onCancelPollClose);
            }
            _loc3_ = this.var_332.findChildByName("poll_cancel_confirm_button_ok");
            if(_loc3_ != null)
            {
               _loc3_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onCancelPollOk);
            }
            _loc4_ = this.var_332.findChildByName("poll_cancel_confirm_button_cancel");
            if(_loc4_ != null)
            {

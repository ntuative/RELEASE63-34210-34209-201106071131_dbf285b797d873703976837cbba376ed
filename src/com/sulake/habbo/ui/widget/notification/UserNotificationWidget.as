package com.sulake.habbo.ui.widget.notification
{
   ...
   public class UserNotificationWidget extends RoomWidgetBase
   {
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetUserNotificationEvent.const_577,this.onDisplayNotification);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetUserNotificationEvent.const_577,this.onDisplayNotification);

package com.sulake.habbo.ui.widget.doorbell
{
   ...
   public class DoorbellView
   {
      ...
      {
         var _loc1_:int = 0;
         if(this.var_321.users.length == 0)
         {
            this.hide();
            return;
         }
         ...
         if(this.var_66 != null)
         {
            ...
            _loc1_ = 0;
            while(_loc1_ < this.var_321.users.length)
            {
               this.var_66.addListItem(this.createListItem(this.var_321.users[_loc1_] as String,_loc1_));
               _loc1_++;
            }
         }
      }
      ...
      {
         var _loc6_:* = null;
         var _loc3_:XmlAsset = this.var_321.assets.getAssetByName("doorbell_list_entry") as XmlAsset;
         var _loc4_:IWindowContainer = this.var_321.windowManager.buildFromXML(_loc3_.content as XML) as IWindowContainer;
         if(_loc4_ == null)
         {
      ...
      public function createMainWindow() : void
      {
         ...
         var _loc1_:XmlAsset = this.var_321.assets.getAssetByName("doorbell") as XmlAsset;
         this._frame = this.var_321.windowManager.buildFromXML(_loc1_.content as XML) as IFrameWindow;
         if(this._frame == null)
         {
            throw new Error("Failed to construct window from XML!");
         }
      ...
      private function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         {
            case "accept":
               this.var_321.accept(_loc2_);
               break;
            case "deny":
               this.var_321.deny(_loc2_);
         }
      }
   }
}

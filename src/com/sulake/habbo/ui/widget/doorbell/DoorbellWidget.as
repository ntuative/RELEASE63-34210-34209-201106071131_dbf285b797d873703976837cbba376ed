package com.sulake.habbo.ui.widget.doorbell
{
   ...
   public class DoorbellWidget extends RoomWidgetBase
   {
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetDoorbellEvent.const_64,this.onDoorbellHandled);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetDoorbellEvent.const_64,this.onDoorbellHandled);
      }

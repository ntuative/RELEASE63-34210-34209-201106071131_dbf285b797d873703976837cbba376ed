package com.sulake.habbo.ui.widget.chooser
{
   ...
   public class ChooserView
   {
      ...
      private const const_2026:uint = 0;
      
      private const const_2301:uint = 4.282169599E9;
      ...
      public function populate(param1:Array, param2:Boolean) : void
      {
         ...
         while(_loc6_ < param1.length)
         {
            ...
            if(_loc4_ != null)
            {
               ...
               _loc5_.color = !!(_loc6_ % 2) ? uint(this.const_2026) : uint(this.const_2027);
      ...
      {
         var _loc2_:* = null;
         if(this._itemList == null || param1 < 0 || param1 > this._itemList.numListItems || param1 == this.var_1038)
         {
            return;
         }
         if(this.var_1038 != -1)
         {
            _loc2_ = this._itemList.getListItemAt(this.var_1038) as IWindowContainer;
            if(_loc2_ != null)
            {
               _loc2_.color = !!(this.var_1038 % 2) ? uint(this.const_2026) : uint(this.const_2027);
            }
         }
         _loc2_ = this._itemList.getListItemAt(param1) as IWindowContainer;
         if(_loc2_ != null)
         {
            _loc2_.color = this.const_2301;
      ...
      public function removeItem(param1:int, param2:int) : void
      {
         ...
         this.populate(this._items,this.var_2026);
      }

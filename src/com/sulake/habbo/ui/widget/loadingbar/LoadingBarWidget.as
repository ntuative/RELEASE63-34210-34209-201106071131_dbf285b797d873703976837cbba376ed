package com.sulake.habbo.ui.widget.loadingbar
{
   ...
   public class LoadingBarWidget extends RoomWidgetBase
   {
      ...
      private var var_582:Sprite = null;
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_582.removeEventListener(MouseEvent.CLICK,this.clickHandler);
            this.var_582 = null;
         }
         if(this.var_48 != null)
         {
      ...
      private function onShowInterstitial(param1:RoomWidgetInterstitialUpdateEvent) : void
      {
         ...
         if(this.var_582 == null)
         {
            this.var_582 = new Sprite();
            this.var_582.addChild(new Bitmap(this.var_48));
            this.var_582.addEventListener(MouseEvent.CLICK,this.clickHandler);
         }
         else
         {
            _loc5_ = this.var_582.getChildAt(0) as Bitmap;
            if(_loc5_ != null)
            {
               _loc5_.bitmapData = this.var_48;
            }
         }
         _loc2_.setDisplayObject(this.var_582);
      ...
      private function clickHandler(param1:Event) : void
      {
         if(this.var_1371 != "")
         {
            HabboWebTools.openWebPage(this.var_1371);
         }
      }
   }
}

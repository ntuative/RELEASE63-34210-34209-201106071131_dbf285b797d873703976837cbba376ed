package com.sulake.habbo.ui.widget.memenu
{
   ...
   public class MeMenuSoundSettingsView implements IMeMenuView
   {
      ...
      private var var_999:MeMenuSoundSettingsSlider;
      ...
      public function updateSettings(param1:RoomWidgetSettingsUpdateEvent) : void
      {
         ...
         if(this.var_999 != null)
         {
            this.var_999.setValue(this.var_1002);
         }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         {
            this.var_1003 = (_loc5_.content as BitmapData).clone();
         }
         ...
         this.var_999 = new MeMenuSoundSettingsSlider(this,this._window.findChildByName("volume_container") as IWindowContainer,this._widget.assets,0,1);
         this.updateSoundIcons();
         ...
         this._widget.messageListener.processWidgetMessage(new RoomWidgetGetSettingsMessage(RoomWidgetGetSettingsMessage.const_930));
      }
      ...
      private function updateSoundIcons() : void
      {
         if(this.var_1002 == 0)
         {
            ...
            this.setBitmapWrapperContent("sounds_off_icon",this.var_1003);
         }
         else
         {
      ...
      public function saveVolume(param1:Number, param2:Boolean = true) : void
      {
         ...
         {
            _loc3_ = new RoomWidgetStoreSettingsMessage(RoomWidgetStoreSettingsMessage.const_971);
         }

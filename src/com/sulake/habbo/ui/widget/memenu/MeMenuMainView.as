package com.sulake.habbo.ui.widget.memenu
{
   ...
   public class MeMenuMainView implements IMeMenuView
   {
      ...
      public function init(param1:MeMenuWidget, param2:String) : void
      {
         ...
         this.var_180["rooms_icon"] = ["gohome_white","gohome_color"];
         this.var_180["dance_icon"] = ["dance_white","dance_color"];
         this.var_180["clothes_icon"] = ["clothes_white","clothes_color"];
         this.var_180["effects_icon"] = ["effects_white","effects_color"];
         this.var_180["badges_icon"] = ["badges_white","badges_color"];
         this.var_180["wave_icon"] = ["wave_white","wave_color"];
         this.var_180["hc_icon"] = ["_white","_color"];
         this.var_180["settings_icon"] = ["settings_white","settings_color"];
         this.var_180["credits_icon"] = ["credits_white","credits_color"];
         this.var_180["news_icon"] = ["news_white","news_color"];
         this._widget = param1;
      ...
      {
         if(this.var_180[param1] == null)
         {
            return;
         }
         if(param3 != null)
         {
            this.var_180[param1][0] = param3;
         }
         if(param4 != null)
         {
            this.var_180[param1][1] = param4;
         }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         for(_loc3_ in this.var_180)
         {
            _loc6_ = this.var_180[_loc3_];
      ...
      private function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc3_)
         {
            case "dance":
               ...
               this._widget.changeView(MeMenuWidget.const_1180);
               break;
            case "wave":
               if(this._widget.hasEffectOn)
               {
               ...
               if(this._widget.isDancing)
               {
                  this._widget.messageListener.processWidgetMessage(new RoomWidgetDanceMessage(RoomWidgetDanceMessage.const_1350));
            ...
            case "rooms":
               ...
               break;
            case "badges":
               this._widget.messageListener.processWidgetMessage(new RoomWidgetOpenInventoryMessage(RoomWidgetOpenInventoryMessage.const_1371));
               this._widget.hide();
               break;
            case "clothes":
               ...
               break;
            case "hc":
               this._widget.messageListener.processWidgetMessage(new RoomWidgetOpenCatalogMessage(RoomWidgetOpenCatalogMessage.const_1293));
               this._widget.hide();
               break;
            case "settings":
               this._widget.changeView(MeMenuWidget.const_863);
               break;
            case "news":

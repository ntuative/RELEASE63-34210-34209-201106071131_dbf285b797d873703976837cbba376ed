package com.sulake.habbo.ui.widget.memenu
{
   ...
   public class EffectView
   {
      ...
      private const const_2297:int = 1000;
      ...
      {
         super();
         this.var_215 = new Timer(this.const_2297);
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         if(this.var_191.isActive)
         {
            _loc2_ = this.var_191.secondsLeft / Number(this.var_191.duration);
      ...
      private function setTimeLeft() : void
      {
         ...
         var _loc2_:int = this.var_191.secondsLeft;
      ...
      private function createWindow(param1:String) : void
      {
         ...
         var _loc7_:* = null;
         var _loc3_:String = "";
         if(this.var_191.isInUse)
         {
            _loc3_ = "memenu_effect_selected";
         }
         else if(this.var_191.isActive)
         {
         ...
         else
         {
            ...
            this.var_1013 = this._window.findChildByName("effect_hilite");
         ...
         if(this.var_191.icon)
         {
            this.setElementBitmap("effect_icon",this.var_191.icon);
         }
      }

package com.sulake.habbo.ui.widget.chatinput
{
   ...
   public class RoomChatInputWidget extends RoomWidgetBase
   {
      ...
      private static const const_1426:int = 5000;
      ...
      private var var_306:Timer = null;
      ...
      {
         return getTimer() - this.var_2359 > const_1426;
      }
      
      public function setLastPasteTime() : void
      {
         this.var_2359 = getTimer();
      }
      ...
      public function sendChat(param1:String, param2:int, param3:String = "") : void
      {
         ...
         var _loc4_:RoomWidgetChatMessage = new RoomWidgetChatMessage(RoomWidgetChatMessage.const_938,param1,param2,param3);
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetChatInputContentUpdateEvent.const_955,this.onChatInputUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetChatInputContentUpdateEvent.const_955,this.onChatInputUpdate);
      ...
      private function onChatInputUpdate(param1:RoomWidgetChatInputContentUpdateEvent) : void
      {
         ...
         switch(param1.messageType)
         {
            case RoomWidgetChatInputContentUpdateEvent.const_1285:
               ...
               break;
            case RoomWidgetChatInputContentUpdateEvent.const_1793:
         }
      }
      ...
      private function onReleaseTimerTick(param1:TimerEvent) : void
      {
         if(this._visualization != null)
         {
            this._visualization.updateBlockText(this.var_306.repeatCount - this.var_306.currentCount);
         }
      }
      ...
      public function onFloodControl(param1:RoomWidgetFloodControlEvent) : void
      {
         ...
         {
            this.var_306 = new Timer(1000,param1.seconds);
            this.var_306.addEventListener(TimerEvent.TIMER,this.onReleaseTimerTick);
            this.var_306.addEventListener(TimerEvent.TIMER_COMPLETE,this.onReleaseTimerComplete);
         }
         this.var_306.start();
         if(this._visualization != null)
         {

package com.sulake.habbo.ui.widget.furniture.welcomegift
{
   ...
   public class WelcomeGiftWidget extends RoomWidgetBase
   {
      ...
      private const const_1065:String = "welcome_gift_email_verified";
      
      private const const_1553:String = "welcome_gift_email_change";
      ...
      private function createMainView() : void
      {
         ...
         if(this.var_1267)
         {
            this.setViewState(this.const_1065);
         }
         else
         {
      ...
      {
         this.setViewState(this.const_1553);
      }
      ...
      {
         this.setViewState(!!this.var_1267 ? this.const_1065 : this.const_680);
      }
      ...
      private function saveEmail(param1:WindowMouseEvent) : void
      {
         ...
         this.var_1544 = _loc2_.text;
         messageListener.processWidgetMessage(new RoomWidgetChangeEmailMessage(this.var_1544));
      }
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetWelcomeGiftUpdateEvent.const_540,this.updateEventHandler);
         param1.addEventListener(RoomWidgetChangeEmailResultEvent.const_765,this.emailChangeHandler);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetWelcomeGiftUpdateEvent.const_540,this.updateEventHandler);
         param1.removeEventListener(RoomWidgetChangeEmailResultEvent.const_765,this.emailChangeHandler);
      }
      ...
      private function updateEventHandler(param1:RoomWidgetWelcomeGiftUpdateEvent) : void
      {
         switch(param1.type)
         {
            case RoomWidgetWelcomeGiftUpdateEvent.const_540:
               this.var_1545 = param1.email;
               this.var_1267 = param1.isVerified;
      ...
      private function emailChangeHandler(param1:RoomWidgetChangeEmailResultEvent) : void
      {
         if(param1.result == 0)
         {
            this.var_1545 = this.var_1544;
            this.setViewState(this.const_680);
         }
         else
         {
            if(param1.result == this.const_2296)
            {
               this.var_1009 = false;
            }
      ...
      private function showEmailChangeError(param1:int) : void
      {
         ...
         this.setCaption("email_input",this.var_1544);

package com.sulake.habbo.ui.widget.furniture.stickie
{
   ...
   public class StickieFurniWidget extends RoomWidgetBase
   {
      ...
      private static const const_1437:int = 14;
      
      private static const const_1440:int = 500;
      
      private static const const_1439:Number = 100;
      
      private static const const_1438:Number = 100;
       
      
      private var _window:IWindowContainer;
      
      protected var var_226:int = -1;
      ...
      protected var var_2193:String = "stickieui_container";
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetStickieDataUpdateEvent.const_945,this.onObjectUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetStickieDataUpdateEvent.const_945,this.onObjectUpdate);
      }
      ...
      protected function onObjectUpdate(param1:RoomWidgetStickieDataUpdateEvent) : void
      {
         ...
         this.var_1388 = param1.objectType;
      ...
      protected function showInterface() : void
      {
         ...
         {
            this._window = windowManager.createWindow(this.var_2193,"",HabboWindowType.const_87,HabboWindowStyle.const_32,0 | 0,new Rectangle(const_1439,const_1438,2,2),null,0) as IWindowContainer;
         ...
         if(_loc3_ != null)
         {
            ...
            _loc3_.addEventListener(WindowEvent.const_117,this.onTextWindowEvent);
         }
         _loc6_ = this._window.findChildByTag("bg") as IBitmapWrapperWindow;
         if(_loc6_ != null)
         {
            if(this.var_1388 == "post_it_vd")
            {
         ...
         this.setColorButtons(this.var_27 && this.var_1388 == "post_it");
      }
      ...
      protected function sendUpdate() : void
      {
         ...
         {
            _loc1_ = new RoomWidgetStickieSendUpdateMessage(RoomWidgetStickieSendUpdateMessage.const_521,this.var_226,this._text,this.var_343);
      ...
      protected function sendSetColor(param1:uint) : void
      {
         ...
         if(messageListener != null)
         {
            _loc3_ = new RoomWidgetStickieSendUpdateMessage(RoomWidgetStickieSendUpdateMessage.const_521,this.var_226,this._text,this.var_343);
      ...
      protected function sendDelete() : void
      {
         ...
         {
            _loc1_ = new RoomWidgetStickieSendUpdateMessage(RoomWidgetStickieSendUpdateMessage.const_742,this.var_226);
            messageListener.processWidgetMessage(_loc1_);
         }
      }
      ...
      private function onTextWindowEvent(param1:WindowEvent) : void
      {
         ...
         _loc2_.maxChars = const_1440;
         if(_loc2_.numLines < const_1437)
         {
            return;
         }

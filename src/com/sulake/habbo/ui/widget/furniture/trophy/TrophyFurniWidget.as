package com.sulake.habbo.ui.widget.furniture.trophy
{
   ...
   public class TrophyFurniWidget extends RoomWidgetBase
   {
      ...
      private static const const_1574:Array = new Array("trophy_bg_gold","trophy_bg_silver","trophy_bg_bronze");
      
      private static const const_1575:Array = new Array(4293707079,4291411404,4290279476);
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetTrophyDataUpdateEvent.const_1000,this.onObjectUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetTrophyDataUpdateEvent.const_1000,this.onObjectUpdate);
      }
      ...
      private function showInterface() : void
      {
         ...
         if(_loc4_ != null)
         {
            _loc4_.color = const_1575[this._color];
         }
         ...
         _loc8_ = assets.getAssetByName(const_1574[this._color]) as BitmapDataAsset;

package com.sulake.habbo.ui.widget.furniture.dimmer
{
   ...
   public class DimmerFurniWidget extends RoomWidgetBase
   {
      ...
      private static const const_1427:Array = new Array(7665141,21495,15161822,15353138,15923281,8581961,0);
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetDimmerUpdateEvent.const_931,this.onHide);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetDimmerUpdateEvent.const_931,this.onHide);
      ...
      private function onPresets(param1:RoomWidgetDimmerUpdateEvent) : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         this.var_1175 = param1.selectedPresetId - 1;
      ...
      private function onDimmerState(param1:RoomWidgetDimmerStateUpdateEvent) : void
      {
         ...
         this.var_2266 = param1.presetId;
         this.var_1176 = param1.effectId;
         this._color = param1.color;
         this.var_1174 = param1.brightness;
         if(this._view != null)
         {
            this._view.update();
         }
         if(!this.validateBrightness(this.var_1174,this.var_1176))
         {
            return;
         }
         _loc2_ = new RoomWidgetDimmerPreviewMessage(this._color,this.var_1174,this.var_1176 == 2);
      ...
      public function storeCurrentSetting(param1:Boolean) : void
      {
         ...
         var _loc2_:int = this.var_1175 + 1;
         ...
         var _loc6_:DimmerFurniWidgetPresetItem = this._presets[this.var_1175] as DimmerFurniWidgetPresetItem;
      ...
      public function removePreview() : void
      {
         ...
         _loc1_ = new RoomWidgetDimmerPreviewMessage(this._color,this.var_1174,this.var_1176 == 2);
         messageListener.processWidgetMessage(_loc1_);
      }

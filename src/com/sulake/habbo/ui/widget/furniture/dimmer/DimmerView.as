package com.sulake.habbo.ui.widget.furniture.dimmer
{
   ...
   public class DimmerView
   {
      ...
      private var var_675:DimmerViewColorGrid;
      
      private var var_464:DimmerViewAlphaSlider;
      ...
      private function createWindow() : void
      {
         ...
         this._window = this._widget.windowManager.createWindow("dimmerui_container","",HabboWindowType.const_87,HabboWindowStyle.const_32,0 | 0,new Rectangle(const_1439,const_1438,2,2),null,0) as IWindowContainer;
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc5_ != null)
            {
               this.var_675 = new DimmerViewColorGrid(this,_loc5_ as IItemGridWindow,this._widget.windowManager,this._widget.assets);
            }
         }
         _loc1_ = this._window.findChildByName("brightness_container");
         if(_loc1_ != null)
         {
            this.var_464 = new DimmerViewAlphaSlider(this,_loc1_ as IWindowContainer,this._widget.assets);
         }
      ...
      private function selectPreset(param1:int) : void
      {
         ...
         this.var_1561 = _loc2_.light;
         if(this.var_464 != null)
         {
            this.var_464.setValue(this.var_1561);
         }
         this.var_521 = this.colors.indexOf(_loc2_.color);
         if(this.var_675 != null)
         {
            this.var_675.setSelectedColorIndex(this.var_521);
         }
      ...
      private function get windowXML() : XML
      {
         ...
         this.var_1560 = XML(_loc1_.content);
         return this.var_1560;
      }
      ...
      public function set selectedType(param1:int) : void
      {
         ...
         if(this.var_464 != null)
         {
            this.var_464.min = this._widget.minLights[param1 - 1];
         }
      }
      ...
      public function set selectedColorIndex(param1:int) : void
      {
         ...
         if(this.var_675 != null)
         {
            this.var_675.setSelectedColorIndex(param1);
         }
         this._widget.previewCurrentSetting();
      }

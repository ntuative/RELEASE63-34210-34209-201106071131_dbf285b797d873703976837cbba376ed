package com.sulake.habbo.ui.widget.furniture.dimmer
{
   ...
   public class DimmerViewColorGrid
   {
      ...
      private function populateColourGrid(param1:IHabboWindowManager) : void
      {
         ...
         {
            _loc3_ = param1.buildFromXML(this.var_1799) as IWindowContainer;
            ...
            if(_loc5_ != null)
            {
               _loc5_.bitmap = new BitmapData(this.var_1190.width,this.var_1190.height,true,0);
            ...
            if(_loc6_ != null)
            {
               _loc6_.bitmap = new BitmapData(this.var_951.width,this.var_951.height,true,16777215);
               _loc6_.bitmap.copyPixels(this.var_951,this.var_951.rect,new Point(0,0),null,null,true);
      ...
      private function storeAssets(param1:IAssetLibrary) : void
      {
         ...
         this.var_1799 = XML(_loc2_.content);
         ...
         this.var_1190 = BitmapData(_loc3_.content);
         _loc3_ = BitmapDataAsset(param1.getAssetByName("dimmer_color_selected"));
         this.var_951 = BitmapData(_loc3_.content);
      }

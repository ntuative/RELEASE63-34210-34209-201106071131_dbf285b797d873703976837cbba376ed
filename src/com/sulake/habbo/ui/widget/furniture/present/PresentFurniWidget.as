package com.sulake.habbo.ui.widget.furniture.present
{
   ...
   public class PresentFurniWidget extends RoomWidgetBase
   {
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetPresentDataUpdateEvent.const_482,this.onObjectUpdate);
         param1.addEventListener(RoomWidgetPresentDataUpdateEvent.const_649,this.onObjectUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetPresentDataUpdateEvent.const_482,this.onObjectUpdate);
         param1.removeEventListener(RoomWidgetPresentDataUpdateEvent.const_649,this.onObjectUpdate);
      ...
      private function onObjectUpdate(param1:RoomWidgetPresentDataUpdateEvent) : void
      {
         switch(param1.type)
         {
            case RoomWidgetPresentDataUpdateEvent.const_76:
               ...
               break;
            case RoomWidgetPresentDataUpdateEvent.const_649:
               if(!this.var_359)
               {
                  return;
               }
      ...
      {
         var _loc1_:* = null;
         if(this.var_359 || this.var_226 == -1 || !this.var_27)
         {
            return;
         }
         this.var_359 = true;
         ...
         {
            _loc1_ = new RoomWidgetPresentOpenMessage(RoomWidgetPresentOpenMessage.const_195,this.var_226);

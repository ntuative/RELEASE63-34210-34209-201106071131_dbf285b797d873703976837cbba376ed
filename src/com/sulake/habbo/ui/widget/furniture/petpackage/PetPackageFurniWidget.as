package com.sulake.habbo.ui.widget.furniture.petpackage
{
   ...
   public class PetPackageFurniWidget extends RoomWidgetBase
   {
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetPetPackageUpdateEvent.const_599,this.onObjectUpdate);
         param1.addEventListener(RoomWidgetPetPackageUpdateEvent.const_519,this.onObjectUpdate);
         param1.addEventListener(RoomWidgetPetPackageUpdateEvent.const_404,this.onObjectUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetPetPackageUpdateEvent.const_599,this.onObjectUpdate);
         param1.removeEventListener(RoomWidgetPetPackageUpdateEvent.const_519,this.onObjectUpdate);
         param1.removeEventListener(RoomWidgetPetPackageUpdateEvent.const_404,this.onObjectUpdate);
      ...
      private function onObjectUpdate(param1:RoomWidgetPetPackageUpdateEvent) : void
      {
         ...
         switch(event.type)
         {
            case RoomWidgetPetPackageUpdateEvent.const_599:
               this.hideInterface();
               this.var_226 = event.objectId;
               this.var_716 = event.image;
               this.showInterface();
               this.showPetImage();
               break;
            case RoomWidgetPetPackageUpdateEvent.const_519:
               if(!this.var_1374)
               {
                  return;
               }
               ...
               break;
            case RoomWidgetPetPackageUpdateEvent.const_404:
               if(event.objectId != this.var_226)
               {
                  return;
               }
               this.var_716 = event.image;
      ...
      {
         var _loc2_:* = null;
         if(this.var_716 == null || this._window == null)
         {
            return;
         }
         ...
         if(_loc1_ != null)
         {
            ...
            _loc2_ = new Point((_loc1_.width - this.var_716.width) / 2,(_loc1_.height - this.var_716.height) / 2);
            _loc1_.bitmap.copyPixels(this.var_716,this.var_716.rect,_loc2_);
         }
      }
      ...
      private function sendOpenPetPackage() : void
      {
         ...
         if(this.var_1374 || this.var_226 == -1)
         {
            return;
         }
         ...
         {
            this.var_1374 = true;
            message = new RoomWidgetOpenPetPackageMessage(RoomWidgetOpenPetPackageMessage.const_965,this.var_226,name);

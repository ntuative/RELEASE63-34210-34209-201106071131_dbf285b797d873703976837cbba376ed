package com.sulake.habbo.ui.widget.furniture.placeholder
{
   ...
   public class PlaceholderWidget extends RoomWidgetBase
   {
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetShowPlaceholderEvent.const_866,this.onShowEvent);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetShowPlaceholderEvent.const_866,this.onShowEvent);
      }

package com.sulake.habbo.ui.widget.furniture.placeholder
{
   ...
   public class PlaceholderView
   {
      ...
      private function createWindow() : void
      {
         ...
         this._window = this._windowManager.createWindow("habbohelp_window","",HabboWindowType.const_87,HabboWindowStyle.const_48,0 | 0,new Rectangle(-300,300,10,10),null) as IWindowContainer;

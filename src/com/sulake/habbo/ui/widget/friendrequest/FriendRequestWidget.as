package com.sulake.habbo.ui.widget.friendrequest
{
   ...
   public class FriendRequestWidget extends RoomWidgetBase implements IUpdateReceiver
   {
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetFriendRequestUpdateEvent.const_651,this.eventHandler);
         param1.addEventListener(RoomWidgetFriendRequestUpdateEvent.const_568,this.eventHandler);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetFriendRequestUpdateEvent.const_651,this.eventHandler);
         param1.removeEventListener(RoomWidgetFriendRequestUpdateEvent.const_568,this.eventHandler);
      }
      ...
      public function acceptRequest(param1:int) : void
      {
         ...
         messageListener.processWidgetMessage(new RoomWidgetFriendRequestMessage(RoomWidgetFriendRequestMessage.const_898,param1));

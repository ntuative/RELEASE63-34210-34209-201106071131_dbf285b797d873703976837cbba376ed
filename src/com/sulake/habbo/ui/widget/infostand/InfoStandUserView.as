package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class InfoStandUserView
   {
      ...
      private const const_1053:int = 5;
      
      private const const_2290:int = 3;
      
      private const const_1524:int = 11184810;
      
      private const const_1523:int = 16777215;
      
      private const const_2289:int = 2000;
      
      private const const_2288:int = 50;
      
      private const const_2287:int = 23;
      ...
      public function InfoStandUserView(param1:InfostandWidget, param2:String)
      {
         ...
         this.var_2605 = !this._widget.config.getBoolean("menu.avatar.enabled",false);
      }
      ...
      public function set realName(param1:String) : void
      {
         ...
         _loc2_.height = _loc2_.textHeight + this.const_1053;
      ...
      public function setMotto(param1:String, param2:Boolean) : void
      {
         ...
         _loc5_.text = param1;
         _loc5_.height = Math.min(_loc5_.textHeight + this.const_1053,this.const_2288);
         _loc5_.height = Math.max(_loc5_.height,this.const_2287);
         _loc3_.height = _loc5_.height + this.const_2290;
         if(param2)
         {
            _loc5_.addEventListener(WindowKeyboardEvent.const_360,this.onMottoKeyboard);
            _loc5_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onMottoClicked);
         }
         else
         {
            _loc5_.removeEventListener(WindowKeyboardEvent.const_360,this.onMottoClicked);
         }
         this.updateWindow();
      }
      ...
      protected function setTradeButtonTooltip(param1:int) : void
      {
         ...
         switch(param1)
         {
            case RoomWidgetUserInfoUpdateEvent.const_713:
               _loc2_ = "${infostand.button.trade.tooltip.shutdown}";
               break;
            case RoomWidgetUserInfoUpdateEvent.const_944:
      ...
      protected function onMottoKeyboard(param1:WindowKeyboardEvent) : void
      {
         ...
         {
            _loc6_ = getTimer();
            if(_loc6_ - this.var_2604 > this.const_2289 && _loc4_ != this._widget.localizations.getKey("infostand.motto.change"))
            {

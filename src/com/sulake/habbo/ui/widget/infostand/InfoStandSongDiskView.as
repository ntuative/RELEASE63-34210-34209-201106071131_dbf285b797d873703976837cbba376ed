package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class InfoStandSongDiskView extends InfoStandFurniView
   {
      ...
      {
         super.update(param1);
         this.var_1903 = this.getSongIdFromExtraParam(param1.extraParam);
      }
      
      public function updateSongInfo(param1:RoomWidgetSongUpdateEvent) : void
      {
         if(param1.type == RoomWidgetSongUpdateEvent.const_410 && param1.songId == this.var_1903)
         {
      ...
      override protected function createWindow(param1:String) : void
      {
         ...
         if(var_49 != null)
         {
            var_54 = var_49.findChildByName("infostand_element_list") as IItemListWindow;
         }
         _window.name = param1;
         ...
         var_254 = var_49.findChildByTag("catalog");
         if(var_254 != null)
         {
            var_254.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onCatalogButtonClicked);
         }
      ...
      private function getSongIdFromExtraParam(param1:String) : int
      {
         ...
         if(param1 != null)
         {
            _loc2_ = param1.substr(RoomWidgetInfostandExtraParamEnum.const_401.length,param1.length);

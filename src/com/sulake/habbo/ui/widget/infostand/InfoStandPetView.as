package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private static const const_1411:int = 152;
      
      private static const const_1419:int = 16;
      
      private static const const_662:int = 4;
      
      private static const const_1415:uint = 14342874;
      
      private static const const_1418:uint = 3815994;
      
      private static const const_1422:uint = 2085362;
      
      private static const const_1423:uint = 39616;
      
      private static const const_1416:uint = 10513106;
      
      private static const const_1410:uint = 8734654;
      
      private static const const_1414:uint = 9094430;
      
      private static const const_1421:uint = 6200576;
      
      private static const const_1417:String = "happiness";
      
      private static const const_1413:String = "experience";
      
      private static const const_1412:String = "energy";
      
      private static const const_1420:int = 250;
      
      private static const const_1029:int = 25;
      
      private static const const_1030:int = 5;
      ...
      private var var_207:PetCommandTool;
      ...
      {
         if(this.var_54 == null || this.var_49 == null || this.var_107 == null)
         {
            return;
         }
         ...
         this.var_49.height = this.var_54.height + 20;
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         this.updateStateElement(const_1417,param1.nutrition,param1.nutritionMax,const_1423,const_1422);
         this.updateStateElement(const_1413,param1.experience,param1.experienceMax,const_1410,const_1416);
         this.updateStateElement(const_1412,param1.energy,param1.energyMax,const_1421,const_1414);
         ...
         this.updateWindow();
         this.var_532 = param1.id;
         this._petData.remove(param1.id);
         this._petData.add(param1.id,param1);
         if(this.var_207 && this.var_207.isVisible() && param1.isOwnPet)
         {
            this.var_207.showCommandToolForPet(param1.id,param1.name,param1.image);
         }
      }
      ...
      public function updateEnabledTrainingCommands(param1:int, param2:CommandConfiguration) : void
      {
         ...
         this.var_207.setEnabledCommands(param1,param2);
      }
      ...
      private function createPercentageBar(param1:int, param2:int, param3:uint, param4:uint) : BitmapData
      {
         ...
         var _loc7_:BitmapData = new BitmapData(const_1411,const_1419,false);
         _loc7_.fillRect(new Rectangle(0,0,_loc7_.width,_loc7_.height),const_1415);
         var _loc8_:Rectangle = new Rectangle(1,1,_loc7_.width - 2,_loc7_.height - 2);
         _loc7_.fillRect(_loc8_,const_1418);
      ...
      private function openTrainView() : void
      {
         if(this.var_207 == null)
         {
            this.var_207 = new PetCommandTool(this._widget);
         }
         var _loc1_:InfoStandPetData = this._petData.getValue(this.var_532) as InfoStandPetData;
         if(_loc1_ != null)
         {
            this.var_207.showWindow(true);
            this.var_207.showCommandToolForPet(_loc1_.id,_loc1_.name,_loc1_.image);
         }
      }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         if(this.var_49 != null)
         {
            this.var_54 = this.var_49.findChildByName("infostand_element_list") as IItemListWindow;
         }
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            case "btn_pick":
               _loc3_ = "null";
               if(this.var_207 && this.var_207.getPetId() == this.var_532)
               {
                  this.var_207.showWindow(false);
               }
               break;
            case "btn_train":
               this.openTrainView();
            ...
            case "btn_buy_food":
               if(this._catalog)
               {
                  this._catalog.openCatalogPage(CatalogPageName.const_1896,true);
            ...
            case "btn_petrespect":
               ...
               break;
            case "btn_kick":
               _loc2_ = new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_388,this._widget.petData.ownerId);
      ...
      private function arrangeButtons() : void
      {
         ...
         for each(_loc5_ in _loc2_)
         {
            if(_loc5_.visible)
            {
               ...
               {
                  _loc3_ = _loc1_;
                  _loc4_ += const_1029 + const_1030;
               }
               _loc5_.x = _loc3_ - _loc5_.width;
               _loc5_.y = _loc4_;
               _loc3_ = _loc5_.x - const_1030;
            }
         }
         this.var_107.height = _loc4_ + const_1029;
         this.updateWindow();
      }
   }
}

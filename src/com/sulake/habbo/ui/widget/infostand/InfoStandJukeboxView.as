package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class InfoStandJukeboxView extends InfoStandFurniView
   {
      ...
      {
         if(param1.type == RoomWidgetSongUpdateEvent.const_448)
         {
            this.var_1903 = param1.songId;
         }
         if(param1.songId == this.var_1903)
         {
            this._songName = param1.songName;
            this.var_2380 = param1.songAuthor;
            this.updateNowPlaying(this.var_1903 >= 0);
         }
      }
      ...
      private function updateNowPlaying(param1:Boolean) : void
      {
         ...
         if(param1)
         {
            ...
            this.nowPlayingAuthorName = this.var_2380;
         }
         else
         {

package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class InfoStandFurniView
   {
      ...
      protected function createWindow(param1:String) : void
      {
         ...
         this.var_254 = this.var_49.findChildByTag("catalog");
         if(this.var_254 != null)
         {
            this.var_254.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onCatalogButtonClicked);
         }
      }
      ...
      {
         if(this.var_54 == null || this.var_49 == null || this._buttons == null)
         {
            return;
         }
      ...
      public function update(param1:RoomWidgetFurniInfoUpdateEvent) : void
      {
         ...
         if(param1.extraParam == RoomWidgetInfostandExtraParamEnum.const_1290 || param1.extraParam == RoomWidgetInfostandExtraParamEnum.const_556 && param1.isRoomOwner)
         {
      ...
      private function getAdFurnitureExtraParams() : Map
      {
         ...
         {
            _loc2_ = this._widget.furniData.extraParam.substr(RoomWidgetInfostandExtraParamEnum.const_1146.length);
            _loc3_ = _loc2_.split("\t");
            if(_loc3_ != null)
            {
      ...
      private function showCatalogButton(param1:Boolean) : void
      {
         if(param1)
         {
            ...
            {
               this.var_54.addListItem(this.var_254);
            }
            this.var_254.visible = param1;
         }
         else
         {
            this.var_54.removeListItem(this.var_254);
         }
      }
   }
}

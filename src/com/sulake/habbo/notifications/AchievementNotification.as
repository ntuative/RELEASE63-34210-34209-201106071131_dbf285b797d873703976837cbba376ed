package com.sulake.habbo.notifications
{
   ...
   public class AchievementNotification
   {
      ...
      private const const_2007:String = "badge_bg_001_png";
      
      private const const_2279:String = "achievement_bg_001_png";
      ...
      public function AchievementNotification(param1:String, param2:int, param3:int, param4:int, param5:int, param6:int, param7:int, param8:IAssetLibrary, param9:IHabboWindowManager, param10:IHabboLocalizationManager, param11:IHabboConfigurationManager, param12:IHabboCommunicationManager, param13:ISessionDataManager)
      {
         ...
         this._window.center();
         this.var_2414 = this.var_69.getBadgeName(this.var_310);
         this.var_2419 = this.var_69.getBadgeDesc(this.var_310);
         this.var_2417 = this.var_69.getAchievementNameForFacebook(this.var_310,this.var_366.userName,this.var_366.realName,this.var_1334);
         this.var_2415 = this.var_69.getAchievementDescForFacebook(this.var_310,this.var_366.userName,this.var_366.realName,this.var_1334);
         ...
         this.var_69.registerParameter("notifications.text.achievement.achievement_points","achievement_points",this.var_2071.toString());
         this.var_69.registerParameter("notifications.achievement.bonus.value","bonus_points",this.var_1458.toString());
         this.var_69.registerParameter("notifications.achievement.no_facebook","bonus_points",this.var_1458.toString());
         var _loc15_:IWindow = this._window.findChildByName("level_reward_points");
         var _loc16_:String = "notifications.text.achievement.reward." + this.var_1788;
         var _loc17_:String = this.var_1788 == 0 ? "pixels" : "activitypoints";
         this.var_69.registerParameter(_loc16_,_loc17_,"" + this.var_2418);
         _loc15_.caption = this.var_69.getKey(_loc16_);
         this._window.findChildByName("achievement_info").caption = this._desc;
         this.setBadge(param13.getBadgeImage(param1),this.const_2007);
         var _loc18_:BitmapData = (param8.getAssetByName(this.const_2279) as BitmapDataAsset).content as BitmapData;
         ...
         if(this.var_1458 <= 0 || !_loc21_)
         {
            _loc22_.removeListItem(_loc23_);
            _loc22_.removeListItem(_loc25_);
            _loc26_.send(new EventLogMessageComposer("Achievements",this.var_310,"client.show.no_post"));
         }
         else
         {
            ...
            {
               _loc22_.removeListItem(_loc25_);
               _loc26_.send(new EventLogMessageComposer("Achievements",this.var_310,"client.show.post"));
            }
            else
            {
               _loc22_.removeListItem(_loc23_);
               _loc26_.send(new EventLogMessageComposer("Achievements",this.var_310,"client.show.no_fb"));
            }
         }
         var _loc27_:int = 32;
      ...
      {
         this.var_69.registerParameter(param1,"badge_name",this.var_2414);
         this.var_69.registerParameter(param1,"badge_desc",this.var_2419);
         this.var_69.registerParameter(param1,"badge_name_fb",this.var_2417);
         this.var_69.registerParameter(param1,"badge_desc_fb",this.var_2415);
         this.var_69.registerParameter(param1,"level",this.var_1334.toString());
         this.var_69.registerParameter(param1,"name",this.var_366.userName);
         return this.var_69.registerParameter(param1,"realname",this.var_366.realName);
      }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_366.events.removeEventListener(BadgeImageReadyEvent.const_119,this.onBadgeImageReady);
            this.var_366 = null;
         }
         if(this._window != null)
         {
      ...
      private function onBadgeImageReady(param1:BadgeImageReadyEvent) : void
      {
         ...
         this.setBadge(param1.badgeImage,this.const_2007);
      }
      
      public function requestPostDialog(param1:String) : void
      {
         HabboWebTools.facebookAchievementPost(this.var_310,this._feedTitleFb,this.var_2416,param1);
      }
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "post_to_facebook":
               ...
               _loc3_.send(new EventLogMessageComposer("Achievements",this.var_310,"client.start_post"));
               this._window.visible = false;
               break;
            case "close":
               _loc3_.send(new EventLogMessageComposer("Achievements",this.var_310,"client.skip_post"));
               this.dispose();
               return;
         }
      }

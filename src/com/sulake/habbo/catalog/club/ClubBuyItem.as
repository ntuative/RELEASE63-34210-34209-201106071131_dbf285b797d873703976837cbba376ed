package com.sulake.habbo.catalog.club
{
   ...
   public class ClubBuyItem
   {
      ...
      public function ClubBuyItem(param1:ClubBuyOfferData, param2:ICatalogPage)
      {
         ...
         this._window = this.var_405.viewer.catalog.windowManager.buildFromXML(_loc3_) as IWindowContainer;
      ...
      {
         var _loc2_:ClubBuyController = (this.var_405.viewer.catalog as HabboCatalog).getClubBuyController();
         (this.var_405.viewer.catalog as HabboCatalog).showPurchaseConfirmation(this.var_101,this.var_405.pageId);
      }
      
      private function getAssetXML(param1:String) : XML
      {
         if(!this.var_405 || !this.var_405.viewer || !this.var_405.viewer.catalog || !this.var_405.viewer.catalog.assets)
         {
            return null;
         }
         var _loc2_:XmlAsset = this.var_405.viewer.catalog.assets.getAssetByName(param1) as XmlAsset;
         if(_loc2_ == null)
         {
            return null;
         }

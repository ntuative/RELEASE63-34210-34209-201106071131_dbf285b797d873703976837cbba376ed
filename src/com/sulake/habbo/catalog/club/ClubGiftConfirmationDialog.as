package com.sulake.habbo.catalog.club
{
   ...
   public class ClubGiftConfirmationDialog
   {
      ...
      public function showConfirmation() : void
      {
         ...
         if(!this.var_101.productContainer)
         {
            return;
         }
         this.var_101.productContainer.view = _loc2_;
         this.var_101.productContainer.initProductIcon(this.var_27.roomEngine);
      }
      ...
      private function windowEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            case "select_button":
               this.var_27.confirmSelection(this.var_101.localizationId);
               break;

package com.sulake.habbo.catalog.club
{
   ...
   public class ClubBuyConfirmationDialog
   {
      ...
      private var var_101:ClubBuyOfferData;
      ...
      public function showConfirmation() : void
      {
         ...
         _loc6_ += !!this.var_101.vip ? "vip" : "hc";
         _loc6_ += !!this.var_101.upgrade ? ".period" : "";
         ...
         var _loc11_:String = !!this.var_101.vip ? "vip" : "hc";
         var _loc12_:String = _loc2_.getLocalization("catalog.club." + _loc11_).value;
         var _loc13_:int = this.var_101.periods == 0 ? 1 : int(this.var_101.periods);
         _loc2_.registerParameter("catalog.club.buy.confirm.price","price",String(this.var_101.price));
         ...
         _loc2_.registerParameter("catalog.club.buy.confirm.amount","day",String(this.var_101.day));
         _loc2_.registerParameter("catalog.club.buy.confirm.amount","month",String(this.var_101.month));
         _loc2_.registerParameter("catalog.club.buy.confirm.amount","year",String(this.var_101.year));
         _loc2_.registerParameter("catalog.club.buy.confirm.before","days",String(_loc10_));
         _loc2_.registerParameter("catalog.club.buy.confirm.after","days",String(this.var_101.daysLeftAfterPurchase));
         if(this.var_101.upgrade)
         {
      ...
      {
         var _loc1_:* = null;
         if(this.var_101 && this.var_101.productContainer && this.var_101.productContainer.firstProduct)
         {
            _loc1_ = this.var_101.productContainer.firstProduct.productData;
            if(_loc1_)
            {
               return _loc1_.name;
            }
      ...
      {
         if(!param1 || !param2 || !this.var_27 || !this.var_101)
         {
            return;
         }
         ...
         {
            case "select_button":
               this.var_27.confirmSelection(this.var_101,this.var_1482);
               break;

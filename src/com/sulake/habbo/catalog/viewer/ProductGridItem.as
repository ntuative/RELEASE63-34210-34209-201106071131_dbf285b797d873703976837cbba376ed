package com.sulake.habbo.catalog.viewer
{
   ...
   public class ProductGridItem implements IGridItem
   {
      ...
      private static const const_1032:String = "bg";
       
      
      protected var _view:IWindowContainer;
      
      private var var_220:IItemGrid;
      ...
      {
         this._view.getChildByName(const_1032).style = HabboWindowStyle.const_32;
      }
      
      public function deActivate() : void
      {
         this._view.getChildByName(const_1032).style = 3;
      }
      ...
      public function setDraggable(param1:Boolean) : void
      {
         ...
         {
            (this._view as IInteractiveWindow).setMouseCursorForState(WindowState.const_91,MouseCursorType.const_849);
            (this._view as IInteractiveWindow).setMouseCursorForState(0 | 0,MouseCursorType.const_849);
         }
      }
      ...
      private function eventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.const_45)
         {
            ...
            this.var_220.select(this);
            this.var_548 = param2;
         }
         else if(param1.type == WindowMouseEvent.const_25 && this.var_548 != null && this.var_548 == param2)
         {
            _loc3_ = this.var_220.startDragAndDrop(this);
            if(_loc3_)
            {
               this.var_548 = null;
            }

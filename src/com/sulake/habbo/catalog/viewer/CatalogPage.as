package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogPage implements ICatalogPage
   {
      ...
      protected static const const_1980:String = "ctlg_";
      ...
      private var var_519:EventDispatcher;
      
      private var _catalog:HabboCatalog;
      
      private var var_1198:ItemGridCatalogWidget;
      ...
      public function CatalogPage(param1:ICatalogViewer, param2:int, param3:String, param4:IPageLocalization, param5:Array, param6:HabboCatalog)
      {
         ...
         this.var_519 = new EventDispatcher();
      ...
      {
         return this._localization.getLinks(this.var_1199);
      }
      
      public function get hasLinks() : Boolean
      {
         return this._localization.hasLinks(this.var_1199);
      }
      ...
      {
         var _loc2_:String = const_1980 + param1;
      ...
      private function createWidget(param1:IWindowContainer) : void
      {
         ...
         switch(param1.name)
         {
            case CatalogWidgetEnum.const_1695:
               if(this.var_1198 == null)
               {
                  this.var_1198 = new ItemGridCatalogWidget(param1,this._catalog.sessionDataManager);
                  this.var_39.push(this.var_1198);
               }
               break;
            ...
            case CatalogWidgetEnum.const_1796:
               ...
               break;
            case CatalogWidgetEnum.const_1959:
      ...
      private function initializeWidgets() : void
      {
         ...
         this.var_519.dispatchEvent(new CatalogWidgetsInitializedEvent());
      }
      ...
      public function dispatchWidgetEvent(param1:Event) : Boolean
      {
         if(this.var_519 != null)
         {
            return this.var_519.dispatchEvent(param1);
         }
         return false;
      }

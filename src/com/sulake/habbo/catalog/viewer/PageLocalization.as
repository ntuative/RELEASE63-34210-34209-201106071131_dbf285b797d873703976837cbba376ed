package com.sulake.habbo.catalog.viewer
{
   ...
   public class PageLocalization implements IPageLocalization
   {
      ...
      private static const const_1391:Array = ["ctlg_header_text","ctlg_description","ctlg_special_txt","ctlg_text_1","ctlg_text_2"];
      
      private static const const_1390:Array = ["ctlg_header_img","ctlg_teaserimg_1","ctlg_special_img","ctlg_teaserimg_2","ctlg_teaserimg_3"];
      ...
      private static const const_1020:Object = {"frontpage3":[7,8]};
      
      private static const const_1019:Object = {"frontpage3":[["ctlg_txt1","ctlg_txt2"],["ctlg_txt3"]]};
      ...
      public function getColorUintFromText(param1:int) : uint
      {
         ...
         if(param1 < this.var_734.length)
         {
            _loc2_ = String(this.var_734[param1]).replace("#","0x");

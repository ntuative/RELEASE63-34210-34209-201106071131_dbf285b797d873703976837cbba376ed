package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogViewer implements ICatalogViewer
   {
      ...
      private var var_2112:HabboCatalog;
      ...
      public function showCatalogPage(param1:int, param2:String, param3:IPageLocalization, param4:Array, param5:int) : void
      {
         ...
         {
            if(this.var_405.pageId == param1)
            {
               if(param5 > -1)
               {
                  this.var_405.selectOffer(param5);
               }
               return;
            }
            this._container.removeChild(this.var_405.window);
            this.var_405.dispose();
         }
         var _loc6_:ICatalogPage = new CatalogPage(this,param1,param2,param3,param4,this.var_2112);
         this.var_405 = _loc6_;
      ...
      {
         return this.var_405.dispatchWidgetEvent(param1);
      }
      ...
      public function getCurrentLayoutCode() : String
      {
         ...
         return this.var_405.layoutCode;
      }
   }
}

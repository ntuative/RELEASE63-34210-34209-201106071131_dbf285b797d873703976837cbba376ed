package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class TraxPreviewCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      public function TraxPreviewCatalogWidget(param1:IWindowContainer, param2:IHabboSoundManager)
      {
         ...
         Logger.log("Trax listener found button: " + this.var_463);
      ...
      private function onSelectProduct(param1:SelectProductEvent) : void
      {
         ...
         {
            this.var_1061 = parseInt(_loc3_.extraParam);
            _loc2_ = true;
         }
         if(this.var_463 != null)
         {
      ...
      private function onClickPlay(param1:WindowMouseEvent) : void
      {
         if(this._soundManager != null && this._soundManager.musicController != null)
         {
            ...
            this._soundManager.musicController.playSong(this.var_1061,HabboMusicPrioritiesEnum.const_201,15,40,0,2);
         }
      }

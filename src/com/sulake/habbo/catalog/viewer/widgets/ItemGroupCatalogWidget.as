package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ItemGroupCatalogWidget extends ItemGridCatalogWidget implements ICatalogWidget, IItemGrid, IDragAndDropDoneReceiver
   {
      ...
      {
         var _loc2_:Offer = this.var_221[this.var_550][this.var_688];
      ...
      override public function select(param1:IGridItem) : void
      {
         ...
         super.select(param1);
         this.var_550 = var_498.getGridItemIndex(param1.view);
         ...
         events.dispatchEvent(new CatalogWidgetColoursEvent(_loc4_,"ctlg_clr_40x32_1","ctlg_clr_40x32_2","ctlg_clr_40x32_3",this.var_688));
      }
      
      override public function startDragAndDrop(param1:IGridItem) : Boolean
      {
         var _loc2_:Array = this.var_221[this.var_550] as Array;
         var _loc3_:Offer = _loc2_[this.var_688] as Offer;
         if(_loc3_ != null)
         {
      ...
      override protected function populateItemGrid() : void
      {
         ...
         {
            if(this.var_688 < _loc1_.length)
            {
               _loc2_ = _loc1_[this.var_688] as Offer;
      ...
      private function updateGridWithSelectedColour() : void
      {
         ...
         var_498.destroyGridItems();
         this.populateItemGrid();
         var _loc1_:Array = this.var_221[this.var_550] as Array;
         var _loc2_:Offer = _loc1_[this.var_688] as Offer;
         var_228 = _loc2_.productContainer as ProductGridItem;
         var_228.activate();
      }
      ...
      private function createOfferGroups() : void
      {
         ...
         {
            if(_loc1_.pricingModel == Offer.const_408 || _loc1_.pricingModel == Offer.const_438)
            {

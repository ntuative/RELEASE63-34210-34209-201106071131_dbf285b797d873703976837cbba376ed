package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RecyclerCatalogWidget extends CatalogWidget implements ICatalogWidget, IRecyclerVisualization
   {
      ...
      private var var_285:CatalogObjectMover;
      ...
      private function onMainContainerEvent(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            case WindowMouseEvent.const_25:
               if(this.var_285 != null)
               {
                  this.var_285.resetIcon();
               }
               break;
            case WindowMouseEvent.const_178:
               if(this.var_285 != null)
               {
                  this.var_285.onMainContainerEvent(param1,param2,_loc4_);
               }
               break;
            case WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER:
               if(this.var_285 == null)
               {
                  this.var_285 = new CatalogObjectMover();
                  this.var_285.mainContainer = window;
                  this.var_285.roomEngine = _loc3_;
               }
         }
      }
      ...
      private function onSlotMouseEvent(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(event.type == WindowMouseEvent.const_178)
         {

package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RoomPreviewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener, IDragAndDropDoneReceiver
   {
      ...
      private var var_406:BitmapData = null;
      ...
      private function eventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.const_25 && this.var_548 != null && this.var_548 == param2)
         {
            if(this.var_101)
            {
               (page.viewer.catalog as HabboCatalog).requestSelectedItemToMover(this,this.var_101);
               this.var_548 = null;
            }
         }
      ...
      private function onUpdateRoomPreview(param1:CatalogWidgetUpdateRoomPreviewEvent) : void
      {
         ...
         {
            this.var_2116 = _loc3_.id;
            this.var_2115 = _loc4_.id;
      ...
      public function imageReady(param1:int, param2:BitmapData) : void
      {
         ...
         if(this.var_406 != null && this._imageStoreWindow != null)
         {
            this.setRoomImage(this.var_406,this._imageStoreWindow);
         }
      }
   }
}

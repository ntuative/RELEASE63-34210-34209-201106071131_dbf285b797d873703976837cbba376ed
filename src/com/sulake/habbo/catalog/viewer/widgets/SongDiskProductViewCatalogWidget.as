package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class SongDiskProductViewCatalogWidget extends ProductViewCatalogWidget
   {
      ...
      private var var_463:IButtonWindow;
      ...
      {
         super(param1);
         this.var_463 = _window.findChildByName("listen") as IButtonWindow;
         this.var_1332 = _window.findChildByName("ctlg_song_length") as ITextWindow;
         if(this.var_463 != null)
         {
            this.var_463.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onClickPlay);
            this.var_463.disable();
         }
         this.var_1333 = _window.findChildByName("playPreviewContainer") as IWindowContainer;
      ...
      override public function dispose() : void
      {
         if(this.var_463 != null)
         {
            this.var_463.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onClickPlay);
         }
      ...
      private function onClickPlay(param1:WindowMouseEvent) : void
      {
         if(this._soundManager != null && this._soundManager.musicController != null)
         {
            ...
            this._soundManager.musicController.playSong(this.var_1061,HabboMusicPrioritiesEnum.const_201,15,40,0.5,2);
         }
      }
      ...
      private function onSelectProduct(param1:SelectProductEvent) : void
      {
         ...
         {
            this.var_1061 = parseInt(_loc2_.extraParam);
            if(this.var_1333 != null)
            {
               this.var_1333.visible = true;
            }
         }
         else
         {
      ...
      private function updateView() : void
      {
         ...
         if(_loc2_ >= 0)
         {
            ...
            {
               this.var_1332.text = _loc8_;
            }
         }
         else if(this.var_1332 != null)
         {
            this.var_1332.text = "";
         }
         if(this.var_463 != null)
      ...
      private function getSongLength() : int
      {
         ...
         if(this._soundManager != null && this._soundManager.musicController != null)
         {
            _loc1_ = this._soundManager.musicController.getSongInfo(this.var_1061);
            if(_loc1_ != null)
            {
               return _loc1_.length / 1000;
            }
            this._soundManager.musicController.requestSongInfoWithoutSamples(this.var_1061);
         }
         return -1;
      }

package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class MarketPlaceCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener, IMarketPlaceVisualization
   {
      ...
      private const const_2271:int = 40;
      
      private const const_2272:int = 10;
      
      private var var_746:Array;
      
      private var var_1432:MarketPlaceOfferData;
      
      private var _itemList:IItemListWindow;
      
      private var var_609:IWindowContainer;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_505)
         {
            this.var_505.removeEventListener(TimerEvent.TIMER,this.onPopulationTimer);
            this.var_505 = null;
         }
      }
      ...
      private function selectSearchCategory(param1:String) : void
      {
         ...
         switch(param1)
         {
            ...
            case "search_by_activity":
               _loc5_ = "marketplace_search_simple";
               this.var_746 = [3,4,5,6];
               break;
            case "search_advanced":
               _loc5_ = "marketplace_search_advanced";
               this.var_746 = [1,2,3,4,5,6];
               break;
            default:
               return;
         }
         ...
         if(_loc7_ != null)
         {
            _loc7_.populate(this.getSortKeys(this.var_746));
            _loc7_.selection = 0;
         }
      }
      ...
      private function updateList() : void
      {
         ...
         if(!this.var_609)
         {
            ...
            this.var_609 = _loc5_.buildFromXML(_loc4_) as IWindowContainer;
         }
         if(!this.var_609)
         {
            return;
         ...
         this.updateStatusDisplay(this.const_2002,_loc3_.length,_loc2_);
         if(!this.var_505)
         {
            this.var_505 = new Timer(25);
            this.var_505.addEventListener(TimerEvent.TIMER,this.onPopulationTimer);
         }
         this.var_1153 = 0;
         this.populateList();
         this.var_505.start();
      ...
      private function populateList() : Boolean
      {
         ...
         while(_loc1_ < 5)
         {
            if(this.var_1153 >= this._offers.length)
            {
               return true;
            }
            this.addListItem(this._offers.getWithIndex(this.var_1153));
            ++this.var_1153;
            _loc1_++;
         }
         return false;
      ...
      private function addListItem(param1:MarketPlaceOfferData) : void
      {
         ...
         var _loc10_:* = null;
         var _loc11_:* = null;
         if(!param1 || !this._itemList || !this.var_609 || !this.marketPlace.localization)
         {
            return;
         }
         var _loc2_:IWindowContainer = this.var_609.clone() as IWindowContainer;
      ...
      {
         var _loc5_:* = null;
         this.updateStatusDisplay(this.const_2003);
         var _loc1_:int = -1;
         var _loc2_:int = -1;
         var _loc3_:String = "";
         var _loc4_:int = 1;
         ...
         if(_loc6_ && _loc6_.selection >= 0 && _loc6_.selection < this.var_746.length)
         {
            _loc4_ = this.var_746[_loc6_.selection];
         }
         ...
         else if(param1.type == WindowEvent.const_117)
         {
            ...
            switch(_loc7_.name)
            {
               ...
               case "max_price_input":
                  _loc8_ = this.const_2272;
                  break;
               case "search_input":
                  _loc8_ = this.const_2271;
                  break;
               default:
                  return;
            }
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "back_button":
                  ...
                  break;
               case "buy_button":
                  this.marketPlace.buyOffer(this.var_1432.offerId);
            }
            return;
         }
         if(param1.type == WindowEvent.const_49)

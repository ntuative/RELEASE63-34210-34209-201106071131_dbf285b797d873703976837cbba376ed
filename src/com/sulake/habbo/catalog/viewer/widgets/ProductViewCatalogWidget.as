package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_501:IDisplayObjectWrapper;
      
      private var var_1677:Point;
      
      private var var_502:IItemGridWindow;
      
      private var var_1407:IScrollbarWindow;
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_185.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onClickRoomView);
            this.var_185 = null;
         }
      }
      ...
      override public function init() : Boolean
      {
         ...
         this.var_910 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         this.var_1131 = _window.findChildByName("ctlg_description") as ITextWindow;
         this.var_93 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         this.var_185 = _window.findChildByName("room_canvas_container") as IWindowContainer;
         if(this.var_185 != null)
         {
            this.var_185.visible = false;
            this.var_501 = this.var_185.findChildByName("room_canvas") as IDisplayObjectWrapper;
            _loc3_ = (page.viewer.catalog as HabboCatalog).roomPreviewer;
            if(this.var_501 != null && _loc3_ != null)
            {
               this.var_185.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onClickRoomView);
               _loc3_.reset();
               _loc4_ = _loc3_.getRoomCanvas(this.var_501.width,this.var_501.height);
               if(_loc4_ != null)
               {
                  this.var_501.setDisplayObject(_loc4_);
               }
            }
            else
            {
         ...
         this.var_1677 = new Point(this.var_93.x,this.var_93.y);
         this.var_502 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         this.var_1407 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         this.var_910.text = _loc4_;
         this.var_1131.text = _loc5_;
         this.var_910.height = this.var_910.textHeight + 5;
         this.var_1131.y = this.var_910.y + this.var_910.height;
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_623:
                  ...
                  if(this.var_502 != null)
                  {
                     ...
                     _loc11_.populateItemGrid(this.var_502,this.var_1407,this.var_1685);
               ...
               case Offer.const_438:
                  ...
                  if(this.var_185 != null)
                  {
                     if(_loc9_.productType == ProductTypeEnum.const_74 || _loc9_.productType == ProductTypeEnum.const_63 || _loc9_.productType == ProductTypeEnum.const_187)
                     {
                  ...
                  switch(_loc9_.productType)
                  {
                     case ProductTypeEnum.const_74:
                        if(_loc8_ != null && this.var_501 != null)
                        {
                     ...
                     case ProductTypeEnum.const_187:
                        ...
                        else
                        {
                           ...
                           _loc6_ = new BitmapData(this.var_93.width,this.var_93.height,false,_loc15_);
                           _loc16_ = null;
                           ...
                           if(_loc17_.avatarRenderManager != null)
                           {
                              ...
                              if(_loc18_ != null)
                              {
                                 ...
                                 _loc18_.appendAction(AvatarAction.const_321,AvatarAction.const_518);
      ...
      private function addEffectSprites(param1:BitmapData, param2:IAvatarImage, param3:Point, param4:Point, param5:Boolean = true) : void
      {
         ...
         {
            _loc7_ = _window.getChildIndex(this.var_93);
      ...
      {
         var _loc1_:* = null;
         for each(_loc1_ in this.var_2221)
         {
      ...
      private function setPreviewImage(param1:BitmapData, param2:Boolean, param3:Point = null) : void
      {
         ...
         if(this.var_93 != null && true)
         {
            ...
            if(this.var_93.bitmap == null)
            {
               this.var_93.bitmap = new BitmapData(this.var_93.width,this.var_93.height,true,16777215);
            }
            this.var_93.bitmap.fillRect(this.var_93.bitmap.rect,16777215);
            _loc4_ = new Point((this.var_93.width - param1.width) / 2,(this.var_93.height - param1.height) / 2);
            this.var_93.bitmap.copyPixels(param1,param1.rect,_loc4_,null,null,true);
            this.var_93.invalidate();
            this.var_93.x = this.var_1677.x;
            this.var_93.y = this.var_1677.y;
            if(param3 != null)
            {
               this.var_93.x += param3.x;
               this.var_93.y += param3.y;
            }
         }
         if(param2)
         {

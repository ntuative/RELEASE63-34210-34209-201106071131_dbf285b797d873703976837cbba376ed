package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_1059.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onRedeem);
            this.var_1059 = null;
         }
         if(this.var_1060 != null)
         {
            this.var_1060.removeEventListener(WindowKeyboardEvent.const_224,this.windowKeyEventProcessor);
            this.var_1060 = null;
         }
      }
      ...
      override public function init() : Boolean
      {
         ...
         this.var_1059 = _window.findChildByName("redeem") as IButtonWindow;
         if(this.var_1059 != null)
         {
            this.var_1059.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onRedeem);
         }
         this.var_1060 = _window.findChildByName("voucher_code") as ITextFieldWindow;
         if(this.var_1060 != null)
         {
            this.var_1060.addEventListener(WindowKeyboardEvent.const_224,this.windowKeyEventProcessor);
         }
         return true;
      }

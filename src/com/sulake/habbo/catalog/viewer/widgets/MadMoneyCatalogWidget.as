package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class MadMoneyCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_1154.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.eventProc);
            this.var_1154 = null;
         }
      }
      ...
      override public function init() : Boolean
      {
         ...
         this.var_1154 = _window.findChildByName("ctlg_madmoney_button") as IButtonWindow;
         if(this.var_1154 != null)
         {
         }
         return true;

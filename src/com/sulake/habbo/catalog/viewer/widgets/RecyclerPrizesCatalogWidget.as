package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RecyclerPrizesCatalogWidget extends CatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      private var var_1685:XML;
      
      private var var_1686:XML;
      
      private var var_228:IGridItem;
      ...
      override public function init() : Boolean
      {
         ...
         this.var_599 = this.recycler.getPrizeTable();
         ...
         this.var_1686 = _loc1_.content as XML;
         this.populateItemGrid();
         if(this.var_599.length > 0 && this.var_599[0].prizes.length > 0)
         {
            this.select(this.var_599[0].prizes[0] as IGridItem);
         }
         return true;
      }
      ...
      {
         var _loc2_:int = 0;
         while(_loc2_ < this.var_599.length)
         {
            this.createLevelItem(this.var_599[_loc2_]);
            _loc2_++;
         }
      }
      ...
      {
         var _loc6_:* = null;
         var _loc2_:IWindowContainer = page.viewer.catalog.windowManager.buildFromXML(this.var_1686) as IWindowContainer;
      ...
      private function createPrizeItem(param1:PrizeContainer, param2:IItemGridWindow) : void
      {
         ...
         var _loc3_:IWindowContainer = page.viewer.catalog.windowManager.buildFromXML(this.var_1685) as IWindowContainer;

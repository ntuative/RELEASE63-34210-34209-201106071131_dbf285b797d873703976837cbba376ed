package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class NewPetsCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private static const const_1389:int = 18;
      ...
      override public function init() : Boolean
      {
         ...
         _loc1_.addEventListener(WindowEvent.const_117,this.onTextWindowEvent);
         ...
         this.var_503 = this.getPetTypeIndexFromProduct(_loc2_.localizationId);
         if(this.var_503 < 8)
         {
            return false;
         }
         this.var_2222 = _loc2_.localizationId;
         this.updateAvailableBreeds(_loc2_.localizationId);
         if(this.var_210 != null && this.var_210.length > 0)
         {
            this.var_349 = this.var_210[0];
         }
         else
         {
            this.var_349 = -1;
         }
         this._offers.add(this.var_503,_loc2_);
      ...
      private function initializeBreedSelection() : void
      {
         ...
         if(this.var_210 != null)
         {
            _loc1_ = [];
            _loc2_ = 0;
            while(_loc2_ < const_1389 && _loc2_ < this.var_210.length)
            {
               _loc3_ = (page.viewer.catalog as HabboCatalog).roomEngine.getPetColor(this.var_503,this.var_210[_loc2_]);
               if(_loc3_ != null)
               {
      ...
      private function selectedBreed(param1:int) : void
      {
         if(this.var_210 != null && this.var_210.length > 0)
         {
            ...
            this.var_349 = this.var_210[param1];
            this.updateImage();
         }
      }
      ...
      private function getPetLocalization() : String
      {
         ...
         if(page != null && false)
         {
            ...
            {
               return _loc1_.localization.getKey(this.getRaceLocalizationKey(this.var_503,this.var_349),this.getRaceLocalizationKey(this.var_503,this.var_349));
            }
         }
         return this.getRaceLocalizationKey(this.var_503,this.var_349);
      }

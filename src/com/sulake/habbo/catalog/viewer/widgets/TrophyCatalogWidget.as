package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class TrophyCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private static const const_1564:int = 16763904;
      
      private static const const_1565:int = 13421772;
      
      private static const const_1563:int = 13395456;
      ...
      override public function init() : Boolean
      {
         ...
         this.var_93 = window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         ...
         _loc4_ = this.var_280.getWithIndex(this.var_327);
         if(_loc4_ != null)
         {
            _loc3_ = _loc4_.getValue(this.var_838);
            if(_loc3_ == null)
            {
      ...
      private function onWidgetsInitialized(param1:CatalogWidgetsInitializedEvent) : void
      {
         ...
         _loc2_.push(const_1564);
         _loc2_.push(const_1565);
         _loc2_.push(const_1563);
      ...
      private function onColourIndex(param1:CatalogWidgetColourIndexEvent) : void
      {
         ...
         var _loc2_:Map = this.var_280.getWithIndex(this.var_327);
         if(_loc2_ != null)
         {
            _loc3_ = _loc2_.getValue(this.var_838);
            if(_loc3_ == null)
            {
      ...
      private function onClickNext(param1:WindowMouseEvent) : void
      {
         var _loc3_:* = null;
         ++this.var_327;
         if(this.var_327 >= this.var_280.length)
         {
            this.var_327 = 0;
         }
         var _loc2_:Map = this.var_280.getWithIndex(this.var_327);
      ...
      private function onClickPrev(param1:WindowMouseEvent) : void
      {
         ...
         if(this.var_327 < 0)
         {
            this.var_327 = this.var_280.length - 1;
         }
         var _loc2_:Map = this.var_280.getWithIndex(this.var_327);
         if(_loc2_ != null)
         {
      ...
      private function setPreviewImage(param1:BitmapData, param2:Boolean) : void
      {
         ...
         if(this.var_93 != null)
         {
            ...
            _loc3_ = new Point((this.var_93.width - param1.width) / 2,(this.var_93.height - param1.height) / 2);
            this.var_93.bitmap.copyPixels(param1,param1.rect,_loc3_,null,null,true);

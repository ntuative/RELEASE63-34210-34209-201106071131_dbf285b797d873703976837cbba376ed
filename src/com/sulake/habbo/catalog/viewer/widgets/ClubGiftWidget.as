package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ClubGiftWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private function updateInfo() : void
      {
         ...
         if(_loc6_)
         {
            _loc2_ = this.var_27.purse.pastVipDays >= this.const_234 ? "catalog.club_gift.past_vip.long" : "catalog.club_gift.past_vip";
            _loc3_ = this.var_27.purse.pastVipDays % this.const_234;
            _loc4_ = this.var_27.purse.pastVipDays / this.const_234;
            this.var_27.localization.registerParameter(_loc2_,"days",_loc3_.toString());
            this.var_27.localization.registerParameter(_loc2_,"months",_loc4_.toString());

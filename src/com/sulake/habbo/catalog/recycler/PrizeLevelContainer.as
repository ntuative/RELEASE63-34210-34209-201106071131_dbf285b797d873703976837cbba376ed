package com.sulake.habbo.catalog.recycler
{
   ...
   public class PrizeLevelContainer
   {
      ...
      public function PrizeLevelContainer(param1:PrizeLevelMessageData, param2:IHabboCatalog)
      {
         ...
         var _loc6_:* = null;
         super();
         this.var_1598 = param1.prizeLevelId;
         param2.localization.registerParameter("recycler.prizes.odds." + this.var_1598,"odds","1:" + param1.probabilityDenominator);
         ...
         while(_loc3_ < param1.prizes.length)
         {
            ...
            _loc6_ = new PrizeContainer(_loc4_.productItemType,_loc4_.productItemTypeId,_loc5_,this.var_1598);
            this.var_599.push(_loc6_);
            _loc3_++;
         }
      }

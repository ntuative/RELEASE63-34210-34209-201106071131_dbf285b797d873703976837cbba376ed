package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      {
         return this.var_677 != const_1071;
      }
      
      private function get systemActive() : Boolean
      {
         return this.var_1996 != RecyclerStatusMessageEvent.const_1152;
      }
      
      private function get ready() : Boolean
      {
         return this.active && this.var_677 == const_466;
      }
      ...
      {
         this.var_677 = const_1072;
         this.var_133 = new Array(const_223);
         if(param1 == null)
         {
            return;
         }
      ...
      public function setSystemStatus(param1:int, param2:int) : void
      {
         ...
         {
            case RecyclerStatusMessageEvent.const_1766:
               this.var_677 = const_466;
            ...
            case RecyclerStatusMessageEvent.const_1152:
               ...
               this._catalog.setupInventoryForRecycler(false);
               break;
            case RecyclerStatusMessageEvent.const_1703:
               if(this._view == null || this._view.disposed)
               {
                  return;
               }
      ...
      public function setFinished(param1:int, param2:int) : void
      {
         ...
         switch(status)
         {
            case RecyclerFinishedMessageEvent.const_1312:
               if(this._view != null)
               {
      ...
      public function placeObjectAtSlot(param1:int, param2:int, param3:int, param4:int, param5:String) : void
      {
         ...
         {
            oldObjectData = this.var_133[0];
            newSlotId = 0;
            while(oldObjectData != null && newSlotId < const_223)
            {
               oldObjectData = this.var_133[newSlotId];
         ...
         this.var_133[slotId] = new FurniSlotItem(itemId,category,typeId,xxxExtra);
         this.updateRecyclerSlots();
         this.updateRecyclerButton();
      }
      ...
      public function releaseSlot(param1:int) : void
      {
         ...
         if(!this._catalog.returnInventoryFurniFromRecycler(this.var_133[param1].id))
         {
            return;
         }
      ...
      private function isPoolFull() : Boolean
      {
         ...
         if(this.var_133.length < const_223)
         {
            return false;
         }
         var _loc1_:int = 0;

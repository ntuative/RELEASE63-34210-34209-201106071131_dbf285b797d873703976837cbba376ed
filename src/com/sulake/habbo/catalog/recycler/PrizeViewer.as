package com.sulake.habbo.catalog.recycler
{
   ...
   public class PrizeViewer implements IGetImageListener
   {
      ...
      {
         var _loc8_:* = null;
         this.var_335 = param2.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         switch(param3)
         {
      ...
      {
         var _loc3_:* = null;
         if(this.var_335 != null && !this.var_335.disposed)
         {
            if(param1 == null)
            {
            ...
            this.var_335.bitmap = new BitmapData(this.var_335.width,this.var_335.height,true,16777215);
            this.var_335.bitmap.fillRect(this.var_335.bitmap.rect,16777215);
            _loc3_ = new Point((this.var_335.width - param1.width) / 2,(this.var_335.height - param1.height) / 2);
            this.var_335.bitmap.copyPixels(param1,param1.rect,_loc3_,null,null,true);
         }

package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNodeRenderable extends CatalogNode
   {
      ...
      private static const const_1633:Number = 4285716709;
      
      private static var _listSubItemWindowLayout:XML;
      
      private static var var_1611:XML;
      
      private static var var_1612:XML;
       
      
      private var var_2085:Number = 4.294967295E9;
      
      private var _icon:BitmapData;
      
      private var _window:IWindowContainer;
      
      private var var_3019:IWindowContainer;
      ...
      override public function activate() : void
      {
         ...
         if(_loc1_ != null)
         {
            if(this.var_2085 == 4294967295)
            {
               this.var_2085 = _loc1_.color;
            }
            _loc1_.color = const_1633;
         }
      }
      ...
      override public function open() : void
      {
         ...
         if(isBranch)
         {
            ...
            if(_loc1_ != null)
            {
               _loc1_.style = HabboIconType.const_1901;
            }
         }
      }
      ...
      override public function close() : void
      {
         ...
         if(isBranch)
         {
            ...
            if(_loc1_ != null)
            {
               _loc1_.style = HabboIconType.const_1791;
            }
         }
      }
      ...
      {
         this.var_66 = navigator.catalog.windowManager.buildFromXML(var_1612) as IItemListWindow;
         if(this.var_66 == null)
         {
      ...
      private function createWindow() : void
      {
         if(depth == 1)
         {
            this._window = navigator.catalog.windowManager.buildFromXML(var_1611) as IWindowContainer;
         }
         else
         {

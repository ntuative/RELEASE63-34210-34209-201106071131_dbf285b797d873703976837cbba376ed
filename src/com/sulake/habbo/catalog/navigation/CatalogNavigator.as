package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNavigator implements ICatalogNavigator
   {
      ...
      private var var_3003:String = "magic.pixels";
      
      private var var_3002:String = "catalog.page.club";
      ...
      {
         this.openPage(this.var_3003);
      }
      
      private function openClubPage() : void
      {
         this._catalog.openCatalogPage(this.var_3002,true);
      }

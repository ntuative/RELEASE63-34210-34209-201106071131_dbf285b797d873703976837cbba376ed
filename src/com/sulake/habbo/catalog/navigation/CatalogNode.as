package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNode implements ICatalogNode
   {
      ...
      private static const const_1654:Array = [4293190884,4293914607,4294957908,4289454682,4289431551,4285716709,4294016606,4293326172,4293694138,4285383659,4293082689,4288782753];
      ...
      public function CatalogNode(param1:ICatalogNavigator, param2:NodeData, param3:int)
      {
         ...
         this.var_2916 = param2.navigateable;
         this._localization = param2.localization;
         this.var_1482 = param2.pageId;
         this._color = const_1654[param2.color];
         this.var_2124 = param2.icon;
         this._children = [];
      }
      ...
      protected function get iconName() : String
      {
         ...
         return ICON_PREFIX + this.var_2124.toString();
      }
   }
}

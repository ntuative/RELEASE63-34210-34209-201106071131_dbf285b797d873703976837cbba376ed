package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog implements IGetImageListener, IDisposable
   {
      ...
      private const const_2281:int = 10;
      ...
      private const const_2027:uint = 4.293848814E9;
      
      private const const_2026:uint = 4.294967295E9;
      
      private const const_1436:uint = 4.291613146E9;
      ...
      public function onIsOfferGiftable(param1:IsOfferGiftableMessageParser) : void
      {
         ...
         if(this.var_1204 != param1.offerId)
         {
            return;
         }
      ...
      private function showGiftDialog() : void
      {
         ...
         if(_loc6_ != null)
         {
            _loc6_.addEventListener(WindowEvent.const_117,this.onNameInputChange);
            _loc6_.addEventListener(WindowMouseEvent.const_45,this.onNameInputMouseDown);
            _loc6_.addEventListener(WindowKeyboardEvent.const_360,this.onNameInputKeyUp);
         }
         ...
         if(_loc7_ != null)
         {
            ...
            _loc7_.addEventListener(WindowEvent.const_364,this.onMessageInputFocus);
         }
         this.var_1826 = true;
         this.var_1825 = true;
         if(_loc1_.isEnabled)
         {
            ...
            this.var_1827 = _loc1_.stuffTypes;
            this.var_782 = _loc1_.boxTypes;
            this.var_781 = _loc1_.ribbonTypes;
            this.var_1203 = this.var_1827[0];
            this.var_362 = this.var_782[0];
            this.var_361 = this.var_781[0];
            this.initColorGrid();
      ...
      private function updatePreview() : void
      {
         if(this.var_361 < 0)
         {
            this.var_361 = this.var_781.length - 1;
         }
         if(this.var_361 > this.var_781.length - 1)
         {
            this.var_361 = 0;
         }
         if(this.var_362 < 0)
         {
            this.var_362 = this.var_782.length - 1;
         }
         if(this.var_362 > this.var_782.length - 1)
         {
            this.var_362 = 0;
         }
         var _loc1_:int = this.var_782[this.var_362] * 1000 + this.var_781[this.var_361];
         if(this._window == null)
         {
            return;
         }
         ...
         var _loc2_:ImageResult = this._roomEngine.getFurnitureImage(this.var_1203,new Vector3d(180),64,this,0,_loc1_.toString());
         if(_loc2_ == null)
         {
            return;
         }
         this.var_1481 = _loc2_.id;
      ...
      private function initColorGrid() : void
      {
         ...
         for each(_loc3_ in this.var_1827)
         {
      ...
      private function giveGift() : void
      {
         ...
         var _loc7_:int = !!_loc6_ ? 0 : int(this.var_1203);
         var _loc8_:int = !!_loc6_ ? 0 : int(this.var_782[this.var_362]);
         var _loc9_:int = !!_loc6_ ? 0 : int(this.var_781[this.var_361]);
         this._catalog.purchaseProductAsGift(this.var_1482,this.var_1204,this.var_1480,_loc2_,_loc4_,_loc7_,_loc8_,_loc9_);
      }
      
      private function onBuyButtonClick(param1:WindowEvent) : void
      {
         this._catalog.purchaseProduct(this.var_1482,this.var_1204,this.var_1480);
         this.dispose();
      }
      ...
      private function onNameInputChange(param1:WindowEvent) : void
      {
         ...
         if(this.var_2505 == _loc2_.text)
         {
            return;
         }
         var _loc3_:String = _loc2_.text.toLowerCase();
         var _loc4_:* = [];
         for each(_loc5_ in this.var_237)
         {
            if(_loc5_.toLowerCase().search(_loc3_) != -1)
            {
               _loc4_.push(_loc5_);
            }
            if(_loc4_.length >= this.const_2281)
            {
               break;
            }
         }
         this.updateSuggestions(_loc4_);
         this.var_2505 = _loc2_.text;
      }
      ...
      private function onNameInputKeyUp(param1:WindowEvent) : void
      {
         ...
         {
            case Keyboard.UP:
               this.highlightSuggestion(this.var_363 - 1);
               break;
            case Keyboard.DOWN:
               this.highlightSuggestion(this.var_363 + 1);
               break;
      ...
      {
         if(this.var_266 == null || !this.var_266.visible)
         {
            return;
         }
         var _loc1_:IItemListWindow = this.var_266.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc1_ == null)
         {
            return;
         }
         var _loc2_:IWindowContainer = _loc1_.getListItemAt(this.var_363) as IWindowContainer;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function updateSuggestions(param1:Array) : void
      {
         ...
         if(this.var_266 == null)
         {
            this.var_266 = this._window.findChildByName("suggestion_container") as IWindowContainer;
         }
         if(this.var_783 == null)
         {
            this.var_783 = this.createWindow("suggestion_list_item") as IWindowContainer;
         }
         if(this.var_266 == null || this.var_783 == null)
         {
            return;
         }
         var _loc2_:IItemListWindow = this.var_266.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function onSuggestionsMouseOver(param1:WindowEvent) : void
      {
         ...
         var _loc3_:IItemListWindow = this.var_266.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc3_ == null)
         {
            return;
         }
      ...
      private function highlightSuggestion(param1:int) : void
      {
         ...
         _loc3_ = _loc2_.getListItemAt(this.var_363) as IWindowContainer;
         if(_loc3_ != null)
         {
            _loc3_.color = this.getColor(this.var_363);
         }
         this.var_363 = param1;
         if(this.var_363 < 0)
         {
            this.var_363 = _loc2_.numListItems - 1;
         }
         if(this.var_363 >= _loc2_.numListItems)
         {
            this.var_363 = 0;
         }
         _loc3_ = _loc2_.getListItemAt(this.var_363) as IWindowContainer;
         if(_loc3_ != null)
         {
            _loc3_.color = this.const_1436;
         }
      }
      
      private function getColor(param1:int) : uint
      {
         return param1 % 2 == 0 ? uint(this.const_2027) : uint(this.const_2026);
      }
      ...
      {
         this.var_1203 = param1.target.id;
         this.updateColorGrid();
         this.updatePreview();
      }
      ...
      private function updateColorGrid() : void
      {
         ...
         while(_loc4_ < _loc1_.numGridItems)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc3_.visible = _loc2_.id == this.var_1203;
               }
            }
            _loc4_++;
         }

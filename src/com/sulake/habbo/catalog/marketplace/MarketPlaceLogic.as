package com.sulake.habbo.catalog.marketplace
{
   ...
   public class MarketPlaceLogic implements IMarketPlace
   {
      ...
      private static const const_1406:String = "poster";
       
      
      public const const_2227:int = 1;
      
      public const const_2071:int = 2;
      
      public const const_2307:int = 3;
      ...
      public function dispose() : void
      {
         ...
         {
            this.disposeOffers(this.var_259);
            this.var_259 = null;
         }
         if(this.var_302 != null)
         {
            this.disposeOffers(this.var_302);
            this.var_302 = null;
         }
         this._disposed = true;
      }
      ...
      {
         this.requestOffers(this.var_2308,this.var_2310,this.var_2305,this.var_2312);
      }
      ...
      {
         if(!this.var_259 || !this._catalog || !this._catalog.getPurse())
         {
            return;
         }
         var _loc2_:MarketPlaceOfferData = this.var_259.getValue(param1) as MarketPlaceOfferData;
         if(!_loc2_)
         {
            return;
         }
         ...
         this.showConfirmation(this.const_2227,_loc2_);
      }
      ...
      public function redeemSoldOffers() : void
      {
         ...
         var _loc1_:Array = this.var_302.getKeys();
         for each(_loc2_ in _loc1_)
         {
            _loc3_ = this.var_302.getValue(_loc2_);
            if(_loc3_.status == MarketPlaceOfferState.const_475)
            {
               this.var_302.remove(_loc2_);
               _loc3_.dispose();
            }
         }
         if(this._catalog)
      ...
      public function onOffers(param1:IMessageEvent) : void
      {
         ...
         for each(_loc4_ in _loc3_.offers)
         {
            ...
            this.var_259.add(_loc4_.offerId,_loc5_);
         }
         this.var_2304 = _loc3_.totalItemsFound;
         if(this._visualization != null)
         {
            this._visualization.listUpdatedNotify();
         }
      ...
      public function onOwnOffers(param1:IMessageEvent) : void
      {
         ...
         this.var_2307 = _loc3_.creditsWaiting;
         for each(_loc4_ in _loc3_.offers)
         {
            ...
            _loc5_.timeLeftMinutes = _loc4_.timeLeftMinutes;
            this.var_302.add(_loc4_.offerId,_loc5_);
         }
         if(this._visualization != null)
         {
            this._visualization.listUpdatedNotify();
      ...
      public function onBuyResult(param1:IMessageEvent) : void
      {
         ...
         {
            item = this.var_259.remove(parser.requestedOfferId);
            if(item != null)
            {
               item.dispose();
            }
         ...
         {
            updateItem = this.var_259.getValue(parser.requestedOfferId) as MarketPlaceOfferData;
            if(updateItem)
            {
               updateItem.offerId = parser.offerId;
               updateItem.price = parser.newPrice;
               --updateItem.offerCount;
               this.var_259.add(parser.offerId,updateItem);
            }
            this.var_259.remove(parser.requestedOfferId);
            this.showConfirmation(this.const_2071,updateItem);
            if(this._visualization != null)
            {
               this._visualization.listUpdatedNotify();
            }
      ...
      public function onCancelResult(param1:IMessageEvent) : void
      {
         ...
         if(parser.result == 1)
         {
            item = this.var_302.remove(parser.offerId);
            if(item != null)
            {
               item.dispose();
            }
      ...
      {
         if(param1.furniCategoryId != this.var_2309 || param1.furniTypeId != this.var_2311)
         {
            return;
         }
      ...
      private function isPosterItem(param1:IMarketPlaceOfferData) : Boolean
      {
         ...
         if(param1.furniType == 2 && param1.stuffData != null)
         {
            ...
            {
               _loc4_ = _loc3_.name;
               if(_loc4_ != null && _loc4_ == const_1406)
               {
                  _loc2_ = true;
               }
            }

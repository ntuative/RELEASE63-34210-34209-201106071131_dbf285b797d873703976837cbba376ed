package com.sulake.habbo.catalog.marketplace
{
   ...
   public class MarketplaceChart
   {
      ...
      public function draw(param1:int, param2:int) : BitmapData
      {
         ...
         this.var_1017 = param2 - _loc6_.textHeight;
         ...
         _loc9_.graphics.lineTo(0,this.var_1017);
         _loc10_ = 0;
         while(_loc10_ <= 5)
         {
            _loc4_ = (this.var_1017 - 1) / 5 * _loc10_;
         ...
         _loc3_.draw(_loc9_,new Matrix(1,0,0,1,param1 - this.var_1275,(param2 - this.var_1017) / 2));
         return _loc3_;
      }
      
      private function getX(param1:int) : Number
      {
         return this.var_1275 + this.var_1275 / -this.var_3011 * this._x[param1];
      }
      
      private function getY(param1:int) : Number
      {
         return this.var_1017 - this.var_1017 / this.var_670 * this.var_182[param1];
      }
      
      public function get available() : Boolean
      {
         return this._x && this.var_182 && this._x.length > 1;
      }
   }
}

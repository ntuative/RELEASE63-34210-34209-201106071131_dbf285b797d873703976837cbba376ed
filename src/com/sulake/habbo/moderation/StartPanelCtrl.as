package com.sulake.habbo.moderation
{
   ...
   public class StartPanelCtrl implements IDisposable
   {
      ...
      private function onChatlogButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_35.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(!!this.var_2005 ? 0 : 1,this._roomId),this.var_35,WindowTracker.const_836,this._roomId),this._frame,false,false,true);
      }

package com.sulake.habbo.moderation
{
   ...
   public class PickedIssuesView implements IIssueBrowserView
   {
      ...
      private var var_2395:IssueListView;
      ...
      public function PickedIssuesView(param1:IssueManager, param2:IssueBrowser, param3:IWindowContainer)
      {
         ...
         this.var_631 = param2;
         this._window = this.var_631.createWindow("picked_issues_xml") as IWindowContainer;
         param3.addChild(this._window);
         var _loc4_:IItemListWindow = this._window.findChildByName("issue_list") as IItemListWindow;
         this.var_2395 = new IssueListView(param1,param2,_loc4_,"picked_issues_list_item_xml");
      }
      ...
      {
         var _loc1_:Array = this._issueManager.getBundles(IssueManager.const_1230);
         this.var_2395.update(_loc1_);
      }
   }
}

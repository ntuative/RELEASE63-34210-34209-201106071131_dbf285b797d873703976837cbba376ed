package com.sulake.habbo.moderation
{
   ...
   public class IssueListView
   {
      ...
      private var var_3038:BitmapData;
      
      private var var_3039:BitmapData;
      ...
      public function IssueListView(param1:IssueManager, param2:IssueBrowser, param3:IItemListWindow, param4:String)
      {
         ...
         this.var_1995 = this.var_631.createWindow(param4) as IWindowContainer;
      }
      ...
      public function update(param1:Array) : void
      {
         ...
         if(_loc4_ < _loc5_)
         {
            ...
            {
               _loc3_ = this.var_1995.clone() as IWindowContainer;
         ...
         for each(_loc7_ in param1)
         {
            ...
            if(_loc7_ == null || this.var_1995 == null)
            {
               return;
            }
            ...
            if(_loc11_ != null)
            {
               ...
               _loc13_ = this.var_631.assets.getAssetByName(_loc12_) as BitmapDataAsset;

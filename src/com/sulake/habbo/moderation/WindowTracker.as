package com.sulake.habbo.moderation
{
   ...
   public class WindowTracker
   {
      ...
      public static const const_836:int = 4;
      
      public static const const_1255:int = 5;
      
      public static const const_1856:int = 6;
      
      public static const const_1764:int = 7;
      ...
      {
         var _loc2_:Dictionary = this.var_1910[param1];
         if(_loc2_ == null)
         {
            _loc2_ = new Dictionary();
            this.var_1910[param1] = _loc2_;
         }
         return _loc2_;
      }
   }

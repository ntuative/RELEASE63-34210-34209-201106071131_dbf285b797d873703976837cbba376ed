package com.sulake.habbo.moderation
{
   ...
   public class IssueManager
   {
      ...
      public static const const_744:String = "issue_bundle_my";
      
      public static const const_1230:String = "issue_bundle_picked";
      
      public static const const_1819:int = 15000;
       
      
      private var var_73:ModerationManager;
      
      private var var_631:IssueBrowser;
      ...
      public function IssueManager(param1:ModerationManager)
      {
         ...
         this.var_631 = new IssueBrowser(this,this.var_73.windowManager,this.var_73.assets);
         this.var_1208 = [];
         this.var_1207 = [];
         this.var_964 = new Map();
         this.var_2507 = parseInt(this.var_73.configuration.getKey("chf.score.updatefactor","60"));
         this.var_1829 = new Timer(const_1819,0);
         this.var_1829.addEventListener(TimerEvent.TIMER,this.updatePriorities);
         this.var_1829.start();
      }
      ...
      public function pickBundle(param1:int, param2:Boolean = false, param3:int = 0) : void
      {
         ...
         this.var_1208 = this.var_1208.concat(_loc4_.getIssueIds());
      }
      ...
      private function sendRelease(param1:Array) : void
      {
         ...
         this.var_1207 = this.var_1207.concat(param1);
      }
      ...
      public function playSound(param1:IssueMessageData) : void
      {
         ...
         if(this.var_631 == null || !this.var_631.isOpen())
         {
            this.var_73.soundManager.playSound(HabboSoundTypesEnum.const_1236);
         }
      }
      ...
      public function updateIssue(param1:IssueMessageData) : void
      {
         ...
         if(param1.state == IssueMessageData.const_1884)
         {
            this._issues.remove(param1.issueId);
            return;
         }
         ...
         if(this.var_1208.indexOf(param1.issueId) != -1)
         {
         ...
         {
            _loc6_ = this.getBundles(const_744);
            _loc7_ = false;
            ...
            _loc9_ = this.var_1207.indexOf(param1.issueId);
            if(_loc9_ == -1 && _loc7_)
            {
      ...
      public function updatePriorities(param1:Event = null) : void
      {
         ...
         for each(_loc4_ in this._issues)
         {
            if(_loc4_ != null)
            {
               ...
               _loc4_.temporalPriority = int(_loc3_ / this.var_2507);
            }
         }

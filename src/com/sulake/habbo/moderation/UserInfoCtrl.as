package com.sulake.habbo.moderation
{
   ...
   public class UserInfoCtrl implements IDisposable
   {
      ...
      private static const const_1109:int = 60;
      
      private static const const_1111:int = 3600;
      
      private static const const_1110:int = 86400;
      
      private static const const_1108:int = 31536000;
      ...
      {
         if(param1 < 2 * const_1109)
         {
            return param1 + " secs ago";
         }
         if(param1 < 2 * const_1111)
         {
            return Math.round(param1 / const_1109) + " mins ago";
         }
         if(param1 < 2 * const_1110)
         {
            return Math.round(param1 / const_1111) + " hours ago";
         }
         if(param1 < 2 * const_1108)
         {
            return Math.round(param1 / const_1110) + " days ago";
         }
         return Math.round(param1 / const_1108) + " years ago";
      }
      ...
      {
         var _loc1_:IWindowContainer = IWindowContainer(this.var_1360.findChildByName("user_info"));
         if(_loc1_ == null)
         {
            _loc1_ = IWindowContainer(this.var_35.getXmlWindow("user_info"));
            this.var_1360.addChild(_loc1_);
      ...
      private function onChatlogButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_35.windowTracker.show(new ChatlogCtrl(new GetUserChatlogMessageComposer(this._data.userId),this.var_35,WindowTracker.const_1255,this._data.userId),this._callerFrame,this.var_1359,false,true);
      }
      ...
      private function onRoomVisitsButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_35.windowTracker.show(new RoomVisitsCtrl(this.var_35,this._data.userId),this._callerFrame,this.var_1359,false,true);
      }
      ...
      private function onMessageButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_35.windowTracker.show(new SendMsgsCtrl(this.var_35,this._data.userId,this._data.userName,this.var_1492),this._callerFrame,this.var_1359,false,true);
      }
      ...
      private function onModActionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_35.windowTracker.show(new ModActionCtrl(this.var_35,this._data.userId,this._data.userName,this.var_1492),this._callerFrame,this.var_1359,false,true);
      }

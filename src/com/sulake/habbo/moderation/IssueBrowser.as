package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private const const_2293:String = "my_issues";
      
      private const const_2292:String = "open_issues";
      
      private const const_2294:String = "picked_issues";
      
      private const const_2306:String = "closed_issues";
      ...
      private var var_1927:IIssueBrowserView;
      
      private var var_1926:IIssueBrowserView;
      
      private var var_1928:PickedIssuesView;
      ...
      private function selectView(param1:String) : void
      {
         ...
         this.var_381.view.width = this.var_273.container.width;
         this.var_381.view.height = this.var_273.container.height;
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case this.const_2293:
               if(this.var_1927 == null)
               {
                  this.var_1927 = new MyIssuesView(this.issueManager,this,this.var_273.container);
               }
               return this.var_1927;
            case this.const_2292:
               if(this.var_1926 == null)
               {
                  this.var_1926 = new OpenIssuesView(this.issueManager,this,this.var_273.container);
               }
               return this.var_1926;
            case this.const_2294:
               if(this.var_1928 == null)
               {
                  this.var_1928 = new PickedIssuesView(this.issueManager,this,this.var_273.container);
               }

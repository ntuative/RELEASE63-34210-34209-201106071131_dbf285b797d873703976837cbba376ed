package com.sulake.habbo.moderation
{
   ...
   public class ChatlogCtrl implements IDisposable, TrackedWindow
   {
      ...
      private static var var_1739:int = 1000;
      
      private static var var_931:Array = [];
      
      private static var var_1737:int = 200;
      ...
      private var var_1708:IMessageComposer;
      ...
      {
         this.var_751 = IWindowContainer(this.var_35.getXmlWindow("chatlog_roomheader"));
         this.var_750 = IWindowContainer(this.var_35.getXmlWindow("chatlog_chatline"));
         ...
         this.var_35.connection.send(this.var_1708);
      ...
      private function populateChatline(param1:IItemListWindow, param2:ChatlineData, param3:Boolean) : void
      {
         ...
         _loc4_.color = this.var_1738[param2.chatterId] != null ? (!!param3 ? 4294623571 : uint(4294959680)) : (!!param3 ? 4288861930 : uint(4294967295));
         ...
         if(param2.chatterId > 0)
         {
            ...
            if(!this.var_1437.getValue(param2.chatterName))
            {
               this.var_1437.add(param2.chatterName,param2.chatterId);
            }
         }
      ...
      private function onChatLogUserClick(param1:WindowMouseEvent) : void
      {
         ...
         var _loc3_:int = this.var_1437.getValue(_loc2_);
      ...
      public function dispose() : void
      {
         ...
         for each(_loc1_ in this.var_1439)
         {

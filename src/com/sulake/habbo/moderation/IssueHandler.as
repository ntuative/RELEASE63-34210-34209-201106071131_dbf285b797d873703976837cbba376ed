package com.sulake.habbo.moderation
{
   ...
   public class IssueHandler implements TrackedWindow
   {
      ...
      private var var_1162:UserInfoCtrl;
      ...
      private function createView() : void
      {
         ...
         this.var_509 = new UserInfoCtrl(this._window,this.var_73,_loc3_.message);
         this.var_1162 = new UserInfoCtrl(this._window,this.var_73,_loc3_.message);
         ...
         {
            this.var_1162.load(_loc4_,this.var_165.reportedUserId);
         }
         else
         {
      ...
      {
         if(this.var_73 != null && this.var_73.issueManager != null && this.var_165 != null)
         {
            this.var_73.issueManager.removeHandler(this.var_165.id);
         }
         this.dispose();
      }
      ...
      private function onCloseUseless(param1:WindowMouseEvent) : void
      {
         ...
         this.var_73.issueManager.closeBundle(this.var_165.id,1);
      ...
      private function onCloseAbusive(param1:WindowMouseEvent) : void
      {
         ...
         this.var_73.issueManager.closeBundle(this.var_165.id,2);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onCloseResolved(param1:WindowMouseEvent) : void
      {
         ...
         this.var_73.issueManager.closeBundle(this.var_165.id,3);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onRelease(param1:WindowMouseEvent) : void
      {
         ...
         this.var_73.issueManager.releaseBundle(this.var_165.id);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onShowChatlog(param1:WindowMouseEvent) : void
      {
         ...
         this.var_73.windowTracker.show(new ChatlogCtrl(new GetCfhChatlogMessageComposer(_loc2_),this.var_73,WindowTracker.const_1220,_loc2_),this._window,false,false,true);
      }

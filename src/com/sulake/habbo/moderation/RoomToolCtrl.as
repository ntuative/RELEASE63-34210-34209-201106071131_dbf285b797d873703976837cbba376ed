package com.sulake.habbo.moderation
{
   ...
   public class RoomToolCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1503:ICheckBoxWindow;
      
      private var var_1502:ICheckBoxWindow;
      ...
      public function show() : void
      {
         ...
         this.var_35.connection.send(new GetModeratorRoomInfoMessageComposer(this.var_391));
      ...
      public function populate() : void
      {
         ...
         this.var_1503 = ICheckBoxWindow(this._frame.findChildByName("lock_check"));
         this.var_1502 = ICheckBoxWindow(this._frame.findChildByName("changename_check"));
      ...
      private function onChatlog(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_35.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(0,this._data.flatId),this.var_35,WindowTracker.const_836,this._data.flatId),this._frame,false,false,true);
      }
      ...
      private function act(param1:Boolean) : void
      {
         ...
         this.var_35.connection.send(new ModeratorActionMessageComposer(ModeratorActionMessageComposer.const_1722,_loc2_,this.var_525.text,"",""));
         if(this.var_1503.isSelected || this.var_1502.isSelected || this.var_978.isSelected)
         {
            this.var_35.connection.send(new ModerateRoomMessageComposer(this._data.flatId,this.var_1503.isSelected,this.var_1502.isSelected,this.var_978.isSelected));
         }
         this.dispose();
      }
      ...
      private function determineAction(param1:Boolean, param2:Boolean) : int
      {
         if(param2)
         {
            return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1863);
         }
         return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1745);
      }
      ...
      private function onSelectTemplate(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = this.var_35.initMsg.roomMessageTemplates[this.var_1234.selection];
         if(_loc3_ != null)
         {
            this.var_687 = false;

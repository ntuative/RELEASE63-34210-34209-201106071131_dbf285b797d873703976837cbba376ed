package com.sulake.habbo.moderation
{
   ...
   public class IssueBundle
   {
      ...
      private var var_777:IssueMessageData = null;
      ...
      public function IssueBundle(param1:int, param2:IssueMessageData)
      {
         ...
         this.var_2487 = param2.pickerUserId;
         this.var_2488 = param2.pickerUserName;
         this.var_1596 = param2.reportedUserId;
      ...
      private function addIssue(param1:IssueMessageData) : void
      {
         ...
         if(this.var_777 == null || param1.timeStamp < this.var_777.timeStamp)
         {
            this.var_777 = param1;
         }
      ...
      {
         var _loc3_:* = null;
         var _loc2_:IssueMessageData = this.var_777;
         if(_loc2_ == null)
         {

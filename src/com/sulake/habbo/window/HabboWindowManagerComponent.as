package com.sulake.habbo.window
{
   ...
   public class HabboWindowManagerComponent extends Component implements IHabboWindowManager, ICoreWindowManager, IWindowFactory, IUpdateReceiver, IWindowContextStateListener
   {
      ...
      private static const const_472:uint = 3;
      
      private static const const_1646:uint = 1;
      ...
      private var var_1084:IWindowRenderer;
      
      private var _skinContainer:ISkinContainer;
      
      private var var_294:Array;
      
      private var var_1630:IEventDispatcher;
      
      private var var_1355:Boolean = false;
      
      private var var_2102:ProfilerOutput;
      
      private var var_1631:ProfilerAgentTask;
      
      private var var_1629:ProfilerAgentTask;
      ...
      private function initialize(param1:IID, param2:IUnknown) : void
      {
         ...
         this.var_1084 = new WindowRenderer(this._skinContainer);
         this._windowContextArray = new Array(const_472);
         ...
         var _loc6_:int = 0;
         while(_loc6_ < const_472)
         {
            this._windowContextArray[_loc6_] = new WindowContext("layer_" + _loc6_,this.var_1084,this,this._localization,context.displayObjectContainer,_loc5_,this);
            _loc6_++;
         }
         this.var_676 = this._windowContextArray[const_1646];
         unlock();
      ...
      private function receiveProfilerInterface(param1:IID, param2:IUnknown) : void
      {
         ...
         if(_loc3_ != null)
         {
            if(!this.var_2102)
            {
               this.var_2102 = new ProfilerOutput(context,this,this.var_1084);
            }
            this.var_2102.profiler = _loc3_;
            ...
            this.var_1629 = new ProfilerAgentTask("Redraw","Window rasterizer");
            _loc3_.getProfilerAgentForReceiver(this).addSubTask(this.var_1629);
            this.var_1355 = true;
         }
      }
      ...
      {
         return this.var_676.create(param1,param7,param2,param3,param4,param5,param6,param10,param8,param11,param9);
      }
      ...
      {
         return this.var_676.getWindowParser().windowToXMLString(param1);
      }
      
      public function getLayoutByTypeAndStyle(param1:uint, param2:uint) : XML
      {
         var _loc3_:Dictionary = this.var_294[param2] as Dictionary;
         if(_loc3_ == null)
         {
            return null;
         }
         var _loc4_:XML = _loc3_[param1] as XML;
         return _loc4_ == null ? this.var_294[0][param1] as XML : _loc4_;
      }
      ...
      {
         return this._windowContextArray[param1].getDesktopWindow().getChildAt(this.var_676.getDesktopWindow().numChildren - 1);
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         if(WindowContext.var_413.length > 0)
         {
            this.var_1630.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_INPUT));
            _loc2_ = const_472 - 1;
            while(_loc2_ >= 0)
            {
         ...
         this.var_1630.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_RENDER));
         _loc2_ = 0;
         while(_loc2_ < const_472)
         {
         ...
         if(WindowContext.var_413.length > 0)
         {
            WindowContext.var_413.flush();
         }
         MouseCursorControl.change();
         this.var_1630.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_SLEEP));
      }
      ...
      public function mouseEventReceived(param1:String, param2:IWindow) : void
      {
         if(param2 != null)
         {
            ...
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1794,new Date().getTime().toString());
            ...
            else if(param1 == MouseEvent.MOUSE_UP)
            {
               ...
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1939,param2.name + ": " + param2.toString());
            }
         }
      }

package com.sulake.habbo.inventory.badges
{
   ...
   public class BadgesView implements IInventoryView
   {
      ...
      private var var_1014:IItemGridWindow;
      ...
      public function BadgesView(param1:BadgesModel, param2:IHabboWindowManager, param3:IAssetLibrary)
      {
         ...
         this.var_667 = this._view.findChildByName("inactive_items") as IItemGridWindow;
         this.var_667.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onInactiveBadgeClick);
         this.var_1014 = this._view.findChildByName("active_items") as IItemGridWindow;
         this.var_1014.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onActiveBadgeClick);
      }
      ...
      private function updateListViews() : void
      {
         ...
         var _loc1_:Number = this.var_667.scrollV;
         this.var_667.removeGridItems();
         this.var_1014.removeGridItems();
         var _loc2_:Array = this.var_76.getBadges(BadgesModel.const_559);
         var _loc4_:int = 0;
         while(_loc4_ < _loc2_.length)
         {
            ...
            if(!_loc3_.isInUse)
            {
               this.var_667.addGridItem(_loc3_.window);
         ...
         if(_loc1_ > 0)
         {
            this.var_667.scrollV = _loc1_;
         }
         var _loc5_:Array = this.var_76.getBadges(BadgesModel.const_349);
         _loc4_ = 0;
         while(_loc4_ < _loc5_.length)
         {
            _loc3_ = _loc5_[_loc4_] as Badge;
            this.var_1014.addGridItem(_loc3_.window);
      ...
      public function updateActionView() : void
      {
         ...
         else
         {
            ...
            _loc3_ = this.var_76.getBadges(BadgesModel.const_349);
      ...
      {
         var _loc2_:int = this.var_667.getGridItemIndex(param1.window);
      ...
      {
         var _loc2_:int = this.var_1014.getGridItemIndex(param1.window);

package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingView implements IInventoryView, IGetImageListener
   {
      ...
      private static const const_1049:uint = 4284532064;
      
      private static const const_1048:uint = 2577770;
      ...
      private var var_641:ItemPopupCtrl;
      ...
      private var var_1871:IWindowContainer;
      
      private var var_215:Timer;
      
      private var var_977:GroupItem;
      ...
      public function TradingView(param1:TradingModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IRoomEngine, param5:IHabboLocalizationManager, param6:IHabboSoundManager)
      {
         ...
         this.var_641 = new ItemPopupCtrl(_loc9_,this._assetLibrary);
      ...
      public function getWindowContainer() : IWindowContainer
      {
         ...
         {
            this.var_1871 = this.createMinimizedWindow();
         }
         if(!this.var_2583)
         {
            return this.var_78;
      ...
      public function updateUserInterface() : void
      {
         ...
         if(this.var_78)
         {
            ...
            if(_loc1_)
            {
               _loc1_.color = !!this.var_20.ownUserAccepts ? uint(const_1049) : uint(const_1048);
            }
            ...
            if(_loc1_)
            {
               _loc1_.color = !!this.var_20.otherUserAccepts ? uint(const_1049) : uint(const_1048);
            }
      ...
      private function thumbEventProc(param1:WindowEvent, param2:IWindow, param3:Boolean) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            if(_loc5_.category == FurniCategory.const_1707)
            {
            ...
            this.var_641.updateContent(param2 as IWindowContainer,_loc7_,_loc6_,ItemPopupCtrl.const_621);
            this.var_641.show();
         }
         else if(param1.type == WindowMouseEvent.const_25)
         {
            this.var_641.hideDelayed();
         }
      }
         ...
         if(this.var_190.length > 0)
         {
            ...
            if(_loc5_.extra == param1.id)
            {
               if(_loc2_ && this.var_20.ownUserItems.getWithIndex(_loc4_) == _loc3_ || !_loc2_ && this.var_20.otherUserItems.getWithIndex(_loc4_) == _loc3_)
               {
                  ...
                  this.var_641.updateContent(_loc8_ as IWindowContainer,_loc6_,_loc7_,ItemPopupCtrl.const_621);
               }
            }
            else
            {

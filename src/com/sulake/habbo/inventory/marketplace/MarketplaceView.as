package com.sulake.habbo.inventory.marketplace
{
   ...
   public class MarketplaceView implements IGetImageListener
   {
      ...
      public function showMakeOffer(param1:IItem) : void
      {
         ...
         this.var_2836 = this._localization.getKey(_loc5_);
      ...
      {
         this._localization.registerParameter("inventory.marketplace.confirm_offer.info","furniname",this.var_2836);
         this._localization.registerParameter("inventory.marketplace.confirm_offer.info","price",this.var_2065.toString());
      ...
      private function confirmationCallback(param1:IConfirmDialog, param2:WindowEvent) : void
      {
         ...
         {
            this.var_76.makeOffer(this.var_2065);
         }
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               ...
               case "make_offer_button":
                  ...
                  if(_loc3_ != null)
                  {
                     this.var_2065 = parseInt(_loc3_.text);

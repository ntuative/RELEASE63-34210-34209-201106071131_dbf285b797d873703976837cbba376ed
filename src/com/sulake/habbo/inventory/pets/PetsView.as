package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsView implements IInventoryView, IPetImageListener, IGetImageListener
   {
      ...
      private const const_2036:int = 0;
      
      private const const_1115:int = 1;
      
      private const const_1112:int = 2;
      
      private const const_1116:int = 3;
      ...
      private var var_220:IItemGridWindow;
      ...
      private var var_228:PetsGridItem;
      ...
      public function PetsView(param1:PetsModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:IRoomEngine, param6:IAvatarRenderManager)
      {
         ...
         this.var_220 = this._view.findChildByName("grid") as IItemGridWindow;
      ...
      public function update() : void
      {
         ...
         this.updateGrid();
         this.updatePreview(this.var_228);
      }
      
      public function removePet(param1:int) : void
      {
         var _loc2_:PetsGridItem = this.var_522.remove(param1) as PetsGridItem;
         if(_loc2_ == null)
         {
            return;
         }
         this.var_220.removeGridItem(_loc2_.window);
         if(this.var_228 == _loc2_)
         {
            this.var_228 = null;
            this.selectFirst();
         }
      ...
      {
         if(this.var_522 == null || this.var_522.length == 0)
         {
            this.updatePreview();
            return;
         }
         this.setSelectedGridItem(this.var_522.getWithIndex(0));
      }
      ...
      public function addPet(param1:PetData) : void
      {
         ...
         if(this.var_522.getValue(param1.id) != null)
         {
            return;
         }
         ...
         if(_loc2_ != null)
         {
            this.var_220.addGridItem(_loc2_.window);
            this.var_522.add(param1.id,_loc2_);
      ...
      private function placeButtonClickHandler(param1:WindowMouseEvent) : void
      {
         ...
         var _loc2_:PetData = this.var_228.pet;
         if(_loc2_ == null)
         {
            return;
         }
         ...
         if(param1.type == WindowEvent.const_49)
         {
            switch(param2.name)
            {
               case "tab_floor":
                  ...
                  break;
               case "tab_wall":
                  this.var_76.switchToFurnitureCategory(FurniModelCategory.const_46);
            }
            this.selectPetsTab();
         }
      }
      ...
      public function setSelectedGridItem(param1:PetsGridItem) : void
      {
         if(this.var_228 != null)
         {
            this.var_228.setSelected(false);
         }
         this.var_228 = param1;
         if(this.var_228 != null)
         {
            this.var_228.setSelected(true);
         }
      ...
      public function updateCategoryButtons() : void
      {
         ...
         _loc1_.visible = this.var_76.furniModel.getUnseenItemCount(UnseenItemCategoryEnum.const_443) > 0;
         _loc1_ = this._view.findChildByTag("unseen_symbol_wall");
         _loc1_.visible = this.var_76.furniModel.getUnseenItemCount(UnseenItemCategoryEnum.const_405) > 0;

package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsGridItem
   {
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         switch(param1.type)
         {
            case WindowMouseEvent.const_45:
               this.var_1644.setSelectedGridItem(this);
               this.var_1645 = true;
               break;
            ...
            case WindowMouseEvent.const_25:
               ...
               {
                  this.var_1645 = false;
                  this.var_1644.placePetToRoom(this._petData.id,true);
               }
         }
      }
      ...
      public function setSelected(param1:Boolean) : void
      {
         ...
         this.var_1483.color = !!this.var_1593 ? uint(const_1445) : uint(const_1444);
         this.var_2429.visible = param1;
      }

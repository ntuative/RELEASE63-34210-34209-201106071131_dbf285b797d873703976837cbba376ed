package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      private static const const_1444:int = 13421772;
      
      private static const const_1445:int = 10275685;
      ...
      protected var var_901:int = 0;
      
      protected var var_717:BitmapData;
      ...
      protected var var_2980:BitmapData;
      
      private var var_1460:Boolean;
      
      private const const_2008:Number = 1;
      
      private const const_2009:Number = 0.2;
      ...
      public function GroupItem(param1:int, param2:String, param3:int, param4:IWindowContainer, param5:IRoomEngine, param6:BitmapData, param7:Boolean, param8:String = null, param9:Number = NaN, param10:BitmapData = null, param11:Boolean = false)
      {
         ...
         this.var_2429 = this._window.findChildByName("outline");
         this._roomEngine = param5;
         this.var_2980 = param6;
      ...
      public function initImage(param1:Boolean = true) : void
      {
         ...
         if(this.var_2195 == FurniModelCategory.const_36)
         {
            _loc2_ = this._roomEngine.getFurnitureIcon(this._type,this,String(this.var_1463));
         }
         else
         {
            _loc2_ = this._roomEngine.getWallItemIcon(this._type,this,this.var_2196);
         }
         if(_loc2_.id > 0)
         {
            if(param1)
      ...
      public function method_6(param1:int) : IItem
      {
      ...
      public function updateThumbData() : void
      {
         ...
         if(_loc1_)
         {
            ...
            if(_loc2_ <= 0)
            {
               this._window.blend = this.const_2009;
               _loc1_.blend = this.const_2009;
            }
            else
            {
               this._window.blend = this.const_2008;
               _loc1_.blend = this.const_2008;
            }
         }
         this.var_1483.color = !!this.var_1460 ? uint(const_1445) : uint(const_1444);
         this.var_2429.visible = this.isSelected;
         ...
         if(_loc5_)
         {
            if(this.var_2194 && this.getRecyclableCount() > 0)
            {
               _loc5_.bitmap = this.var_2980;
               _loc5_.visible = true;
            }
            else
            {

package com.sulake.habbo.inventory
{
   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      private const const_2273:int = 500;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_16 != null)
         {
            ...
            this.var_16.events.removeEventListener(RoomSessionPropertyUpdateEvent.const_614,this.roomSessionEventHandler);
      ...
      public function get furniModel() : FurniModel
      {
         ...
         return FurniModel(this.var_55.getValue(InventoryCategory.const_79));
      }
      ...
      public function get tradingModel() : TradingModel
      {
         ...
         return TradingModel(this.var_55.getValue(InventorySubCategory.const_356));
      }
      ...
      public function get effectsModel() : EffectsModel
      {
         ...
         return EffectsModel(this.var_55.getValue(InventoryCategory.const_926));
      }
      ...
      public function get badgesModel() : BadgesModel
      {
         ...
         return BadgesModel(this.var_55.getValue(InventoryCategory.const_249));
      }
      ...
      public function get recyclerModel() : RecyclerModel
      {
         ...
         return RecyclerModel(this.var_55.getValue(InventorySubCategory.const_1246));
      }
      ...
      public function get petsModel() : PetsModel
      {
         ...
         return PetsModel(this.var_55.getValue(InventoryCategory.const_133));
      }
      ...
      public function get marketplaceModel() : MarketplaceModel
      {
         ...
         return this.var_55.getValue(InventoryCategory.const_418) as MarketplaceModel;
      }
      ...
      {
         this.var_366 = ISessionDataManager(param2);
         this.initInventory();
      }
      ...
      private function onRoomSessionManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_16.events.addEventListener(RoomSessionPropertyUpdateEvent.const_614,this.roomSessionEventHandler);
         this.initInventory();
      }
      ...
      private function roomSessionEventHandler(param1:RoomSessionEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomSessionEvent.const_82:
               this.var_1165 = null;
               break;
            case RoomSessionPropertyUpdateEvent.const_614:
               if(this.petsModel != null)
               {
                  this.petsModel.updatePetsAllowed();
               }
      ...
      {
         if(!this._communication || !this._windowManager || !this._localization || !this._roomEngine || !this.var_366 || !this._config || !this._catalog || !this._avatarRenderer || !this.var_16 || !this._toolbar || !this._soundManager)
         {
            return;
         }
         ...
         this.var_55.add(InventoryCategory.const_418,_loc1_);
         ...
         this.var_55.add(InventoryCategory.const_79,_loc2_);
         var _loc3_:BadgesModel = new BadgesModel(this,this._windowManager,this._communication,this._assetLibrary,this.var_366);
         this.var_55.add(InventoryCategory.const_249,_loc3_);
         ...
         this.var_55.add(InventoryCategory.const_926,_loc4_);
         var _loc5_:AchievementsModel = new AchievementsModel(this,this._windowManager,this._communication,this._assetLibrary,this._localization,this.var_366);
         ...
         this.var_55.add(InventorySubCategory.const_356,_loc6_);
         ...
         this.var_55.add(InventorySubCategory.const_1246,_loc7_);
         ...
         this.var_55.add(InventoryCategory.const_133,_loc8_);
      ...
      public function setInventoryCategoryInit(param1:String, param2:Boolean = true) : void
      {
         ...
         if(param2)
         {
            if(this.var_935.indexOf(param1) == -1)
            {
         ...
         {
            _loc3_ = this.var_935.indexOf(param1);
            if(_loc3_ >= 0)
            {
               this.var_935.splice(_loc3_,1);
            }
         }
      }
      ...
      {
         if(this.var_935.indexOf(param1) >= 0)
         {
            return true;
         }
         return false;
      ...
      public function requestInventoryCategoryInit(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.requestInitialization(this.const_2273);
         }
      }
      
      public function notifyChangedEffects() : void
      {
         events.dispatchEvent(new HabboInventoryEffectsEvent(HabboInventoryEffectsEvent.const_416));
      }
      ...
      public function updateUnseenItemCounts() : void
      {
         ...
         if(_loc1_ != this.var_2351)
         {
            this.var_2351 = _loc1_;

package com.sulake.habbo.inventory.effects
{
   ...
   public class EffectsView implements IInventoryView
   {
      ...
      public function EffectsView(param1:EffectsModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:IThumbListDataProvider, param6:IThumbListDataProvider)
      {
         ...
         this.var_758 = new ThumbListManager(this._assetLibrary,param5,"thumb_bg_png","thumb_bg_selected_png",this.getActiveThumbListImageWidth(),this.getActiveThumbListImageHeight());
         this.var_759 = new ThumbListManager(this._assetLibrary,param6,"thumb_bg_png","thumb_bg_selected_png",this.getActiveThumbListImageWidth(),this.getActiveThumbListImageHeight());
      ...
      public function updateListViews() : void
      {
         ...
         var _loc1_:IBitmapWrapperWindow = this._view.findChildByName("inactive_items_image") as IBitmapWrapperWindow;
         var _loc2_:BitmapData = this.var_759.getListImage();
         ...
         var _loc4_:BitmapData = this.var_758.getListImage();

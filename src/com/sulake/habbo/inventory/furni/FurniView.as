package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniView implements IInventoryView, IGetImageListener
   {
      ...
      private static const const_2036:int = 0;
      ...
      private static const const_1114:int = 42;
      
      private static const const_1113:int = 120;
      
      private static const const_1044:int = 4;
      ...
      private var var_778:MarketplaceModel;
      ...
      public function FurniView(param1:FurniModel, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IRoomEngine, param6:IHabboSoundManager)
      {
         ...
         this.var_407.add(FurniModelCategory.const_36,new FurniGridView(this.var_76,FurniModelCategory.const_36,this._windowManager,this._assetLibrary,this._roomEngine));
         this.var_407.add(FurniModelCategory.const_46,new FurniGridView(this.var_76,FurniModelCategory.const_46,this._windowManager,this._assetLibrary,this._roomEngine));
      ...
      private function addUnseenItemSymbols() : void
      {
         ...
         for each(_loc5_ in ["floor","wall","pets"])
         {
            ...
            _loc3_.x = _loc4_.rectangle.right - _loc3_.width - const_1044;
            _loc3_.y = _loc4_.y + const_1044;
      ...
      public function switchCategory(param1:String) : void
      {
         ...
         switch(param1)
         {
            case FurniModelCategory.const_46:
               ...
               this.var_484 = FurniModelCategory.const_46;
               break;
            ...
            case FurniModelCategory.const_242:
               ...
               this.var_484 = FurniModelCategory.const_242;
               break;
            default:
      ...
      private function showCategoryGrid(param1:String = null) : void
      {
         ...
         var _loc3_:FurniGridView = this.var_407.getValue(this.var_484);
         if(_loc3_)
         {
      ...
      public function setViewToState() : void
      {
         ...
         if(this.var_2509 == _loc2_)
         {
            return;
         }
         this.var_2509 = _loc2_;
      ...
      public function clearViews() : void
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         var _loc1_:Array = [FurniModelCategory.const_36,FurniModelCategory.const_46];
         var _loc4_:int = 0;
      ...
      public function updateCategoryButtons() : void
      {
         ...
         _loc1_.visible = this.var_76.getUnseenItemCount(UnseenItemCategoryEnum.const_443) > 0;
         _loc1_ = this._view.findChildByTag("unseen_symbol_wall");
         _loc1_.visible = this.var_76.getUnseenItemCount(UnseenItemCategoryEnum.const_405) > 0;
      ...
      public function updateActionView() : void
      {
         ...
         if(_loc3_ > -1 && _loc4_ != null && _loc4_.peek() != null)
         {
            _loc5_ = _loc4_.peek();
            _loc1_ = true;
            _loc16_ = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_207);
            ...
            if(_loc5_.category == FurniCategory.const_325)
            {
         ...
         if(_loc11_)
         {
            if(_loc1_ && this.var_778 && this.var_778.isEnabled && _loc5_.sellable)
            {
               _loc11_.enable();
            }
            else
      ...
      private function setPreviewImage(param1:BitmapData) : void
      {
         ...
         if(_loc3_ > const_1113)
         {
            _loc3_ = const_1113;
         }
         else if(_loc3_ < const_1114)
         {
            _loc3_ = const_1114;
         }
         else

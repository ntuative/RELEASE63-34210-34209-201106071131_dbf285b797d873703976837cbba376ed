package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniGridView
   {
      ...
      public function FurniGridView(param1:FurniModel, param2:String, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IRoomEngine)
      {
         ...
         if(this._view != null)
         {
            this.var_220 = this._view.findChildByName("item_grid") as IItemGridWindow;
         }
      }
      ...
      {
         var _loc3_:IWindow = this.var_220.getGridItemAt(param1);
         if(_loc3_)
         {
            _loc3_ = param2;
         }
      ...
      public function setLock(param1:Boolean) : void
      {
         if(param1)
         {
            this.var_220.autoArrangeItems = false;
            this.var_220.lock();
         }
         else
         {
            this.var_220.autoArrangeItems = true;
            this.var_220.unlock();
         }
      }
      ...
      private function itemEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.const_45)
         {
            ...
            this.var_76.toggleItemSelection(this._category,this.var_220.getGridItemIndex(param1.window));
            this.var_548 = param2;
         }
         else if(param1.type == WindowMouseEvent.const_25 && this.var_548 != null && this.var_548 == param2 && !this.var_76.isTradingOpen)
         {
         ...
         else if(param1.type == WindowMouseEvent.const_148)
         {

package com.sulake.habbo.inventory.achievements
{
   ...
   public class AchievementsView implements IInventoryView
   {
      ...
      {
         Logger.log("Got badge: " + param1.badgeId + ", " + this.var_452.running);
      ...
      private function refreshBadgeImage(param1:IWindowContainer, param2:AchievementData) : void
      {
         ...
         var _loc4_:BitmapData = this.var_768[param2.badgeId];
         if(_loc4_ == null)
         {
            _loc4_ = this.var_366.getBadgeImage(param2.badgeId);
            this.var_768[param2.badgeId] = _loc4_;
         }

package com.sulake.habbo.inventory.common
{
   ...
   public class ThumbListManager
   {
      ...
      private var var_1564:IThumbListDataProvider;
      ...
      public function ThumbListManager(param1:IAssetLibrary, param2:IThumbListDataProvider, param3:String, param4:String, param5:int, param6:int)
      {
         ...
         if(_loc7_ != null)
         {
            this.var_679 = BitmapData(_loc7_.content);
         }
         ...
         this._thumbWidth = this.var_679.width;
         this.var_105 = this.var_679.height;
         this.var_1286 = param5;
         this.var_1022 = param6;
         this.var_244 = Math.floor(this.var_1286 / this._thumbWidth);
         this.var_29 = new BitmapData(this.var_1286,this.var_1022);
      }
      ...
      public function updateImageFromList() : void
      {
         ...
         var _loc5_:* = null;
         var _loc6_:* = null;
         this.var_678 = this.resolveRowCountFromList();
         if(this.var_678 == 0)
         {
            this.var_29 = new BitmapData(this.var_1286,this.var_1022);
            return;
         }
         this.var_29 = new BitmapData(Math.max(this.var_244 * this._thumbWidth,this.var_1286),Math.max(this.var_678 * this.var_105,this.var_1022),true,16777215);
         this.var_29.fillRect(this.var_29.rect,4294967295);
         var _loc1_:int = 0;
         var _loc2_:Array = this.getList();
         var _loc3_:int = 0;
         while(_loc3_ < this.var_678)
         {
            _loc4_ = 0;
      ...
      public function addItemAsFirst(param1:IThumbListDrawableItem) : void
      {
         ...
         if(_loc3_.x == this.var_244 && this.var_29.height < _loc3_.y * this.var_105)
         {
         ...
         _loc4_ = new Rectangle(0,0,this._thumbWidth * (this.var_244 - 1),this.var_105);
         _loc2_.copyPixels(this.var_29,_loc4_,new Point(this._thumbWidth,0),null,null,true);
         _loc4_ = new Rectangle(this._thumbWidth * (this.var_244 - 1),0,this._thumbWidth,this.var_29.height);
         _loc2_.copyPixels(this.var_29,_loc4_,new Point(0,this.var_105),null,null,true);
         _loc4_ = new Rectangle(0,this.var_105,this._thumbWidth * (this.var_244 - 1),this.var_29.height - this.var_105);
      ...
      private function getList() : Array
      {
         ...
         {
            _loc1_ = this.var_1564.getDrawableList();
         }
      ...
      private function removeItemInImage(param1:Point) : void
      {
         ...
         if(this.var_29.height < this.var_1022)
         {
            _loc12_ = new BitmapData(this.var_29.width,this.var_1022);
      ...
      {
         var _loc4_:* = null;
         var _loc3_:BitmapData = new BitmapData(this.var_679.width,this.var_679.height);
         if(param2)
         {
            _loc3_.copyPixels(this._itemBgImageSelected,this.var_679.rect,new Point(0,0),null,null,false);
         }
         else
         {
            _loc3_.copyPixels(this.var_679,this.var_679.rect,new Point(0,0),null,null,false);
         }
         if(param1 != null)
         {

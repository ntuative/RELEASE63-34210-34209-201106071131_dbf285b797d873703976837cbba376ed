package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarExtension
   {
      ...
      private static const const_1434:uint = 16777215;
      
      private static const const_1436:uint = 12247545;
      
      private static const const_1435:String = "HELP";
      
      private static const const_1433:String = "ROOMINFO";
      ...
      private const const_1009:int = 41;
      ...
      public function ToolbarExtension(param1:HabboToolbar, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IEventDispatcher, param5:IHabboConfigurationManager)
      {
         ...
         this.var_400 = this._window.findChildByName("roominfo_region");
      ...
      {
         this.var_66.removeListItem(this.var_400);
      }
      
      public function showRoomInfo() : void
      {
         this.var_66.addListItemAt(this.var_400,0);
      }
      ...
      private function createWindow(param1:String) : IWindow
      {
         ...
         _loc3_.x = _loc4_.width - _loc3_.width - this.const_718;
         _loc3_.y = this.const_1009;
         return _loc3_;
      }
      ...
      private function showConfirmation() : void
      {
         if(!this.var_620)
         {
            this.var_620 = this.createWindow("logout_confirmation_xml") as IWindowContainer;
         }
      }
      ...
      private function onClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "logout_region":
               ...
               break;
            case "help_region":
               this._toolbar.toggleWindowVisibility(const_1435);
               break;
            case "roominfo_region":
               this._toolbar.toggleWindowVisibility(const_1433);
               break;
            case "confirm":
               if(false)
               {

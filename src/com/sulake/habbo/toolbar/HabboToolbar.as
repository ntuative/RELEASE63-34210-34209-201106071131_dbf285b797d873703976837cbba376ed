package com.sulake.habbo.toolbar
{
   ...
   public class HabboToolbar extends Component implements IHabboToolbar
   {
      ...
      private var var_824:ToolbarExtension;
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         {
            this.var_824 = new ToolbarExtension(this,this._windowManager,this._assetLibrary,events,this._config);
         }
         if(this._view == null)
         {
      ...
      private function toolbarExtensionVisible(param1:Boolean) : void
      {
         ...
         if(param1)
         {
            this.var_824.showRoomInfo();
         }
         else
         {
            this.var_824.hideRoomInfo();
         }
      }

package com.sulake.core.assets
{
   ...
   public class AssetLibraryCollection extends EventDispatcher implements IAssetLibrary
   {
      ...
      protected var var_1117:LoaderContext;
      ...
      public function AssetLibraryCollection(param1:String)
      {
         ...
         this.var_1117 = new LoaderContext(false,ApplicationDomain.currentDomain,null);
         this.var_496 = new AssetLibrary("lib-" + this.var_592++);
         this.var_31.push(this.var_496);
      }
      ...
      public function loadFromFile(param1:LibraryLoader, param2:Boolean = false) : void
      {
         ...
         {
            this.loaderContext = this.var_1117;
         }
      ...
      public function unload() : void
      {
         ...
         {
            (this.var_588.pop() as IAssetLibrary).dispose();
         }
      ...
      private function loadEventHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         if(param1.type == LibraryLoaderEvent.LIBRARY_LOADER_EVENT_COMPLETE)
         {
            ...
            _loc4_ = 0;
            while(_loc4_ < this.var_588.length)
            {
               _loc3_ = this.var_588[_loc4_] as IAssetLibrary;
               if(_loc3_.url == _loc2_.url)
               {
                  this.var_588.splice(_loc4_,1);
                  break;
               }
               _loc4_++;
            }
      ...
      public function method_12(param1:String) : Boolean
      {
         var _loc3_:* = null;

package com.sulake.core.assets
{
   ...
   public class BitmapDataAsset implements ILazyAsset
   {
      ...
      protected static var var_593:uint = 0;
      
      protected static var var_542:uint = 0;
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._bitmap)
            {
               try
               {
                  var_542 -= this._bitmap.width * this._bitmap.height * 4;
      ...
      public function prepareLazyContent() : void
      {
         ...
         if(this.var_119 is BitmapDataAsset)
         {
            ...
            this.var_1627 = BitmapDataAsset(this.var_119).var_1627;
            this.var_1628 = BitmapDataAsset(this.var_119).var_1628;
            if(this._bitmap != null)
            {
               this.var_119 = null;
               return;
         ...
         while(_loc2_ < param1.length())
         {
            ...
            switch(_loc3_)
            {
               case "offset":
                  ...
                  break;
               case "flipH":
                  this.var_1627 = _loc4_ == "1" || _loc4_ == "true";
                  break;
               case "flipV":
                  this.var_1628 = _loc4_ == "1" || _loc4_ == "true";
                  break;
            }
            _loc2_++;
         }

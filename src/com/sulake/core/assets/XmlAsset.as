   ...
   public class XmlAsset implements IAsset
   {
      ...
      public function setUnknownContent(param1:Object) : void
      {
         ...
         if(param1 is Class)
         {
            ...
            this.var_188 = new XML(_loc2_.readUTFBytes(_loc2_.length));
            return;
         }
         ...
         if(param1 is String)
         {
            this.var_188 = new XML(param1 as String);
            return;
         }
         if(param1 is XML)
         {
            this.var_188 = param1 as XML;
            return;
         }
         if(param1 is XmlAsset)
         {
            this.var_188 = XmlAsset(param1).var_188;
            return;
         }
      }

package com.sulake.core.runtime
{
   ...
   public final class CoreComponentContext extends ComponentContext implements ICore
   {
      ...
      private static const const_1531:String = "asset-libraries";
      
      private static const const_1538:String = "library";
      
      private static const const_1536:String = "service-libraries";
      
      private static const const_1533:String = "library";
      
      private static const const_1532:String = "component-libraries";
      
      private static const const_1535:String = "library";
      
      private static const const_1530:String = "error_data";
      
      private static const const_1537:String = "error_cat";
      
      private static const const_1534:String = "error_desc";
       
      
      private var var_373:LibraryLoaderQueue;
      
      private var var_810:IEventDispatcher;
      
      private var var_537:uint;
      
      private var var_374:Function;
      ...
      public function CoreComponentContext(param1:DisplayObjectContainer, param2:uint)
      {
         ...
         switch(param2 & 0)
         {
            case Core.const_1269:
               ...
               this.var_374 = this.simpleFrameUpdateHandler;
               break;
            case Core.const_929:
               debug("Core; using complex frame update handler");
               this.var_374 = this.complexFrameUpdateHandler;
               break;
            case Core.const_792:
               debug("Core; using profiler frame update handler");
               this.var_374 = this.profilerFrameUpdateHandler;
               this.var_217 = new Profiler(this);
               attachComponent(this.var_217,[new IIDProfiler()]);
               var_414.addChild(new ProfilerViewer(this.var_217));
               break;
            case Core.const_594:
               debug("Core; using experimental frame update handler");
               this.var_374 = this.experimentalFrameUpdateHandler;
               break;
            case Core.CORE_SETUP_DEBUG:
               debug("Core; using debug frame update handler");
               this.var_374 = this.debugFrameUpdateHandler;
         }
      }
      ...
      override public function error(param1:String, param2:Boolean, param3:int = -1, param4:Error = null) : void
      {
         if(param4)
         {
            ErrorReportStorage.setParameter(const_1530,String(param4.getStackTrace()));
         }
         ErrorReportStorage.setParameter(const_1537,String(param3));
         ErrorReportStorage.setParameter(const_1534,param1);
      ...
      public function readConfigDocument(param1:XML, param2:IEventDispatcher = null) : void
      {
         ...
         this.var_810 = loadingEventDelegate;
         if(this.var_373 == null)
         {
         ...
         try
         {
            node = config.child(const_1536)[0];
            if(node != null)
            {
               list = node.child(const_1533);
               for each(item in list)
               {
                  url = item.attribute("url").toString();
                  loader = new LibraryLoader(context,true,_debug);
         ...
         try
         {
            node = config.child(const_1532)[0];
            if(node != null)
            {
               list = node.child(const_1535);
               for each(item in list)
               {
                  url = item.attribute("url").toString();
                  loader = new LibraryLoader(context,true,_debug);
      ...
      private function errorInLoadingProcess(param1:LibraryLoaderEvent = null) : void
      {
         ...
         this.error("Failed to download library \"" + _loc2_.url + "\" HTTP status " + param1.status + ": " + _loc2_.getLastErrorMessage(),true,Core.const_1228);
         if(!disposed)
         {
      ...
      private function finalizeLoadingEventDelegate() : void
      {
         if(this.var_810)
         {
            this.var_810.dispatchEvent(new Event(Event.COMPLETE));
         }
      }
      ...
      private function updateLoadingProgress(param1:LibraryLoaderEvent = null) : void
      {
         ...
         if(this.var_810)
         {
            ...
            this.var_810.dispatchEvent(new LibraryProgressEvent(_loc2_.url,param1.bytesLoaded,param1.bytesTotal,_loc2_.elapsedTime));
         }
      }
         ...
         if(param1 != null)
         {
            if(param1.type == LibraryLoaderEvent.LIBRARY_LOADER_EVENT_COMPLETE || param1.type == LibraryLoaderEvent.LIBRARY_LOADER_EVENT_ERROR)
            {
               ...
               if(!disposed)
               {
                  if(this.var_810)
                  {
                     this.var_810.dispatchEvent(new LibraryProgressEvent(_loc2_.url,this.var_537 - this.var_373.length,this.var_537,_loc2_.elapsedTime));
                  }
               }
            }
         }
      ...
      override public function registerUpdateReceiver(param1:IUpdateReceiver, param2:uint) : void
      {
         ...
         var _loc3_:int = !!this.var_217 ? 0 : this.var_1521 & 0;
         if(_loc3_ == Core.const_594)
         {
      ...
      private function onEnterFrame(param1:Event) : void
      {
         ...
         this.var_374(_loc2_,_loc2_ - this._lastUpdateTimeMs);
      ...
      private function complexFrameUpdateHandler(param1:uint, param2:uint) : void
      {
         ...
         while(priority < CoreComponentContext.const_107)
         {
            ...
            {
               if(this.var_654[priority] < priority)
               {
                  ++this.var_654[priority];
                  skip = true;
               }
            }
            if(!skip)

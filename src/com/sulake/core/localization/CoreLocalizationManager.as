package com.sulake.core.localization
{
   ...
   public class CoreLocalizationManager extends Component implements ICoreLocalizationManager
   {
      ...
      {
         var _loc4_:LocalizationDefinition = this.var_985[param1];
         if(_loc4_ == null)
         {
            _loc4_ = new LocalizationDefinition(param1,param2,param3);
            this.var_985[param1] = _loc4_;
         }
      }
      
      public function activateLocalization(param1:String) : Boolean
      {
         var _loc2_:LocalizationDefinition = this.var_985[param1];
         if(_loc2_ != null)
         {
      ...
      {
         return this.var_985[param1] as ILocalizationDefinition;
      }
      
      public function getActiveLocalizationDefinition() : ILocalizationDefinition
      {
         return this.getLocalizationDefinition(this.var_2610);
      }
      ...
      private function onLocalizationReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            this.events.dispatchEvent(new Event(LocalizationEvent.const_179));
         }
      }
      ...
      public function updateKey(param1:String, param2:String) : void
      {
         ...
         {
            _loc3_.registerParameter("predefined",this.var_1894);
         }
      }
      ...
      public function printNonExistingKeys() : void
      {
         var _loc2_:* = null;
         var _loc1_:String = "";
         for each(_loc2_ in this.var_1245)
         {
            _loc1_ += _loc2_ + "\n";
         }
         Logger.log(_loc1_);
      ...
      protected function setPredefinedUrl(param1:String) : void
      {
         ...
         for each(_loc2_ in this.var_69)
         {
            ...
            {
               _loc2_.registerParameter("predefined",this.var_1894);
            }
         }
      }
   }

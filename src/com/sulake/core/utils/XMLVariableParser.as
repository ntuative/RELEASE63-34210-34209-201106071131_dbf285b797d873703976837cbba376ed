package com.sulake.core.utils
{
   ...
   public class XMLVariableParser
   {
      ...
      public static const const_1815:String = "float";
      
      public static const const_38:String = "Boolean";
      
      public static const const_1781:String = "bool";
      ...
      private static const const_694:String = "value";
      
      private static const const_691:String = "true";
      
      private static const const_2031:String = "false";
      ...
      private static function parseVariableToken(param1:XML, param2:Map, param3:Array = null) : void
      {
         ...
         _loc7_ = param1.attribute(const_694);
         if(_loc7_.length() > 0)
         {
            _loc6_ = String(param1.attribute(const_694));
         }
         if(_loc6_ != null)
         {
         ...
         {
            _loc8_ = param1.child(const_694)[0];
            if(_loc8_ != null)
            {
            ...
            else if(_loc5_ == const_259 || _loc5_ == const_146)
            {
      ...
      public static function castStringToType(param1:String, param2:String) : Object
      {
         switch(param2)
         {
            ...
            case const_1815:
               return Number(param1);
            case const_38:
               return param1 == const_691 || int(param1) > 0;
            case const_1781:
               return param1 == const_691 || int(param1) > 0;
            case const_168:
               return uint(param1);
            case const_146:
               return param1.split(const_1578);
            default:

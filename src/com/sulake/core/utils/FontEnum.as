package com.sulake.core.utils
{
   ...
   public class FontEnum
   {
      ...
      private static const const_668:Map = new Map();
      
      private static const const_375:Map = new Map();
      
      private static var var_1200:Boolean = false;
      ...
      {
         return const_668.getValue(param1) != null;
      }
      
      public static function isEmbeddedFont(param1:String) : Boolean
      {
         return const_375.getValue(param1) != null;
      }
      ...
      public static function registerFont(param1:Class) : Font
      {
         ...
         const_375.add(_loc4_.fontName,_loc4_);
         return _loc4_;
      }
      ...
      private static function init() : void
      {
         ...
         if(!var_1200)
         {
            ...
            for each(_loc3_ in _loc1_)
            {
               ...
               {
                  const_668.add(_loc3_.fontName,_loc3_);
               }
            }
            var_1200 = true;
         }
      ...
      public static function refresh() : void
      {
         ...
         while(_loc5_ < _loc4_)
         {
            ...
            _loc3_ = const_375.getValue(_loc2_.fontName);
            if(!_loc3_ || _loc3_.fontType != _loc2_.fontType || _loc3_.fontStyle != _loc2_.fontStyle)
            {
               const_375.add(_loc2_.fontName,_loc2_);
            }
            _loc5_++;
         }
      }

package com.sulake.core.window.components
{
   ...
   public class ItemListController extends WindowController implements IItemListWindow, IInputProcessorRoot
   {
      ...
      protected var var_2206:Boolean = false;
      ...
      public function ItemListController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         this.var_120 = 0;
         this.var_106 = 0;
         this._horizontal = param2 == WindowType.const_434;
         super(param1,param2,param3,param4,param5,param6,param7,param8,param9,param10,param11);
         var_184 = var_499 || !testParamFlag(WindowParam.const_34);
         this._container = _context.create("_CONTAINER","",WindowType.const_452,WindowStyle.const_124,0 | 0 | 0,new Rectangle(0,0,width,height),null,this,0,null,[TAG_INTERNAL,TAG_EXCLUDE]) as IWindowContainer;
         ...
         this._container.addEventListener(WindowEvent.const_189,this.containerEventHandler);
         this._container.addEventListener(WindowEvent.const_210,this.containerEventHandler);
         this._container.clipping = clipping;
         this.resizeOnItemUpdate = this.var_1391;
      }
      ...
      public function set scrollH(param1:Number) : void
      {
         ...
         if(param1 != this.var_718)
         {
            ...
            _loc2_ = WindowEvent.allocate(WindowEvent.const_524,this,null);
      ...
      public function set resizeOnItemUpdate(param1:Boolean) : void
      {
         ...
         if(this._container)
         {
            ...
            {
               this._container.setParamFlag(WindowParam.const_637,param1);
            }
         }
      }
      ...
      override public function dispose() : void
      {
         if(!_disposed)
         {
            ...
            this._container.removeEventListener(WindowEvent.const_189,this.containerEventHandler);
      ...
      public function process(param1:WindowEvent) : Boolean
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.const_178:
               if(this.var_1393)
               {
                  this.var_1390 = this.var_2208 - _loc3_;
                  this.var_1392 = this.var_2207 - _loc4_;
                  if(this._horizontal)
                  {
                  ...
                  else if(this.var_1392 != 0 && this.var_106 != 0)
                  {
                     this.scrollV += this.var_1392 / this.var_106;
                  }
                  this.var_2208 = _loc3_;
                  this.var_2207 = _loc4_;
                  _loc2_ = true;
            ...
            case WindowMouseEvent.const_274:
               if(this.var_1393)
               {
                  ...
                  {
                     _context.getWindowServices().getGestureAgentService().begin(this,this.scrollAnimationCallback,0,0,-this.var_1392);
                  }
                  this.var_1393 = false;
                  _loc2_ = true;
               }
      ...
      protected function updateScrollAreaRegion() : void
      {
         ...
         var _loc3_:int = 0;
         var _loc4_:int = 0;
         if(this.var_1114 && !this.var_584 && this._container)
         {
            this.var_584 = true;
      ...
      override public function get properties() : Array
      {
         ...
         if(this._spacing != PropertyDefaults.const_859)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_383,this._spacing,PropertyStruct.const_43,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1295);
         }
         if(this.var_1114 != PropertyDefaults.const_1266)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_963,this.var_1114,PropertyStruct.const_38,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1784);
         }
         if(this.var_492 != PropertyDefaults.const_1240)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_822,this.var_492,PropertyStruct.const_38,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1860);
         }
         if(this.var_1391 != PropertyDefaults.const_1181)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_855,this.var_1391,PropertyStruct.const_38,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1945);
         }
         if(this.var_721 != PropertyDefaults.const_1281)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_820,this.var_721,PropertyStruct.const_138,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1905);
         }
         if(this.var_719 != PropertyDefaults.const_1178)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_885,this.var_719,PropertyStruct.const_138,true));
         }
         else
         {
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               ...
               case PropertyDefaults.const_855:
                  ...
                  break;
               case PropertyDefaults.const_963:
                  this.var_1114 = _loc2_.value as Boolean;
                  break;

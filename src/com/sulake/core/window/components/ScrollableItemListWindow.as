package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_1320:IItemListWindow;
      
      private var var_470:IScrollbarWindow;
      ...
      override public function dispose() : void
      {
         if(this.var_470)
         {
            this.var_470.removeEventListener(WindowEvent.const_269,this.scrollBarEventProc);
            this.var_470.removeEventListener(WindowEvent.const_255,this.scrollBarEventProc);
            this.var_470 = null;
         }
         if(this.var_1320)
         {
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!this.var_1320)
         {
            this.var_1320 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!this.var_470)
         {
            this.var_470 = findChildByTag("_SCROLLBAR") as IScrollbarWindow;
            if(this.var_470)
            {
               this.var_470.addEventListener(WindowEvent.const_269,this.scrollBarEventProc);
               this.var_470.addEventListener(WindowEvent.const_255,this.scrollBarEventProc);
            }
         }
         return this.var_470;
      }
      ...
      private function scrollBarEventProc(param1:WindowEvent) : void
      {
         ...
         else if(param1.type == WindowEvent.const_255)
         {
            this.hideScrollBar();
         }
      }

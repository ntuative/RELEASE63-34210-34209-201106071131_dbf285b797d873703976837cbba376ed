package com.sulake.core.window.components
{
   ...
   public class ItemGridController extends ItemListController implements IItemGridWindow
   {
      ...
      public function removeGridItem(param1:IWindow) : IWindow
      {
         ...
         if(this.method_11(_loc2_) != param1)
         {
      ...
      {
         var _loc2_:IItemListWindow = _context.create(_name + "_COLUMN_" + numListItems,null,WindowType.const_444,WindowStyle.const_124,0 | 0,new Rectangle(0,0,Math.max(param1.width,0),Math.max(param1.height,0)),this.listEventProc,null,numListItems,null,[WindowController.TAG_INTERNAL,WindowController.TAG_EXCLUDE]) as IItemListWindow;
      ...
      protected function method_11(param1:uint) : IWindow
      {
         var _loc7_:* = null;

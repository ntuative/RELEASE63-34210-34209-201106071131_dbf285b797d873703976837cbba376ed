package com.sulake.core.window.components
{
   ...
   public class ActivatorController extends ContainerController
   {
      ...
      override public function update(param1:WindowController, param2:WindowEvent) : Boolean
      {
         ...
         else if(param2.type == WindowEvent.const_1257)
         {
            return true;
         }
      ...
      public function setActiveChild(param1:IWindow) : IWindow
      {
         ...
         var _loc2_:IWindow = this.var_903;
         if(this.var_903 != param1)
         {
            if(this.var_903 != null)
            {
               if(!this.var_903.disposed)
               {
                  this.var_903.deactivate();
               }
            }
            this.var_903 = param1;

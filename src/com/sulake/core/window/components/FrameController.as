package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_1487:String = "_TITLE";
      
      private static const const_1542:String = "_HEADER";
      
      private static const const_1544:String = "_CONTENT";
      
      private static const const_1543:String = "_SCALER";
       
      
      private var _title:ILabelWindow;
      
      private var var_1528:IHeaderWindow;
      ...
      public function get title() : ILabelWindow
      {
         if(this._title == null)
         {
            this._title = findChildByTag(const_1487) as ILabelWindow;
            if(!this._title)
            {
      ...
      public function get header() : IHeaderWindow
      {
         ...
         {
            this.var_1528 = findChildByTag(const_1542) as IHeaderWindow;
            if(!this.var_1528)
            {
      ...
      public function get content() : IWindowContainer
      {
         ...
         {
            this.var_188 = findChildByTag(const_1544) as IWindowContainer;
            if(!this.var_188)
            {
      ...
      {
         return findChildByTag(const_1543) as IScalerWindow;
      }
      ...
      override public function set color(param1:uint) : void
      {
         ...
         groupChildrenWithTag(const_1383,_loc2_,false);
      ...
      {
         return this.content != null && this.var_1119 ? this.content.iterator : new Iterator(this);
      }
      ...
      private function setupScaling() : void
      {
         ...
         var _loc2_:Boolean = testParamFlag(WindowParam.const_367);
         var _loc3_:Boolean = testParamFlag(WindowParam.const_285);
         var _loc4_:Boolean = testParamFlag(WindowParam.const_286);
         if(_loc1_)
         {
            if(_loc3_ || _loc2_)
            {
            ...
            if(_loc4_ || _loc2_)
            {
               _loc1_.setParamFlag(WindowParam.const_286,true);
            }
            else
            {
               _loc1_.setParamFlag(WindowParam.const_286,false);
            }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_300,_loc3_.left,PropertyStruct.const_43,_loc2_));
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_277,_loc3_.top,PropertyStruct.const_43,_loc2_));
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_303,0 - _loc3_.right,PropertyStruct.const_43,_loc2_));
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_288,0 - _loc3_.bottom,PropertyStruct.const_43,_loc2_));
         return _loc1_;
      }

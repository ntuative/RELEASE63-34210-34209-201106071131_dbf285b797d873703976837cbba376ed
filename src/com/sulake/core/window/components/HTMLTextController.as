package com.sulake.core.window.components
{
   ...
   public class HTMLTextController extends TextFieldController implements IHTMLTextWindow
   {
      ...
      private var var_1177:String = null;
      
      private var var_1787:StyleSheet = null;
      ...
      {
         this.var_757 = PropertyDefaults.HTML_LINK_TARGET_VALUE;
      ...
      private static function setHtmlStyleSheetString(param1:HTMLTextController, param2:String) : void
      {
         ...
         if(param1.var_1177 == param2)
         {
            return;
         }
         param1.var_1177 = param2;
         param1.var_1787 = null;
         if(param1.var_1177 != null)
         {
            _loc3_ = new StyleSheet();
            _loc3_.parseCSS(param1.var_1177);
            param1.var_1787 = _loc3_;
         }
      }
      ...
      {
         if(PropertyDefaults.const_1003.indexOf(param1) > -1)
         {
            this.var_757 = param1;
         }
      }
      ...
      {
         return this.var_757 == LinkTarget.const_32 ? defaultLinkTarget : this.var_757;
      }
      ...
      override public function set htmlText(param1:String) : void
      {
         ...
         {
            _field.htmlText = convertLinksToEvents(var_18);
            _field.styleSheet = this.var_1787;
            refreshTextImage();
         }
      }
      ...
      override protected function immediateClickHandler(param1:Event) : void
      {
         ...
         if(param1 is TextEvent)
         {
            ...
            if(!_loc2_.isWindowOperationPrevented() && this.linkTarget != LinkTarget.const_1198)
            {
      ...
      override public function get properties() : Array
      {
         ...
         if(this.var_757 != PropertyDefaults.HTML_LINK_TARGET_VALUE)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_835,this.var_757,PropertyStruct.const_52,true,PropertyDefaults.const_1003));
         }
         else
         {
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         {
            if(_loc2_.key == PropertyDefaults.const_835)
            {
               this.var_757 = _loc2_.value as String;
               break;
            }

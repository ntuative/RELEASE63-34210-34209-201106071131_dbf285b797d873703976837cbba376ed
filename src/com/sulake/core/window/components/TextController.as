package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected static const const_1382:Dictionary = createPropertySetterTable();
      ...
      protected var var_587:Number;
      
      protected var var_586:Boolean;
      
      protected var var_44:TextMargins;
      
      protected var _autoSize:String = "none";
      
      protected var var_140:Boolean = false;
      ...
      private static function setTextStyleString(param1:TextController, param2:String) : void
      {
         ...
         else
         {
            ...
            if(_loc3_)
            {
               ...
               {
                  TextStyleManager.method_10(_loc3_.name,_loc3_);
               }
      ...
      {
         return new Rectangle(this.var_904 * this.maxScrollH,this.var_587 * this.maxScrollV,width,height);
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_731,this._field.antiAliasType,PropertyStruct.const_52,this._field.antiAliasType != _loc2_.antiAliasType,PropertyDefaults.const_1169));
         _loc1_.push(this._autoSize != PropertyDefaults.const_1283 ? new PropertyStruct(PropertyDefaults.const_818,this._autoSize,PropertyStruct.const_52,true,PropertyDefaults.const_1342) : PropertyDefaults.const_1801);
         _loc1_.push(new PropertyStruct("border",this._field.border,PropertyStruct.const_38,this._field.border == true));
         _loc1_.push(new PropertyStruct("border_color",this._field.borderColor,PropertyStruct.const_168,this._field.borderColor != 0));
         ...
         _loc1_.push(new PropertyStruct("font_size",this.defaultTextFormat.size,PropertyStruct.const_293,this.defaultTextFormat.size != _loc2_.fontSize));
         _loc1_.push(this._field.gridFitType != PropertyDefaults.const_1287 ? new PropertyStruct(PropertyDefaults.const_1259,this._field.gridFitType,PropertyStruct.const_52,true,PropertyDefaults.const_1206) : PropertyDefaults.const_1804);
         _loc1_.push((_loc2_.color != null ? this._field.textColor != _loc2_.color : this._field.textColor != PropertyDefaults.const_900) ? new PropertyStruct(PropertyDefaults.const_421,this._field.textColor,PropertyStruct.const_168,true) : PropertyDefaults.const_1157);
         _loc1_.push(this.var_454 != TextStyleManager.const_219 ? new PropertyStruct(PropertyDefaults.const_407,this.var_454,PropertyStruct.const_52,true,PropertyDefaults.const_862) : PropertyDefaults.const_1233);
         _loc1_.push(this.var_44.left != PropertyDefaults.const_959 ? new PropertyStruct(PropertyDefaults.const_300,this.var_44.left,PropertyStruct.const_43,true) : PropertyDefaults.const_779);
         _loc1_.push(this.var_44.top != PropertyDefaults.const_743 ? new PropertyStruct(PropertyDefaults.const_277,this.var_44.top,PropertyStruct.const_43,true) : PropertyDefaults.const_1009);
         _loc1_.push(this.var_44.right != PropertyDefaults.const_973 ? new PropertyStruct(PropertyDefaults.const_303,this.var_44.right,PropertyStruct.const_43,true) : PropertyDefaults.const_718);
         _loc1_.push(this.var_44.bottom != PropertyDefaults.const_760 ? new PropertyStruct(PropertyDefaults.const_288,this.var_44.bottom,PropertyStruct.const_43,true) : PropertyDefaults.const_854);
         _loc1_.push(this._field.mouseWheelEnabled != PropertyDefaults.const_1322 ? new PropertyStruct(PropertyDefaults.const_829,this._field.mouseWheelEnabled,PropertyStruct.const_38,true) : PropertyDefaults.const_1903);

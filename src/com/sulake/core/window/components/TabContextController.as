package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      private static const const_1404:String = "_SELECTOR";
      
      private static const const_1405:String = "_CONTENT";
       
      
      protected var var_1112:ITabSelectorWindow;
      
      protected var var_2191:IWindowContainer;
      ...
      public function get selector() : ITabSelectorWindow
      {
         ...
         {
            this.var_1112 = findChildByTag(const_1404) as ITabSelectorWindow;
            if(this.var_1112 != null)
            {
               this.var_1112.procedure = this.selectorEventProc;
            }
         }
      ...
      public function get container() : IWindowContainer
      {
         ...
         {
            this.var_2191 = findChildByTag(const_1405) as IWindowContainer;
         }
      ...
      {
         return !!this.var_801 ? this.selector.iterator : null;
      }
      
      public function get numTabItems() : uint
      {
         return this.var_1112.numSelectables;
      }

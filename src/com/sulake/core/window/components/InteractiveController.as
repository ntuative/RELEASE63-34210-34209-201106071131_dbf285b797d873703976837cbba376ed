package com.sulake.core.window.components
{
   ...
   public class InteractiveController extends WindowController implements IInteractiveWindow
   {
      ...
      {
         this.var_1665 = PropertyDefaults.const_957;
         this.var_1381 = PropertyDefaults.const_449;
         param4 |= 0;
      ...
      {
         if(param1.toolTipCaption != PropertyDefaults.const_449)
         {
            if(param2.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
            {
               param1.context.getWindowServices().getToolTipAgentService().begin(param1);
            }
            else if(param2.type != WindowMouseEvent.const_178)
            {
      ...
      public static function writeInteractiveWindowProperties(param1:IInteractiveWindow, param2:Array) : Array
      {
         if(param1.toolTipCaption != PropertyDefaults.const_449)
         {
            param2.push(new PropertyStruct(PropertyDefaults.const_784,param1.toolTipCaption,PropertyStruct.const_52,true));
         }
         else
         {
            param2.push(PropertyDefaults.const_1913);
         }
         if(param1.toolTipDelay != PropertyDefaults.const_957)
         {
            param2.push(new PropertyStruct(PropertyDefaults.const_786,param1.toolTipDelay,PropertyStruct.const_293,true));
         }
         else
         {
      ...
      {
         this.var_1381 = param1 == null ? "null" : param1;
      }

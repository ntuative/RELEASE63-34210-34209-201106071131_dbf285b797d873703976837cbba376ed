package com.sulake.core.window.components
{
   ...
   public class DropMenuController extends InteractiveController implements IDropMenuWindow, ITouchAwareWindow
   {
      ...
      {
         if(param1 > this.var_290.lenght - 1)
         {
      ...
      private function getSubMenu() : DropMenuController
      {
         ...
         if(this.var_200 == null || this.var_200.disposed)
         {
            this.var_200 = context.create(name + "::submenu","",WindowType.const_591,var_86,0 | 0,_loc1_,this.subMenuEventProc,null,0,null,[WindowController.TAG_EXCLUDE]) as DropMenuController;
         }
         else
         {
      ...
      override public function populate(param1:Array) : void
      {
         ...
         {
            this.var_290.push(param1[_loc2_]);
            _loc2_++;
         }
         this.var_1072 = true;
         this.closeMenuView();
      ...
      protected function openMenuView() : void
      {
         if(!this.var_1072)
         {
            if(this.open())
            {
               if(this.var_290.length)
               {
                  this.populateMenuItemContainer(this.var_290,this.getSubMenu(),this.subMenuEventProc);
                  this.var_1072 = true;
               }
            }
         }
      ...
      protected function closeMenuView() : void
      {
         if(this.close())
         {
            ...
            this.var_1072 = false;
            this.getTitleLabel().text = this.var_697 < this.var_290.length && this.var_697 > -1 ? this.var_290[this.var_697] : caption;
         }
      }
      ...
      protected function populateMenuItemContainer(param1:Array, param2:DropMenuController, param3:Function) : void
      {
         ...
         while(_loc9_ < _loc5_)
         {
            _loc6_ = context.create(name + "::menu_item_" + _loc9_,param1[_loc9_],WindowType.const_515,var_86,0 | 0 | 0 | 0 | 0,null,param3,null,_loc9_,null,["_EXCLUDE"]) as DropMenuItemController;
         ...
         var _loc10_:IWindow = context.create(name + "::padding","",WindowType.const_452,var_86,0 | 0 | 0 | 0,new Rectangle(0,0,1,2),null,null,0,null,["_EXCLUDE"]);
         _loc4_.addListItem(_loc10_);
         _loc4_.autoArrangeItems = true;
         this.fitToDesktop(param2);
         param2.activate();
         if(this.var_697 > -1 && _loc5_)
         {
            _loc4_.getListItemAt(this.var_697).setStateFlag(WindowState.const_56,true);
         }
      }
      ...
      {
         var _loc3_:* = 0;
         if(param1.type == WindowMouseEvent.const_45 || param1.type == WindowTouchEvent.const_795)
         {
      ...
      private function subMenuEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.const_57:
               ...
               break;
            case WindowTouchEvent.const_1013:
      ...
      public function close() : Boolean
      {
         ...
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_1936,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
      ...
      public function enumerateSelection() : Array
      {
         ...
         if(!_disposed)
         {
            ...
            {
               _loc1_.push(this.var_290[_loc2_]);
               _loc2_++;
            }
         }
         return _loc1_;
      ...
      override public function get properties() : Array
      {
         ...
         if(this.var_290.length)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_875,this.var_290,PropertyStruct.const_146,true));
         }
         else
         {

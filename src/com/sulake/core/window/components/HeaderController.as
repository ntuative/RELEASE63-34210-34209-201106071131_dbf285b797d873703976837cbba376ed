package com.sulake.core.window.components
{
   ...
   public class HeaderController extends ContainerController implements IHeaderWindow
   {
      ...
      private static const const_1486:String = "_CONTROLS";
      ...
      {
         return findChildByTag(const_1487) as ILabelWindow;
      }
      
      public function get controls() : IItemListWindow
      {
         return findChildByTag(const_1486) as IItemListWindow;
      }
      ...
      override public function set color(param1:uint) : void
      {
         ...
         groupChildrenWithTag(const_1383,_loc2_,true);

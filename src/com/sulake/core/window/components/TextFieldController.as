package com.sulake.core.window.components
{
   ...
   public class TextFieldController extends TextController implements ITextFieldWindow
   {
      ...
      protected var var_1665:uint = 500;
      
      protected var var_1381:String = "";
      
      protected var var_1383:Boolean = false;
      ...
      {
         this.var_1381 = param1 == null ? "" : param1;
      }
      ...
      override public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         if(param1 && !var_22)
         {
            var_22 = new GraphicContext("GC {" + _name + "}",GraphicContext.const_1340,var_11);
         }
         return var_22;
      }
      ...
      protected function refreshAutoSize() : void
      {
         ...
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(this.var_801 && autoSize != TextFieldAutoSize.NONE)
         {
            if(false)
            {
      ...
      private function onKeyDownEvent(param1:KeyboardEvent) : void
      {
         ...
         try
         {
            windowEvent = WindowKeyboardEvent.allocate(WindowKeyboardEvent.const_224,event,this,null);
      ...
      private function onChangeEvent(param1:Event) : void
      {
         ...
         {
            this.refreshAutoSize();
            windowEvent = WindowEvent.allocate(WindowEvent.const_117,this,null);
            this.update(this,windowEvent);
            windowEvent.recycle();
         }
         catch(e:Error)
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(true ? new PropertyStruct(PropertyDefaults.const_745,false,PropertyStruct.const_38,true) : PropertyDefaults.const_1816);
         _loc1_.push(this.var_1383 != PropertyDefaults.const_1362 ? new PropertyStruct(PropertyDefaults.const_870,this.var_1383,PropertyStruct.const_38,true) : PropertyDefaults.const_1699);
         _loc1_.push(_field.selectable != PropertyDefaults.const_1326 ? new PropertyStruct(PropertyDefaults.const_915,_field.selectable,PropertyStruct.const_38,true) : PropertyDefaults.const_1847);
         _loc1_.push(_field.displayAsPassword != PropertyDefaults.const_1243 ? new PropertyStruct("display_as_password",_field.displayAsPassword,PropertyStruct.const_38,true) : PropertyDefaults.const_1680);
         return _loc1_;
      }
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               ...
               case PropertyDefaults.const_745:
                  ...
                  break;
               case PropertyDefaults.const_1368:

package com.sulake.core.window.components
{
   ...
   public class ScrollbarController extends InteractiveController implements IScrollbarWindow, ITouchAwareWindow
   {
      ...
      private static const const_1616:String = "increment";
      
      private static const const_1615:String = "decrement";
      
      private static const const_1093:String = "slider_track";
      
      private static const const_696:String = "slider_bar";
       
      
      protected var _offset:Number = 0;
      
      protected var var_726:Number = 0.1;
      ...
      public function set scrollable(param1:IScrollableWindow) : void
      {
         if(this.var_19 != null && !this.var_19.disposed)
         {
            ...
            this.var_19.removeEventListener(WindowEvent.const_524,this.onScrollableScrolled);
         }
         this.var_19 = param1;
         if(this.var_19 != null && !this.var_19.disposed)
         {
            this.var_19.addEventListener(WindowEvent.const_41,this.onScrollableResized);
            this.var_19.addEventListener(WindowEvent.const_524,this.onScrollableScrolled);
            this.updateLiftSizeAndPosition();
         }
      }
      ...
      {
         return findChildByName(const_1093) as WindowController;
      }
      
      protected function get lift() : WindowController
      {
         return this.track.findChildByName(const_696) as WindowController;
      }
      ...
      override public function update(param1:WindowController, param2:WindowEvent) : Boolean
      {
         switch(param1.name)
         {
            case ScrollbarController.const_696:
         ...
         if(param2.type == WindowEvent.const_553)
         {
            if(this.var_19 == null)
            {
         ...
         if(param1 == this)
         {
            ...
            else if(param2.type == WindowMouseEvent.const_353)
            {
               if(WindowMouseEvent(param2).delta > 0)
               {
                  if(this._horizontal)
                  {
                     this.scrollH -= this.var_726;
                  }
                  else
                  {
                     this.scrollV -= this.var_726;
                  }
               }
      ...
      private function scrollButtonEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.const_45 || param1.type == WindowTouchEvent.const_795)
         {
            ...
            else if(param2.name == const_1615)
            {
               if(this.var_19)
               {
                  this.var_1330 = true;
            ...
            else if(param2.name == const_1093)
            {
               ...
               _loc6_ = WindowController(param2).getChildByName(ScrollbarController.const_696).rectangle;
               if(this._horizontal)
               {
                  if(_loc4_ < _loc6_.x)
                  {

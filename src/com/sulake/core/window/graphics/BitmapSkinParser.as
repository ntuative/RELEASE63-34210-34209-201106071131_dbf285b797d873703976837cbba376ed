   ...
   public class BitmapSkinParser
   {
      ...
      protected static function parseLayoutEntity(param1:XML, param2:Map) : SkinLayoutEntity
      {
         ...
         if(_loc8_.length() > 0)
         {
            ...
            {
               case "fixed":
                  _loc5_.var_340 = SkinLayoutEntity.const_566;
                  break;
               case "move":
                  _loc5_.var_340 = SkinLayoutEntity.const_328;
                  break;
               case "strech":
                  _loc5_.var_340 = SkinLayoutEntity.const_561;
                  break;
               case "tiled":
                  _loc5_.var_340 = SkinLayoutEntity.const_372;
                  break;
               case "center":
                  _loc5_.var_340 = SkinLayoutEntity.const_526;
            }
            ...
            {
               case "fixed":
                  _loc5_.var_341 = SkinLayoutEntity.const_566;
                  break;
               case "move":
                  _loc5_.var_341 = SkinLayoutEntity.const_328;
                  break;
               case "strech":
                  _loc5_.var_341 = SkinLayoutEntity.const_561;
                  break;
               case "tiled":
                  _loc5_.var_341 = SkinLayoutEntity.const_372;
                  break;
               case "center":
                  _loc5_.var_341 = SkinLayoutEntity.const_526;
            }
         }

package com.sulake.core.window.graphics.renderer
{
   ...
   public class BitmapSkinRenderer extends SkinRenderer implements ISkinRenderer
   {
      ...
      protected var var_900:Dictionary;
      
      protected var var_899:Dictionary;
      
      private var var_256:Matrix;
      ...
      {
         super(param1);
         this.var_900 = new Dictionary(false);
         this.var_899 = new Dictionary(false);
         this.var_256 = new Matrix();
      ...
      override public function dispose() : void
      {
         ...
         if(!disposed)
         {
            ...
            this.var_256 = null;
            this.var_735 = null;
            for(_loc1_ in this.var_900)
            {
               _loc2_ = this.var_900[_loc1_] as BitmapData;
               _loc2_.dispose();
               delete this.var_900[_loc1_];
            }
            this.var_900 = null;
      ...
      override public function draw(param1:IWindow, param2:IBitmapDrawable, param3:Rectangle, param4:uint, param5:Boolean) : void
      {
         ...
         var _loc7_:ISkinLayout = var_497[param4];
         ...
         if(_loc7_ != null && _loc9_ > 0)
         {
            ...
            if(_loc16_)
            {
               ...
               this.var_735.alphaMultiplier = 1;
            }
            _loc17_ = 0;
            while(_loc17_ < _loc9_)
            {
               ...
               if(_loc11_ != null)
               {
                  ...
                  if(_loc16_ && _loc10_.colorize)
                  {
                     ...
                     _loc18_.colorTransform(_loc18_.rect,this.var_735);
                  }
                  _loc12_ = false;
                  _loc13_ = false;
                  ...
                  if(_loc10_.var_340 == SkinLayoutEntity.const_328)
                  {
                     REGION.x += _loc14_;
                  }
                  else if(_loc10_.var_340 == SkinLayoutEntity.const_561)
                  {
                     _loc12_ = true;
                  ...
                  else if(_loc10_.var_340 == SkinLayoutEntity.const_372)
                  {
                     _loc12_ = true;
                     REGION.right += _loc14_;
                     if(true)
                  ...
                  else if(_loc10_.var_340 == SkinLayoutEntity.const_526)
                  {
                     REGION.x = param3.width / 2 - 0;
                  }
                  if(_loc10_.var_341 == SkinLayoutEntity.const_328)
                  {
                     REGION.y += _loc15_;
                  }
                  else if(_loc10_.var_341 == SkinLayoutEntity.const_561)
                  {
                     _loc13_ = true;
                  ...
                  else if(_loc10_.var_341 == SkinLayoutEntity.const_372)
                  {
                     _loc13_ = true;
                     REGION.bottom += _loc15_;
                     if(true)
                  ...
                  else if(_loc10_.var_341 == SkinLayoutEntity.const_526)
                  {
                  ...
                  else if(_loc10_.var_341 == SkinLayoutEntity.const_372 || _loc10_.var_340 == SkinLayoutEntity.const_372)
                  {
                  ...
                  {
                     this.var_256.a = REGION.width;
                     this.var_256.d = REGION.height;
                     this.var_256.tx = REGION.x;
                     this.var_256.ty = REGION.y;
                     ALPHA.alphaMultiplier = (_loc19_.getPixel32(0,0) >>> 24) / 255;
                     _loc6_.draw(_loc18_,this.var_256,ALPHA);
                  }
                  else
                  {
                     this.var_256.a = 0 / _loc18_.width;
                     this.var_256.d = 0 / _loc18_.height;
                     this.var_256.tx = 0;
                     this.var_256.ty = 0;
                     _loc31_ = new BitmapData(REGION.width,REGION.height,_loc18_.transparent);
                     _loc31_.draw(_loc18_,this.var_256);
                     _loc32_ = new BitmapData(REGION.width,REGION.height,true,0);
                     _loc32_.draw(_loc19_,this.var_256,null);
      ...
      protected function drawStaticLayoutEntity(param1:BitmapData, param2:Rectangle, param3:ISkinLayout, param4:SkinLayoutEntity, param5:ISkinTemplate, param6:ISkinTemplateEntity) : void
      {
         ...
         switch(param6.type)
         {
            case "bitmap":
               ...
               if(param4.var_340 == SkinLayoutEntity.const_328)
               {
                  _loc7_.x += param2.width - param3.width;
               }
               if(param4.var_341 == SkinLayoutEntity.const_328)
               {
      ...
      private function getBitmapFromCache(param1:ISkinTemplate, param2:String) : BitmapData
      {
         ...
         var _loc4_:BitmapData = this.var_900[_loc3_];
         if(_loc4_ == null)
         {

package com.sulake.core.window.graphics.renderer
{
   ...
   public class SkinRenderer implements ISkinRenderer
   {
      ...
      protected var var_589:Dictionary;
      
      protected var var_497:Dictionary;
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            {
               ISkinLayout(this.var_589[_loc1_]).dispose();
      ...
      {
         this.var_589[param1.name] = param1;
         return param1;
      }
      ...
      public function removeLayout(param1:ISkinLayout) : ISkinLayout
      {
         ...
         if(param1 != null)
         {
            for(_loc2_ in this.var_497)
            {
               _loc3_ = uint(_loc2_ as uint);
               if(this.var_497[_loc3_] == param1)
               {
                  this.removeLayoutFromRenderState(_loc3_);
               }
            }
            delete this.var_589[param1.name];
         }
         return param1;
      }

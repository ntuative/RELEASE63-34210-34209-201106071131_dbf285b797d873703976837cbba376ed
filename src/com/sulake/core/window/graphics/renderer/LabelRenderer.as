package com.sulake.core.window.graphics.renderer
{
   ...
   public class LabelRenderer extends SkinRenderer
   {
      ...
      protected var var_2991:TextStyle;
      ...
      override public function draw(param1:IWindow, param2:IBitmapDrawable, param3:Rectangle, param4:uint, param5:Boolean) : void
      {
         ...
         if(param2 != null)
         {
            ...
            if(_loc7_ != this.var_2991)
            {
               this._cachedTextField = TextFieldCache.getTextFieldByStyle(_loc7_);
               this.var_2991 = _loc7_;
            }
            this.var_1125.tx = _loc6_.drawOffsetX;
            this.var_1125.ty = _loc6_.drawOffsetY;
            ...
            BitmapData(param2).draw(this._cachedTextField,this.var_1125,null,null,null,false);

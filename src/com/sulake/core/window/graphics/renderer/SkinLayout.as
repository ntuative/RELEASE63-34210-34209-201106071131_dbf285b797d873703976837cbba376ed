package com.sulake.core.window.graphics.renderer
{
   ...
   public class SkinLayout extends ChildEntityArray implements ISkinLayout
   {
      ...
      public function isFixedWidth() : Boolean
      {
         ...
         while(_loc2_ < _loc1_)
         {
            if(SkinLayoutEntity(getChildAt(_loc2_)).var_340 != SkinLayoutEntity.const_566)
            {
               return false;
            }
            _loc2_++;
      ...
      public function isFixedHeight() : Boolean
      {
         ...
         while(_loc2_ < _loc1_)
         {
            if(SkinLayoutEntity(getChildAt(_loc2_)).var_341 != SkinLayoutEntity.const_566)
            {
               return false;
            }
            _loc2_++;
      ...
      override public function addChild(param1:IChildEntity) : IChildEntity
      {
         ...
         this.var_265 = _loc2_.region.right > this.var_265 ? uint(_loc2_.region.right) : uint(this.var_265);
      ...
      override public function addChildAt(param1:IChildEntity, param2:int) : IChildEntity
      {
         ...
         this.var_265 = _loc3_.region.right > this.var_265 ? uint(_loc3_.region.right) : uint(this.var_265);
      ...
      override public function removeChild(param1:IChildEntity) : IChildEntity
      {
         ...
         this.var_265 = this.calculateWidth();

package com.sulake.core.window.graphics
{
   ...
   public class WindowRenderer implements IWindowRenderer
   {
      ...
      private var var_1451:Rectangle;
      ...
      public function WindowRenderer(param1:ISkinContainer)
      {
         ...
         this.var_1777 = new Point();
         this.var_1451 = new Rectangle();
         this.var_309 = new Rectangle();
         this.var_354 = new Dictionary(true);
      ...
      public function addToRenderQueue(param1:IWindow, param2:Rectangle, param3:uint) : void
      {
         ...
         if(this.getWindowRendererItem(param1).invalidate(param1,param2,param3))
         {
            ...
            this.var_309.x = param2.x - param1.x;
            this.var_309.y = param2.y - param1.y;
            this.var_309.width = param2.width;
            this.var_309.height = param2.height;
            if(param1.testParamFlag(WindowParam.const_34))
            {
               while(param1.testParamFlag(WindowParam.const_34))
               {
                  ...
                  this.var_309.offset(param1.x,param1.y);
                  param1 = _loc4_;
               }
            }
            this.getWindowRendererItem(param1).invalidate(param1,this.var_309,WindowRedrawFlag.const_1141);
            if(this.var_754.indexOf(param1) == -1)
            {
      ...
      {
         var _loc2_:WindowRendererItem = this.var_354[param1] as WindowRendererItem;
         if(_loc2_ == null)
         {
            this.registerRenderable(param1);
            _loc2_ = this.var_354[param1];
         }
         return _loc2_;
      }
      ...
      public function registerRenderable(param1:IWindow) : void
      {
         ...
         if(_loc2_ == null)
         {
            ...
            this.var_354[param1] = _loc2_;
            param1.addEventListener(WindowDisposeEvent.const_785,this.windowDisposedCallback);
         }
      }
      
      public function removeRenderable(param1:IWindow) : void
      {
         param1.removeEventListener(WindowDisposeEvent.const_785,this.windowDisposedCallback);
         var _loc2_:WindowRendererItem = this.var_354[param1] as WindowRendererItem;
         if(_loc2_ != null)
         {
            _loc2_.dispose();
            delete this.var_354[param1];
         }
      }
      ...
      public function render() : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:int = 0;
         var _loc2_:uint = this.var_754.length;
         _loc4_ = 0;
         while(_loc4_ < _loc2_)
         {
            _loc1_ = this.var_754.pop() as WindowController;
            if(!_loc1_.disposed)
            {
               _loc3_ = this.getWindowRendererItem(_loc1_);
               this.var_309.x = _loc3_.dirty.x;
               this.var_309.y = _loc3_.dirty.y;
               this.var_309.width = _loc3_.dirty.width;
               this.var_309.height = _loc3_.dirty.height;
               this.renderWindowBranch(_loc1_,this.var_309,_loc1_.rectangle.clone());
            }
            _loc4_++;
         }
      }
      ...
      private function renderWindowBranch(param1:WindowController, param2:Rectangle, param3:Rectangle) : void
      {
         ...
         if(param1.visible)
         {
            if(getDrawLocationAndClipRegion(param1,param2,this.var_1777,this.var_1451))
            {
               if(this.getWindowRendererItem(param1).render(param1,this.var_1777,this.var_1451))
               {
            ...
            else if(!param1.testParamFlag(WindowParam.const_34))
            {
               ...
               {
                  param1.getGraphicContext(true).setDrawRegion(param1.rectangle,false,this.var_1451);

package com.sulake.core.window.graphics
{
   ...
   public class SkinContainer implements ISkinContainer
   {
      ...
      private static const const_1638:String = "skin";
      
      private static const const_1640:String = "bitmap";
      
      private static const const_1636:String = "fill";
      
      private static const const_1635:String = "text";
      
      private static const const_1639:String = "label";
      
      private static const const_1637:String = "shape";
      ...
      private var var_2092:Dictionary;
      
      private var var_2872:Dictionary;
      
      private var var_2871:Dictionary;
      
      private var var_2870:Dictionary;
      ...
      public function SkinContainer(param1:XML, param2:IAssetLibrary)
      {
         ...
         this.var_2092 = new Dictionary();
         this.var_2872 = new Dictionary();
         TypeCodeTable.fillTables(this.var_2092,this.var_2872);
         this.var_2871 = new Dictionary();
         this.var_2870 = new Dictionary();
         StateCodeTable.fillTables(this.var_2871,this.var_2870);
         this.var_480 = new Dictionary();
         this.var_480[const_1638] = BitmapSkinRenderer;
         this.var_480[const_1640] = BitmapDataRenderer;
         this.var_480[const_1636] = FillSkinRenderer;
         this.var_480[const_1635] = TextSkinRenderer;
         this.var_480[const_1639] = LabelRenderer;
         this.var_480[const_1637] = ShapeSkinRenderer;
         this.var_480[RENDERER_TYPE_UNKNOWN] = SkinRenderer;
         this.var_480[RENDERER_TYPE_NULL] = NullSkinRenderer;
         if(var_348 == null)
         {
            var_348 = new Array();
            var_348.push(WindowState.const_73);
            var_348.push(WindowState.const_94);
            var_348.push(WindowState.const_96);
            var_348.push(WindowState.const_56);
            var_348.push(WindowState.const_91);
            var_348.push(WindowState.const_93);
            var_348.push(WindowState.const_90);
            var_348.push(WindowState.const_101);
         }
         if(param1 != null)
         {
            ...
            if(_loc4_ > 0)
            {
               ...
               while(_loc18_ < _loc4_)
               {
                  ...
                  _loc17_.var_2965 = !!_loc5_.@treshold[0] ? uint(uint(_loc5_.@treshold[0])) : uint(10);
                  ...
                  this.addSkinRenderer(this.var_2092[_loc7_],uint(_loc8_),_loc14_,_loc17_);
                  _loc18_++;
               }
            }
         }
      ...
      {
         if(this.var_1083[param1] == null)
         {
            this.var_1083[param1] = new Array(const_1102);
         }
         this.var_1083[param1][param2] = param3;
         if(this.var_1082[param1] == null)
         {
            this.var_1082[param1] = new Array(const_1102);
         }
         this.var_1082[param1][param2] = param4;
      }
      
      public function getSkinRendererByTypeAndStyle(param1:uint, param2:uint) : ISkinRenderer
      {
         var _loc4_:* = null;
         var _loc3_:Array = this.var_1083[param1];
         if(_loc3_)
         {
            _loc4_ = _loc3_[param2];
            if(!_loc4_ && param2 != WindowStyle.const_124)
            {
               _loc4_ = _loc3_["null"];
            }
         }
      ...
      {
         var _loc4_:* = null;
         var _loc3_:Array = this.var_1082[param1];
         if(_loc3_)
         {
            _loc4_ = _loc3_[param2];
            if(!_loc4_ && param2 != WindowStyle.const_124)

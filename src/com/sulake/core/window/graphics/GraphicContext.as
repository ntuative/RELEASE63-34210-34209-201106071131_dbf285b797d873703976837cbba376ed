package com.sulake.core.window.graphics
{
   ...
   public class GraphicContext extends Sprite implements IGraphicContext
   {
      ...
      public static const const_1925:uint = 0;
      
      public static const const_956:uint = 1;
      
      public static const const_1340:uint = 2;
      
      public static const const_880:uint = 4;
      
      public static const const_1719:uint = 8;
      
      public static const const_1912:uint = 16;
      
      public static const const_2124:uint = 64;
      
      public static const const_2158:uint = 128;
      
      public static const const_1347:uint = 256;
      
      protected static var var_592:uint = 0;
      
      protected static var var_347:uint = 0;
       
      
      protected var var_227:DisplayObjectContainer;
      
      protected var var_2214:Boolean;
      
      protected var var_905:Boolean;
      ...
      public function GraphicContext(param1:String, param2:uint, param3:Rectangle)
      {
         ...
         switch(param2)
         {
            ...
            case GraphicContext.const_1719:
               ...
               break;
            case GraphicContext.const_1912:
               this.setDisplayObject(new MorphShape());
               break;
            case GraphicContext.const_880:
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            {
               while(this.var_227.numChildren > 0)
               {
                  this.var_227.removeChildAt(0);
               }
            }
            this.var_227 = null;
            while(numChildren > 0)
         ...
         if(this.var_905)
         {
            ...
            if(displayObject is Bitmap)
            {
               ...
               if(bitmap != null)
               {
                  ...
                  {
                     var_347 -= bitmap.width * bitmap.height * 4;
                     bitmap.dispose();
                     bitmap = null;
                  }
               }
               if(bitmap == null && width > 0 && height > 0)
               {
                  try
                  {
                     bitmap = new TrackedBitmapData(this,width,height,this.var_2214,16777215);
                  }
                  catch(e:Error)
                  {
                     bitmap = new TrackedBitmapData(this,1,1,var_2214,16777215);
                  }
                  var_347 += bitmap.width * bitmap.height * 4;
               }
      ...
      protected function releaseDrawBuffer() : void
      {
         ...
         if(this.var_905)
         {
            ...
            if(_loc1_ is Bitmap)
            {
               ...
               if(_loc2_ != null)
               {
                  var_347 -= _loc2_.width * _loc2_.height * 4;
                  _loc2_.dispose();
               }
            }
         }
      ...
      protected function setupChildContainer() : DisplayObjectContainer
      {
         if(this.var_227 == null)
         {
            this.var_227 = new Sprite();
            this.var_227.name = this.name + " - Child Container";
            this.var_227.mouseEnabled = false;
            addChild(this.var_227);
         }
         return this.var_227;
      }
      ...
      {
         return this.var_227 != null ? int(this.var_227.numChildren) : 0;
      }

package com.sulake.core.window.events
{
   ...
   public class WindowLinkEvent extends WindowEvent
   {
      ...
      public static const const_1765:String = "WE_LINK";
      ...
      public static function allocate(param1:String, param2:IWindow, param3:IWindow) : WindowEvent
      {
         ...
         _loc4_.var_1815 = param1;
         _loc4_._window = param2;
         _loc4_.var_723 = param3;
         _loc4_.var_495 = false;
         _loc4_.var_724 = POOL;
         return _loc4_;
      }
      ...
      {
         return allocate(this.var_1815,window,related);
      }
      
      override public function toString() : String
      {
         return "WindowLinkEvent { type: " + _type + " link: " + this.link + " cancelable: " + var_494 + " window: " + _window + " }";
      }
   }
}

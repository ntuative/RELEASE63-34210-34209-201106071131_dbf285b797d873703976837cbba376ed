package com.sulake.core.window.tools
{
   ...
   public class ProfilerOutput implements IDevTool
   {
      ...
      private static var var_1599:Class = ProfilerOutput_profiler_dialog_xml;
      
      private static var var_1600:Class = ProfilerOutput_profiler_task_xml;
      ...
      public function ProfilerOutput(param1:IContext, param2:ICoreWindowManager, param3:IWindowRenderer)
      {
         ...
         this.var_3017 = new Array();
         this.var_175 = this.profiler;
         this._windowManager = param2;
         this.var_1084 = param3;
         var _loc4_:ByteArray = new var_1599() as ByteArray;
      ...
      {
         var _loc2_:ByteArray = new var_1600() as ByteArray;

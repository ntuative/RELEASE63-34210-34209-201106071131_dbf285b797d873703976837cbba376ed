package com.sulake.core.window
{
   ...
   public class WindowController extends WindowModel implements IWindow, IGraphicContextHost
   {
      ...
      protected var var_725:Function;
      ...
      public function WindowController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         if(_loc12_ != null)
         {
            var_418 = new Rectangle(0,0,int(_loc12_.attribute("width")),int(_loc12_.attribute("height")));
            var_68 = var_418.clone();
            var_11 = var_418.clone();
         ...
         if(_loc13_)
         {
            ...
            var_500 = _loc13_.var_2965;
            if(var_499 != _loc13_.background)
            {
               this.background = _loc13_.background;
            }
            if(var_255 != _loc13_.color)
            {
      ...
      {
         return this.var_725 != null ? this.var_725 : (this._parent != null ? this._parent.procedure : this.nullEventProc);
      }
      ...
      {
         var_499 = param1;
         var_255 = !!var_499 ? uint(var_255 | var_590) : uint(var_255 & 16777215);
         this.var_184 = this.var_184 || param1;
         _context.invalidate(this,var_11,WindowRedrawFlag.const_62);
      }
      
      public function set color(param1:uint) : void
      {
         var_590 = param1 & 4278190080;
         var_255 = !!var_499 ? uint(param1) : uint(param1 & 16777215);
         _context.invalidate(this,var_11,WindowRedrawFlag.const_62);
      }
      ...
      {
         var_590 = param1 << 24;
         var_255 = !!var_499 ? uint(var_590 | var_255) : uint(16777215 & var_255);
         _context.invalidate(this,var_11,WindowRedrawFlag.const_62);
      }
      ...
      {
         var_500 = param1 > 255 ? 255 : uint(param1);
      }
      ...
      public function set state(param1:uint) : void
      {
         ...
         {
            _state = param1;
            _context.invalidate(this,var_11,WindowRedrawFlag.const_889);
         }
      }
      ...
      public function set parent(param1:IWindow) : void
      {
         ...
         if(this._parent != param1)
         {
            ...
            if(this._parent != null)
            {
               ...
               _loc4_ = WindowEvent.allocate(WindowEvent.const_553,this,this._parent);
            ...
            else
            {
               ...
               _loc4_ = WindowEvent.allocate(WindowEvent.const_1771,this,_loc2_);
               this.update(this,_loc4_);
            }
            _loc4_.recycle();
         }
      ...
      public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         ...
         {
            this.var_22 = new GraphicContext("GC {" + _name + "}",GraphicContext.const_956,var_11);
            this.var_22.visible = var_323;
         }
         return this.var_22;
      }
      ...
      public function clone() : IWindow
      {
         ...
         var _loc2_:WindowController = new _loc1_(_name,_type,var_86,var_21,_context,var_11,null,this.var_725,this.properties,var_907.concat(),_id) as WindowController;
         _loc2_.var_500 = var_500;
         _loc2_.var_184 = this.var_184;
         _loc2_._debug = this._debug;
         _loc2_.var_385 = this.var_385.clone();
         _loc2_.var_11 = var_11.clone();
         _loc2_.var_418 = var_418.clone();
      ...
      {
         return "[Window " + getQualifiedClassName(this) + " " + _name + " " + this.var_2750 + "]";
      }
      ...
      public function setRectangle(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         if(_loc6_ && !_loc5_)
         {
            ...
            else if(_loc7_ == WindowParam.const_537)
            {
               param1 -= param3 - 0;
               _loc5_ = true;
            }
            _loc7_ = uint(var_21 & 0);
            if(_loc7_ == WindowParam.const_558)
            {
               param2 -= (param4 - 0) / 2;
               _loc5_ = true;
            }
            else if(_loc7_ == WindowParam.const_543)
            {
               param2 -= param4 - 0;
               _loc5_ = true;
            }
         ...
         if(_loc5_ || _loc6_)
         {
            ...
            if(_loc6_)
            {
               _loc9_ = WindowEvent.allocate(WindowEvent.const_1370,this,null,true);
               this.update(this,_loc9_);
               if(_loc9_.isWindowOperationPrevented())
               {
                  _loc6_ = false;
            ...
            if(_loc5_)
            {
               _loc9_ = WindowEvent.allocate(WindowEvent.const_436,this,null);
               this.update(this,_loc9_);
               _loc9_.recycle();
            }
            if(_loc6_)
      ...
      public function update(param1:WindowController, param2:WindowEvent) : Boolean
      {
         ...
         var _loc6_:* = null;
         var _loc7_:* = 0;
         if(!testParamFlag(WindowParam.const_890))
         {
         ...
         if(param2 is WindowMouseEvent)
         {
            switch(param2.type)
            {
               case WindowMouseEvent.const_45:
                  ...
                  _loc4_.areaLimit = MouseListenerType.const_1188;
                  ...
                  if((var_21 & 0) > 0)
                  {
                     ...
                     while(_loc3_ != null)
                     {
                        if(_loc3_.testParamFlag(WindowParam.const_367))
                        {
               ...
               case WindowMouseEvent.const_57:
                  ...
                  if(testParamFlag(WindowParam.const_367))
                  {
         ...
         else if(param2 is WindowEvent)
         {
            switch(param2.type)
            {
               case WindowEvent.const_41:
                  ...
                  if(param1 == this)
                  {
                     _loc5_ = WindowEvent.allocate(WindowEvent.const_962,this,null);
                     this.notifyChildren(_loc5_);
                     _loc5_.recycle();
                     if(testParamFlag(WindowParam.const_204,WindowParam.const_176))
                     {
                        this.updateScaleRelativeToParent();
                     }
                     else if(testParamFlag(WindowParam.const_227,WindowParam.const_194))
                     {
                        this.updateScaleRelativeToParent();
                     }
                     if(this._parent != null)
                     {
                        ...
                        if(testParamFlag(WindowParam.const_637))
                        {
                           this._parent.height += 0 - 0;
                        }
                        var_21 = _loc7_;
                        _loc5_ = WindowEvent.allocate(WindowEvent.const_189,this._parent,this);
               ...
               case WindowEvent.const_436:
                  ...
                  _context.invalidate(this,_loc6_,WindowRedrawFlag.const_1237);
                  if(param1 == this)
                  {
                     _loc5_ = WindowEvent.allocate(WindowEvent.const_1946,this,null);
                     this.notifyChildren(_loc5_);
                     _loc5_.recycle();
                     if(this._parent != null)
                     {
               ...
               case WindowEvent.const_641:
                  if(param1 == this)
                  {
                     _loc5_ = WindowEvent.allocate(WindowEvent.const_1257,this,null);
                     this.notifyChildren(_loc5_);
                     _loc5_.recycle();
                     if(this._parent != null)
                     {
               ...
               case WindowEvent.const_553:
                  ...
                  _context.invalidate(this,var_11,WindowRedrawFlag.const_62);
                  break;
               case WindowEvent.const_962:
                  this._parent.getRegionProperties(null,this.var_385);
                  this.updateScaleRelativeToParent();
                  break;
               case WindowEvent.const_633:
      ...
      {
         return this.testLocalPointHitAgainstAlpha(param1,param2,var_500);
      }
      ...
      public function validateGlobalPointIntersection(param1:Point, param2:BitmapData) : Boolean
      {
         ...
         return this.testLocalPointHitAgainstAlpha(_loc3_,param2,var_500);
      }
         ...
         if(this.var_184 && var_500 > 0)
         {
            if(!testParamFlag(WindowParam.const_34))
            {
               if(param1.x <= var_11.width && param1.y <= var_11.height)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     _loc4_ = _loc5_.hitTest(const_1073,param3,param1);
                  }
               }
            }
            else
            {
               _loc4_ = param2 != null ? Boolean(param2.hitTest(const_1073,param3,param1)) : false;
            }
         }
      ...
      public function setStyleFlag(param1:uint, param2:Boolean = true) : void
      {
         ...
         var _loc7_:*;
         var_86 = !!param2 ? (_loc7_ = var_86 | param1, var_86 |= param1, uint(_loc7_)) : (_loc7_ = var_86 & ~param1, var_86 &= ~param1, uint(_loc7_));
         if(var_86 != _loc3_)
         {
            _loc4_ = new Array();
      ...
      protected function updateScaleRelativeToParent() : void
      {
         ...
         var _loc1_:* = !testParamFlag(WindowParam.const_172,WindowParam.const_176);
         var _loc2_:* = !testParamFlag(WindowParam.const_174,WindowParam.const_194);
         if(_loc1_ || _loc2_)
         {
            _loc3_ = var_11.clone();
            if(_loc1_)
            {
               ...
               if(_loc5_ == WindowParam.const_391)
               {
                  _loc3_.width += _loc4_;
               }
               else if(_loc5_ == WindowParam.const_453)
               {
                  _loc3_.x += _loc4_;
               }
            ...
            if(_loc2_)
            {
               ...
               _loc5_ = uint(var_21 & 0);
               if(_loc5_ == WindowParam.const_335)
               {
                  _loc3_.height += _loc4_;
               }
               else if(_loc5_ == WindowParam.const_247)
               {
                  _loc3_.y += _loc4_;
               }
      ...
      {
         if(_state == WindowState.const_565)
         {
            return true;
         }
         _state = WindowState.const_565;
      ...
      public function maximize() : Boolean
      {
         ...
         _loc1_.recycle();
         this.setStateFlag(WindowState.const_73,true);
         _loc1_ = WindowEvent.allocate(WindowEvent.const_1753,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      {
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_1881,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
      ...
      public function unlock() : Boolean
      {
         ...
         _loc1_.recycle();
         this.setStateFlag(WindowState.const_73,false);
         _loc1_ = WindowEvent.allocate(WindowEvent.const_1868,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function enable() : Boolean
      {
         ...
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_801,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
         ...
         _loc1_ = WindowEvent.allocate(WindowEvent.const_269,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function focus() : Boolean
      {
         ...
         _loc1_ = WindowEvent.allocate(WindowEvent.const_364,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function unfocus() : Boolean
      {
         ...
         _loc1_ = WindowEvent.allocate(WindowEvent.const_1898,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function addChild(param1:IWindow) : IWindow
      {
         ...
         _loc2_.parent = this;
         if(this.var_1293 || _loc2_.hasGraphicsContext())
         {
            this.setupGraphicsContext();
         ...
         var _loc3_:WindowEvent = WindowEvent.allocate(WindowEvent.const_633,this,param1);
      ...
      public function addChildAt(param1:IWindow, param2:int) : IWindow
      {
         ...
         _loc3_.parent = this;
         if(this.var_1293 || _loc3_.hasGraphicsContext())
         {
            this.setupGraphicsContext();
         ...
         var _loc4_:WindowEvent = WindowEvent.allocate(WindowEvent.const_633,this,param1);
         this.update(this,_loc4_);
         _loc4_.recycle();
         return param1;
      }

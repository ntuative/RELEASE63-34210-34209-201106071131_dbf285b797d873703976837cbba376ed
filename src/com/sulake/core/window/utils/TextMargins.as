package com.sulake.core.window.utils
{
   ...
   public class TextMargins implements IMargins, IDisposable
   {
      ...
      public function TextMargins(param1:int, param2:int, param3:int, param4:int, param5:Function)
      {
         ...
         this.var_300 = param5 != null ? param5 : this.nullCallback;
      }
      ...
      {
         return this.var_1020 == 0 && this._right == 0 && this._top == 0 && this.var_1019 == 0;
      }
      ...
      {
         return new TextMargins(this.var_1020,this._top,this._right,this.var_1019,param1);
      }

package com.sulake.core.window.utils
{
   ...
   public class TextStyleManager
   {
      ...
      private static const const_1481:String = "/*";
      
      private static const const_1482:String = "*/";
      ...
      public static function method_10(param1:String, param2:TextStyle) : void
      {
      ...
      public static function setStyles(param1:Array, param2:Boolean = false) : void
      {
         ...
         if(param2)
         {
            _loc5_ = [var_94[const_219],var_94[ITALIC],var_94[BOLD]];
            var_94.reset();
            var_94[const_219] = _loc5_[0];
      ...
      private static function parseStyleNamesFromCSS(param1:String) : Array
      {
         ...
         {
            while(_loc5_.indexOf(const_1481) == 0)
            {
               _loc5_ = _loc5_.substring(_loc5_.indexOf(const_1482) + 2,_loc5_.length);
            }

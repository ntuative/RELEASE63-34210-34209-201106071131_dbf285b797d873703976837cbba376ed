package com.sulake.core.window.utils
{
   ...
   public class TextFieldCache implements IDisposable
   {
      ...
      private static var var_1099:Map = new Map();
      ...
      {
         var _loc2_:TextField = var_1099[param1.name];
         if(_loc2_)
         {
            return _loc2_;
         }
         ...
         _loc3_.underline = param1.textDecoration == TextStyle.const_927 ? true : null;

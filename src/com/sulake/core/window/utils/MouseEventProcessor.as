package com.sulake.core.window.utils
{
   ...
   public class MouseEventProcessor implements IEventProcessor, IDisposable
   {
      ...
      protected static var var_346:Array;
      
      protected static var var_301:Array;
      
      protected static var var_419:Point = new Point();
       
      
      protected var var_722:Point;
      
      protected var var_183:WindowController;
      ...
      protected var var_902:IWindowContextStateListener;
      ...
      public function MouseEventProcessor()
      {
         ...
         {
            var_346 = new Array();
            var_346[0] = MouseCursorType.const_315;
            var_346[1] = MouseCursorType.const_32;
            var_346[2] = MouseCursorType.const_315;
            var_346[3] = MouseCursorType.const_315;
            var_346[4] = MouseCursorType.const_315;
            var_346[5] = MouseCursorType.const_32;
            var_346[6] = MouseCursorType.const_315;
         }
         if(var_301 == null)
         {
            var_301 = new Array();
            var_301[0] = WindowState.const_90;
            var_301[1] = WindowState.const_93;
            var_301[2] = WindowState.const_91;
            var_301[3] = WindowState.const_73;
            var_301[4] = WindowState.const_56;
            var_301[5] = WindowState.const_96;
            var_301[6] = WindowState.const_94;
         }
      }
      
      public static function setMouseCursorByState(param1:uint, param2:uint) : void
      {
         var _loc3_:int = var_301.indexOf(param1);
         if(_loc3_ > -1)
         {
            var_346[_loc3_] = param2;
         }
      }
      ...
      protected static function convertMouseEventType(param1:MouseEvent, param2:IWindow, param3:IWindow) : WindowMouseEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case MouseEvent.MOUSE_UP:
               ...
               _loc4_ = !!_loc6_ ? "null" : WindowMouseEvent.const_274;
               break;
      ...
      public function process(param1:EventProcessorState, param2:IEventQueue) : void
      {
         ...
         this.var_92 = state.desktop;
         this.var_71 = state.var_1376 as WindowController;
         this.var_183 = state.var_1378 as WindowController;
         this.var_173 = state.renderer;
         this.var_902 = state.var_1379;
         eventQueue.begin();
         this.var_722.x = -1;
         this.var_722.y = -1;
         ...
         while(true)
         {
            ...
            if(event.stageX != this.var_722.x || event.stageY != this.var_722.y)
            {
               this.var_722.x = event.stageX;
               this.var_722.y = event.stageY;
               array = new Array();
               this.var_92.groupParameterFilteredChildrenUnderPoint(this.var_722,array,WindowParam.const_31);
            }
            ...
            if(index == 0)
            {
               ...
               {
                  if(this.var_71 != this.var_92 && !this.var_71.disposed)
                  {
                     this.var_71.getGlobalPosition(var_419);
                     ...
                     this.var_71 = WindowController(this.var_92);
                     tempWindowEvent.recycle();
                  }
               }
               else if(event.type == MouseEvent.MOUSE_DOWN)
               {
                  window = this.var_92.getActiveWindow();
                  if(window)
                  {
                     window.deactivate();
                  }
               ...
               if(child != null && child.visible)
               {
                  if(event.type == MouseEvent.MOUSE_MOVE)
                  {
                     if(child != this.var_71)
                     {
                        ...
                        if(!child.disposed)
                        {
                           child.getGlobalPosition(var_419);
                  ...
                  else if(event.type == MouseEvent.MOUSE_UP || event.type == MouseEvent.CLICK)
                  {
                     if(this.var_71 && !this.var_71.disposed)
                     {
                        ...
                        {
                           this.var_902.mouseEventReceived(event.type,this.var_71);
                        }
                     }
                  }
                  temp = child.parent;
         ...
         state.desktop = this.var_92;
         state.var_1376 = this.var_71;
         state.var_1378 = this.var_183;
         state.renderer = this.var_173;
         state.var_1379 = this.var_902;
      }
      ...
      private function passMouseEvent(param1:WindowController, param2:MouseEvent, param3:Boolean = false) : WindowController
      {
         ...
         {
            if(param1 != this.var_183)
            {
               if(this.var_183 && !this.var_183.disposed)
               {
                  this.var_183.update(this.var_183,convertMouseEventType(new MouseEvent(MouseEvent.MOUSE_UP,false,true,param2.localX,param2.localY,null,param2.ctrlKey,param2.altKey,param2.shiftKey,param2.buttonDown,param2.delta),this.var_183,param1));
                  this.var_183 = null;
                  if(param1.disposed)
                  {
                     return null;

package com.sulake.core.window.utils
{
   ...
   public class GenericEventQueue implements IEventQueue, IDisposable
   {
      ...
      {
         var _loc1_:* = null;
         if(this._index < this.var_489.length)
         {
            _loc1_ = this.var_489[this._index];
            ++this._index;
         }
         return _loc1_;
      }
      ...
      {
         this.var_489.splice(this._index - 1,1);
         if(this._index > 0)
         {
            --this._index;
         }
      ...
      {
         this.var_489.splice(0,this.var_489.length);
         this._index = 0;
      }

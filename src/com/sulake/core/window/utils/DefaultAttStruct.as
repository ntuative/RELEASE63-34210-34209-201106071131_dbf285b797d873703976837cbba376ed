package com.sulake.core.window.utils
{
   public class DefaultAttStruct
   {
      ...
      public static var var_2157:Boolean = false;
      ...
      {
         return var_2157 && (this.width_min > int.MIN_VALUE || this.height_min > int.MIN_VALUE || this.width_max < int.MAX_VALUE || this.height_max < int.MAX_VALUE);
      }
   }
}

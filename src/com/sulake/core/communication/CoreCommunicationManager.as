package com.sulake.core.communication
{
   ...
   public class CoreCommunicationManager extends Component implements ICoreCommunicationManager, IUpdateReceiver
   {
      ...
      public function createConnection(param1:String, param2:uint = 0) : IConnection
      {
         ...
         switch(param2)
         {
            case ConnectionType.const_1292:
               _loc3_ = new SocketConnection(param1,this,this.var_1968);
               break;
            default:
      ...
      {
         var _loc2_:Class = this.var_1272[param1];
         var _loc3_:* = null;
         if(_loc2_ != null)
         {
      ...
      public function getMessageParser(param1:Class) : IMessageParser
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         for each(var _loc6_ in this.var_1550)
         {
            _loc3_ = _loc6_;
            _loc6_;
            if(_loc3_ is param1)

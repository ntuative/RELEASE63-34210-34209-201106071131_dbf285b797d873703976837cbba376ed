package com.sulake.room
{
   ...
   public class RoomManager extends Component implements IRoomManager, IRoomInstanceContainer
   {
      ...
      private var var_3029:IRoomContentLoader;
      ...
      public function RoomManager(param1:IContext, param2:uint = 0)
      {
         ...
         this.var_614 = [];
         this.var_615 = [];
         events.addEventListener(RoomContentLoadedEvent.const_398,this.onContentLoaded);
         events.addEventListener(RoomContentLoadedEvent.const_589,this.onContentLoaded);
         events.addEventListener(RoomContentLoadedEvent.const_964,this.onContentLoaded);
      }
      ...
      {
         var _loc1_:* = null;
         if(this.var_616 == null || this.var_511 == null)
         {
            return;
         }
         this._state = const_1803;
         if(this.var_1166 != null)
         {
            _loc1_ = this.var_1166;
            this.var_1166 = null;
      ...
      public function initialize(param1:XML, param2:IRoomManagerListener) : Boolean
      {
         ...
         while(_loc4_ < _loc3_.length)
         {
            ...
            if(this.var_614.indexOf(_loc5_) < 0)
            {
      ...
      {
         var _loc4_:* = null;
         var _loc2_:int = this.var_615.indexOf(param1);
         if(_loc2_ >= 0)
         {
            return;
         }
         this.var_615.push(param1);
      ...
      public function createRoom(param1:String, param2:XML) : IRoomInstance
      {
         ...
         var _loc4_:int = this.var_615.length - 1;
         while(_loc4_ >= 0)
         {
            _loc5_ = this.var_615[_loc4_];
      ...
      {
         return this.var_108.getWithIndex(param1);
      }
      ...
      private function processInitialContentLoad(param1:String) : void
      {
         ...
         if(this.var_59.getGraphicAssetCollection(param1) != null)
         {
            _loc2_ = this.var_614.indexOf(param1);
            if(_loc2_ >= 0)
            {
               this.var_614.splice(_loc2_,1);
            }
            if(this.var_614.length == 0)
            {
               this._state = const_720;
      ...
      private function onContentLoaded(param1:RoomContentLoadedEvent) : void
      {
         ...
         if(this.var_936.indexOf(_loc2_) < 0)
         {
      ...
      private function processLoadedContentTypes() : void
      {
         ...
         while(this.var_936.length > 0)
         {
            _loc2_ = this.var_936[0];
            this.var_936.splice(0,1);
      ...
      private function updateObjectContents(param1:String) : void
      {
         ...
         if(this.var_59 == null || this.var_511 == null)
         {
            return;
         }
         ...
         while(_loc8_ >= 0)
         {
            ...
            if(_loc9_ != null)
            {
               ...
               for each(_loc12_ in _loc11_)
               {
                  ...
                  while(_loc14_ >= 0)
                  {
                     _loc15_ = _loc9_.method_5(_loc14_,param1,_loc12_) as IRoomObjectController;
                     if(_loc15_ != null)
                     {

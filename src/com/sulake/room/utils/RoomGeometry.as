package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      public static const const_1274:Number = 32;
      ...
      private var var_1742:Number = 1.0;
      ...
      private var var_2999:Number = -500.0;
      
      private var var_2998:Number = 500.0;
      ...
      public function RoomGeometry(param1:Number, param2:IVector3d, param3:IVector3d, param4:IVector3d = null)
      {
         ...
         this.x_scale = 1;
         this.y_scale = 1;
         this.var_1741 = Math.sqrt(0.5) / Math.sqrt(0.75);
         this.z_scale = 1;
      ...
      {
         this.var_431.assign(this.var_100);
         this.var_431.x *= this.var_429;
         this.var_431.y *= this.var_428;
         this.var_431.z *= this.var_427;
         return this.var_431;
      }
      ...
      {
         if(this.var_429 != param1 * this.var_1742)
         {
            this.var_429 = param1 * this.var_1742;
            ++this.var_166;
         }
      }
      ...
      {
         if(this.var_428 != param1 * this.var_1740)
         {
            this.var_428 = param1 * this.var_1740;
            ++this.var_166;
         }
      }
      ...
      {
         if(this.var_427 != param1 * this.var_1741)
         {
            this.var_427 = param1 * this.var_1741;
            ++this.var_166;
         }
      }
      ...
      public function set location(param1:IVector3d) : void
      {
         ...
         var _loc2_:Number = this.var_100.x;
         var _loc3_:Number = this.var_100.y;
         var _loc4_:Number = this.var_100.z;
         this.var_100.assign(param1);
         this.var_100.x /= this.var_429;
         this.var_100.y /= this.var_428;
         this.var_100.z /= this.var_427;
         if(this.var_100.x != _loc2_ || this.var_100.y != _loc3_ || this.var_100.z != _loc4_)
         {
            ++this.var_166;
         }
      }
      ...
      public function set direction(param1:IVector3d) : void
      {
         ...
         if(_loc10_ != 0)
         {
            ...
            this.var_1163.assign(this.var_181);
         }
         else
         {
      ...
      public function setDisplacement(param1:IVector3d, param2:IVector3d) : void
      {
         ...
         if(this.var_510 != null)
         {
            ...
            this.var_510.remove(_loc3_);
            _loc4_ = new Vector3d();
            _loc4_.assign(param2);
            this.var_510.add(_loc3_,_loc4_);
            ++this.var_166;
         }
      }
      ...
      private function getDisplacenent(param1:IVector3d) : IVector3d
      {
         ...
         if(this.var_510 != null)
         {
            ...
            return this.var_510.getValue(_loc2_);
         }
         return null;
      }
      ...
      {
         var _loc2_:Vector3d = Vector3d.dif(param1,this.var_100);
         _loc2_.x *= this.var_429;
         _loc2_.y *= this.var_428;
         _loc2_.z *= this.var_427;
         var _loc3_:Number = Vector3d.scalarProjection(_loc2_,this.var_1164);
         if(_loc3_ < this.var_2999 || _loc3_ > this.var_2998)
         {
            return null;
         }
         ...
         if(_loc6_ != null)
         {
            _loc2_ = Vector3d.dif(param1,this.var_100);
            _loc2_.add(_loc6_);
            _loc2_.x *= this.var_429;
            _loc2_.y *= this.var_428;
            _loc2_.z *= this.var_427;
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         var _loc8_:Vector3d = new Vector3d(this.var_100.x * this.var_429,this.var_100.y * this.var_428,this.var_100.z * this.var_427);
         _loc8_.add(_loc7_);
         var _loc9_:IVector3d = this.var_181;
         var _loc10_:Vector3d = new Vector3d(param2.x * this.var_429,param2.y * this.var_428,param2.z * this.var_427);
         var _loc11_:Vector3d = new Vector3d(param3.x * this.var_429,param3.y * this.var_428,param3.z * this.var_427);
         var _loc12_:Vector3d = new Vector3d(param4.x * this.var_429,param4.y * this.var_428,param4.z * this.var_427);
      ...
      public function performZoom() : void
      {
         if(this.isZoomedIn())
         {
            this.scale = const_1274;
         }
         else
         {
            this.scale = const_574;
         }
      }
      
      public function isZoomedIn() : Boolean
      {
         return this.scale == const_574;
      }

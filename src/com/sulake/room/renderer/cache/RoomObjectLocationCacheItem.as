package com.sulake.room.renderer.cache
{
   ...
   public class RoomObjectLocationCacheItem
   {
      ...
      public function getScreenLocation(param1:IRoomObject, param2:IRoomGeometry) : IVector3d
      {
         ...
         if(param2.updateId != this.var_1849 || param1.getUpdateID() != this.var_2693)
         {
            this.var_2693 = param1.getUpdateID();
            if(param2.updateId != this.var_1849 || _loc4_.x != this.var_1268.x || _loc4_.y != this.var_1268.y || _loc4_.z != this.var_1268.z)
            {
               this.var_1849 = param2.updateId;
               this.var_1268.assign(_loc4_);
               _loc3_ = true;
            }
         }
         this.var_2694 = _loc3_;
         if(_loc3_)
         {
            ...
            if(isNaN(_loc6_) || _loc6_ == 0)
            {
               ...
               if(_loc7_.x != _loc4_.x || _loc7_.y != _loc4_.y)
               {
                  ...
                  this.var_382.assign(_loc5_);
                  if(_loc8_ != null)
                  {
                     this.var_382.z = _loc8_.z;
                  }
               }
               else
               {
            ...
            this.var_382.x = Math.round(this.var_382.x);
            this.var_382.y = Math.round(this.var_382.y);
         }
         return this.var_382;
      }
   }

package com.sulake.room.renderer.cache
{
   ...
   public class BitmapDataCache
   {
      ...
      public function BitmapDataCache(param1:int, param2:int, param3:int = 1)
      {
         ...
         this.var_995 = param1 * 1024 * 1024;
         this.var_1909 = param2 * 1024 * 1024;
      ...
      {
         this.var_995 += this.var_1527;
         if(this.var_995 > this.var_1909)
         {
            this.var_995 = this.var_1909;
         }
      }
      ...
      public function addBitmapData(param1:String, param2:ExtendedBitmapData) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            if(_loc4_ != null)
            {
               this.var_814 -= _loc4_.width * _loc4_.height * 4;
            }
         ...
         this.var_814 += param2.width * param2.height * 4;
      }
   }
}

package com.sulake.room.renderer.utils
{
   ...
   public class ExtendedSprite extends Bitmap
   {
      ...
      private var var_1638:int = 128;
      
      private var var_1639:Boolean = false;
      
      private var var_3021:Point;
      ...
      {
         if(param1 != this.var_2114 || param2 != this.var_2113)
         {
      ...
      {
         if(this.var_1638 > 255 || bitmapData == null)
         {
            return false;
         }
         if(param1 < 0 || param2 < 0 || param1 >= this.var_265 || param2 >= this._height)
         {
            return false;
         }

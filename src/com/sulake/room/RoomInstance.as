   ...
   public class RoomInstance implements IRoomInstance
   {
      ...
      public function dispose() : void
      {
         ...
         if(this.var_278 != null)
         {
            ...
            {
               _loc3_ = this.var_278.getWithIndex(_loc2_) as IRoomObjectManager;
               if(_loc3_ != null)
               {
                  _loc3_.dispose();
               }
      ...
      {
         if(this.var_1414.indexOf(param1) >= 0)
         {
            return;
         }
         if(param3)
         {
            this.var_1414.push(param1);
         }
      ...
      {
         if(this.var_1413.indexOf(param1) >= 0)
         {
            return;
         }
         if(param3)
         {
            this.var_1413.push(param1);
         }
      ...
      public function update() : void
      {
         ...
         var _loc2_:int = this.var_615.length - 1;
         while(_loc2_ >= 0)
         {
            _loc3_ = int(this.var_615[_loc2_]);
      ...
      public function method_5(param1:int, param2:String, param3:int) : IRoomObject
      {
         var _loc4_:IRoomObjectManager = this.getObjectManager(param3);
         if(_loc4_ != null)
         {
            return _loc4_.method_5(param1,param2);
         }
         return null;
      }
      ...
      protected function createObjectManager(param1:int) : IRoomObjectManager
      {
         ...
         {
            return this.var_278.getValue(_loc2_) as IRoomObjectManager;
         }
         if(this._container == null)
         {
            return null;
      ...
      {
         return this.var_278.getValue(String(param1)) as IRoomObjectManager;
      }
      ...
      protected function disposeObjectManager(param1:int) : Boolean
      {
         ...
         if(this.var_278.getValue(_loc2_) != null)
         {
            _loc3_ = this.var_278.remove(_loc2_) as IRoomObjectManager;
            if(_loc3_ != null)
            {
               _loc3_.dispose();
            }

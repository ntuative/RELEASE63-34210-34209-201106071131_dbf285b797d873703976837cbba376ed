package com.sulake.room.object.visualization.utils
{
   ...
   public class GraphicAssetCollection implements IGraphicAssetCollection
   {
      ...
      private static const const_1652:int = 10;
       
      
      private var _assets:Map;
      
      private var var_404:IAssetLibrary;
      ...
      private function defineAssets(param1:XMLList) : void
      {
         ...
         while(_loc3_ < _loc2_)
         {
            ...
            if(_loc5_.length > 0)
            {
               ...
               _loc12_ = this.var_404.getAssetByName(_loc6_);
               if(_loc12_ != null)
               {
      ...
      private function definePalettes(param1:XMLList) : void
      {
         ...
         for each(_loc3_ in param1)
         {
            if(XMLValidator.checkRequiredAttributes(_loc3_,_loc2_))
            {
               ...
               {
                  _loc6_ = this.var_404.getAssetByName(_loc5_);
      ...
      public function addAsset(param1:String, param2:BitmapData, param3:Boolean, param4:int = 0, param5:int = 0, param6:Boolean = false, param7:Boolean = false) : Boolean
      {
         ...
         if(_loc8_ == null)
         {
            _loc8_ = new BitmapDataAsset(this.var_404.getAssetTypeDeclarationByClass(BitmapDataAsset));
            this.var_404.setAsset(param1,_loc8_);
      ...
      public function disposeAsset(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            if(_loc3_ != null)
            {
               this.var_404.removeAsset(_loc3_);
               _loc3_.dispose();
            }
            _loc2_.dispose();
         }
      ...
      {
         return this.var_404.getAssetByName(param1) as BitmapDataAsset;
      }
      ...
      private function addLibraryAsset(param1:String, param2:BitmapData) : BitmapDataAsset
      {
         ...
         if(_loc3_ == null)
         {
            _loc3_ = new BitmapDataAsset(this.var_404.getAssetTypeDeclarationByClass(BitmapDataAsset));
            this.var_404.setAsset(param1,_loc3_);
      ...
      private function disposePaletteAssets(param1:Boolean = true) : void
      {
         ...
         if(this.var_705 != null)
         {
            if(param1 || this.var_705.length > const_1652)
            {
               for each(_loc2_ in this.var_705)
               {

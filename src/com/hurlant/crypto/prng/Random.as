   ...
   public class Random
   {
      ...
      public function Random(param1:Class = null)
      {
         ...
         while(this.var_121 < this.psize)
         {
            ...
            var _loc4_:*;
            this.var_164[_loc4_ = this.var_121++] = _loc2_ & 255;
         }
         this.var_121 = 0;
         this.seed();
      }
      ...
      public function seed(param1:int = 0) : void
      {
         ...
         var _loc4_:*;
         this.var_164[_loc4_ = this.var_121++] = this.var_164[_loc4_] ^ param1 >> 16 & 255;
         var _loc5_:*;
         this.var_164[_loc5_ = this.var_121++] = this.var_164[_loc5_] ^ param1 >> 24 & 255;

package com.hurlant.math
{
   ...
   class BarrettReduction implements IReduction
   {
      ...
      private var var_2322:BigInteger;
      ...
      function BarrettReduction(param1:BigInteger)
      {
         ...
         BigInteger.const_171.dlShiftTo(2 * param1.t,this.r2);
         this.var_2322 = this.r2.divide(param1);
         this.m = param1;
      }
      ...
      public function reduce(param1:BigInteger) : void
      {
         ...
         this.var_2322.multiplyUpperTo(this.r2,this.m.t + 1,this.q3);
